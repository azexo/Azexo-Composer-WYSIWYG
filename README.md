...
If you need make HTML page(s) via Azexo Composer and export them into ZIP archive (all used files (images, js, css) provided via ZIP archive) - you can try this [product](http://codecanyon.net/item/azexo-composer-page-builder-for-html-templates/8074732?ref=azexo).
