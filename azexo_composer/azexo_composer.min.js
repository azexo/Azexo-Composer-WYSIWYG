...
var u=""
r.indexOf(",")<0&&(u="font-weight: "+r+c+";"),l+=t[a].selector+'{font-family: "'+i+'" '+c+"; "+u+"}"}}}return l+="</style>"}function i(){e(X).detach(),e(X).appendTo("body"),e(X).empty(),e(X).append(o(xn.theme))}function s(t,n,a){var o={}
return e(t).find(n).each(function(){o[e(this).attr(a)]=!0,e(this).remove()}),o}function r(n,a,i){for(var r={},l={},d=e("<div>"+vn+"</div>"),c=0;c<n.length;c++){var p=n[c],m=p.attrs.container.split("/")[0],h=p.attrs.container.split("/")[1],u=e(d).find('.az-container[data-az-type="'+m+'"][data-az-name="'+h+'"]')
if(e(u).empty(),e(u).append(p.get_hover_styles(p)),a){var _=window.azexo_online
window.azexo_online=!1,e(u).append(p.get_loader()),window.azexo_online=_}e(u).append(p.get_html()),r=e.extend(r,n[c].js),l=e.extend(l,n[c].css)}var f=""
e.each(gn,function(){f=f+this.name+'"'+this.value+'" '}),l=e.extend(l,s(d,".az-container link[href]","href")),r=e.extend(r,s(d,".az-container script[src]","src")),t(d),e(d).find(".azexo-backend").remove(),e(d).find(".azexo-editor").removeClass("azexo-editor"),e(d).find(".ui-sortable").removeClass("ui-sortable"),e(document).trigger("azexo_export_filter",{dom:d}),e(d).append(o(xn.theme))
var v="<body "+f+">"+e(d).html()+"</body>",d=e("<div>"+fn+"</div>")
e(d).find(".azexo-backend").remove(),e(document).trigger("azexo_export_filter",{dom:d}),e(d).find("title").text(i),t(d)
for(var g in r)e(d).append('<script src="'+at(g)+'"></script>')
for(var g in l)e(d).append('<link rel="stylesheet" type="text/css" href="'+at(g)+'">')
e(d).append("<script type='text/javascript'> window.ajaxurl = '"+at(window.ajaxurl)+"'; </script>"),e(d).append('<script type="text/javascript"> window.azexo_site_name = "'+yn+'"; </script>')
var y="<head>"+e(d).html()+"</head>"
return"<!DOCTYPE html><html>"+y+v+"</html>"}function d(t){for(var n=0;n<l.length;n++){var a=e(l[n].dom_element).parent()
...
e(O).val(t),e(I).val(wn[t].title),e(document).trigger("azexo_containers_update")}function c(t){var o=new Lt(null,!1)
return o.saveable=!1,o.rendered=!0,o.attrs.container=t,o.html_content=!0,o.loaded_container=o.attrs.container,o.render(e,n,a),e(o.dom_element).attr("data-az-id",o.id),e(o.dom_element).addClass("azexo-editor"),e(o.dom_element).addClass("azexo"),o.show_controls(),o.update_sortable(),o.showed(e,n,a),o}function m(){var e={}
for(var t in bn)if(null!=bn[t]){var n=r(bn[t],!0,wn[t].title)
e[t]=btoa(v(encodeURIComponent(n)))}return e}function h(t,a){e(C).find("a").removeClass(n+"active"),wn[t]={title:a},e('<a href="#" class="'+n+"list-group-item "+n+'active">'+t+"</a>").appendTo(C).click(function(){return e(this).hasClass(n+"active")||(e(C).find("a").removeClass(n+"active"),e(this).addClass(n+"active"),d(e(this).text())),!1})}function u(t){e('<option value="'+t+'">'+t+"</option>").appendTo(F),e(F).find('option[value="'+t+'"]').prop("selected","selected"),bn={},wn={},e(C).empty(),bn.index=[]
for(var n=0;n<l.length;n++)bn.index.push(c(l[n].attrs.container))
h("index","Home"),d("index"),e(Y).click()}function f(t){U(t,function(a){var o=e.parseJSON(a)
yn=t,bn={},wn=o.pages,xn=o.settings,e(C).empty()
for(var s in o.pages){bn[s]=Array(l.length)
for(var r in o.pages[s].containers){var p=c(r)
p.parse_shortcode(decodeURIComponent(v(atob(o.pages[s].containers[r]))))
...
for(var m=0;m<l.length;m++)if(l[m].attrs.container==r){bn[s][m]=p
break}}h(s,o.pages[s].title)}d(o.current_page),i(),e(C).find("a").removeClass(n+"active"),e(C).find('a:contains("'+o.current_page+'")').addClass(n+"active"),e("#az-template-elements-welcome").remove(),e("#az-exporter-welcome").remove()})}function g(t,n){for(var a=[],o={},i=0;i<t.length;i++)a.push(lt(t[i])),o[t[i].param_name]=t[i].value
...
et(t,e)}
for(var b=0;b<l.length;b++)l[b].saveable=!1,e(l[b].controls).remove(),l[b].show_controls()
fn=e("head").html(),vn=e("body").html(),gn=e("body").prop("attributes")
var w=e('<div id="az-exporter" class="az-right-sidebar '+n+'text-center azexo"></div>').appendTo("body"),x=e('<div id="az-exporter-welcome" class="azexo">'+p("Manage and export your site via right panel.")+"</div>").appendTo(w)
e(w).hover(function(){e(x).remove()}),e("<hr>").appendTo(w),e("<h4>"+p("Current site")+"</h4>").appendTo(w)
var z=e('<div class="'+n+'btn-toolbar"></div>').appendTo(w),k=e('<div class="'+n+"btn-group "+n+'btn-group-xs"></div>').appendTo(z),j=e('<div class="'+n+"btn-group "+n+'btn-group-xs"></div>').appendTo(z),T=e('<div class="'+n+"btn-group "+n+'btn-group-xs"></div>').appendTo(z)
e("<hr>").appendTo(w),e('<button class="'+n+"btn "+n+'btn-default">'+p("Add page")+"</button>").appendTo(k).click(function(){var e=window.prompt(p("Please enter page name"),"")
if(""!=e&&null!=e){bn[e]=[]
for(var t=0;t<l.length;t++)bn[e].push(c(l[t].attrs.container))
h(e,e),d(e)}return!1}),e('<button class="'+n+"btn "+n+'btn-danger">'+p("Remove page")+"</button>").appendTo(k).click(function(){if(e(C).find("a").length>1){var t=e(C).find("."+n+"active").text()
e(C).find("."+n+"active").remove()
var a=e(C).find("a:first-child").addClass(n+"active").text()
d(a),delete bn[t],bn[t]=null}return!1}),e('<button class="'+n+"btn "+n+'btn-success">'+p("ZIP download")+"</button>").appendTo(j).click(function(){var e=m()
return azexo_add_js({path:"js/json2.min.js",loaded:"JSON"in window,callback:function(){R(JSON.stringify(e),function(e){e&&(window.location=e)})}}),!1}),e("<h4>"+p("Current site pages")+"</h4>").appendTo(w)
var C=e('<div class="'+n+'list-group"></div>').appendTo(w)
e("<hr>").appendTo(w)
var S=e('<div class="'+n+'text-left"></div>').appendTo(w)
e("<h4>"+p("Current page settings")+"</h4>").appendTo(S)
var O=e('<div class="'+n+'form-group"><label>'+p("File name")+'</label><div><input class="'+n+'form-control" name="name" type="text"></div><p class="'+n+'help-block">'+p('"html"-extension will be added during export process')+"</p></div>").appendTo(S).find('input[name="name"]').change(function(){var t=e(C).find("."+n+"active").text(),a=e(this).val()
bn[a]=bn[t],bn[t]=null,wn[a]=wn[t],wn[t]=null,e(C).find("a."+n+'active:contains("'+t+'")').text(a)
for(var o in bn)if(null!=bn[o])for(var i=0;i<bn[o].length;i++)e(bn[o][i].dom_content_element).find('[href="'+t+'.html"]').each(function(){e(this).attr("href",a+".html")})}),I=e('<div class="'+n+'form-group"><label>'+p("Title")+'</label><div><input class="'+n+'form-control" name="title" type="text"></div><p class="'+n+'help-block">'+p("")+"</p></div>").appendTo(S).find('input[name="title"]').change(function(){var t=e(C).find("."+n+"active").text()
wn[t].title=e(this).val()})
bn.index=l,h("index","Home"),e(O).val("index"),e(I).val("Home")
var P=e('<div class="'+n+"panel "+n+'panel-default"><div class="'+n+'panel-heading" role="tab" id="sites-heading"><h4 class="'+n+'panel-title"><a data-toggle="'+n+'collapse" href="#sites-collapse" aria-expanded="false" class="'+n+'collapsed">'+p("Choose a site for edit")+'</a></h4></div><div id="sites-collapse" class="'+n+"panel-collapse "+n+'collapse" role="tabpanel" aria-labelledby="sites-heading" aria-expanded="false"><div class="'+n+'panel-body"></div></div></div>').prependTo(w).find("."+n+"panel-body")
e("<hr>").appendTo(P)
var A=e('<div class="'+n+"btn-group "+n+'btn-group-xs"></div>').appendTo(P),B=e('<button class="'+n+"btn "+n+'btn-default">'+p("New")+"</button>").appendTo(A).click(function(){var e=window.prompt(p("Please enter site name"),"")
""!=e&&null!=e&&u(e)})
e('<button class="'+n+"btn "+n+'btn-danger">'+p("Delete")+"</button>").appendTo(A).click(function(){M(e(F).find("option:selected").val()),e(F).find("option:selected").remove(),e(F).trigger("change")})
var Y=e('<button class="az-save-site '+n+"btn "+n+'btn-primary">'+p("Save")+"</button>").appendTo(j).click(function(){var t={}
t.settings=xn,t.current_page=e(O).val(),t.pages={}
...
!function(a){e('<li class="'+n+"glyphicon "+n+'glyphicon-folder-close">'+o[r]+"</li>").appendTo(f).click(function(){L(xn.host,xn.username,xn.password,xn.port,a,function(e){t(a,e)})})}(l)}}xn.host=e(r).val(),xn.username=e(l).val(),xn.password=e(d).val(),xn.port=e(c).val(),L(xn.host,xn.username,xn.password,xn.port,xn.directory,function(n){_.isArray(n)?(e(u).hide(),t(xn.directory,n)):alert(n)})})
e(s).find("input").change(function(){xn.host=e(r).val(),xn.username=e(l).val(),xn.password=e(d).val(),xn.port=e(c).val(),xn.directory=e(h).val(),""!=xn.host&&""!=xn.username&&""!=xn.password&&""!=xn.port?(e(u).show(),e(v).show()):(e(u).hide(),e(v).hide())})
var f=e('<ul class="az-browser"></ul>').appendTo(s).hide()
e("<hr>").appendTo(s)
var v=e('<button class="'+n+"btn "+n+'btn-success">'+p("Upload current site")+"</button>").appendTo(s).click(function(){var t=m()
...
q=!1}else t.uploaded.length>0&&e(y).append('<div class="'+n+"alert "+n+'alert-info">'+t.uploaded[0]+" uploaded</div>"),t.count>0?(0==a&&(a=t.count),e(g).show().find("."+n+"progress-bar").css("width",(a-t.count)/a*100+"%"),q=!0,E(JSON.stringify({}),t.site_path,JSON.stringify(t.files),xn.host,xn.username,xn.password,xn.port,xn.directory,o)):(e(g).show().find("."+n+"progress-bar").css("width","100%"),e(y).append('<div class="'+n+"alert "+n+'alert-success">'+p("Done")+"</div>"),q=!1)}
q=!0,E(JSON.stringify(t),"",JSON.stringify([]),xn.host,xn.username,xn.password,xn.port,xn.directory,o)}})})
...
var F=e('<select class="'+n+'form-control"></select>').prependTo(P).change(function(){f(e(this).find("option:selected").val())})
D(function(t){for(var n=0;n<t.length;n++)e('<option value="'+t[n]+'">'+t[n]+"</option>").appendTo(F)
var a="My site"
e(F).find("option:selected").length>0&&(a=e(F).find("option:selected").val())
for(var o=window.location.search.replace("?","").split("&"),n=0;n<o.length;n++){var i=o[n].split("=")
"current_site"==i[0]&&(a=decodeURIComponent(i[1]))}"create-new-site"==a?e(B).click():0==e(F).find('[value="'+a+'"]').length?u(a):(e(F).find('option[value="'+a+'"]').prop("selected","selected"),f(a))})
var X=e("<div></div>").appendTo(w)
e('<button class="az-theme-settings '+n+"btn "+n+'btn-default">'+p("Theme")+"</button>").appendTo(T).click(function(){return g(xn.theme,function(e){xn.theme=e,i()}),!1}),e('<button class="'+n+"btn "+n+'btn-default">'+p("Configuration")+"</button>").appendTo(T).click(function(){return azexo_add_js({path:"js/json2.min.js",loaded:"JSON"in window,callback:function(){function t(){for(var t=.05,n=["color","background-color","border-left-color","border-right-color","border-top-color","border-bottom-color","outline-color"],a={},o=0;o<document.styleSheets.length;o++){var i=document.styleSheets[o]
...
l.push(_),r++}}var f=[],v=[]
for(var d in s){var g=d.match(/rgb\((\d+),\s*(\d+),\s*(\d+)\)/),b=$(g[1],g[2],g[3])
...
if("azexo_colors"in window)for(var r=0;r<window.azexo_colors.length;r++){for(var g=H(window.azexo_colors[r]),b=$(parseInt(g[0]),parseInt(g[1]),parseInt(g[2])),C=1,P=0,u=0;u<k.length;u++){var O=n(b,k[u])
C>O&&(C=O,P=u)}I.push(P)}for(var r=0;r<k.length;r++)if(I.indexOf(r)>=0||0==I.length){var g=J(k[r][0],k[r][1],k[r][2]),_={type:"colorpicker",heading:p("Color group")+" "+r,param_name:"color_group_"+r,value:"rgb("+g[0]+","+g[1]+","+g[2]+")",group:j[r],dependency:{element:"color_group_"+r,not_empty:{}}}
...
l.unshift(_)}}o=JSON.stringify(l,null,"	")}y(o,function(t){xn.theme=e.parseJSON(t),i()})}}),!1}),window.azexo_editor||e(w).hide()}}window.azexo_backend=!0
...
return(u(f)||"an_start"in g||"an_scenes"in g)&&(b='<script type="text/javascript">//<![CDATA['+h()+"//]]></script>"),b},get_html:function(){this.recursive_update_data(),this.recursive_clear_animation()
var t=e("<div>"+e(this.dom_content_element).html()+"</div>")
return this.recursive_restore(t),e(t).find(".az-element > .controls").remove(),e(t).find("> .controls").remove(),e(t).find(".az-sortable-controls").remove(),e(t).find(".az-step-controls").remove(),e(t).find(".az-empty").remove(),e(t).find(".ui-resizable-e").remove(),e(t).find(".ui-resizable-s").remove(),e(t).find(".ui-resizable-se").remove(),e(t).find(".editable-highlight").removeClass("editable-highlight"),e(t).find(".styleable-highlight").removeClass("styleable-highlight"),e(t).find(".sortable-highlight").removeClass("sortable-highlight"),e(t).find(".ui-draggable").removeClass("ui-draggable"),e(t).find(".ui-resizable").removeClass("ui-resizable"),e(t).find(".ui-sortable").removeClass("ui-sortable"),e(t).find(".az-element.az-container > .az-ctnr").empty(),e(t).find(".az-element.az-cms-element").empty(),e(t).find(".g-recaptcha").empty(),e(t).html()},get_container_html:function(){return this.get_css(this)+this.get_hover_styles(this)+this.get_js(this)+this.get_loader()+this.get_html()},click_save_container:function(e){return e.data.object.save_container(),!1},save_container:function(){var e=this
