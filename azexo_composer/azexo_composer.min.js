...
null!=i.parent&&null==i.parent.parent&&a()}),e(document).on("azexo_delete_element",function(t,n){e(g).find('li[data-section-id="'+n+'"]').remove()}),e(document).on("azexo_containers_update",function(){a()}),e("<hr>").appendTo(f),e("<h3>"+p("Elements")+"</h3>").appendTo(f),e("<hr>").appendTo(f),e(f).append(o(i)),e(f).find("> .az-nav-list > li").on("mouseleave",function(){e(this).find(".az-nav-list").css("display","none")})
