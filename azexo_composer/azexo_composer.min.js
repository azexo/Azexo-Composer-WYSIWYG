...
"function"==typeof o&&o!=e.toString&&o!=n.toString&&"\nfunction toString() {\n    [native code]\n}\n"!=o&&(e.toString=t.toString)}return e}function q(e,t,n,a){return 0>n&&(n+=e.length),a=void 0!==a?a:e.length,0>a&&(a=a+e.length-n),e.slice(0,n)+t.substr(0,a)+t.slice(a)+e.slice(n+a)}function F(e){function t(e){return("0"+parseInt(e).toString(16)).slice(-2)}return e.replace(/rgb\((\d+),\s*(\d+),\s*(\d+)\)/g,function(e,n,a,o){return"#"+t(n)+t(a)+t(o)})}function H(e){e=e.lastIndexOf("#")>-1?e.replace(/#/,"0x"):"0x"+e
var t=e>>16,n=(65280&e)>>8,a=255&e
return[t,n,a]}function J(e,t,n){function a(e,t,n){return 0>n&&(n+=1),n>1&&(n-=1),1/6>n?e+6*(t-e)*n:.5>n?t:2/3>n?e+(t-e)*(2/3-n)*6:e}var o,i,s
if(0==t)o=i=s=n
else{var r=.5>n?n*(1+t):n+t-n*t,l=2*n-r
o=a(l,r,e+1/3),i=a(l,r,e),s=a(l,r,e-1/3)}return[Math.round(255*o),Math.round(255*i),Math.round(255*s)]}function $(e,t,n){e/=255,t/=255,n/=255
var a,o,i=Math.max(e,t,n),s=Math.min(e,t,n),r=(i+s)/2
if(i==s)a=o=0
else{var l=i-s
switch(o=r>.5?l/(2-i-s):l/(i+s),i){case e:a=(t-n)/l+(n>t?6:0)
break
case t:a=(n-e)/l+2
break
case n:a=(e-t)/l+4}a/=6}return[a,o,r]}function X(e,t){var a=n+"col-"+t+"-",o=e?e.split("/"):[1,1],i=_.range(1,13),s=!_.isUndefined(o[0])&&_.indexOf(i,parseInt(o[0],10))>=0?parseInt(o[0],10):!1,r=!_.isUndefined(o[1])&&_.indexOf(i,parseInt(o[1],10))>=0?parseInt(o[1],10):!1
return s!==!1&&r!==!1?a+12*s/r:a+"12"}function W(e){return _.isString(e)?e.replace(/(\`{2})/g,'"'):e}function V(e){return decodeURIComponent((e+"").replace(/%(?![\da-f]{2})/gi,function(){return"%25"}))}function G(e,t,n){var a=new Date
a.setDate(a.getDate()+n)
var o=encodeURIComponent(t)+(null===n?"":"; expires="+a.toUTCString())
document.cookie=e+"="+o}function Q(e){var t,n,a,o=document.cookie.split(";")
for(t=0;t<o.length;t++)if(n=o[t].substr(0,o[t].indexOf("=")),a=o[t].substr(o[t].indexOf("=")+1),n=n.replace(/^\s+|\s+$/g,""),n==e)return decodeURIComponent(a)}function Z(t){var n=parseInt(e(t).css("z-index"))
return e(t).parent().find("*").each(function(){var t=parseInt(e(this).css("z-index"))
t>n&&(n=t)}),n}function K(t){var n=Z(t)
e(t).css("z-index",n+1)}function et(t,n){var a="<select>"
...
return e(i).chosen({search_contains:!0,allow_single_deselect:!0}),e(i).change(function(){e(this).find("option:selected").each(function(){e(n).val(e(this).val())})}),e(i).parent().find(".chosen-container").width("100%"),e('<div><a class="direct-input" href="#">'+p("Direct input")+"</a></div>").insertBefore(i).click(function(){e(n).css("display","block"),e(i).parent().find(".chosen-container").remove(),e(i).remove(),e(this).remove()}),i}function tt(t,n,a){var o='<select multiple="multiple">',i=""
...
e(this).find("option:selected").each(function(){t.push(e(this).val())}),e(n).val(t.join(a))}),e(r).parent().find(".chosen-container").width("100%"),e('<div><a class="direct-input" href="#">'+p("Direct input")+"</a></div>").insertBefore(r).click(function(){e(n).css("display","block"),e(r).parent().find(".chosen-container").remove(),e(r).remove(),e(this).remove()}),r}function nt(e){var t=/^.*((youtu.be\/)|(v\/)|(\/u\/\w\/)|(embed\/)|(watch\?))\??v?=?([^#\&\?]*).*/,n=e.match(t)
return n&&11==n[7].length?n[7]:!1}function at(e){if(-1!=e.search(/^\/\//))return window.location.protocol+e
if(-1!=e.search(/:\/\//))return e
if(-1!=e.search(/^\//))return window.location.origin+e
var t=window.location.href.match(/(.*\/)/)[0]
return t+e}function ot(e,t,a){var o='<select name="'+t+'" class="'+n+'form-control">'
o+='<option value="">'+p("Please select")+"</option>"
for(var i in e)o+=i==a?'<option value="'+i+'" selected>'+e[i]+"</option>":'<option value="'+i+'">'+e[i]+"</option>"
return o+="/<select>"}function it(e){return'<div class="'+n+"alert "+n+"alert-warning "+n+"fade "+n+'in" role="alert"><button type="button" class="'+n+'close" data-dismiss="'+n+'alert"><span aria-hidden="true">×</span><span class="'+n+'sr-only">'+p("Close")+"</span></button>"+e+"</div>"}function st(){this.dom_element=null,this.heading="",this.description="",this.param_name="",this.required=!1,this.admin_label="",this.holder="",this.wrapper_class="",this.value=null,this.can_be_empty=!1,this.hidden=!1,this.tab="",this.dependency={},"create"in this&&this.create()}function rt(e,t){B(t,st),t.prototype.type=e,st.prototype.param_types[e]=t}function lt(e){if(e.type in st.prototype.param_types){var t=new st.prototype.param_types[e.type]
return Y(t,e),t}var t=new st
return Y(t,e),t}function dt(){dt.baseclass.apply(this,arguments)}function ct(e){var t=document.createElement("div")
return t.innerHTML=e,0===t.childNodes.length?"":t.childNodes[0].nodeValue}function pt(){pt.baseclass.apply(this,arguments)}function mt(){}function ht(e,n){this.id=_.uniqueId(t?"f":"b"),null!=e&&(this.parent=e,"boolean"==typeof n?n?e.children.push(this):e.children.unshift(this):e.children.splice(n,0,this)),this.children=[],this.dom_element=null,this.dom_content_element=null,this.attrs={}
...
this.controls=null,s.add_element(this.id,this,n)}function ut(e,t,n){if(B(n,ht),n.prototype.base=e,n.prototype.is_container=t,ht.prototype.elements[e]=n,ht.prototype.tags[e]=n,t)for(var a=1;a<ht.prototype.max_nested_depth;a++)ht.prototype.tags[e+"_"+a]=n}function _t(){_t.baseclass.apply(this,arguments)}function ft(){if(window.azexo_editor){azexo_add_css("css/font-awesome.css",function(){}),0==e("#azexo-clipboard").length&&e("body").prepend('<div id="azexo-clipboard" style="display:none"></div>'),azexo_add_js({path:"chosen/chosen.jquery.min.js"}),azexo_add_css("chosen/chosen.min.css",function(){})
for(var t in s.elements_instances){var n=s.elements_instances[t]
n instanceof Lt&&e(n.dom_element).addClass("azexo-editor"),null==n.controls&&n.show_controls(),n.update_sortable()}e("#az-exporter").show()}else{for(var t in s.elements_instances){var n=s.elements_instances[t]
n instanceof Lt&&e(n.dom_element).removeClass("azexo-editor"),null!=n.controls&&e(n.controls).remove(),n.update_empty()}e("#az-exporter").hide()}}function vt(){"ajaxurl"in window||(!window.azexo_editor||window.azexo_online)&&delete window.azexo_editor,h(function(t){window.azexo_editor=t,e(function(){ft()}),!t&&"azexo_exporter"in window&&bt()})}function gt(t){e.holdReady(!0),"complete"===document.readyState?setTimeout(t):document.addEventListener?(document.addEventListener("DOMContentLoaded",t,!1),window.addEventListener("load",t,!1)):(document.attachEvent("onreadystatechange",t),window.attachEvent("onload",t))}function yt(o){if(e(o).length>0){var i=e(o).html(),s=/^\s*\<[\s\S]*\>\s*$/.exec(i)
...
e(o).replaceWith(r.dom_element),e(r.dom_element).attr("data-az-type",p),e(r.dom_element).attr("data-az-name",m),r.showed(e,n,a),window.azexo_editor&&r.show_controls()}return window.azexo_editor&&e(r.dom_element).addClass("azexo-editor"),r}return null}function bt(){e("#az-admin-modal").remove()
...
P(function(t){t.length>0&&"0"!=t&&"false"!=t&&(s=e(t).on("keydown.azexo",function(t){13==t.keyCode&&e("#az-admin-modal").find(".save").click()}),e(i).find("."+n+"modal-body").append(s),window.azexo_editor&&e('<button type="button" class="'+n+"btn "+n+'btn-default" data-dismiss="'+n+'modal">'+p("Logout")+"</button>").appendTo("#az-admin-modal .modal-footer").click(function(){G("azexo_password","",null),window.location.reload()}),e("#az-admin-modal").find(".save").click(function(){return A(s.serialize(),function(t){t&&window.location.reload(),e("#az-admin-modal")[a+"modal"]("hide")}),!1}),e("#az-admin-modal")[a+"modal"]("show"))})}function wt(){un||(un=!0,e(".az-container").each(function(){var e=yt(this)
e&&l.push(e)}),window.azexo_editor&&0==e("#azexo-clipboard").length&&e("body").prepend('<div id="azexo-clipboard" class="azexo-backend" style="display:none"></div>'),e("body").on("keydown.azexo",function(e){e.ctrlKey&&e.altKey&&bt()}))}function xt(){xt.baseclass.apply(this,arguments)}function zt(e,t,n){if(B(n,xt),n.prototype.base=e,n.prototype.is_container=t,xt.prototype.elements[e]=n,xt.prototype.tags[e]=n,t)for(var a=1;a<xt.prototype.max_nested_depth;a++)xt.prototype.tags[e+"_"+a]=n}function kt(){kt.baseclass.apply(this,arguments)}function jt(e,t){jt.baseclass.apply(this,arguments),this.columns="",t&&"boolean"==typeof t||this.set_columns("1/1"),this.attrs.device="sm"}function Tt(e,t){Tt.baseclass.call(this,e,t)}function Ct(e,t){Ct.baseclass.apply(this,arguments),this.linked_elements_index={},t&&"boolean"==typeof t||this.add_item(),this.attach_events()}function St(){St.baseclass.apply(this,arguments)}function Ot(){Ot.baseclass.apply(this,arguments)}function It(e,t){It.baseclass.apply(this,arguments),t&&"boolean"==typeof t||this.add_tab()}function Pt(){Pt.baseclass.apply(this,arguments)}function At(e,t){At.baseclass.apply(this,arguments),t&&"boolean"==typeof t||this.add_toggle()}function Rt(){Rt.baseclass.apply(this,arguments)}function Dt(e,t){Dt.baseclass.apply(this,arguments),t&&"boolean"==typeof t||this.add_slide()}function Ut(){Ut.baseclass.apply(this,arguments)}function Nt(e,t){Nt.baseclass.apply(this,arguments),t&&"boolean"==typeof t||this.add_step(),window.azexo_editor&&this.init_scroll_variables()}function Mt(){Mt.baseclass.apply(this,arguments)}function Lt(){Lt.baseclass.apply(this,arguments),this.rendered=!1,this.loaded_container=null,this.js={},this.css={}}function Et(){Et.baseclass.apply(this,arguments),this.menu_items={}
for(var t in s.elements_instances){var o=s.elements_instances[t]
o instanceof kt&&""!=o.attrs.menu_item_title&&(this.menu_items[t]=o.attrs.menu_item_title)}var i=this,r=function(t,o){e("body")[a+"scrollspy"]({target:"#"+i.id+".navbar-collapse",offset:i.navbar_height})
var r=s.get_element(o)
r instanceof kt&&(""!=r.attrs.menu_item_title?(i.menu_items[o]=r.attrs.menu_item_title,i.replace_render(),i.showed(e,n,a)):o in i.menu_items&&(delete i.menu_items[o],i.replace_render(),i.showed(e,n,a)))}
...
var r=s.get_element(o)
r instanceof kt&&(delete i.menu_items[o],i.replace_render(),i.showed(e,n,a))}),e(document).on("azexo_update_sorting",function(t,o){e("body")[a+"scrollspy"]({target:"#"+i.id+".navbar-collapse",offset:i.navbar_height})
var r=e(o.item).closest("[data-az-id]").attr("data-az-id"),l=s.get_element(r)
i.id==r&&e(l.dom_element).find("."+n+"navbar")[a+"affix"]({offset:{top:e(l.dom_element).find("."+n+"navbar").offset().top,bottom:0}})})}function Bt(){Bt.baseclass.apply(this,arguments)}function Yt(){Yt.baseclass.apply(this,arguments)}function qt(e,t){B(t,Yt),t.prototype.base=e,Yt.prototype.elements[e]=t,Yt.prototype.tags[e]=t,Yt.prototype.form_elements[e]=t}function Ft(){if("azexo_elements"in window)for(var e=0;e<window.azexo_elements.length;e++){var t=window.azexo_elements[e],n=function(){n.baseclass.apply(this,arguments)}
zt(t.base,t.is_container,n),t.baseclass=n.baseclass,t.params=t.params.concat(n.prototype.params),Y(n.prototype,t)
for(var a=0;a<n.prototype.params.length;a++){var o=n.prototype.params[a],i=lt(o)
n.prototype.params[a]=i}}}function Ht(){if("azexo_form_elements"in window)for(var e=0;e<window.azexo_form_elements.length;e++){var t=window.azexo_form_elements[e],n=function(){n.baseclass.apply(this,arguments)}
qt(t.base,n),t.baseclass=n.baseclass,t.params=t.params.concat(n.prototype.params),Y(n.prototype,t)
for(var a=0;a<n.prototype.params.length;a++){var o=n.prototype.params[a],i=lt(o)
n.prototype.params[a]=i}}}function Jt(){if("azexo_extend"in window)for(var e in window.azexo_extend){var t=window.azexo_extend[e],n=[]
"params"in t&&(n=t.params),delete t.params
var a=ht.prototype.elements[e]
if(!("extended"in a)){a.extended=!0,Y(a.prototype,t)
for(var o=0;o<n.length;o++){var i=lt(n[o])
a.prototype.params.push(i)}}}}function $t(){(!window.azexo_editor||window.azexo_online)&&z(function(e){_.isObject(e)&&s.create_template_elements(e)})}function Xt(){b(function(e){_.isObject(e)?s.create_cms_elements(e):s.cms_elements_loaded=!0})}function Wt(){function t(t){e(t).find("link[href]").each(function(){e(this).attr("href",at(e(this).attr("href")))}),e(t).find("script[src]").each(function(){e(this).attr("src",at(e(this).attr("src")))}),e(t).find("img[src]").each(function(){e(this).attr("src",at(e(this).attr("src")))}),e(t).find('[style*="background-image"]').each(function(){var t=e(this).attr("style").replace(/background-image[: ]*url\([\'\" ]*([^\)\'\"]*)[\'\" ]*\) *;/,function(e,t){return e.replace(t,encodeURI(at(decodeURI(t))))})
...
n[i].subsets=n[i].subsets.concat(s.split(",")),e.unique(n[i].subsets),n[i].variants=n[i].variants.concat(r.split(",")),e.unique(n[i].variants)}var l='<style class="az-theme-styles">'
...
if("integer_slider"==t[a].type&&(o+="px"),"image"==t[a].type&&(o='url("'+o+'")'),"google_font"!=t[a].type){if("selector"in t[a]&&"property"in t[a]){var c=""
if("important"in t[a]&&t[a].important&&(c=" !important"),_.isArray(t[a].property))for(var p=0;p<t[a].property.length;p++){var m=t[a].property[p],h=c
m.indexOf("!important")>=0&&(m=m.replace("!important",""),h=" !important"),l+=t[a].selector+"{"+m+": "+o+h+";}"}else{var m=t[a].property
m.indexOf("!important")>=0&&(m=m.replace("!important",""),c=" !important"),l+=t[a].selector+"{"+m+": "+o+c+";}"}}}else if(""!=o&&3==o.split("|").length){var i=o.split("|")[0],r=o.split("|")[2]
if("selector"in t[a]){var c=""
"important"in t[a]&&t[a].important&&(c=" !important")
var u=""
r.indexOf(",")<0&&(u="font-weight: "+r+c+";"),l+=t[a].selector+'{font-family: "'+i+'" '+c+"; "+u+"}"}}}return l+="</style>"}function i(){e(F).detach(),e(F).appendTo("body"),e(F).empty(),e(F).append(o(xn.theme))}function s(n,a,i){for(var s={},r={},l=e("<div>"+vn+"</div>"),d=0;d<n.length;d++){var c=n[d],p=c.attrs.container.split("/")[0],m=c.attrs.container.split("/")[1],h=e(l).find('.az-container[data-az-type="'+p+'"][data-az-name="'+m+'"]')
if(e(h).empty(),e(h).append(c.get_hover_styles(c)),a){var u=window.azexo_online
window.azexo_online=!1,e(h).append(c.get_loader()),window.azexo_online=u}e(h).append(c.get_html()),s=e.extend(n[d].js,s),r=e.extend(n[d].css,r)}var _=""
e.each(gn,function(){_=_+this.name+'"'+this.value+'" '}),t(l),e(l).find(".azexo-backend").remove(),e(l).find(".azexo-editor").removeClass("azexo-editor"),e(l).find(".ui-sortable").removeClass("ui-sortable"),e(document).trigger("azexo_export_filter",{dom:l}),e(l).append(o(xn.theme))
var f="<body "+_+">"+e(l).html()+"</body>",l=e("<div>"+fn+"</div>")
e(l).find(".azexo-backend").remove(),e(document).trigger("azexo_export_filter",{dom:l}),e(l).find("title").text(i),t(l)
var v=[]
for(var g in s)v.push(e.isNumeric(s[g])?[g,s[g]]:[g,0])
v.sort(function(e,t){return e[1]-t[1]})
for(var d=0;d<v.length;d++)e(l).append('<script src="'+at(v[d][0])+'"></script>')
for(var g in r)e(l).append('<link rel="stylesheet" type="text/css" href="'+at(g)+'">')
e(l).append("<script type='text/javascript'> window.ajaxurl = '"+at(window.ajaxurl)+"'; </script>"),e(l).append('<script type="text/javascript"> window.azexo_site_name = "'+yn+'"; </script>')
var y="<head>"+e(l).html()+"</head>"
return"<!DOCTYPE html><html>"+y+f+"</html>"}function r(t){for(var n=0;n<l.length;n++){var a=e(l[n].dom_element).parent()
e(l[n].dom_element).detach(),e(bn[t][n].dom_element).appendTo(a)}l=bn[t]
for(var n=0;n<l.length;n++)"to_recursive_showed"in l[n]&&(l[n].recursive_showed(),delete l[n].to_recursive_show)
e(S).val(t),e(O).val(wn[t].title),e(document).trigger("azexo_containers_update")}function d(t){var o=new Lt(null,!1)
return o.saveable=!1,o.rendered=!0,o.attrs.container=t,o.html_content=!0,o.loaded_container=o.attrs.container,o.render(e,n,a),e(o.dom_element).attr("data-az-id",o.id),e(o.dom_element).addClass("azexo-editor"),e(o.dom_element).addClass("azexo"),o.show_controls(),o.update_sortable(),o.showed(e,n,a),o}function c(){var e={}
for(var t in bn)if(null!=bn[t]){var n=s(bn[t],!0,wn[t].title)
e[t]=btoa(v(encodeURIComponent(n)))}return e}function m(t,a){e(T).find("a").removeClass(n+"active"),wn[t]={title:a},e('<a href="#" class="'+n+"list-group-item "+n+'active">'+t+"</a>").appendTo(T).click(function(){return e(this).hasClass(n+"active")||(e(T).find("a").removeClass(n+"active"),e(this).addClass(n+"active"),r(e(this).text())),!1})}function h(t){e('<option value="'+t+'">'+t+"</option>").appendTo(q),e(q).find('option[value="'+t+'"]').prop("selected","selected"),bn={},wn={},e(T).empty(),bn.index=[]
for(var n=0;n<l.length;n++)bn.index.push(d(l[n].attrs.container))
m("index","Home"),r("index"),e(B).click()}function u(t){U(t,function(a){var o=e.parseJSON(a)
yn=t,bn={},wn=o.pages,xn=o.settings,e(T).empty()
for(var s in o.pages){bn[s]=Array(l.length)
for(var c in o.pages[s].containers){var p=d(c)
p.parse_shortcode(decodeURIComponent(v(atob(o.pages[s].containers[c]))))
for(var h=0;h<p.children.length;h++)p.children[h].recursive_render()
e(p.dom_content_element).empty(),p.attach_children(),p.update_empty(),p.update_sortable(),p.to_recursive_showed=!0
for(var h=0;h<l.length;h++)if(l[h].attrs.container==c){bn[s][h]=p
break}}m(s,o.pages[s].title)}r(o.current_page),i(),e(T).find("a").removeClass(n+"active"),e(T).find('a:contains("'+o.current_page+'")').addClass(n+"active"),e("#az-template-elements-welcome").remove(),e("#az-exporter-welcome").remove()})}function f(t,n){for(var a=[],o={},i=0;i<t.length;i++)a.push(lt(t[i])),o[t[i].param_name]=t[i].value
for(var i=0;i<a.length;i++)"group"in a[i]&&"colorpicker"==a[i].type&&(a[i].dependency.callback=function(){function t(t){var n=t.match(/rgb\((\d+),\s*(\d+),\s*(\d+)\)/)
null==n?n=H(e.trim(t)):n.shift()
var a=$(parseInt(n[0]),parseInt(n[1]),parseInt(n[2]))
return a}function n(e){return e[0]<0&&(e[0]=e[0]+1),e[0]>1&&(e[0]=e[0]-1),e[1]<0&&(e[1]=0),e[1]>1&&(e[1]=1),e[2]<0&&(e[2]=0),e[2]>1&&(e[2]=1),e}var a=this,o=t(a.value)
a.value=a.get_value()
var i=t(a.value),s=[i[0]-o[0],i[1]/o[1],i[2]/o[2]]
s[0]<0&&(s[0]=s[0]+1),s[0]>1&&(s[0]=s[0]-1)
for(var r=0;r<a.group.length;r++){var l=e(a.dom_element).closest("#az-editor-modal").find('[name="'+a.group[r]+'"]')
if(l.length>0){var d=e(l).val(),c=t(d),i=[c[0]+s[0],c[1]*s[1],c[2]*s[2]]
i=n(i)
var p=J(i[0],i[1],i[2])
e(l).val("rgb("+p[0]+","+p[1]+","+p[2]+")"),e(l).trigger("change")}}})
st.prototype.show_editor(a,{name:p("Theme"),attrs:o},function(e){for(var a=0;a<t.length;a++)t[a].value=e[t[a].param_name]
n(t)})}function g(e,t){var n=[]
n.push(lt({type:"javascript",heading:p("Configuration"),param_name:"configuration",value:e})),st.prototype.show_editor(n,{name:p("Theme configuration"),attrs:{configuration:e}},function(e){t(e.configuration)})}if(0==e("#az-exporter").length){window.links_select=function(e){var t={}
for(var n in wn)null!=wn[n]&&(t[n+".html"]=wn[n].title)
et(t,e)}
for(var y=0;y<l.length;y++)l[y].saveable=!1,e(l[y].controls).remove(),l[y].show_controls()
fn=e("head").html(),vn=e("body").html(),gn=e("body").prop("attributes")
var b=e('<div id="az-exporter" class="az-right-sidebar '+n+'text-center azexo"></div>').appendTo("body"),w=e('<div id="az-exporter-welcome" class="azexo">'+p("Manage and export your site via right panel.")+"</div>").appendTo(b)
e(b).hover(function(){e(w).remove()}),e("<hr>").appendTo(b),e("<h4>"+p("Current site")+"</h4>").appendTo(b)
var x=e('<div class="'+n+'btn-toolbar"></div>').appendTo(b),z=e('<div class="'+n+"btn-group "+n+'btn-group-xs"></div>').appendTo(x),k=e('<div class="'+n+"btn-group "+n+'btn-group-xs"></div>').appendTo(x),j=e('<div class="'+n+"btn-group "+n+'btn-group-xs"></div>').appendTo(x)
e("<hr>").appendTo(b),e('<button class="'+n+"btn "+n+'btn-default">'+p("Add page")+"</button>").appendTo(z).click(function(){var e=window.prompt(p("Please enter page name"),"")
if(""!=e&&null!=e){bn[e]=[]
for(var t=0;t<l.length;t++)bn[e].push(d(l[t].attrs.container))
m(e,e),r(e)}return!1}),e('<button class="'+n+"btn "+n+'btn-danger">'+p("Remove page")+"</button>").appendTo(z).click(function(){if(e(T).find("a").length>1){var t=e(T).find("."+n+"active").text()
e(T).find("."+n+"active").remove()
var a=e(T).find("a:first-child").addClass(n+"active").text()
r(a),delete bn[t],bn[t]=null}return!1}),e('<button class="'+n+"btn "+n+'btn-success">'+p("ZIP download")+"</button>").appendTo(k).click(function(){var e=c()
return azexo_add_js({path:"js/json2.min.js",loaded:"JSON"in window,callback:function(){R(JSON.stringify(e),function(e){e&&(window.location=e)})}}),!1}),e("<h4>"+p("Current site pages")+"</h4>").appendTo(b)
var T=e('<div class="'+n+'list-group"></div>').appendTo(b)
e("<hr>").appendTo(b)
var C=e('<div class="'+n+'text-left"></div>').appendTo(b)
e("<h4>"+p("Current page settings")+"</h4>").appendTo(C)
var S=e('<div class="'+n+'form-group"><label>'+p("File name")+'</label><div><input class="'+n+'form-control" name="name" type="text"></div><p class="'+n+'help-block">'+p('"html"-extension will be added during export process')+"</p></div>").appendTo(C).find('input[name="name"]').change(function(){var t=e(T).find("."+n+"active").text(),a=e(this).val()
bn[a]=bn[t],bn[t]=null,wn[a]=wn[t],wn[t]=null,e(T).find("a."+n+'active:contains("'+t+'")').text(a)
for(var o in bn)if(null!=bn[o])for(var i=0;i<bn[o].length;i++)e(bn[o][i].dom_content_element).find('[href="'+t+'.html"]').each(function(){e(this).attr("href",a+".html")})}),O=e('<div class="'+n+'form-group"><label>'+p("Title")+'</label><div><input class="'+n+'form-control" name="title" type="text"></div><p class="'+n+'help-block">'+p("")+"</p></div>").appendTo(C).find('input[name="title"]').change(function(){var t=e(T).find("."+n+"active").text()
wn[t].title=e(this).val()})
bn.index=l,m("index","Home"),e(S).val("index"),e(O).val("Home")
var I=e('<div class="'+n+"panel "+n+'panel-default"><div class="'+n+'panel-heading" role="tab" id="sites-heading"><h4 class="'+n+'panel-title"><a data-toggle="'+n+'collapse" href="#sites-collapse" aria-expanded="false" class="'+n+'collapsed">'+p("Choose a site for edit")+'</a></h4></div><div id="sites-collapse" class="'+n+"panel-collapse "+n+'collapse" role="tabpanel" aria-labelledby="sites-heading" aria-expanded="false"><div class="'+n+'panel-body"></div></div></div>').prependTo(b).find("."+n+"panel-body")
e("<hr>").appendTo(I)
var P=e('<div class="'+n+"btn-group "+n+'btn-group-xs"></div>').appendTo(I),A=e('<button class="'+n+"btn "+n+'btn-default">'+p("New")+"</button>").appendTo(P).click(function(){var e=window.prompt(p("Please enter site name"),"")
""!=e&&null!=e&&h(e)})
e('<button class="'+n+"btn "+n+'btn-danger">'+p("Delete")+"</button>").appendTo(P).click(function(){M(e(q).find("option:selected").val()),e(q).find("option:selected").remove(),e(q).trigger("change")})
var B=e('<button class="az-save-site '+n+"btn "+n+'btn-primary">'+p("Save")+"</button>").appendTo(k).click(function(){var t={}
t.settings=xn,t.current_page=e(S).val(),t.pages={}
for(var n in bn)if(null!=wn[n]&&null!=bn[n]){t.pages[n]=wn[n],wn[n].containers={}
for(var a=0;a<bn[n].length;a++){var o=bn[n][a].attrs.container
wn[n].containers[o]=btoa(v(encodeURIComponent(bn[n][a].get_children_shortcode())))}}azexo_add_js({path:"js/json2.min.js",loaded:"JSON"in window,callback:function(){N(e(q).find("option:selected").val(),JSON.stringify(t))}})}),Y=!1
e('<button class="az-publish-site '+n+"btn "+n+'btn-success">'+p("FTP upload")+"</button>").appendTo(k).click(function(){if(!Y){e("#az-ftp-modal").remove()
var t='<div class="'+n+'modal-header"><button type="button" class="'+n+'close" data-dismiss="'+n+'modal" aria-hidden="true">&times;</button><h4 class="'+n+'modal-title">'+p("FTP upload")+"</h4></div>",o='<div class="'+n+'modal-footer"><button type="button" class="'+n+"btn "+n+'btn-default" data-dismiss="'+n+'modal">'+p("Close")+"</button></div>",i=e('<div id="az-ftp-modal" class="'+n+'modal azexo"><div class="'+n+"modal-dialog "+n+'modal-sm"><div class="'+n+'modal-content">'+t+'<div class="'+n+'modal-body"></div>'+o+"</div></div></div>").prependTo("body"),s=e(i).find("."+n+"modal-body"),r=e('<div class="'+n+'form-group"><label>'+p("Host")+'</label><div><input class="'+n+'form-control" name="host" type="text" value="'+xn.host+'"></div><p class="'+n+'help-block"></p></div>').appendTo(s).find("input"),l=e('<div class="'+n+'form-group"><label>'+p("Username")+'</label><div><input class="'+n+'form-control" name="username" type="text" value="'+xn.username+'"></div><p class="'+n+'help-block"></p></div>').appendTo(s).find("input"),d=e('<div class="'+n+'form-group"><label>'+p("Password")+'</label><div><input class="'+n+'form-control" name="password" type="password" value="'+xn.password+'"></div><p class="'+n+'help-block"></p></div>').appendTo(s).find("input"),m=e('<div class="'+n+'form-group"><label>'+p("Port")+'</label><div><input class="'+n+'form-control" name="port" type="text" value="'+xn.port+'"></div><p class="'+n+'help-block"></p></div>').appendTo(s).find("input"),h=e('<div class="'+n+'form-group"><label>'+p("Directory")+'</label><div><input class="'+n+'form-control" name="directory" type="text" value="'+xn.directory+'"></div><p class="'+n+'help-block"></p></div>').appendTo(s).find("input"),u=e('<button class="'+n+"btn "+n+'btn-primary">'+p("Choose upload directory")+"</button>").appendTo(s).click(function(){function t(a,o){if(e(f).empty().show(),e(y).empty().hide(),e(h).val(a),xn.directory=a,"."!=a){var i=a.split("/")
i.pop()
var s=i.join("/")
e('<li class="az-directory">'+p("< Up one level")+"</li>").appendTo(f).click(function(){L(xn.host,xn.username,xn.password,xn.port,s,function(e){t(s,e)})})
for(var r=0;r<o.length;r++)o[r]=o[r].replace(a+"/","")}for(var r=0;r<o.length;r++){var l=a+"/"+o[r]
!function(a){e('<li class="'+n+"glyphicon "+n+'glyphicon-folder-close">'+o[r]+"</li>").appendTo(f).click(function(){L(xn.host,xn.username,xn.password,xn.port,a,function(e){t(a,e)})})}(l)}}xn.host=e(r).val(),xn.username=e(l).val(),xn.password=e(d).val(),xn.port=e(m).val(),L(xn.host,xn.username,xn.password,xn.port,xn.directory,function(n){_.isArray(n)?(e(u).hide(),t(xn.directory,n)):alert(n)})})
e(s).find("input").change(function(){xn.host=e(r).val(),xn.username=e(l).val(),xn.password=e(d).val(),xn.port=e(m).val(),xn.directory=e(h).val(),""!=xn.host&&""!=xn.username&&""!=xn.password&&""!=xn.port?(e(u).show(),e(v).show()):(e(u).hide(),e(v).hide())})
var f=e('<ul class="az-browser"></ul>').appendTo(s).hide()
e("<hr>").appendTo(s)
var v=e('<button class="'+n+"btn "+n+'btn-success">'+p("Upload current site")+"</button>").appendTo(s).click(function(){var t=c()
...
Y=!1}else t.uploaded.length>0&&e(y).append('<div class="'+n+"alert "+n+'alert-info">'+t.uploaded[0]+" uploaded</div>"),t.count>0?(0==a&&(a=t.count),e(g).show().find("."+n+"progress-bar").css("width",(a-t.count)/a*100+"%"),Y=!0,E(JSON.stringify({}),t.site_path,JSON.stringify(t.files),xn.host,xn.username,xn.password,xn.port,xn.directory,o)):(e(g).show().find("."+n+"progress-bar").css("width","100%"),e(y).append('<div class="'+n+"alert "+n+'alert-success">'+p("Done")+"</div>"),Y=!1)}
Y=!0,E(JSON.stringify(t),"",JSON.stringify([]),xn.host,xn.username,xn.password,xn.port,xn.directory,o)}})})
...
var q=e('<select class="'+n+'form-control"></select>').prependTo(I).change(function(){u(e(this).find("option:selected").val())})
D(function(t){for(var n=0;n<t.length;n++)e('<option value="'+t[n]+'">'+t[n]+"</option>").appendTo(q)
var a="My site"
e(q).find("option:selected").length>0&&(a=e(q).find("option:selected").val())
for(var o=window.location.search.replace("?","").split("&"),n=0;n<o.length;n++){var i=o[n].split("=")
"current_site"==i[0]&&(a=decodeURIComponent(i[1]))}"create-new-site"==a?e(A).click():0==e(q).find('[value="'+a+'"]').length?h(a):(e(q).find('option[value="'+a+'"]').prop("selected","selected"),u(a))})
var F=e("<div></div>").appendTo(b)
e('<button class="az-theme-settings '+n+"btn "+n+'btn-default">'+p("Theme")+"</button>").appendTo(j).click(function(){return f(xn.theme,function(e){xn.theme=e,i()}),!1}),e('<button class="'+n+"btn "+n+'btn-default">'+p("Configuration")+"</button>").appendTo(j).click(function(){return azexo_add_js({path:"js/json2.min.js",loaded:"JSON"in window,callback:function(){function t(){for(var t=.05,n=["color","background-color","border-left-color","border-right-color","border-top-color","border-bottom-color","outline-color"],a={},o=0;o<document.styleSheets.length;o++){var i=document.styleSheets[o]
if("href"in i&&null!=i.href&&i.href.indexOf("azexo_elements")>=0)for(var s=0;s<i.cssRules.length;s++){var r=i.cssRules[s]
if(r instanceof CSSStyleRule&&"::selection"!=r.selectorText&&"::-moz-selection"!=r.selectorText)for(var l in r.style)if(e.isNumeric(l)){var d=r.style[l]
if(n.indexOf(d)>=0){var c=r.style.getPropertyValue(r.style[l]),p=r.style.getPropertyPriority(r.style[l])
""!=p&&(d=d+"!"+p)
var m=c.match(/rgb\((\d+),\s*(\d+),\s*(\d+)\)/)
if(null!=m){var h=$(m[1],m[2],m[3])
h[1]>=t&&(c in a||(a[c]={}),d in a[c]||(a[c][d]=[]),a[c][d].push(r.selectorText))}}}}}return a}function n(e,t){var n=Math.abs(e[0]-t[0]),a=Math.abs(1-e[0]-t[0]),o=Math.abs(e[0]-(1-t[0]))
return Math.min(n,a,o)}function a(e){if("value"in e)return e.value
for(var t=a(e.left),n=a(e.right),o=Array(t.length),i=0;i<o.length;i++)o[i]=(t[i]*e.left.size+n[i]*e.right.size)/(e.left.size+e.right.size)
return o}var o=JSON.stringify(xn.theme,null,"	")
if("[]"==o){var s=t(),r=0,l=[]
for(var d in s){var c={}
for(var m in s[d]){for(var h=[],u=0;u<s[d][m].length;u++)h.push(s[d][m][u])
e.unique(h),h=h.join(", "),h in c||(c[h]=[]),c[h].push(m)}for(var h in c){var _={type:"colorpicker",tab:p("Colors"),heading:c[h].join("/")+" "+r,description:h,param_name:"color"+r,value:d,selector:h,property:c[h]}
l.push(_),r++}}var f=[],v=[]
for(var d in s){var y=d.match(/rgb\((\d+),\s*(\d+),\s*(\d+)\)/),b=$(y[1],y[2],y[3])
f.push(b),v.push(d)}var w=function(e){this.linkage="average",this.threshold=void 0==e?1/0:e}
w.prototype={distance:n,merge:function(e){return e},cluster:function(e){this.clusters=[],this.dists=[],this.mins=[],this.index=[]
for(var t=0;t<e.length;t++){var n={value:e[t],key:t,index:t,size:1}
this.clusters[t]=n,this.index[t]=n,this.dists[t]=[],this.mins[t]=0}for(var t=0;t<this.clusters.length;t++)for(var a=0;t>=a;a++){var o=t==a?1/0:this.distance(this.clusters[t].value,this.clusters[a].value)
this.dists[t][a]=o,this.dists[a][t]=o,o<this.dists[t][this.mins[t]]&&(this.mins[t]=a)}for(var i=this.mergeClosest(),t=0;i;)i=this.mergeClosest()
return this.clusters.forEach(function(e){delete e.key,delete e.index}),this.clusters},mergeClosest:function(){for(var e=0,t=1/0,n=0;n<this.clusters.length;n++){var a=this.clusters[n].key,o=this.dists[a][this.mins[a]]
t>o&&(e=a,t=o)}if(t>=this.threshold)return!1
var i=this.index[e],s=this.index[this.mins[e]],r={left:i,right:s,key:i.key,size:i.size+s.size}
this.clusters[i.index]=r,this.clusters.splice(s.index,1),this.index[i.key]=r
for(var n=0;n<this.clusters.length;n++){var o,l=this.clusters[n]
i.key==l.key?o=1/0:"single"==this.linkage?(o=this.dists[i.key][l.key],this.dists[i.key][l.key]>this.dists[s.key][l.key]&&(o=this.dists[s.key][l.key])):"complete"==this.linkage?(o=this.dists[i.key][l.key],this.dists[i.key][l.key]<this.dists[s.key][l.key]&&(o=this.dists[s.key][l.key])):o="average"==this.linkage?(this.dists[i.key][l.key]*i.size+this.dists[s.key][l.key]*s.size)/(i.size+s.size):this.distance(l.value,i.value),this.dists[i.key][l.key]=this.dists[l.key][i.key]=o}for(var n=0;n<this.clusters.length;n++){var d=this.clusters[n].key
if(this.mins[d]==i.key||this.mins[d]==s.key){for(var t=d,c=0;c<this.clusters.length;c++){var p=this.clusters[c].key
this.dists[d][p]<this.dists[d][t]&&(t=p)}this.mins[d]=t}this.clusters[n].index=n}return delete i.key,delete s.key,delete i.index,delete s.index,!0}}
for(var x=new w(.01),z=x.cluster(f),k=[],j=[],r=0;r<z.length;r++){var T=a(z[r])
k.push(T),j.push([])}for(var r=0;r<f.length;r++){for(var C=0,S=1/0,u=0;u<k.length;u++){var O=n(f[r],k[u])
S>O&&(C=u,S=O)}for(var u=0;u<l.length;u++)l[u].value==v[r]&&j[C].push(l[u].param_name)}var I=[]
if("azexo_colors"in window)for(var r=0;r<window.azexo_colors.length;r++){for(var y=H(window.azexo_colors[r]),b=$(parseInt(y[0]),parseInt(y[1]),parseInt(y[2])),C=1,P=0,u=0;u<k.length;u++){var O=n(b,k[u])
C>O&&(C=O,P=u)}I.push(P)}for(var r=0;r<k.length;r++)if(I.indexOf(r)>=0||0==I.length){var y=J(k[r][0],k[r][1],k[r][2]),_={type:"colorpicker",heading:p("Color group")+" "+r,param_name:"color_group_"+r,value:"rgb("+y[0]+","+y[1]+","+y[2]+")",group:j[r],dependency:{element:"color_group_"+r,not_empty:{}}}
l.unshift(_)}if("azexo_fonts_selectors"in window){e.unique(window.azexo_fonts_selectors)
for(var r=0;r<window.azexo_fonts_selectors.length;r++){var _={type:"google_font",heading:p("Font")+" "+r,description:window.azexo_fonts_selectors[r],param_name:"font_"+r,value:"Open Sans|latin|400,700",selector:window.azexo_fonts_selectors[r]}
l.unshift(_)}}o=JSON.stringify(l,null,"	")}g(o,function(t){xn.theme=e.parseJSON(t),i()})}}),!1}),window.azexo_editor||e(b).hide()}}window.azexo_backend=!0
var Vt=(""+arguments.callee).replace(/((\/\/.*$)|(\/\*[\s\S]*?\*\/)|(\s))/gm,"").match(/^function\s*[^\(]*\(\s*([^\)]*)\)/m)[1].split(/,/),Gt=Vt[0],Qt=Vt[1],Zt=Vt[2],Kt=Vt[3],en=Vt[4],tn=Vt[5],nn=Vt[6],an=Vt[7],on=Vt[8],sn=Vt[9]
"azexo_prefix"in window&&(n=window.azexo_prefix,a=window.azexo_prefix.replace("-","_")),window.azexo_title={"Drag and drop":p("Drag and drop element."),Add:p("Add new element into current element area."),Edit:p("Open settings form to change element properties, set CSS styles and add CSS classes."),Paste:p("Paste elements into current element area from clipboard copied into it before."),Copy:p("Copy element or contained elements to clipboard."),Clone:p("Clone current element."),Remove:p("Delete current element"),"Save as template":p("Save element or contained elements as template to template library."),"Save container":p("Save to server all elements which placed in current container element.")},e.ajaxPrefilter(function(e,t){("script"==e.dataType||"script"==t.dataType)&&(e.cache=!0)})
var rn={}
rn.shortcode={next:function(e,t,n){var a,o,i=rn.shortcode.regexp(e)
return i.lastIndex=n||0,(a=i.exec(t))?"["===a[1]&&"]"===a[7]?rn.shortcode.next(e,t,i.lastIndex):(o={index:a.index,content:a[0],shortcode:rn.shortcode.fromMatch(a)},a[1]&&(o.match=o.match.slice(1),o.index++),a[7]&&(o.match=o.match.slice(0,-1)),o):void 0},replace:function(e,t,n){return t.replace(rn.shortcode.regexp(e),function(e,t,a,o,i,s,r,l){if("["===t&&"]"===l)return e
var d=n(rn.shortcode.fromMatch(arguments))
return d?t+d+l:e})},string:function(e){return new rn.shortcode(e).string()},regexp:_.memoize(function(e){return RegExp("\\[(\\[?)("+e+")(?![\\w-])([^\\]\\/]*(?:\\/(?!\\])[^\\]\\/]*)*?)(?:(\\/)\\]|\\](?:([^\\[]*(?:\\[(?!\\/\\2\\])[^\\[]*)*)(\\[\\/\\2\\]))?)(\\]?)","g")}),attrs:_.memoize(function(e){var t,n,a={},o=[]
...
return t=e[4]?"self-closing":e[6]?"closed":"single",new rn.shortcode({tag:e[2],attrs:e[3],type:t,content:e[5]})}},rn.shortcode=_.extend(function(e){_.extend(this,_.pick(e||{},"tag","attrs","type","content"))
var t=this.attrs
this.attrs={named:{},numeric:[]},t&&(_.isString(t)?this.attrs=rn.shortcode.attrs(t):_.isEqual(_.keys(t),["named","numeric"])?this.attrs=t:_.each(e.attrs,function(e,t){this.set(t,e)},this))},rn.shortcode),_.extend(rn.shortcode.prototype,{get:function(e){return this.attrs[_.isNumber(e)?"numeric":"named"][e]},set:function(e,t){return this.attrs[_.isNumber(e)?"numeric":"named"][e]=t,this},string:function(){var e="["+this.tag
return _.each(this.attrs.numeric,function(t){e+=/\s/.test(t)?' "'+t+'"':" "+t}),_.each(this.attrs.named,function(t,n){e+=" "+n+'="'+t+'"'}),"single"===this.type?e+"]":"self-closing"===this.type?e+" /]":(e+="]",this.content&&(e+=this.content),e+"[/"+this.tag+"]")}}),rn.html=_.extend(rn.html||{},{attrs:function(e){var t,n
return"/"===e[e.length-1]&&(e=e.slice(0,-1)),t=rn.shortcode.attrs(e),n=t.named,_.each(t.numeric,function(e){/\s/.test(e)||(n[e]="")}),n},string:function(e){var t="<"+e.tag,n=e.content||""
return _.each(e.attrs,function(e,n){t+=" "+n,""!==e&&(_.isBoolean(e)&&(e=e?"true":"false"),t+='="'+e+'"')}),e.single?t+" />":(t+=">",t+=_.isObject(n)?rn.html.string(n):n,t+"</"+e.tag+">")}})
var ln=(_.memoize(function(e){return RegExp("(\\[(\\[?)["+e+"]+(?![\\w-])[^\\]\\/]*[\\/(?!\\])[^\\]\\/]*]?(?:\\/]\\]|\\](?:[^\\[]*(?:\\[(?!\\/"+e+"\\])[^\\[]*)*\\[\\/"+e+"\\])?)\\]?)","g")}),_.memoize(function(e){return RegExp("\\[(\\[?)("+e+")(?![\\w-])([^\\]\\/]*(?:\\/(?!\\])[^\\]\\/]*)*?)(?:(\\/)\\]|\\](?:([^\\[]*(?:\\[(?!\\/\\2\\])[^\\[]*)*)(\\[\\/\\2\\]))?)(\\]?)")}))
if(e.fn.closest_descendents=function(t){for(var n=e(),a=this;a.length;)n=e.merge(n,a.filter(t)),a=a.not(t),a=a.children()
return n},st.prototype={safe:!0,param_types:{},show_editor:function(t,o,i){e("#az-editor-modal").remove()
...
e(v).append(g)}e(h).append(v),e(d).find("."+n+"modal-body").append(h),e('#az-editor-tabs a[href="#az-editor-tab-1"]')[a+"tab"]("show"),e('#az-editor-modal input[name="el_class"]').each(function(){tt(ht.prototype.el_classes,this," ")})
...
e(window).on("scroll.az-editor-modal",function(){e(window).scrollTop(w)}),e("#az-editor-modal")[a+"modal"]("show")},opened:function(){},closed:function(){},render:function(){}},rt("container",dt),Y(dt.prototype,{get_value:function(){return e(this.dom_element).find('input[name="'+this.param_name+'_type"]').val()+"/"+e(this.dom_element).find('input[name="'+this.param_name+'_name"]').val()},render:function(t){var a=t.split("/")[0],o=t.split("/")[1]
...
u(function(t){n=et(t,e(o.dom_element).find('input[name="'+o.param_name+'_type"]')),e(n).chosen().change(function(){f(e(this).val(),function(t){e(a).parent().find(".direct-input").click(),e(o.dom_element).find('input[name="'+o.param_name+'_name"]').val(""),a=et(t,e(o.dom_element).find('input[name="'+o.param_name+'_name"]'))})})}),f(t.split("/")[0],function(t){a=et(t,e(o.dom_element).find('input[name="'+o.param_name+'_name"]'))})}}),e.fn.deserialize=function(t){var n=e(this),a={}
return e.each(t.split("&"),function(){var e=this.split("="),t=V(e[0]),n=e.length>1?V(e[1]):null
...
for(var a=0;a<t.length;a++)n.find("select[name='"+e+"'] > option[value='"+t[a]+"']").prop("selected","selected")}),e("input:checkbox:checked,input:radio:checked").each(function(){e(this).attr("name")in a||(this.checked=!1)}),this},rt("cms_settings",pt),Y(pt.prototype,{get_value:function(){return e(this.dom_element).find("form").serialize()},render_form:function(t){var n=this
x(t,function(t){e(n.dom_element).empty(),e(t).appendTo(n.dom_element),e(n.dom_element).find('[type="submit"]').remove(),n.form_value.length>0&&e(n.dom_element).deserialize(ct(n.form_value))})},get_form:function(e){var t=e.get_value()
t.length>0&&this.render_form(t)},render:function(t){this.form_value=t,this.dom_element=e('<div class="'+n+'form-group"></div>')},opened:function(){"instance"in this&&this.render_form(this.instance)}}),"azexo_param_types"in window)for(var dn=0;dn<window.azexo_param_types.length;dn++){var cn=window.azexo_param_types[dn],pn=function(){pn.baseclass.apply(this,arguments)}
rt(cn.type,pn),cn.baseclass=pn.baseclass,Y(pn.prototype,cn)}window.azexo_add_css=function(t,n){var a=window.azexo_baseurl+t
...
for(var n=0;n<t.length;n++)t[n]()}},n.appendChild(a)},Y(mt.prototype,{elements_instances:{},elements_instances_by_an_name:{},template_elements_loaded:!1,cms_elements_loaded:!1,edit_stack:[],try_render_unknown_elements:function(){if(this.template_elements_loaded&&this.cms_elements_loaded)for(var t in s.elements_instances){var n=s.elements_instances[t]
if(n instanceof _t){var a=n.attrs.content,o=/^\s*\<[\s\S]*\>\s*$/.exec(a)
o?ht.prototype.parse_html.call(n,a):ht.prototype.parse_shortcode.call(n,a)
for(var i=0;i<n.children.length;i++)n.children[i].recursive_render()
e(n.dom_content_element).empty(),n.attach_children(),window.azexo_editor&&n.update_sortable(),n.recursive_showed()}}},create_template_elements:function(t){function a(){var t=st.prototype.param_types.icon.prototype.icons
return"azexo_icons"in window&&(t=t.concat(window.azexo_icons)),e.unique(t),st.prototype.param_types.icon.prototype.icons=t,t=t.map(function(e){return e.replace(/^/,".").replace(/ /,".")})}e(document).on("azexo_export_filter",function(t,n){e(n.dom).find(".az-editable").removeClass("az-editable"),e(n.dom).find(".az-styleable").removeClass("az-styleable"),e(n.dom).find(".az-sortable").removeClass("az-sortable"),e(n.dom).find(".az-synchronizable").removeClass("az-synchronizable"),e(n.dom).find(".az-restoreable").removeClass("az-restoreable"),e(n.dom).find(".az-containable").removeClass("az-containable"),e(n.dom).find(".az-rootable").removeClass("az-rootable"),e(n.dom).find("[data-az-editable]").removeAttr("data-az-editable"),e(n.dom).find("[data-az-tags]").removeAttr("data-az-tags"),e(n.dom).find("[data-az-url]").removeAttr("data-az-url")})
var o={"link[href]":"href","script[src]":"src","img[src]":"src"}
"azexo_urls_to_update"in window&&(o=e.extend(o,window.azexo_urls_to_update))
var i=[]
"azexo_editable"in window&&(i=window.azexo_editable)
var r=[]
"azexo_attr_editable"in window&&(r=window.azexo_attr_editable)
var d=[]
"azexo_styleable"in window&&(d=window.azexo_styleable)
var c=[]
"azexo_sortable"in window&&(c=window.azexo_sortable)
var m=[]
"azexo_synchronizable"in window&&(m=window.azexo_synchronizable)
var h=[]
"azexo_restoreable"in window&&(h=window.azexo_restoreable)
var u=[]
"azexo_containable"in window&&(u=window.azexo_containable)
var f=a()
for(var v in t){var g=t[v].name,y=t[v].html,b=v.split("|")
b.pop(),b=b.join("/")
var w=window.azexo_baseurl+"../azexo_elements/"+b+"/"
"baseurl"in t[v]&&(w=t[v].baseurl)
var x=""
"thumbnail"in t[v]&&(x=t[v].thumbnail)
var z=y.indexOf("az-rootable")>=0,k=function(){function t(t){function a(e){return 0==e.indexOf("azexo_elements")?window.azexo_baseurl+"../"+e:0!=e.indexOf("/")&&0!=e.indexOf("http://")&&0!=e.indexOf("https://")?n.baseurl+e:e}for(var i in o){var s=o[i]
e(t).find(i).each(function(){e(this).attr(s,a(e(this).attr(s)))})}e(t).find("[data-az-url]").each(function(){var t=e(this).attr("data-az-url")
e(this).attr(t,a(e(this).attr(t)))}),e(t).find('[style*="background-image"]').each(function(){var t=e(this).attr("style").replace(/background-image[: ]*url\(([^\)]+)\) *;/,function(e,t){return e.replace(t,encodeURI(a(decodeURI(t))))})
e(this).attr("style",t)})}for(var n=this,a=0;a<this.baseclass.prototype.params.length;a++)if("content"==this.baseclass.prototype.params[a].param_name&&""==this.baseclass.prototype.params[a].value){if("ajaxurl"in window){var i=e("<div>"+n.template+"</div>")
t(i),i=e(i).html(),this.baseclass.prototype.params[a].value=i}break}ht.apply(this,arguments)}
ut(g,!1,k),Y(k.prototype,{baseclass:k,template:y,baseurl:w,path:v,name:g,icon:"fa fa-cube",description:p(""),thumbnail:x,params:[lt({type:"html",heading:p("Content"),param_name:"content",value:""})].concat(k.prototype.params),show_settings_on_create:!1,is_container:!0,has_content:!0,section:z,category:p("Template-elements"),is_template_element:!0,editable:[".az-editable"].concat(i),attr_editable:[].concat(r),styleable:[".az-styleable"].concat(d),sortable:[".az-sortable"].concat(c),synchronizable:[".az-synchronizable"].concat(m),restoreable:[".az-restoreable"].concat(h),containable:[".az-containable"].concat(u),restore_nodes:{},contained_elements:{},show_controls:function(){function t(t){if(s.edit_stack.length>0){var n=s.edit_stack.length-1,a=e(t.node).width()*e(t.node).height(),o=e(s.edit_stack[n].node).width()*e(s.edit_stack[n].node).height()
2>a/o&&s.edit_stack.push(t)}else s.edit_stack.push(t)}function o(t){e(t.node).css("outline-width","2px"),e(t.node).css("outline-style","dashed")
var n=setInterval(function(){"rgb(255, 0, 0)"!=e(t.node).css("outline-color")?e(t.node).css("outline-color","rgb(255, 0, 0)"):e(t.node).css("outline-color","rgb(255, 255, 255)")},100)
u=setTimeout(function(){clearInterval(n),u=null,e(t.node).css("outline-color",""),e(t.node).css("outline-width",""),e(t.node).css("outline-style",""),i(t.node,t.edit,t.style,t.attrs,function(){v()})},500)}function i(t,n,o,i,s){var r=[],d="",c="",u="",v=e.trim(e(t).text())
if(""!=v&&(v=e(t).html()),n){f=a()
var g=f.join(", ")
if(e(t).is(g)){for(var y=0;y<f.length;y++)if(e(t).is(f[y])){u=f[y].split("."),u.shift(),u=u.join(" ")
break}r.push(lt({type:"icon",heading:p("Icon"),param_name:"icon"}))}"IMG"!=e(t).prop("tagName")?""!=v&&r.push(lt({type:"textarea",heading:p("Content"),param_name:"content"})):(d=e(t).attr("src"),r.push(lt({type:"image",heading:p("Image"),param_name:"image",description:p("Select image from media library.")}))),"A"==e(t).prop("tagName")&&(c=e(t).attr("href"),r.push(lt({type:"link",heading:p("Link"),param_name:"link",description:p("Content link (url).")})))}for(var b in i){var w=b,x=_.clone(i[b])
""in i[b]&&(w=i[b][""],delete x[""]),r.push(Object.keys(x).length>0?"class"==b?lt({type:"checkbox",heading:w,param_name:"attr_"+b,value:x}):lt({type:"dropdown",heading:w,param_name:"attr_"+b,value:x}):lt({type:"textfield",heading:w,param_name:"attr_"+b}))}var z="",k=!0
for(var b in t.style)e.isNumeric(b)&&(0!=t.style[b].indexOf("background")&&(k=!1),z=z+t.style[b]+": "+t.style.getPropertyValue(t.style[b])+"; ")
if(z=F(z),z=z.replace(/\-value\: /g,": "),z=z.replace("border-top-color","border-color"),z=z.replace("border-top-left-radius","border-radius"),z=z.replace("border-top-style","border-style"),z=z.replace("background-position-x: 50%; background-position-y: 50%;","background-position: center;"),z=z.replace("background-position-x: 50%; background-position-y: 100%;","background-position: center bottom;"),z=z.replace("background-position-x: 0px; background-position-y: 0px;","background-position: 0 0;"),z=z.replace("background-repeat-x: repeat; background-repeat-y: repeat;","background-repeat: repeat;"),z=z.replace("background-repeat-x: no-repeat; background-repeat-y: no-repeat;","background-repeat: no-repeat;"),z=z.replace("background-repeat-x: repeat;","background-repeat: repeat-x;"),k)if(""!=t.style.getPropertyValue("background-image"))if(z=t.style.getPropertyValue("background-image")){var j=z.match(/url\([\'\" ]*([^\)\'\"]*)[\'\" ]*/)
j&&(z=j[1])}else z="",k=!1
else k=!1
if(o){if(k)r.push(lt({type:"image",heading:p("Image"),param_name:"style",description:p("Select image from media library.")}))
else{var T=lt({type:"style",heading:p("Content style"),param_name:"style",description:p("Style options."),tab:p("Style")})
n||Object.keys(i).length>0?r.push(T):r.unshift(T)}r.push(lt({type:"textfield",heading:p("Content classes"),param_name:"el_class",description:p("If you wish to style particular content element differently, then use this field to add a class name and then refer to it in your css file.")}))}e(t).removeClass("editable-highlight"),e(t).removeClass("styleable-highlight"),e(t).removeClass(u)
var C=e(t).attr("class")
e(t).addClass(u),(void 0===C||C===!1)&&(C="")
var S={content:v,link:c,image:d,el_class:C,style:z,icon:u}
for(var b in i){var x=_.clone(i[b])
if(""in i[b]&&(w=i[b][""],delete x[""]),Object.keys(x).length>0)if("class"==b){var O=[],C=e(t).attr(b).split(" ")
for(var I in i[b])""!=I&&C.indexOf(I)>=0&&O.push(I)
S["attr_"+b]=O.join(",")}else S["attr_"+b]=e(t).attr(b)
else S["attr_"+b]=e(t).attr(b)}st.prototype.show_editor(r,{name:p("Content"),attrs:S},function(a){n&&(""!=u&&(e(t).removeClass(u),a.el_class=a.el_class+" "+a.icon),"A"==e(t).prop("tagName")&&e(t).attr("href",a.link),"IMG"==e(t).prop("tagName")?e(t).attr("src",a.image):""!=v&&""!=a.content&&e(t).html(a.content)),o&&(e(t).attr("class",a.el_class),k?e(t).attr("style","background-image: url("+encodeURI(a.style)+");"):e(t).attr("style",a.style))
for(var r in i){var d=_.clone(i[r])
if(""in i[r]&&(w=i[r][""],delete d[""]),Object.keys(d).length>0)if("class"==r){var c=a["attr_"+r].split(",")
for(var p in i[r])""!=p&&(c.indexOf(p)>=0?e(t).addClass(p):e(t).removeClass(p))}else e(t).attr(r,a["attr_"+r])
else e(t).attr(r,a["attr_"+r])}h.attrs.content=e(h.dom_content_element).html(),h.restore_content(),l(),m(),s()})}function r(t){var n=e(t).clone()
e(n).find("*").each(function(){for(var e=this;e.attributes.length>0;)e.removeAttribute(e.attributes[0].name)})
var a=e(n).html()
return a=a.replace(/\s*/g,"")}function l(){d()
for(var t=0;t<h.synchronizable.length;t++)e(h.dom_content_element).find(h.synchronizable[t]).each(function(){if(0==e(this).closest("[data-az-restore]").length){e(this).find(".editable-highlight").removeClass("editable-highlight"),e(this).find(".styleable-highlight").removeClass("styleable-highlight"),e(this).find(".sortable-highlight").removeClass("sortable-highlight"),e(this).find('[class=""]').removeAttr("class"),e(this).find('[style=""]').removeAttr("style")
var t=e(this).data("synchronized")
if(t)for(var n=0;n<t.length;n++)e(t[n]).html(e(this).html())
e(this).data("current-state")?e(document).trigger("azexo_synchronize",{from_node:this,old_state:e(this).data("current-state"),new_state:e(this).html()}):e(document).trigger("azexo_synchronize",{from_node:this,old_state:r(this),new_state:e(this).html()}),e(this).data("current-state",r(this)),h.attrs.content=e(h.dom_content_element).html(),h.restore_content()}})
m()}function d(){for(var t=0;t<h.sortable.length;t++)e(h.dom_content_element).find(h.sortable[t]).each(function(){e(this).hasClass("ui-sortable")&&e(this).data("sortable")&&(e(this).data("sortable",!1),e(this).sortable("destroy"),e(this).find(".ui-sortable-handle").removeClass("ui-sortable-handle"))})}function c(){for(var t=0;t<h.sortable.length;t++)e(h.dom_element).find(h.sortable[t]).each(function(){0==e(this).closest("[data-az-restore]").length&&(e(this).data("sortable",!0),e(this).sortable({items:"> *",placeholder:"az-sortable-placeholder",forcePlaceholderSize:!0,start:function(t,n){e(n.item).removeClass("sortable-highlight").find(".az-sortable-controls").remove()},update:function(){h.attrs.content=e(h.dom_content_element).html(),h.restore_content(),l()},over:function(e,t){t.placeholder.attr("class",t.helper.attr("class")),t.placeholder.removeClass("ui-sortable-helper"),t.placeholder.addClass("az-sortable-placeholder")}}))})}function m(){function a(e){for(var t={},n=e.split(","),a=0;a<n.length;a++){var o=n[a].split(":")[0],i=/(.+)\((.+)\)/.exec(o)
if(i&&(o=i[1]),o in t||(t[o]={}),i&&(t[o][""]=i[2]),2==n[a].split(":").length)for(var s=n[a].split(":")[1].split("/"),r=0;r<s.length;r++)t[o][s[r].split("=")[0]]=s[r].split("=")[1]}return t}function o(t){if(e(t).hasClass("sortable-highlight")){e(t).find(".az-sortable-controls").remove()
var a=e('<div class="az-sortable-controls"></div>').appendTo(t),o=e('<div class="az-sortable-clone '+n+"glyphicon "+n+'glyphicon-repeat" title="'+p("Clone")+'"></div>').appendTo(a).click(function(){return d(),e(t).removeClass("sortable-highlight").find(".az-sortable-controls").remove(),e(t).clone().insertAfter(t),y=[],b=null,h.attrs.content=e(h.dom_content_element).html(),h.restore_content(),l(),m(),!1})
e(o).css("line-height",e(o).height()+"px").css("font-size",e(o).height()/2+"px")
var i=e('<div class="az-sortable-remove '+n+"glyphicon "+n+'glyphicon-remove" title="'+p("Remove")+'"></div>').appendTo(a).click(function(){return d(),e(t).removeClass("sortable-highlight").find(".az-sortable-controls").remove(),e(t).remove(),y=[],b=null,h.attrs.content=e(h.dom_content_element).html(),h.restore_content(),l(),m(),!1})
e(i).css("line-height",e(i).height()+"px").css("font-size",e(i).height()/2+"px")}}for(var i=0;i<h.restoreable.length;i++)e(h.dom_element).find(h.restoreable[i]).off("mouseenter.az-restoreable").on("mouseenter.az-restoreable",function(){e(this).addClass("restoreable-highlight")}),e(h.dom_element).find(h.restoreable[i]).off("mouseleave.az-restoreable").on("mouseleave.az-restoreable",function(){e(this).removeClass("restoreable-highlight")}),e(h.dom_element).find(h.restoreable[i]).off("click.az-restoreable").on("click.az-restoreable",function(){if(e(this).is("[data-az-restore]")){var t=[]
t.push(lt({type:"html",heading:p("HTML"),param_name:"html"}))
var n=e(this).attr("data-az-restore"),a=h.restore_nodes[n]
return st.prototype.show_editor(t,{name:p("Content"),attrs:{html:a}},function(e){h.restore_nodes[n]=e.html,h.restore_content(),h.update_dom(),l()}),!1}})
for(var i=0;i<h.styleable.length;i++)e(h.dom_element).find(h.styleable[i]).off("mouseenter.az-styleable").on("mouseenter.az-styleable",function(){0==e(this).closest("[data-az-restore]").length&&e(this).addClass("styleable-highlight")}),e(h.dom_element).find(h.styleable[i]).off("mouseleave.az-styleable").on("mouseleave.az-styleable",function(){0==e(this).closest("[data-az-restore]").length&&e(this).removeClass("styleable-highlight")}),e(h.dom_element).find(h.styleable[i]).off("click.az-styleable").on("click.az-styleable",function(n){if(0==e(this).closest("[data-az-restore]").length){if(0==e(this).parent().closest(".styleable-highlight, .editable-highlight").length)return t({node:this,edit:!1,style:!0,attrs:{}}),v(n),!1
t({node:this,edit:!1,style:!0,attrs:{}}),setTimeout(function(){null==u&&s.edit_stack.length>0&&v(n)},0)}})
for(var i=0;i<h.editable.length;i++)e(h.dom_element).find(h.editable[i]).off("mouseenter.az-editable").on("mouseenter.az-editable",function(){0==e(this).closest("[data-az-restore]").length&&e(this).addClass("editable-highlight")}),e(h.dom_element).find(h.editable[i]).off("mouseleave.az-editable").on("mouseleave.az-editable",function(){0==e(this).closest("[data-az-restore]").length&&e(this).removeClass("editable-highlight")}),e(h.dom_element).find(h.editable[i]).off("click.az-editable").on("click.az-editable",function(n){if(0==e(this).closest("[data-az-restore]").length){if(0==e(this).parent().closest(".styleable-highlight, .editable-highlight").length)return t({node:this,edit:!0,style:!0,attrs:{}}),v(n),!1
t({node:this,edit:!0,style:!0,attrs:{}}),setTimeout(function(){null==u&&s.edit_stack.length>0&&v(n)},0)}})
for(var r={},i=0;i<h.attr_editable.length;i++){var _=h.attr_editable[i].split("|")[0],f=h.attr_editable[i].split("|")[1]
r[_]=e.extend({},r[_],a(f))}e(h.dom_element).find("[data-az-editable]").length>0&&(r["[data-az-editable]"]={})
for(var _ in r){var g=r[_]
e(h.dom_element).find(_).off("mouseenter.az-editable").on("mouseenter.az-editable",function(){0==e(this).closest("[data-az-restore]").length&&e(this).addClass("editable-highlight")}),e(h.dom_element).find(_).off("mouseleave.az-editable").on("mouseleave.az-editable",function(){0==e(this).closest("[data-az-restore]").length&&e(this).removeClass("editable-highlight")}),e(h.dom_element).find(_).each(function(){var t=g
"[data-az-editable]"==_&&(t=a(e(this).attr("data-az-editable"))),e(this).data("attr-editable")?e(this).data("attr-editable",e.extend({},e(this).data("attr-editable"),t)):e(this).data("attr-editable",g)}),e(h.dom_element).find(_).each(function(){function n(n){if(0==e(a).closest("[data-az-restore]").length){if(0==e(a).parent().closest(".styleable-highlight, .editable-highlight").length)return t({node:a,edit:!1,style:!1,attrs:e(a).data("attr-editable")}),v(n),!1
t({node:a,edit:!1,style:!1,attrs:e(a).data("attr-editable")}),setTimeout(function(){null==u&&s.edit_stack.length>0&&v(n)},0)}}var a=this
"IFRAME"==a.tagName?e(window).off("blur.az-attr-editable").on("blur.az-attr-editable",function(){e(a).hasClass("editable-highlight")&&n(null)}):e(a).off("click.az-attr-editable").on("click.az-attr-editable",n)})}var y=[],b=null,w=null
e(h.dom_element).off("mousemove.az-able").on("mousemove.az-able",function(){null!=b&&e(b).hasClass("sortable-highlight")&&(clearTimeout(w),w=setTimeout(function(){o(b)},1e3))})
for(var i=0;i<h.sortable.length;i++)!function(t){e(h.dom_element).find(h.sortable[t]).find("> *").off("mouseenter.az-sortable").on("mouseenter.az-sortable",function(){if(0==e(this).closest("[data-az-restore]").length){var t=this,n=y[y.length-1];(e(n).has(t).length||0==y.length)&&(e(h.dom_element).find(".az-sortable-controls").remove(),e(h.dom_element).find(".sortable-highlight").removeClass("sortable-highlight"),null!==b&&clearTimeout(w),e(t).addClass("sortable-highlight"),y.push(t),e.unique(y),b=t,w=setTimeout(function(){o(t)},1e3))}}),e(h.dom_element).find(h.sortable[t]).find("> *").off("mouseleave.az-sortable").on("mouseleave.az-sortable",function(){if(0==e(this).closest("[data-az-restore]").length){var t=this
e(h.dom_element).find(".az-sortable-controls").remove(),e(h.dom_element).find(".sortable-highlight").removeClass("sortable-highlight"),null!==b&&clearTimeout(w),y.pop(),y.length>0?(t=y[y.length-1],e(t).addClass("sortable-highlight"),b=t,w=setTimeout(function(){o(t)},1e3)):b=null}})}(i)
c()}if(window.azexo_editor){var h=this
ht.prototype.show_controls.apply(this,arguments)
var u=null,v=function(t){if(e(".az-edit-select").remove(),s.edit_stack.length>1){for(var a=e('<div class="az-edit-select '+n+'btn-group-vertical"></div>').appendTo("body"),i=0;i<s.edit_stack.length;i++){var r=s.edit_stack[i],l=""
l=r.edit?"Edit":0==Object.keys(r.attrs).length?"Style":"Settings",function(t){e('<button title="'+p(l)+'" class="select '+n+"btn "+n+'btn-default">'+p(l)+"</button>").appendTo(a).click(function(){return e(a).remove(),o(t),!1})}(r)}e(a).css("left",t.clientX+"px"),e(a).css("top",t.clientY+"px"),s.edit_stack=[]}else if(1==s.edit_stack.length){var r=s.edit_stack.shift()
o(r)}}
e(document).on("azexo_synchronize",function(t,n){d()
for(var a=0;a<h.synchronizable.length;a++)e(h.dom_content_element).find(h.synchronizable[a]).each(function(){if(0==e(this).closest("[data-az-restore]").length&&(e(this).find(".editable-highlight").removeClass("editable-highlight"),e(this).find(".styleable-highlight").removeClass("styleable-highlight"),e(this).find(".sortable-highlight").removeClass("sortable-highlight"),e(this).find('[class=""]').removeAttr("class"),e(this).find('[style=""]').removeAttr("style"),this!=n.from_node&&r(this)==n.old_state)){var t=e(n.from_node).data("synchronized")
t||(t=[]),t.push(this),t=e.unique(t),e(n.from_node).data("synchronized",t),t=e(this).data("synchronized"),t||(t=[]),t.push(n.from_node),t=e.unique(t),e(this).data("synchronized",t),e(this).html(n.new_state),h.attrs.content=e(h.dom_content_element).html(),h.restore_content()}})
m()}),m(),l()}},restore_content:function(){var t=e("<div>"+this.attrs.content+"</div>")
for(var n in this.restore_nodes)e(t).find('[data-az-restore="'+n+'"]').html(this.restore_nodes[n])
e(document).trigger("azexo_restore",{dom:t}),this.attrs.content=e(t).html()},get_content:function(){return this.restore_content(),ht.prototype.get_content.apply(this,arguments)},restore:function(t){ht.prototype.restore.apply(this,arguments)
for(var n in this.restore_nodes)e(t).find('[data-az-restore="'+n+'"]').html(this.restore_nodes[n])
e(document).trigger("azexo_restore",{dom:t}),e(t).find("[data-az-restore]").removeAttr("data-az-restore")},showed:function(e,t){ht.prototype.showed.apply(this,arguments)
var n=this
...
this.attrs.content=e(n).html(),e(this.attrs.content).appendTo(this.dom_content_element),ht.prototype.render.apply(this,arguments)}})}this.template_elements_loaded=!0,Jt(),this.try_render_unknown_elements(),e(function(){function a(){if(e(g).empty(),1==l.length){for(var t=0;t<l[0].children.length;t++){var o=l[0].children[t]
e('<li class="'+n+"glyphicon "+n+'glyphicon-move" data-section-id="'+o.id+'">'+o.base+"("+o.id+")</li>").appendTo(g).click(function(){var t=e(this).attr("data-section-id"),n=s.get_element(t)
return n.remove(),a(),!1})}e(g).sortable({items:"li",placeholder:"az-sortable-placeholder",forcePlaceholderSize:!0,update:function(t,n){var a=e(n.item).attr("data-section-id"),o=s.get_element(a)
if(e(o.dom_element).detach(),e(n.item).prev().length>0){var i=e(n.item).prev().attr("data-section-id")
e(l[0].dom_content_element).find('[data-az-id="'+i+'"]').after(o.dom_element)}else{var r=e(n.item).next().attr("data-section-id")
e(l[0].dom_content_element).find('[data-az-id="'+r+'"]').before(o.dom_element)}l[0].update_sorting_children()},over:function(e,t){t.placeholder.attr("class",t.helper.attr("class")),t.placeholder.removeClass("ui-sortable-helper"),t.placeholder.addClass("az-sortable-placeholder")}})}}function o(t){if(_.isArray(t))return null
var a=e('<ul class="'+n+'nav az-nav-list"></ul>')
for(var i in t)if("_"!=i){var r=e("<li></li>").appendTo(a).on("mouseenter",function(){e(this).find("> .az-nav-list").css("display","block")}),d=t[i],c=i
0==c.indexOf("_")&&(c=c.replace("_","")),function(t){e('<a href="#">'+c+"</a>").appendTo(r).click(function(){function n(t){if(_.isArray(t))for(var a=0;a<t.length;a++)e('<div class="az-thumbnail" data-az-base="'+t[a].name+'" style="background-image: url('+encodeURI(t[a].thumbnail)+'); background-position: center center; background-size: cover;"></div>').appendTo(y)
else for(var o in t)n(t[o])}var a=this
e(y).empty(),e(y).css("display","block"),e(f).addClass("az-thumbnails"),n(t),e(f).off("mouseleave").on("mouseleave",function(){o||(e(f).css("left",""),e(f).removeClass("az-thumbnails"),e(y).css("overflow-y","scroll"),e(y).css("display","none"))})
var o=!1,i=0
return e(y).find(".az-thumbnail").click(function(){if(1==l.length){i=e(window).scrollTop()
{s.create_element(l[0],e(this).attr("data-az-base"),!0,function(){})}e(window).scrollTop(i)}return!1}),e(y).sortable({items:".az-thumbnail",connectWith:".az-ctnr",start:function(){o=!0,e(f).css("left","0px"),e(y).css("overflow-y","visible"),i=e(window).scrollTop(),e(window).on("scroll.template-elements-sortable",function(){e(window).scrollTop(i)})},stop:function(){o=!1,e(f).css("left",""),e(f).removeClass("az-thumbnails"),e(y).css("overflow-y","scroll"),e(y).css("display","none"),e(window).off("scroll.template-elements-sortable")},update:function(t,n){for(var o=s.get_element(e(n.item).parent().closest("[data-az-id]").attr("data-az-id")),r=0,l=e(n.item).parent().find("[data-az-id], .az-thumbnail"),d=0;d<l.length;d++)if(e(l[d]).hasClass("az-thumbnail")){r=d
break}s.create_element(o,e(n.item).attr("data-az-base"),r,function(){})
e(n.item).detach(),e(a).click(),e(window).scrollTop(i)},placeholder:"az-sortable-placeholder",forcePlaceholderSize:!0,over:function(e,t){t.placeholder.attr("class",t.helper.attr("class")),t.placeholder.removeClass("ui-sortable-helper"),t.placeholder.addClass("az-sortable-placeholder")}}),!1})}(d),e(r).append(o(t[i]))}return a}if(window.azexo_editor&&Object.keys(t).length>0&&l.length>0){var i={}
for(var r in t){var d=/data-az-tags=\"([^"]+)\"/.exec(t[r].html),c=[]
c=d?d[1].split(","):[""]
var m=r.split("|")
m.pop()
for(var h=i,u=0;u<m.length;u++)m[u]in h||(h[m[u]]={}),h=h[m[u]]
for(var u=0;u<c.length;u++)"_"+c[u]in h||(h["_"+c[u]]=[]),h["_"+c[u]].push(t[r])}var f=e('<div id="az-template-elements" class="az-left-sidebar azexo"></div>').appendTo("body"),v=e('<div id="az-template-elements-welcome" class="azexo">'+p("For adding elements: click on plus-buttons or drag and drop elements from left panel.")+"</div>").appendTo(f)
e(f).hover(function(){e(v).remove()})
var g=e('<ul class="az-root-sections"></ul>').appendTo(f)
e(document).on("azexo_add_element",function(e,t){var n=s.get_element(t.id)
null!=n.parent&&null==n.parent.parent&&a()}),e(document).on("azexo_update_sorting",function(t,n){var o=e(n.item).closest("[data-az-id]").attr("data-az-id"),i=s.get_element(o)
null!=i.parent&&null==i.parent.parent&&a()}),e(document).on("azexo_delete_element",function(t,n){e(g).find('li[data-section-id="'+n+'"]').remove()}),e(document).on("azexo_containers_update",function(){a()}),e("<hr>").appendTo(f),e("<h3>"+p("Elements")+"</h3>").appendTo(f),e("<hr>").appendTo(f),1==Object.keys(i).length&&(i=i[Object.keys(i)[0]]),e(f).append(o(i)),e(f).find("> .az-nav-list > li").on("mouseleave",function(){e(this).find(".az-nav-list").css("display","none")})
var y=e('<div id="az-thumbnails"></div>').appendTo(f)}})},create_cms_elements:function(e){for(var t in e){var a="az_"+t,o=function(){o.baseclass.apply(this,arguments)}
ut(a,!1,o),Y(o.prototype,{name:e[t],icon:"fa fa-cube",description:p(""),category:"CMS",instance:t,params:[lt({type:"cms_settings",heading:p("Settings"),param_name:"settings",instance:t})].concat(o.prototype.params),show_settings_on_create:!0,is_container:!0,has_content:!0,is_cms_element:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+"pull-left "+n+'text-overflow" data-az-element="'+this.base+'"><i class="'+n+"text-primary "+this.icon+'"></i><div class="'+n+'small">'+this.name+"</div></div>"},get_content:function(){return""},showed:function(e){if(o.baseclass.prototype.showed.apply(this,arguments),"content"in this.attrs&&""!=this.attrs.content)e(this.dom_content_element).append(this.attrs.content),this.attrs.content=""
else{var t=this
...
w(t.instance,t.attrs.settings,n.attrs.container,function(n){e(t.dom_content_element).empty(),e(t.dom_content_element).append(n)})},{offset:"100%",triggerOnce:!0}),e(document).trigger("scroll")}})}},render:function(e){this.dom_element=e('<div class="az-element az-cms-element '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=e("<div></div>").appendTo(this.dom_element),o.baseclass.prototype.render.apply(this,arguments)}})}this.cms_elements_loaded=!0,Jt(),this.try_render_unknown_elements()},create_element:function(e,t,n,a){var o=e.get_nested_depth(t)
if(o<ht.prototype.max_nested_depth){var i=ht.prototype.elements[t]
if(e instanceof Lt&&null==e.parent&&!i.prototype.section){var s=new kt(e,n)
s.update_dom()
var r=new i(s,!1)
...
for(var l in ht.prototype.elements)ht.prototype.elements[l].prototype.hidden||"az_popup"!=t.base&&i.indexOf(ht.prototype.elements[l].prototype.base)>=0||(ht.prototype.elements[l].prototype.category in r?r[ht.prototype.elements[l].prototype.category].push(ht.prototype.elements[l]):r[ht.prototype.elements[l].prototype.category]=[ht.prototype.elements[l]])
...
var u=e('<div class="'+n+'tab-content"></div>')
for(var h in r){c++
for(var _=e('<div id="az-elements-tab-'+c+'" class="'+n+"tab-pane "+n+'clearfix"></div>'),f=0;f<r[h].length;f++)e(_).append(r[h][f].prototype.get_button())
e(u).append(_)}window.azexo_online&&(_=e('<div id="az-elements-tab-templates" class="'+n+"tab-pane "+n+'clearfix"></div>')),e(u).append(_),e(d).append(u),e("#az-elements-modal").remove()
...
ht.prototype.parse_shortcode.call(t,n)
...
var mn={}
if("azexo_classes"in window&&(mn=window.azexo_classes),ht.prototype={el_classes:e.extend(_.object([n+"optgroup-bootstrap",n+"bg-primary",n+"text-primary",n+"bg-success",n+"text-success",n+"bg-default",n+"text-default",n+"text-muted",n+"small",n+"text-left",n+"text-right",n+"text-center",n+"text-justify",n+"pull-left",n+"pull-right",n+"center-block",n+"well",n+"visible-xs-block",n+"visible-sm-block",n+"visible-md-block",n+"visible-lg-block",n+"hidden-xs",n+"hidden-sm",n+"hidden-md",n+"hidden-lg"],[p("Bootstrap classes"),p("Background primary style"),p("Text primary style"),p("Background success style"),p("Text success style"),p("Background default style"),p("Text default style"),p("Text muted style"),p("Text small style"),p("Text align left"),p("Text align right"),p("Text align center"),p("Text align justify"),p("Pull left"),p("Pull right"),p("Block align center"),p("Well"),p("Visible on extra small devices, phones (<768px)"),p("Visible on small devices, tablets (≥768px)"),p("Visible on medium devices, desktops (≥992px)"),p("Visible on large devices, desktops (≥1200px)"),p("Hidden on extra small devices, phones (<768px)"),p("Hidden on small devices, tablets (≥768px)"),p("Hidden on medium devices, desktops (≥992px)"),p("Hidden on large devices, desktops (≥1200px)")]),mn),elements:{},tags:{},max_nested_depth:3,name:"",category:"",description:"",params:[lt({type:"textfield",heading:p("Element classes"),param_name:"el_class",description:p("If you wish to style particular content element differently, then use this field to add a class name and then refer to it in your css file.")}),lt({type:"style",heading:p("Style"),param_name:"style",description:p("Style options."),tab:p("Style")}),lt({type:"style",heading:p("Hover style"),param_name:"hover_style",important:!0,description:p("Hover style options."),tab:p("Hover style")}),lt({type:"integer_slider",heading:p("Left"),param_name:"pos_left",tab:p("Placement"),max:"1",step:"0.01",hidden:!0}),lt({type:"integer_slider",heading:p("Right"),param_name:"pos_right",tab:p("Placement"),max:"1",step:"0.01",hidden:!0}),lt({type:"integer_slider",heading:p("Top"),param_name:"pos_top",tab:p("Placement"),max:"1",step:"0.01",hidden:!0}),lt({type:"integer_slider",heading:p("Bottom"),param_name:"pos_bottom",tab:p("Placement"),max:"1",step:"0.01",hidden:!0}),lt({type:"integer_slider",heading:p("Width"),param_name:"pos_width",tab:p("Placement"),max:"1",step:"0.01",hidden:!0}),lt({type:"integer_slider",heading:p("Height"),param_name:"pos_height",tab:p("Placement"),max:"1",step:"0.01",hidden:!0}),lt({type:"integer_slider",heading:p("Z-index"),param_name:"pos_zindex",tab:p("Placement"),hidden:!0})],icon:"",thumbnail:"",is_container:!1,has_content:!1,frontend_render:!1,show_settings_on_create:!1,wrapper_class:"",weight:0,hidden:!1,disallowed_elements:[],show_parent_controls:!1,highlighted:!0,style_selector:"",section:!1,controls_position:function(){if(!this.is_container||this.has_content){var t=e(this.dom_element).height(),n=e(window).height()
if(t>n){var a=e(window).scrollTop(),o=(e(this.controls).offset().top,e(this.dom_element).offset().top),i=a-o+n/2
i>40&&t>i?e(this.controls).css("top",i):i>t?e(this.controls).css("top",t-40):e(this.controls).css("top",40)}}},update_controls_zindex:function(){K(this.controls)},show_controls:function(){if(window.azexo_editor){var t=this
...
else if(o instanceof Ot)if(o.layer_number<o.children.length){var l=o.children[o.layer_number]
...
if("content"===t.param_name&&"html"==t.type)return btoa(encodeURIComponent(this.attrs.content))}return this.attrs.content},set_content:function(e){for(var t=W(e),n=0;n<this.params.length;n++){var a=this.params[n]
...
if(a.param_name in t)if(a.safe)this.attrs[a.param_name]=W(t[a.param_name])
else{var o=W(t[a.param_name])
...
return null!=this.parent&&(t+=this.parent.get_nested_depth(e)),this.base==e&&t++,t},get_my_shortcode:function(){var e=_.keys(ht.prototype.elements),t=_.object(e,Array.apply(null,Array(e.length)).map(Number.prototype.valueOf,0)),n=this.get_shortcode(t)
return n},get_children_shortcode:function(){for(var e=_.keys(ht.prototype.elements),t=_.object(e,Array.apply(null,Array(e.length)).map(Number.prototype.valueOf,0)),n="",a=0;a<this.children.length;a++)n+=this.children[a].get_shortcode(t)
...
this.is_container&&(s+=this.has_content?this.get_content()+"[/"+a+"]":t+"[/"+a+"]")}return e[this.base]--,s},parse_shortcode:function(t){var n=_.keys(ht.prototype.tags).join("|"),a=rn.shortcode.regexp(n),o=e.trim(t).match(a)
if(_.isNull(o)){if(0==t.length)return
this.parse_shortcode("["==t.substring(0,1)&&"]"==t.slice(-1)?"[az_unknown]"+t+"[/az_unknown]":'[az_row][az_column width="1/1"][az_text]'+t+"[/az_text][/az_column][/az_row]")}_.each(o,function(e){var a=e.match(ln(n)),o=a[5],i=RegExp("^[\\s]*\\[\\[?("+_.keys(ht.prototype.tags).join("|")+")(?![\\w-])"),s=rn.shortcode.attrs(a[3]),r=a[2]
if(!(this.get_nested_depth(r)>ht.prototype.max_nested_depth)){var l=_t
if(r in ht.prototype.tags&&(l=ht.prototype.tags[r]),this instanceof Lt&&null==this.parent&&!l.prototype.section)return void this.parse_shortcode("[az_section]"+t+"[/az_section]")
var d=new l(this,!0)
d.parse_attrs(s.named)
var c=ht.prototype.tags[r].prototype
...
if(0==e(n).children().closest_descendents("[data-azb]").length&&e.trim(e(n).html()).length>0){var o=new jt(a,!1)
o.children=[]
var i=new Tt(o,!1),r=ht.prototype.elements.az_text,l=new r(i,!1)
l.attrs.content=e(n).html(),l.update_dom(),"update_empty"in a&&a.update_empty(),"update_empty"in i&&i.update_empty(),"update_empty"in o&&o.update_empty()}else e(n).children().closest_descendents("[data-azb]").each(function(){var n=e(this).attr("data-azb"),o=_t
n in ht.prototype.tags&&(o=ht.prototype.tags[n])
var i=new o(a,!0)
...
l.length>0&&(i.dom_content_element=e(l),i.has_content?i instanceof _t?(i.attrs.content=e(l).wrap("<div></div>").parent().html(),e(l).unwrap()):i.attrs.content=e(l).html():i.parse_html(l))}})},recursive_render:function(){for(var o=0;o<this.children.length;o++)this.children[o].recursive_render()
...
ht.prototype.parse_shortcode.call(this,n)
for(var o=[],i=a;i<this.children.length;i++)this.children[i].recursive_render(),o.push(this.children[i])
this.children=this.children.slice(0,a),this.children.splice.apply(this.children,[t,0].concat(o)),this.detach_children(),this.attach_children(),this.update_empty(),this.update_sortable(),this.recursive_showed(),e(document).trigger("azexo_containers_update")}},click_save_template:function(e){return e.data.object.save_template(),!1},save_template:function(){var e=this.get_my_shortcode(),t=window.prompt(p("Please enter template name"),"")
...
n.js[e]=!0,window.azexo_add_external_js(e,t)},get_my_container:function(){return this instanceof Lt?this:this.parent.get_my_container()},get_all_disallowed_elements:function(){if("parent"in this){var e=_.uniq(this.parent.get_all_disallowed_elements().concat(this.disallowed_elements))
return e}return this.disallowed_elements}},ut("az_unknown",!0,_t),Y(_t.prototype,{has_content:!0,hidden:!0,show_controls:function(){},update_empty:function(){},render:function(e){if(this.dom_element=e('<div class = "az-element"></div>'),this.dom_content_element=this.dom_element,"content"in this.attrs){var t=/\[[^\]]*\]([^\[]*)\[\/[^\]]*\]/.exec(this.attrs.content)
t&&e(this.dom_element).append(t[1])}_t.baseclass.prototype.render.apply(this,arguments)}}),!("azexo_baseurl"in window))if(e('script[src*="azexo_composer.js"]').length>0){var hn=e('script[src*="azexo_composer.js"]').attr("src")
window.azexo_baseurl=hn.slice(0,hn.indexOf("azexo_composer.js"))}else if(e('script[src*="azexo_composer.min.js"]').length>0){var hn=e('script[src*="azexo_composer.min.js"]').attr("src")
window.azexo_baseurl=hn.slice(0,hn.indexOf("azexo_composer.min.js"))}"azexo_online"in window||(window.azexo_online="http:"==window.location.protocol||"https:"==window.location.protocol),s=new mt,"azexo_editor"in window||(window.azexo_editor=!1),vt(),gt(function(){wt(),"azexo_exporter"in window&&Wt(),e.holdReady(!1)})
var un=!1
...
s.show_js_animations_editor(r,!1,function(){o()}),e("#az-editor-modal").find(".save").off("mousedown.an_js_in").on("mousedown.an_js_in",function(){s.save_js_animations(!1)})}}}),lt({type:"dropdown",heading:p("Animation out"),param_name:"an_out",tab:p("Animation"),value:_n,dependency:{element:"an_start",value:["hover","trigger"]}}),lt({type:"dropdown",heading:p("JS animation out"),param_name:"an_js_out",tab:p("Animation"),value:{},dependency:{element:"an_out",value:["js"],callback:function(t){function a(){s.save_js_animations(!1),e(s.animations_editor).remove(),delete s.animations_editor}function o(){s.update_js_animations_list()
var t=i.dom_element,n=i.get_value()
i.render(n),e(t).replaceWith(i.dom_element)}var i=this,s=this.element
...
"js"!=e&&a()})
var r=e('<div id="az-js-animation-form" class="'+n+"clearfix "+n+"form-group "+n+'well"></div>').insertAfter(this.dom_element)
s.show_js_animations_editor(r,!1,function(){o()}),e("#az-editor-modal").find(".save").off("mousedown.an_js_out").on("mousedown.an_js_out",function(){s.save_js_animations(!1)})}}}),lt({type:"checkbox",heading:p("Hidden"),param_name:"an_hidden",tab:p("Animation"),value:{before_in:p("Before in-animation"),after_in:p("After in-animation")},dependency:{element:"an_start",value:["appear","hover","click","trigger"]}}),lt({type:"checkbox",heading:p("Infinite?"),param_name:"an_infinite",tab:p("Animation"),value:{yes:p("Yes, please")},dependency:{element:"an_start",value:["appear","hover","click","trigger"]}}),lt({type:"dropdown",heading:p("By letters?"),param_name:"an_letters",tab:p("Animation"),value:{"":p("No"),sequence:p("Sequence"),reverse:p("Reverse"),sync:p("Sync"),shuffle:p("Shuffle")},dependency:{element:"an_start",value:["appear","hover","click","trigger"]}}),lt({type:"integer_slider",heading:p("Duration"),param_name:"an_duration",tab:p("Animation"),max:"3000",description:p("In milliseconds."),value:"1000",dependency:{element:"an_start",value:["appear","hover","click","trigger"]}}),lt({type:"integer_slider",heading:p("In-delay"),param_name:"an_in_delay",tab:p("Animation"),max:"10000",description:p("In milliseconds."),value:"0",dependency:{element:"an_start",value:["appear","hover","click","trigger"]}}),lt({type:"integer_slider",heading:p("Out-delay"),param_name:"an_out_delay",tab:p("Animation"),max:"10000",description:p("In milliseconds."),value:"0",dependency:{element:"an_start",value:["hover","trigger"]}}),lt({type:"integer_slider",heading:p("Parent number"),param_name:"an_parent",tab:p("Animation"),max:"10",min:"0",description:p("Define the number of Parent Containers the animation should attempt to break away from."),value:"1",dependency:{element:"an_start",value:["hover","click"]}}),lt({type:"dropdown",heading:p("Animation fill mode"),param_name:"an_fill_mode",tab:p("Animation"),value:{"":p("Default"),forwards:p("Forwards"),backwards:p("Backwards"),both:p("Both"),none:p("None")},description:p('"FORWARDS" - after the animation ends (determined by animation-iteration-count), the animation will apply the property values for the time the animation ended; "BACKWARDS" - The animation will apply the property values defined in the keyframe that will start the first iteration of the animation, during the period defined by animation-delay. These are either the values of the from keyframe (when animation-direction is "normal" or "alternate") or those of the to keyframe (when animation-direction is "reverse" or "alternate-reverse"); "BOTH" - the animation will follow the rules for both forwards and backwards. That is, it will extend the animation properties in both directions; "NONE" - The animation will not apply any styles to the target before or after it is executing.'),dependency:{element:"an_start",value:["appear","hover","click","trigger"]}}),lt({type:"textfield",heading:p("Name for animations"),param_name:"an_name",hidden:!0}),lt({type:"textfield",heading:p("Animation scenes"),param_name:"an_scenes",hidden:!0})].concat(xt.prototype.params),set_in_timeout:function(){var t=this
...
""!=t&&(i=t,_.isObject(a[o])||(a[o]={}),a[o][t]=n)}var p="property"+s,m="property"+s+"value",h=e('<div class="row"><div class="select '+n+'col-xs-5">'+ot(r,p,i)+'</div><div class="value '+n+'col-xs-5"><input class="'+n+'form-control" name="'+m+'" type="text" value="'+l+'"></div><div class="remove '+n+'col-xs-2"><button title="'+c("Remove")+'" type="button" class="control remove '+n+"btn "+n+"btn-danger "+n+"glyphicon "+n+'glyphicon-remove"> </button></div></div>').appendTo(t)
...
window.azexo_editor&&(xt.baseclass.prototype.show_controls.apply(this,arguments),e('<button title="'+c("Scroll animations")+'" class="control scroll-animation '+n+"btn "+n+"btn-warning "+n+"glyphicon "+n+'glyphicon-sort"> </button>').appendTo(this.controls).click(function(){e("#az-js-animation-modal").remove()
...
o.setTween(i)}}})},showed:function(e){xt.baseclass.prototype.showed.apply(this,arguments),this.an_name="","an_name"in this.attrs&&""!=this.attrs.an_name&&(this.an_name=this.attrs.an_name,s.elements_instances_by_an_name[this.an_name]=this),this.an_scenes=[],"an_scenes"in this.attrs&&""!=this.attrs.an_scenes&&(this.an_scenes=e.parseJSON(decodeURIComponent(atob(this.attrs.an_scenes))),this.update_scroll_animation()),"an_start"in this.attrs&&""!=this.attrs.an_start&&"no"!=this.attrs.an_start&&this.animation()},render:function(e){"an_name"in this.attrs&&""!=this.attrs.an_name&&e(this.dom_element).attr("data-an-name",this.attrs.an_name),xt.baseclass.prototype.render.apply(this,arguments)}}),zt("az_section",!0,kt),Y(kt.prototype,{name:p("Section"),icon:"fa fa-square-o",description:p("Bootstrap grid container"),category:p("Layout"),params:[lt({type:"checkbox",heading:p("Fluid?"),param_name:"fluid",value:{yes:p("Yes, please")}}),lt({type:"dropdown",heading:p("Background Effect"),param_name:"effect",tab:p("Background Effects"),value:{"":p("Simple Image"),fixed:p("Fixed Image"),parallax:p("Parallax Image"),youtube:p("YouTube Video")},description:p("Select the effect you want to apply to the section background.")}),lt({type:"integer_slider",heading:p("Parallax speed"),param_name:"parallax_speed",tab:p("Background Effects"),value:20,dependency:{element:"effect",value:["parallax"]}}),lt({type:"checkbox",heading:p("Video Play Options"),param_name:"video_options",tab:p("Background Effects"),description:p("Select options for the video."),value:{loop:p("Loop"),mute:p("Muted")},dependency:{element:"effect",value:["youtube"]}}),lt({type:"textfield",heading:p("YouTube Video URL"),param_name:"video_youtube",tab:p("Background Effects"),description:p("Enter the YouTube video URL."),dependency:{element:"effect",value:["youtube"]}}),lt({type:"textfield",heading:p("Start Time in seconds"),param_name:"video_start",tab:p("Background Effects"),description:p("Enter time in seconds from where video start to play."),value:"0",dependency:{element:"effect",value:["youtube"]}}),lt({type:"textfield",heading:p("Stop Time in seconds"),param_name:"video_stop",tab:p("Background Effects"),description:p("Enter time in seconds where video ends."),value:"0",dependency:{element:"effect",value:["youtube"]}})].concat(kt.prototype.params),is_container:!0,section:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},showed:function(e){kt.baseclass.prototype.showed.apply(this,arguments)
var t=this
...
this.add_css("jquery.mb.YTPlayer/css/YTPlayer.css","mb_YTPlayer"in e.fn,function(){}),this.add_js_list({paths:["jquery.mb.YTPlayer/inc/jquery.mb.YTPlayer.js","jquery-waypoints/waypoints.min.js"],loaded:"waypoint"in e.fn&&"mb_YTPlayer"in e.fn,callback:function(){e(t.dom_element).waypoint(function(){e(t.dom_element).attr("data-property","{videoURL:'"+nt(t.attrs.video_youtube)+"',containment:'#"+t.id+"', showControls:false, autoPlay:true, loop:"+n+", mute:"+a+", startAt:"+t.attrs.video_start+", stopAt:"+t.attrs.video_stop+", opacity:1, addRaster:false, quality:'default'}"),e(t.dom_element).mb_YTPlayer(),e(t.dom_element).playYTP()},{offset:"100%",triggerOnce:!0}),e(document).trigger("scroll")}})}},render:function(e,t){this.dom_element=e('<div id="'+this.id+'" class="az-element az-section '+this.attrs.el_class+' " style="'+this.attrs.style+'"></div>'),this.dom_content_element="yes"==this.attrs.fluid?e('<div class="az-ctnr '+t+'container-fluid"></div>').appendTo(this.dom_element):e('<div class="az-ctnr '+t+'container"></div>').appendTo(this.dom_element),kt.baseclass.prototype.render.apply(this,arguments)}}),zt("az_row",!0,jt),Y(jt.prototype,{name:p("Row"),icon:"fa fa-table",description:p("One row to implement a Bootstrap grid layout with responsive ability. You can choose number of columns and thier widths. Used by default."),category:p("Layout"),params:[lt({type:"dropdown",heading:p("Device"),param_name:"device",value:{xs:p("Extra small devices Phones (<768px)"),sm:p("Small devices Tablets (≥768px)"),md:p("Medium devices Desktops (≥992px)"),lg:p("Large devices Desktops (≥1200px)")},description:p("Bootstrap responsive grid system")})].concat(jt.prototype.params),is_container:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},show_controls:function(){if(window.azexo_editor){jt.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".add").remove(),e(this.controls).find(".paste").remove()
...
if(0==this.children.length)for(var n=0;n<t.length;n++){var a=new Tt(this,!0)
...
else{var a=new Tt(this,!0)
a.update_dom(),a.update_width(t[n])}this.update_sortable()},render:function(e,t){this.dom_element=e('<div class="az-element az-row '+t+"row "+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=this.dom_element,jt.baseclass.prototype.render.apply(this,arguments)}}),ut("az_column",!0,Tt),Y(Tt.prototype,{name:p("Column"),params:[lt({type:"textfield",heading:p("Column with"),param_name:"width",hidden:!0})].concat(Tt.prototype.params),hidden:!0,is_container:!0,show_parent_controls:!0,get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p("Settings for this row and current column. You can choose columns layout by mouse over (or click) this button: ")+'<span class="'+n+"glyphicon "+n+'glyphicon-th"></span></div></div>'},show_controls:function(){window.azexo_editor&&(Tt.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".clone").remove(),e(this.controls).find(".copy").remove(),e(this.controls).find(".remove").remove())},get_my_shortcode:function(){return this.get_children_shortcode()},update_width:function(t){e(this.dom_element).removeClass(X(this.attrs.width,this.parent.attrs.device)),this.attrs.width=t,e(this.dom_element).addClass(X(this.attrs.width,this.parent.attrs.device)),e(document).trigger("azexo_update_element",this.id)},render:function(e){this.dom_element=e('<div class="az-element az-ctnr az-column '+this.attrs.el_class+" "+X(this.attrs.width,this.parent.attrs.device)+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=this.dom_element,Tt.baseclass.prototype.render.apply(this,arguments)}}),zt("az_grid",!0,Ct),Y(Ct.prototype,{name:p("Grid"),icon:"fa fa-th-large",description:p("Grid with filter by tags. Every item of grid can contain any number of any types of elements."),category:p("Layout"),params:[lt({type:"integer_slider",heading:p("Columns number"),param_name:"columns_number",min:"1",max:"20",value:"3"}),lt({type:"checkbox",heading:p("Masonry grid?"),param_name:"masonry",value:{yes:p("Yes, please")}})].concat(Ct.prototype.params),is_container:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},update_sortable:function(){function t(e,t){t.placeholder.attr("class",t.helper.attr("class")),t.placeholder.css("width",t.helper.css("width")),t.placeholder.css("height",t.helper.css("height")),t.placeholder.removeClass("ui-sortable-helper"),t.placeholder.addClass("az-sortable-placeholder")}if(window.azexo_editor){var n=this
...
var t=s.get_element(e(this).closest("[data-az-id]").attr("data-az-id"))
if(t)for(var n=0;n<t.children.length;n++)t.children[n].update_empty()},show_controls:function(){window.azexo_editor&&(Ct.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".add").remove(),e(this.controls).find(".paste").remove(),e(this.controls).find(".clone").remove(),azexo_add_js({path:"js/json2.min.js",loaded:"JSON"in window,callback:function(){}}))},click_add_item:function(e){return e.data.object.add_item(),!1},add_item:function(){var e=new St(this,!0)
...
c.id!=i.parent.id&&(c.children.splice(a.to_pos,0,c.children.splice(a.from_pos,1)[0]),c.update_dom())}else for(var p=(n.get_path(a.source),n.get_linked_elements(a.source,!1)),m=(n.get_path(a.target),n.get_linked_elements(a.target,!1)),d=0;d<p.length;d++){var h=p[d],u=m[d]
if(h.id!=a.source.id&&u.id!=a.target.id){var _=h.children.splice(a.from_pos,1)[0]
h.update_dom(),u.children.splice(a.to_pos,0,_),u.update_dom()}}}})}},get_path:function(e){if("az_item"==e.base)return[]
...
if(e.length==a.children.length)for(var n=ht.prototype.tags[this.base],o=this.get_child_position(),t=0;t<e.length;t++)if(e[t].id!=this.parent.id){var i=e[t],s=new n(i,!0)
...
for(var o=0;o<t.children.length;o++)a.add_control(t.children[o])},showed:function(e,t){Ct.baseclass.prototype.showed.apply(this,arguments)
var n=this
...
e(a.dom_element).css("font-size",100*o+"%"),e(a.dom_content_element).css("height",a.attrs.height*o+"px"),n(a,o)}),e(window).trigger("resize"))},render:function(e){this.dom_element=e('<div class="az-element az-layers '+this.attrs.el_class+'" style="'+this.attrs.style+'"><div id="'+this.id+'" class="az-ctnr"></div></div>'),this.dom_content_element=e(this.dom_element).find(".az-ctnr"),e(this.dom_content_element).css("width",this.attrs.width),e(this.dom_content_element).css("height",this.attrs.height),Ot.baseclass.prototype.render.apply(this,arguments)}}),zt("az_tabs",!0,It),Y(It.prototype,{name:p("Tabs"),icon:"fa fa-folder-o",description:p("Bootstrap content tabs. Every tab can contain any number of any types of elements."),category:p("Layout"),params:[].concat(It.prototype.params),is_container:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},show_controls:function(){window.azexo_editor&&(It.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".add").remove(),e(this.controls).find(".paste").remove(),e('<button title="'+c("Add tab")+'" class="control add-tab '+n+"btn "+n+"btn-primary "+n+"glyphicon "+n+'glyphicon-plus-sign" > </button>').appendTo(this.controls).click({object:this},this.click_add_tab))},update_sortable:function(){window.azexo_editor&&e(this.dom_element).sortable({axis:"x",items:"> ul > li",update:this.update_sorting,placeholder:"az-sortable-placeholder",forcePlaceholderSize:!0,over:function(e,t){t.placeholder.attr("class",t.helper.attr("class")),t.placeholder.removeClass("ui-sortable-helper"),t.placeholder.addClass("az-sortable-placeholder")}})},update_sorting:function(t,a){var o=s.get_element(e(this).attr("data-az-id"))
...
o.update_dom(),e(document).trigger("azexo_update_sorting",a)}},click_add_tab:function(e){return e.data.object.add_tab(),!1},add_tab:function(){var t=new Pt(this,!1)
t.update_dom(),this.update_dom(),e(this.dom_element).find('a[href="#'+t.id+'"]')[a+"tab"]("show")},showed:function(e,t,n){It.baseclass.prototype.showed.apply(this,arguments),e(this.dom_element).find("ul."+t+"nav-tabs li:first a")[n+"tab"]("show")},render:function(e,t){this.dom_element=e('<div class="az-element az-tabs '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>')
...
this.dom_content_element=e(o).appendTo(this.dom_element),It.baseclass.prototype.render.apply(this,arguments)}}),ut("az_tab",!0,Pt),Y(Pt.prototype,{name:p("Tab"),params:[lt({type:"textfield",heading:p("Tab title"),param_name:"title",value:p("Title")})].concat(Pt.prototype.params),hidden:!0,is_container:!0,show_parent_controls:!0,get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p("Settings for this tabs element and for current tab element. ")+'<span class="'+n+"glyphicon "+n+'glyphicon-plus-sign"></span>'+p(" - add a new tab.")+" "+p("Tabs headers are draggable. You can enter tab title by click on this button: ")+'<span class="'+n+"glyphicon "+n+'glyphicon-pencil"></span></div></div>'},show_controls:function(){window.azexo_editor&&(Pt.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".drag-and-drop").remove(),e('<span class="control '+n+"btn "+n+"btn-primary "+n+'glyphicon">'+this.name+"</span>").prependTo(this.controls))},get_my_shortcode:function(){return this.get_children_shortcode()},edited:function(){Pt.baseclass.prototype.edited.apply(this,arguments),this.parent.update_dom(),e('a[href="#'+this.id+'"]')[a+"tab"]("show")},clone:function(){var t=Pt.baseclass.prototype.get_my_shortcode.apply(this,arguments)
e("#azexo-clipboard").html(btoa(encodeURIComponent(t))),this.parent.paste(this.parent.children.length),this.parent.update_dom()},remove:function(){Pt.baseclass.prototype.remove.apply(this,arguments),this.parent.update_dom()},render:function(e,t){this.dom_element=e('<div id="'+this.id+'" class="az-element az-ctnr az-tab '+t+"tab-pane "+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=this.dom_element,Pt.baseclass.prototype.render.apply(this,arguments)}}),zt("az_accordion",!0,At),Y(At.prototype,{name:p("Accordion"),icon:"fa fa-bars",description:p("Bootstrap content accordion. Every toggle of this element can contain any number of any types of elements."),category:p("Layout"),params:[lt({type:"dropdown",heading:p("Type"),param_name:"type",value:{"panel-default":p("Default"),"panel-primary":p("Primary"),"panel-success":p("Success"),"panel-info":p("Info"),"panel-warning":p("Warning"),"panel-danger":p("Danger")}}),lt({type:"checkbox",heading:p("Collapsed?"),param_name:"collapsed",value:{yes:p("Yes, please")}})].concat(At.prototype.params),is_container:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},show_controls:function(){window.azexo_editor&&(At.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".add").remove(),e(this.controls).find(".paste").remove(),e('<button title="'+c("Add toggle")+'" class="control add-toggle '+n+"btn "+n+"btn-primary "+n+"glyphicon "+n+'glyphicon-plus-sign" > </button>').appendTo(this.controls).click({object:this},this.click_add_toggle))},update_sortable:function(){window.azexo_editor&&e(this.dom_element).sortable({axis:"y",items:"> .az-toggle",handle:"> .controls > .drag-and-drop",update:this.update_sorting,placeholder:"az-sortable-placeholder",forcePlaceholderSize:!0,over:function(e,t){t.placeholder.attr("class",t.helper.attr("class")),t.placeholder.removeClass("ui-sortable-helper"),t.placeholder.addClass("az-sortable-placeholder")}})},click_add_toggle:function(e){return e.data.object.add_toggle(),!1},add_toggle:function(){var e=new Rt(this,!1)
e.update_dom(),this.update_dom()},update_dom:function(){for(var e=0;e<this.children.length;e++)this.children[e].update_dom()
At.baseclass.prototype.update_dom.apply(this,arguments)},showed:function(e,t,n){At.baseclass.prototype.showed.apply(this,arguments),e(this.dom_element).find("> .az-toggle > ."+t+"in").removeClass(t+"in"),e(this.dom_element).find("> .az-toggle > ."+t+"collapse:not(:first)")[n+"collapse"]({toggle:!1,parent:"#"+this.id}),e(this.dom_element).find("> .az-toggle > ."+t+"collapse:first")[n+"collapse"]({toggle:"yes"!=this.attrs.collapsed,parent:"#"+this.id})},render:function(e,t){this.dom_element=e('<div id="'+this.id+'" class="az-element az-accordion '+t+"panel-group "+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=this.dom_element,At.baseclass.prototype.render.apply(this,arguments)}}),ut("az_toggle",!0,Rt),Y(Rt.prototype,{name:p("Toggle"),params:[lt({type:"textfield",heading:p("Toggle title"),param_name:"title",value:p("Title")})].concat(Rt.prototype.params),hidden:!0,is_container:!0,show_parent_controls:!0,get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p("Settings for this accordion element and for current toggle. ")+'<span class="'+n+"glyphicon "+n+'glyphicon-plus-sign"></span>'+p(" - add a new toggle. You can enter toggle title by click on this button: ")+'<span class="'+n+"glyphicon "+n+'glyphicon-pencil"></span></div></div>'},get_my_shortcode:function(){return this.get_children_shortcode()},clone:function(){var t=Rt.baseclass.prototype.get_my_shortcode.apply(this,arguments)
...
""!=this.parent.attrs.type&&(n=this.parent.attrs.type),this.dom_element=e('<div class="az-element az-toggle '+t+"panel "+n+" "+this.attrs.el_class+'" style="'+this.attrs.style+'"><div class="'+t+'panel-heading"><h4 class="'+t+'panel-title"><a data-toggle="'+t+'collapse" data-parent="#'+this.parent.id+'" href="#'+this.id+'">'+this.attrs.title+'</a></h4></div><div id="'+this.id+'" class="'+t+"panel-collapse "+t+'collapse"><div class="'+t+'panel-body az-ctnr"></div></div></div>'),this.dom_content_element=e(this.dom_element).find("."+t+"panel-body"),Rt.baseclass.prototype.render.apply(this,arguments)}}),zt("az_carousel",!0,Dt),Y(Dt.prototype,{name:p("Carousel"),icon:"fa fa-ellipsis-h",description:p("Content carousel. Every slide of this element can contain any number of any types of elements. It can be used for create classic content slider."),category:p("Layout"),params:[lt({type:"integer_slider",heading:p("Number items"),param_name:"items",min:"1",max:"10",value:"1"}),lt({type:"checkbox",heading:p("Options"),param_name:"options",value:{navigation:p("Navigation"),auto_play:p("Auto play"),mouse:p("Mouse drag"),touch:p("Touch drag")}}),lt({type:"dropdown",heading:p("Transition style"),param_name:"transition",value:{"":p("Default"),fade:p("fade"),backSlide:p("backSlide"),goDown:p("goDown"),fadeUp:p("fadeUp")}})].concat(Dt.prototype.params),is_container:!0,show_settings_on_create:!0,frontend_render:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},show_controls:function(){if(window.azexo_editor){Dt.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".add").remove(),e(this.controls).find(".paste").remove()
e('<button title="'+c("Add slide")+'" class="control add-toggle '+n+"btn "+n+"btn-primary "+n+"glyphicon "+n+'glyphicon-plus-sign" > </button>').appendTo(this.controls).click({object:this},this.click_add_slide)}},update_sortable:function(){},click_add_slide:function(e){return e.data.object.add_slide(),!1},add_slide:function(){var e=new Ut(this,!0)
e.update_dom(),this.update_dom()},showed:function(e){Dt.baseclass.prototype.showed.apply(this,arguments),this.add_css("owl.carousel/owl-carousel/owl.carousel.css","owlCarousel"in e.fn,function(){}),this.add_css("owl.carousel/owl-carousel/owl.theme.css","owlCarousel"in e.fn,function(){}),this.add_css("owl.carousel/owl-carousel/owl.transitions.css","owlCarousel"in e.fn,function(){})
var t=this
...
e(t.dom_content_element).owlCarousel({singleItem:"1"==t.attrs.items,items:t.attrs.items,navigation:_.indexOf(t.attrs.options.split(","),"navigation")>=0,autoPlay:_.indexOf(t.attrs.options.split(","),"auto_play")>=0,mouseDrag:_.indexOf(t.attrs.options.split(","),"mouse")>=0,touchDrag:_.indexOf(t.attrs.options.split(","),"touch")>=0,transitionStyle:""==t.attrs.transition?!1:t.attrs.transition,stopOnHover:!0,afterAction:function(){n(this.owl)},beforeMove:function(){},afterMove:function(){},startDragging:function(){}}),n(t.dom_content_element.data("owlCarousel"))}})},render:function(e){this.dom_element=e('<div id="'+this.id+'" class="az-element az-carousel '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=e("<div></div>").appendTo(this.dom_element),Dt.baseclass.prototype.render.apply(this,arguments)}}),ut("az_slide",!0,Ut),Y(Ut.prototype,{name:p("Slide"),params:[].concat(Ut.prototype.params),hidden:!0,frontend_render:!0,is_container:!0,show_parent_controls:!0,get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p("Settings for this carousel element and for current slide. ")+'<span class="'+n+"glyphicon "+n+'glyphicon-plus-sign"></span>'+p(" - add a new slide.")+"</div></div>"},show_controls:function(){window.azexo_editor&&(Ut.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".clone").remove(),e(this.controls).find(".drag-and-drop").remove(),e('<span class="control '+n+"btn "+n+"btn-primary "+n+'glyphicon">'+this.name+"</span>").prependTo(this.controls))},get_my_shortcode:function(){return this.get_children_shortcode()},edited:function(){Ut.baseclass.prototype.edited.apply(this,arguments),this.parent.update_dom()},render:function(e,t){var n="panel-default"
""!=this.parent.attrs.type&&(n=this.parent.attrs.type),this.dom_element=e('<div class="az-element az-slide az-ctnr '+this.attrs.el_class+" "+t+'clearfix" style="'+this.attrs.style+'"></div>'),this.dom_content_element=this.dom_element,Ut.baseclass.prototype.render.apply(this,arguments)}}),zt("az_presentation",!0,Nt),Y(Nt.prototype,{name:p("Presentation"),icon:"fa fa-file-powerpoint-o",description:p("Content presentation. Every step of presentation can contain any number of any types of elements."),category:p("Layout"),params:[lt({type:"integer_slider",heading:p("Height"),param_name:"height",min:"0",max:"2000",value:"900"}),lt({type:"checkbox",heading:p("Options"),param_name:"options",value:{navigation:p("Navigation"),auto_play:p("Auto play"),full_filling:p("Full filling available area")}}),lt({type:"integer_slider",heading:p("Transition duration"),param_name:"duration",min:"0",max:"10000",value:"1000"})].concat(Nt.prototype.params),is_container:!0,highlighted:!1,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},init_scroll_variables:function(){this.hover=!1,this.scroll_top=0,this.transition_duration="0s",this.transition_delay="0s"},show_controls:function(){function t(e,t){var n={x:0,y:0},a=d.config.rotation/180*Math.PI,o=Math.cos(a),i=Math.sin(a)
...
var m={x:0,y:0,rotate:0,scale:1},h={prevX:!1,prevY:!1,activeFunction:!1},u={}
u.move=function(e,n){var a=t(e,n)
p.data.x=p.data.x?p.data.x+a.x:a.x,p.data.y=p.data.y?p.data.y+a.y:a.y},u.scale=function(e){p.data.scale-=-e*d.config.scaleStep*d.config.visualScaling/10},u.rotate=function(e){p.data.rotate-=-e*d.config.rotateStep}
var _=null
...
d.config.visualScaling=d.config.visualScaling/i,e(d.dom_content_element).css("transform",o+" scale("+i+")")})}},update_sortable:function(){if(window.azexo_editor);},click_add_step:function(e){return e.data.object.add_step(),!1},add_step:function(){var e=new Mt(this,!0)
...
else Nt.baseclass.prototype.attach_children.apply(this,arguments)},edited:function(){Nt.baseclass.prototype.edited.apply(this,arguments),this.update_dom()},showed:function(e,t){Nt.baseclass.prototype.showed.apply(this,arguments)
var n=this
...
""!=this.children[a-1].attrs.name&&(o=this.children[a-1].attrs.name),e('<li><a href="#" class="goto" data-step="'+this.children[a-1].id+'">'+o+"</a></li>").appendTo(n)}e('<li><a href="#" class="'+t+'next">&raquo;</a></li>').appendTo(n)}Nt.baseclass.prototype.render.apply(this,arguments)}}),ut("az_step",!0,Mt),Y(Mt.prototype,{name:p("Step"),params:[lt({type:"textfield",heading:p("Name"),param_name:"name"}),lt({type:"checkbox",heading:p("Options"),param_name:"options",value:{dummy:p("Dummy")}}),lt({type:"integer_slider",heading:p("Width"),param_name:"width",min:"1",max:"100000",value:"900"}),lt({type:"integer_slider",heading:p("Height"),param_name:"height",min:"1",max:"100000",value:"700"}),lt({type:"integer_slider",heading:p("X coordinate"),param_name:"x",min:"-100000",max:"100000",value:"0"}),lt({type:"integer_slider",heading:p("Y coordinate"),param_name:"y",min:"-100000",max:"100000",value:"0"}),lt({type:"integer_slider",heading:p("Z coordinate"),param_name:"z",min:"-10000",max:"10000",value:"0"}),lt({type:"integer_slider",heading:p("X rotate"),param_name:"rotate_x",min:"-180",max:"180",value:"0"}),lt({type:"integer_slider",heading:p("Y rotate"),param_name:"rotate_y",min:"-180",max:"180",value:"0"}),lt({type:"integer_slider",heading:p("Z rotate"),param_name:"rotate_z",min:"-180",max:"180",value:"0"}),lt({type:"integer_slider",heading:p("Scale"),param_name:"scale",min:"0",max:"1000",value:"1",step:"0.01"})].concat(Mt.prototype.params),hidden:!0,is_container:!0,show_parent_controls:!0,disallowed_elements:["az_presentation"],highlighted:!1,get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p('Settings for this presentation element and for current step. Press on "Space" button to going through steps. ')+'<span class="'+n+"glyphicon "+n+'glyphicon-plus-sign"></span>'+p(" - add a new step.")+"</div></div>"},get_my_shortcode:function(){return this.get_children_shortcode()},show_controls:function(){Mt.baseclass.prototype.show_controls.apply(this,arguments),window.azexo_editor&&(e(this.controls).find(".drag-and-drop").remove(),e('<span class="control '+n+"btn "+n+"btn-primary "+n+'glyphicon">'+this.name+"</span>").prependTo(this.controls))},update_sortable:function(){if(window.azexo_editor){var t=this
e(this.dom_element).resizable({stop:function(){t.attrs.width=e(t.dom_element).width(),t.attrs.height=e(t.dom_element).height(),e(document).trigger("azexo_update_element",t.id),"impress"in t.parent&&t.impress.initStep(t.dom_element.get(0))}})}},clone:function(){var t=Mt.baseclass.prototype.get_my_shortcode.apply(this,arguments)
e("#azexo-clipboard").html(btoa(encodeURIComponent(t)))
for(var n=0;n<this.parent.children.length;n++)if(this.parent.children[n].id==this.id){this.parent.paste(n)
break}this.parent.update_dom()},edited:function(){Mt.baseclass.prototype.edited.apply(this,arguments)
var e=this
"impress"in e.parent&&e.parent.impress.initStep(e.dom_element.get(0))},remove:function(){Mt.baseclass.prototype.remove.apply(this,arguments),this.parent.update_dom()},render:function(e){this.dom_element=e('<div id="'+this.id+'" class="az-element az-step az-ctnr step '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),e(this.dom_element).css("width",this.attrs.width),e(this.dom_element).css("height",this.attrs.height),e(this.dom_element).attr("data-x",this.attrs.x),e(this.dom_element).attr("data-y",this.attrs.y),e(this.dom_element).attr("data-z",this.attrs.z),e(this.dom_element).attr("data-rotate-x",this.attrs.rotate_x),e(this.dom_element).attr("data-rotate-y",this.attrs.rotate_y),e(this.dom_element).attr("data-rotate",this.attrs.rotate_z),e(this.dom_element).attr("data-scale",this.attrs.scale),this.dom_content_element=this.dom_element,Mt.baseclass.prototype.render.apply(this,arguments)}}),zt("az_container",!0,Lt),Y(Lt.prototype,{name:p("Container"),icon:"fa fa-archive",description:p("AJAX loaded content from server. Content can be edited and saved to server."),category:p("Layout"),params:[lt({type:"container",heading:p("Container"),param_name:"container",description:p("Type and name used as identificator to save container on server."),value:"/"})].concat(Lt.prototype.params),show_settings_on_create:!0,is_container:!0,hidden:!window.azexo_online,saveable:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},get_empty:function(){return'<div class="az-empty"><div class="top '+n+'well"><strong>'+p("Click to put an element here.")+'</strong></div><div class="top-right '+n+'well"><h1>↗</h1><span class="'+n+"glyphicon "+n+'glyphicon-eye-open"></span>'+p(" - toggle editor helpers.")+' <span class="'+n+"glyphicon "+n+'glyphicon-play-circle"></span>'+p(" - toggle animation engine to not hinder editing.")+' <span class="'+n+"glyphicon "+n+'glyphicon-save"></span>'+p(" - save results of editing on server.")+"</div></div>"},show_controls:function(){if(window.azexo_editor){var t=this
Lt.baseclass.prototype.show_controls.apply(this,arguments),null==this.parent&&(e('<button title="'+c("Toggle editor")+'" class="control toggle-editor '+n+"btn "+n+"btn-default "+n+"glyphicon "+n+'glyphicon-eye-open" > </button>').appendTo(this.controls).click(function(){return e(t.dom_element).toggleClass("azexo-editor"),!1}),e('<button title="'+c("Toggle animations")+'" class="control toggle-animations '+n+"btn "+n+"btn-default "+n+"glyphicon "+n+'glyphicon-play-circle" > </button>').appendTo(this.controls).click(function(){return e(t.dom_element).toggleClass("azexo-animations-disabled"),!1}),e(this.controls).removeClass(n+"btn-group-xs"),e(this.controls).find(".edit").remove(),e(this.controls).find(".copy").remove(),e(this.controls).find(".clone").remove(),e(this.controls).find(".remove").remove(),e(this.controls).find(".js-animation").remove(),e(this.controls).find(".drag-and-drop").attr("title",""),e(this.controls).find(".drag-and-drop").removeClass(n+"glyphicon"),e(this.controls).find(".drag-and-drop").removeClass(n+"glyphicon-move"),e(this.controls).find(".drag-and-drop").removeClass("drag-and-drop")),this.saveable&&e('<button title="'+c("Save container")+'" class="control save-container '+n+"btn "+n+"btn-success "+n+"glyphicon "+n+'glyphicon-save" > </button>').appendTo(this.controls).click({object:this},this.click_save_container)}},get_my_shortcode:function(){return this.get_children_shortcode()},get_hover_styles:function(e){var t=""
...
return n}function h(){var t="(function("+Gt+") {\n"
if(t+="if('azexo_backend' in window) return;\n",t+="var "+Qt+" = true;\n",t+="var "+Zt+" = '"+n+"';var "+Kt+" = '"+a+"';\n",t+=""+p+"\n",t+=""+m+"\n",t+=""+y+"\n",t+=""+B+"\n",t+=""+Y+"\n",t+=""+q+"\n",t+=""+W+"\n",t+=Gt+".fn.closest_descendents = "+e.fn.closest_descendents+" \n",t+=""+st+"\n",t+=st.name+".prototype.safe = true;\n",t+=st.name+".prototype.param_types = {};\n",t+=""+lt+"\n",t+="window.azexo_add_css="+window.azexo_add_css+"\n",t+="window.azexo_add_js="+window.azexo_add_js+"\n",t+="window.azexo_add_js_list="+window.azexo_add_js_list+"\n",t+="var "+en+" = {};\n",t+="var "+tn+" = {};\n",t+="window.azexo_add_external_js="+window.azexo_add_external_js+"\n",t+=""+mt+"\n",t+=mt.name+".prototype.elements_instances = {};\n",t+=mt.name+".prototype.elements_instances_by_an_name = {};\n",t+=s(mt,"get_element",!0),t+=s(mt,"delete_element",!0),t+=s(mt,"add_element",!0),t+=""+ht+"\n",t+=ht.name+".prototype.p = '"+n+"';\n",t+=ht.name+".prototype.fp = '"+a+"';\n",t+=ht.name+".prototype.elements = {};\n",t+=ht.name+".prototype.tags = {};\n",t+=r(ht),t+=s(ht,"get_hover_style",!0),t+=s(ht,"showed",!0),t+=s(ht,"render",!0),t+=s(ht,"recursive_render",!0),t+=s(ht,"replace_render",!0),t+=s(ht,"update_dom",!0),t+=s(ht,"attach_children",!0),t+=s(ht,"detach_children",!0),t+=s(ht,"recursive_showed",!0),t+=s(ht,"parse_attrs",!0),t+=s(ht,"parse_html",!0),t+=s(ht,"add_css",!0),t+=s(ht,"add_js_list",!0),t+=s(ht,"add_js",!0),t+=s(ht,"add_external_js",!0),t+=s(ht,"get_my_container",!0),"an_start"in g&&(t+=s(ht,"trigger_start_in_animation",!0),t+=s(ht,"trigger_start_out_animation",!0)),t+=""+ut+"\n",t+=""+_t+"\n",t+=ut.name+"('az_unknown', true, "+_t.name+");\n",t+=_t.name+".prototype.has_content = true;\n",t+="window.azexo_baseurl = '"+window.azexo_baseurl+"';\n","ajaxurl"in window&&(t+="window.ajaxurl = '"+at(window.ajaxurl)+"';\n"),"azexo_lang"in window&&(t+="window.azexo_lang = '"+window.azexo_lang+"';\n"),t+="window.azexo_online = (window.location.protocol == 'http:' || window.location.protocol == 'https:');\n",t+="var "+nn+" = new "+mt.name+"();\n",t+="var "+an+" = null;\n",t+="window.azexo_editor = false;\n","azexo_exporter"in window&&(t+="window.azexo_exported = "+window.azexo_exporter+";\n"),t+="var "+on+" = [];\n",t+="var "+sn+" = {};\n",t+=""+yt+"\n",t+=""+xt+"\n",t+=B.name+"("+xt.name+", "+ht.name+");\n",t+=r(xt),"an_start"in g&&(t+=s(xt,"set_in_timeout",!0),t+=s(xt,"start_in_animation",!0),t+=s(xt,"set_out_timeout",!0),t+=s(xt,"start_out_animation",!0),t+=s(xt,"clear_animation",!0),t+=s(xt,"end_animation",!0),t+=s(xt,"trigger_start_in_animation",!0),t+=s(xt,"trigger_start_out_animation",!0),t+=s(xt,"animation",!0)),("an_scenes"in g||"an_js"in g)&&(t+=s(xt,"make_timeline",!0)),"an_scenes"in g&&(t+=s(xt,"update_scroll_animation",!0)),"an_letters"in g&&(t+=s(xt,"animation_letters",!0)),("an_start"in g||"an_scenes"in g)&&(t+=s(xt,"showed",!0)),t+=s(xt,"render",!0),t+=""+zt+"\n",t+=""+Yt+"\n",t+=B.name+"("+Yt.name+", "+xt.name+");\n",t+=Yt.name+".prototype.form_elements = {};\n",t+=""+qt+"\n",kt.prototype.base in v&&(t+=""+kt+"\n",t+=zt.name+"('"+kt.prototype.base+"', true, "+kt.name+");\n",t+=r(kt),t+=s(kt,"showed",!0)),jt.prototype.base in v&&(t+=""+jt+"\n",t+=zt.name+"('"+jt.prototype.base+"', true, "+jt.name+");\n",t+=r(jt),t+=jt.name+".prototype.set_columns = function(columns){};\n",t+=""+Tt+"\n",t+=ut.name+"('"+Tt.prototype.base+"', true, "+Tt.name+");\n",t+=r(Tt),t+=s(Tt,"showed",!0)),Ct.prototype.base in v&&(t+=""+Ct+"\n",t+=zt.name+"('"+Ct.prototype.base+"', true, "+Ct.name+");\n",t+=r(Ct),t+=Ct.name+".prototype.attach_events = function(){};\n",t+=s(Ct,"showed",!0),t+=s(Ct,"render",!0),t+=""+St+"\n",t+=ut.name+"('"+St.prototype.base+"', true, "+St.name+");\n",t+=r(St),t+=s(St,"showed",!0),t+=s(St,"render",!0)),Ot.prototype.base in v&&(t+=""+Ot+"\n",t+=zt.name+"('"+Ot.prototype.base+"', true, "+Ot.name+");\n",t+=r(Ot),t+=s(Ot,"showed",!0)),It.prototype.base in v&&(t+=""+It+"\n",t+=zt.name+"('"+It.prototype.base+"', true, "+It.name+");\n",t+=r(It),t+=s(It,"showed",!0),t+=s(It,"render",!0),t+=""+Pt+"\n",t+=ut.name+"('"+Pt.prototype.base+"', true, "+Pt.name+");\n",t+=r(Pt),t+=s(Pt,"render",!0)),At.prototype.base in v&&(t+=""+At+"\n",t+=zt.name+"('"+At.prototype.base+"', true, "+At.name+");\n",t+=r(At),t+=s(At,"showed",!0),t+=s(At,"render",!0),t+=""+Rt+"\n",t+=ut.name+"('"+Rt.prototype.base+"', true, "+Rt.name+");\n",t+=r(Rt),t+=s(Rt,"render",!0),t+=s(Rt,"showed",!0)),Dt.prototype.base in v&&(t+=""+Dt+"\n",t+=zt.name+"('"+Dt.prototype.base+"', true, "+Dt.name+");\n",t+=r(Dt),t+=Dt.name+".prototype.frontend_render = true;\n",t+=s(Dt,"showed",!0),t+=s(Dt,"render",!0),t+=""+Ut+"\n",t+=ut.name+"('"+Ut.prototype.base+"', true, "+Ut.name+");\n",t+=r(Ut),t+=Ut.name+".prototype.frontend_render = true;\n",t+=s(Ut,"showed",!0),t+=s(Ut,"render",!0)),Nt.prototype.base in v&&(t+=""+Nt+"\n",t+=zt.name+"('"+Nt.prototype.base+"', true, "+Nt.name+");\n",t+=r(Nt),t+=Nt.name+".prototype.frontend_render = true;\n",t+=s(Nt,"showed",!0),t+=s(Nt,"render",!0),t+=""+Mt+"\n",t+=ut.name+"('"+Mt.prototype.base+"', true, "+Mt.name+");\n",t+=r(Mt)),Lt.prototype.base in v&&(t+=""+Lt+"\n",t+=zt.name+"('"+Lt.prototype.base+"', true, "+Lt.name+");\n",t+=r(Lt),t+=s(Lt,"showed",!0),t+=s(Lt,"load_container",!0),t+=s(Lt,"update_dom",!0),t+=s(Lt,"render",!0),t+=s(Lt,"recursive_render",!0)),Et.prototype.base in v&&(t+=""+Et+"\n",t+=ut.name+"('"+Et.prototype.base+"', false, "+Et.name+");\n",t+=r(Et),t+=s(Et,"showed",!0)),Bt.prototype.base in v&&(t+=""+it+"\n","azexo_form_submit_type"in window&&(t+="window.azexo_form_submit_type = '"+window.azexo_form_submit_type+"';\n"),"azexo_form_submit_name"in window&&(t+="window.azexo_form_submit_name = '"+window.azexo_form_submit_name+"';\n"),"recaptcha_publickey"in window&&(t+="window.recaptcha_publickey = '"+window.recaptcha_publickey+"';\n"),t+=""+O+"\n",t+=""+Bt+"\n",t+=zt.name+"('"+Bt.prototype.base+"', true, "+Bt.name+");\n",t+=r(Bt),t+=s(Bt,"showed",!0),t+=""+S+"\n"),"azexo_elements"in window){t+="window.azexo_elements = [];\n"
...
return(u(f)||"an_start"in g||"an_scenes"in g)&&(b='<script type="text/javascript">//<![CDATA['+h()+"//]]></script>"),b},get_html:function(){function t(t,n,a){var o={},i=1
return e(t).find(n).each(function(){e(this).attr(a)in o||(o[e(this).attr(a)]=i,i++),e(this).remove()}),o}this.recursive_update_data(),this.recursive_clear_animation()
var n=e("<div>"+e(this.dom_content_element).html()+"</div>")
return this.recursive_restore(n),e(n).find(".az-element > .controls").remove(),e(n).find("> .controls").remove(),e(n).find(".az-sortable-controls").remove(),e(n).find(".az-step-controls").remove(),e(n).find(".az-empty").remove(),e(n).find(".ui-resizable-e").remove(),e(n).find(".ui-resizable-e").remove(),e(n).find(".ui-resizable-s").remove(),e(n).find(".ui-resizable-se").remove(),e(n).find(".editable-highlight").removeClass("editable-highlight"),e(n).find(".styleable-highlight").removeClass("styleable-highlight"),e(n).find(".sortable-highlight").removeClass("sortable-highlight"),e(n).find(".ui-draggable").removeClass("ui-draggable"),e(n).find(".ui-resizable").removeClass("ui-resizable"),e(n).find(".ui-sortable").removeClass("ui-sortable"),e(n).find(".ui-sortable-handle").removeClass("ui-sortable-handle"),e(n).find(".az-element.az-container > .az-ctnr").empty(),e(n).find(".az-element.az-cms-element").empty(),e(n).find(".g-recaptcha").empty(),this.css=e.extend(this.css,t(n,"link[href]","href")),this.js=e.extend(this.js,t(n,"script[src]","src")),e(n).html()},get_container_html:function(){return this.get_css(this)+this.get_hover_styles(this)+this.get_js(this)+this.get_loader()+this.get_html()},click_save_container:function(e){return e.data.object.save_container(),!1},save_container:function(){var e=this
...
for(var i=0;i<n.children.length;i++)n.children[i].recursive_showed()
e(document).trigger("scroll")}s.try_render_unknown_elements(),e(document).trigger("azexo_containers_update")})},clone:function(){Lt.baseclass.prototype.clone.apply(this,arguments),this.rendered=!0},recursive_render:function(){t?(this.render(e,n,a),this.children=[]):Lt.baseclass.prototype.recursive_render.apply(this,arguments),window.azexo_editor&&(this.show_controls(),this.update_sortable())},update_dom:function(){this.loaded_container!=this.attrs.container&&(this.children=[],e(this.dom_content_element).empty(),this.rendered=!1,null!=this.parent&&Lt.baseclass.prototype.update_dom.apply(this,arguments))},showed:function(e){Lt.baseclass.prototype.showed.apply(this,arguments)
var t=this
null==this.parent?t.rendered||(t.rendered=!0,t.load_container()):this.add_js({path:"jquery-waypoints/waypoints.min.js",loaded:"waypoint"in e.fn,callback:function(){e(t.dom_element).waypoint(function(){t.rendered||(t.rendered=!0,t.load_container())},{offset:"100%",triggerOnce:!0}),e(document).trigger("scroll")}})},render:function(e){this.dom_element=e('<div class="az-element az-container"><div class="az-ctnr"></div></div>'),this.dom_content_element=e(this.dom_element).find(".az-ctnr"),Lt.baseclass.prototype.render.apply(this,arguments)}}),kt.prototype.params.push(lt({type:"textfield",heading:p("Menu item title"),param_name:"menu_item_title",description:p("Title which will be used in scroll menu."),tab:p("Menu")})),ut("az_scroll_menu",!1,Et),Y(Et.prototype,{name:p("Scroll Menu"),icon:"fa fa-sitemap",description:p("One page scroll menu"),params:[lt({type:"image",heading:p("Logo"),param_name:"logo",description:p("Select image from media library.")}),lt({type:"link",heading:p("Logo link"),param_name:"logo_link"})].concat(Et.prototype.params),showed:function(e,t,n){this.navbar_height=e(this.dom_element).find("."+t+"navbar").height(),Et.baseclass.prototype.showed.apply(this,arguments)
var a=this
...
i+="</ul>",e(o).append(i),e(this.dom_element).find("."+t+"container-fluid").append(n).append(o),Et.baseclass.prototype.render.apply(this,arguments)}}),zt("az_form",!0,Bt),Y(Bt.prototype,{name:p("Form"),icon:"fa fa-envelope-o",description:p("Form container. Can contain form elements for user input and any number of any other elements types."),category:p("Layout"),params:[lt({type:"textfield",heading:p("Name"),param_name:"name",description:p("Required."),required:!0}),lt({type:"textfield",heading:p("Submit button title"),param_name:"submit_title",value:p("Submit")}),lt({type:"textfield",heading:p("Submited message"),param_name:"submited_message",value:p("Submited")}),lt({type:"textfield",heading:p("Action URL"),param_name:"action",description:p("URL of server script which will receive submitted form data.")})].concat(Bt.prototype.params),is_container:!0,hidden:!window.azexo_online,show_settings_on_create:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><p>'+this.name+'</p><p class="'+n+"text-muted "+n+'small">'+this.description+"</p></div>"},get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p("You can add form element by mouse over this button: ")+'<span class="'+n+"glyphicon "+n+'glyphicon-plus-sign"></span> '+p("You can see all submissions by click on this button: ")+'<span class="'+n+"glyphicon "+n+'glyphicon-list-alt"></span></div></div>'},show_controls:function(){if(window.azexo_editor){Bt.baseclass.prototype.show_controls.apply(this,arguments)
var t=this
...
for(var d in o)if(""!=o[d]){var c=e.parseJSON(o[d]),u={}
for(var m in l)u[m]=m in c?c[m]:""
h.push(u)}var _=e("<table></table>"),f=e("<thead><tr></tr></thead>").appendTo(_)
for(var v in l)e(f).find("tr").append("<th>"+v+"</th>")
for(var g=e("<tbody></tbody>").appendTo(_),y=0;y<h.length;y++){var u=e("<tr></tr>").appendTo(g)
for(var v in l)e("<td>"+h[y][v]+"</td>").appendTo(u)}azexo_add_css("DataTables/media/css/jquery.dataTables.min.css",function(){}),azexo_add_js({path:"DataTables/media/js/jquery.dataTables.min.js",callback:function(){e(_).dataTable()}}),e(r).find("."+n+"modal-body").append(_),e("#az-form-modal")[a+"modal"]("show")})},showed:function(e){Bt.baseclass.prototype.showed.apply(this,arguments)
var t=this
...
return"azexo_form_submit_name"in window&&(o=window.azexo_form_submit_name),O(a,o,t.attrs.name,e(t.dom_element).serialize(),function(e){e&&t.dom_element.prepend(it(t.attrs.submited_message))}),!1}))},render:function(e,t){this.dom_element=e('<form action="'+this.attrs.action+'" method="post" class="az-element az-form '+this.attrs.el_class+'" style="'+this.attrs.style+'" role="form" enctype="multipart/form-data"></form>'),this.dom_content_element=e('<div class="az-ctnr"></div>').appendTo(this.dom_element),e('<div class="'+t+'form-group"><div class="g-recaptcha"></div></div>').appendTo(this.dom_element),e('<div class="'+t+'form-group"><button class="'+t+"btn "+t+"btn-lg "+t+'btn-primary" type="submit">'+this.attrs.submit_title+"</button></div>").appendTo(this.dom_element),Bt.baseclass.prototype.render.apply(this,arguments)}}),B(Yt,xt),Y(Yt.prototype,{form_elements:{},show_parent_controls:".az-form",params:[lt({type:"textfield",heading:p("Name"),param_name:"name",description:p("Required."),required:!0}),lt({type:"checkbox",heading:p("Field is required?"),param_name:"required",value:{yes:p("Yes, please")}}),lt({type:"textfield",heading:p("Title"),param_name:"title"})].concat(Yt.prototype.params)}),Ft(),Ht(),Jt(),$t(),Xt()
var fn="",vn="",gn="",yn="",bn={},wn={},xn={theme:[],host:"",username:"",password:"",port:"21",directory:"."}}(window.jQuery,!1,"","",{},{},{},null,[],{})