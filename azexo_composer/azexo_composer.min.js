...
window.azexo_online=!1,e(h).append(c.get_loader()),window.azexo_online=u}e(h).append(c.get_html()),s=e.extend(s,n[d].js),r=e.extend(r,n[d].css)}var _=""
...
for(var v in s)e(l).append('<script src="'+at(v)+'"></script>')
for(var v in r)e(l).append('<link rel="stylesheet" type="text/css" href="'+at(v)+'">')
...
return"<!DOCTYPE html><html>"+g+f+"</html>"}function r(t){for(var n=0;n<l.length;n++){var a=e(l[n].dom_element).parent()
...
return"azexo_icons"in window&&(t=t.concat(window.azexo_icons)),e.unique(t),st.prototype.param_types.icon.prototype.icons=t,t=t.map(function(e){return e.replace(/^/,".").replace(/ /,".")})}var o={"link[href]":"href","script[src]":"src","img[src]":"src"}
