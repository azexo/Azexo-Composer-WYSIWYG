...
jt(t.base,n),t.baseclass=n.baseclass,t.params=t.params.concat(n.prototype.params),A(n.prototype,t)
for(var a=0;a<n.prototype.params.length;a++){var i=n.prototype.params[a],o=J(i)
...
""!=this.parent.attrs.type&&(n=this.parent.attrs.type),this.dom_element=e('<div class="az-element az-toggle '+t+"panel "+n+" "+this.attrs.el_class+'" style="'+this.attrs.style+'"><div class="'+t+'panel-heading"><h4 class="'+t+'panel-title"><a data-toggle="collapse" data-parent="#'+this.parent.id+'" href="#'+this.id+'">'+this.attrs.title+'</a></h4></div><div id="'+this.id+'" class="'+t+"panel-collapse "+t+'collapse"><div class="'+t+'panel-body az-ctnr"></div></div></div>'),this.dom_content_element=e(this.dom_element).find("."+t+"panel-body"),ft.baseclass.prototype.render.apply(this,arguments)}}),rt("az_carousel",!0,gt),A(gt.prototype,{name:p("Carousel"),icon:"fa fa-ellipsis-h",description:p("Content carousel. Every slide of this element can contain any number of any types of elements. It can be used for create classic content slider."),category:p("Layout"),params:[J({type:"integer_slider",heading:p("Number items"),param_name:"items",min:"1",max:"10",value:"1"}),J({type:"checkbox",heading:p("Options"),param_name:"options",value:{navigation:p("Navigation"),auto_play:p("Auto play"),mouse:p("Mouse drag"),touch:p("Touch drag")}}),J({type:"dropdown",heading:p("Transition style"),param_name:"transition",value:{"":p("Default"),fade:p("fade"),backSlide:p("backSlide"),goDown:p("goDown"),fadeUp:p("fadeUp")}})].concat(gt.prototype.params),is_container:!0,show_settings_on_create:!0,frontend_render:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},show_controls:function(){if(window.azexo_editor){gt.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".add").remove(),e(this.controls).find(".paste").remove()
...
var u=null
"step_controls"in d&&d.step_controls.remove(),d.step_controls=e('<div class="az-step-controls '+n+'btn-group-vertical"></div>').hide(),e('<span class="number '+n+"btn "+n+"btn-primary "+n+'glyphicon"></span>').prependTo(d.step_controls).click(function(){var t=parseInt(e(this).attr("data-step"))-1
...
var f=!1
e(d.dom_element).on("mousedown",function(t){if(t.target==t.currentTarget){f=!0,h.prevX=t.pageX,h.prevY=t.pageY
var n=e(d.dom_content_element).find("> div")
d.transition_duration=e(n).css("transition-duration"),e(n).css("transition-duration","0s"),d.transition_delay=e(n).css("transition-delay"),e(n).css("transition-delay","0s")}}),e(document).off("mouseup.az_presentation"+d.id),e(document).on("mouseup.az_presentation"+d.id,function(){if(f){var t=e(d.dom_content_element).find("> div")
...
if(!_.isUndefined(a))for(var i=0;i<a.children.length;i++)"trigger_start_in_animation"in a.children[i]&&a.children[i].trigger_start_out_animation()},!1),e(n.dom_element).find("> ."+t+"pagination > li > ."+t+"prev").click(function(){return n.impress.prev(),!1}),e(n.dom_element).find("> ."+t+"pagination > li > ."+t+"next").click(function(){return n.impress.next(),!1}),e(n.dom_element).find("> ."+t+"pagination > li > .goto").click(function(){return n.impress.goto(e(this).attr("data-step")),!1}),window.azexo_editor||e(n.dom_content_element).find(".az-step").each(function(){e(this).on("mousewheel",function(t){if(e(this).hasClass("active")){if(this.offsetHeight==this.scrollHeight)return t.originalEvent.wheelDelta<0?(n.impress.next(),!1):(n.impress.prev(),!1)
if(0==this.scrollTop&&t.originalEvent.wheelDelta>0)return n.impress.prev(),!1
if(this.offsetHeight+this.scrollTop>=this.scrollHeight&&t.originalEvent.wheelDelta<0)return n.impress.next(),!1}})}),"auto_play"in n&&clearInterval(n.auto_play),_.indexOf(n.attrs.options.split(","),"auto_play")>=0&&(n.auto_play=setInterval(function(){n.impress.next()},5e3)),_.indexOf(n.attrs.options.split(","),"full_filling")>=0&&(e(n.dom_element).css("height",e(window).height()+"px"),e(n.dom_content_element).find(".az-step").each(function(){e(this).css("height",e(n.dom_element).height()+"px"),e(this).css("width",e(n.dom_element).width()+"px")}))}})},render:function(e,t){if(delete this.impress,this.dom_element=e('<div class="az-element az-presentation '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),e(this.dom_element).css("height",this.attrs.height+"px"),e(this.dom_element).css("overflow","hidden"),this.dom_content_element=e('<div id="'+this.id+'"></div>').appendTo(this.dom_element),e(this.dom_content_element).attr("data-perspective",this.attrs.perspective),e(this.dom_content_element).attr("data-transition-duration",this.attrs.duration),_.indexOf(this.attrs.options.split(","),"navigation")>=0){var n=e('<ul class="'+t+'pagination"></ul>').appendTo(this.dom_element)
...
var k=""
return(h(b)||"an_start"in x||"an_scenes"in x)&&(k='<script type="text/javascript">\n//<![CDATA[\n'+f()+"//]]>\n</script>\n"),y(b)+u(b)+g(b)+k+e(z).html()},click_save_container:function(e){return e.data.object.save_container(),!1},save_container:function(){var e=this
