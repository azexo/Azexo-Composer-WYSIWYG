...
o.id==r&&e(l.dom_element).find("."+n+"navbar")[a+"affix"]({offset:{top:e(l.dom_element).find("."+n+"navbar").offset().top,bottom:0}})})}function wt(){wt.baseclass.apply(this,arguments)}function xt(){xt.baseclass.apply(this,arguments)}function zt(e,t){P(t,xt),t.prototype.base=e,xt.prototype.elements[e]=t,xt.prototype.tags[e]=t,xt.prototype.form_elements[e]=t}function kt(){if("azexo_elements"in window)for(var e=0;e<window.azexo_elements.length;e++){var t=window.azexo_elements[e],n=function(){n.baseclass.apply(this,arguments)}
rt(t.base,t.is_container,n),t.baseclass=n.baseclass,t.params=t.params.concat(n.prototype.params),D(n.prototype,t)
for(var a=0;a<n.prototype.params.length;a++){var i=n.prototype.params[a],o=J(i)
n.prototype.params[a]=o}}}function jt(){if("azexo_form_elements"in window)for(var e=0;e<window.azexo_form_elements.length;e++){var t=window.azexo_form_elements[e],n=function(){n.baseclass.apply(this,arguments)}
zt(t.base,n),t.baseclass=n.baseclass,t.params=t.params.concat(n.prototype.params),D(n.prototype,t)
for(var a=0;a<n.prototype.params.length;a++){var i=n.prototype.params[a],o=J(i)
n.prototype.params[a]=o}}}function Tt(){if("azexo_extend"in window)for(var e in window.azexo_extend){var t=window.azexo_extend[e],n=t.params
t.params={}
var a=K.prototype.elements[e]
D(a.prototype,t)
for(var i=0;i<n.length;i++){var o=J(n[i])
a.prototype.params.push(o)}}}function Ot(){x(function(e){_.isObject(e)&&s.create_template_elements(e)})}function St(){y(function(e){_.isObject(e)&&s.create_cms_elements(e)})}window.azexo_backend=!0
var Ct=(""+arguments.callee).replace(/((\/\/.*$)|(\/\*[\s\S]*?\*\/)|(\s))/gm,"").match(/^function\s*[^\(]*\(\s*([^\)]*)\)/m)[1].split(/,/),It=Ct[0],Et=Ct[1],Pt=Ct[2],Dt=Ct[3],Rt=Ct[4],At=Ct[5],Lt=Ct[6],Ut=Ct[7],Bt=Ct[8],Nt=Ct[9]
...
var Mt={}
Mt.shortcode={next:function(e,t,n){var a,i,o=Mt.shortcode.regexp(e)
return o.lastIndex=n||0,(a=o.exec(t))?"["===a[1]&&"]"===a[7]?Mt.shortcode.next(e,t,o.lastIndex):(i={index:a.index,content:a[0],shortcode:Mt.shortcode.fromMatch(a)},a[1]&&(i.match=i.match.slice(1),i.index++),a[7]&&(i.match=i.match.slice(0,-1)),i):void 0},replace:function(e,t,n){return t.replace(Mt.shortcode.regexp(e),function(e,t,a,i,o,s,r,l){if("["===t&&"]"===l)return e
var d=n(Mt.shortcode.fromMatch(arguments))
return d?t+d+l:e})},string:function(e){return new Mt.shortcode(e).string()},regexp:_.memoize(function(e){return RegExp("\\[(\\[?)("+e+")(?![\\w-])([^\\]\\/]*(?:\\/(?!\\])[^\\]\\/]*)*?)(?:(\\/)\\]|\\](?:([^\\[]*(?:\\[(?!\\/\\2\\])[^\\[]*)*)(\\[\\/\\2\\]))?)(\\]?)","g")}),attrs:_.memoize(function(e){var t,n,a={},i=[]
...
return t=e[4]?"self-closing":e[6]?"closed":"single",new Mt.shortcode({tag:e[2],attrs:e[3],type:t,content:e[5]})}},Mt.shortcode=_.extend(function(e){_.extend(this,_.pick(e||{},"tag","attrs","type","content"))
var t=this.attrs
this.attrs={named:{},numeric:[]},t&&(_.isString(t)?this.attrs=Mt.shortcode.attrs(t):_.isEqual(_.keys(t),["named","numeric"])?this.attrs=t:_.each(e.attrs,function(e,t){this.set(t,e)},this))},Mt.shortcode),_.extend(Mt.shortcode.prototype,{get:function(e){return this.attrs[_.isNumber(e)?"numeric":"named"][e]},set:function(e,t){return this.attrs[_.isNumber(e)?"numeric":"named"][e]=t,this},string:function(){var e="["+this.tag
return _.each(this.attrs.numeric,function(t){e+=/\s/.test(t)?' "'+t+'"':" "+t}),_.each(this.attrs.named,function(t,n){e+=" "+n+'="'+t+'"'}),"single"===this.type?e+"]":"self-closing"===this.type?e+" /]":(e+="]",this.content&&(e+=this.content),e+"[/"+this.tag+"]")}}),Mt.html=_.extend(Mt.html||{},{attrs:function(e){var t,n
return"/"===e[e.length-1]&&(e=e.slice(0,-1)),t=Mt.shortcode.attrs(e),n=t.named,_.each(t.numeric,function(e){/\s/.test(e)||(n[e]="")}),n},string:function(e){var t="<"+e.tag,n=e.content||""
return _.each(e.attrs,function(e,n){t+=" "+n,""!==e&&(_.isBoolean(e)&&(e=e?"true":"false"),t+='="'+e+'"')}),e.single?t+" />":(t+=">",t+=_.isObject(n)?Mt.html.string(n):n,t+"</"+e.tag+">")}})
...
return o.call(i,n),e("#az-editor-modal")[a+"modal"]("hide"),!1}),e("#az-editor-modal")[a+"modal"]("show")},opened:function(){},closed:function(){},render:function(){}},$("container",V),D(V.prototype,{get_value:function(){return e(this.dom_element).find('input[name="'+this.param_name+'_type"]').val()+"/"+e(this.dom_element).find('input[name="'+this.param_name+'_name"]').val()},render:function(t){var a=t.split("/")[0],i=t.split("/")[1]
...
t.length>0&&this.render_form(t)},render:function(t){this.form_value=t,this.dom_element=e('<div class="'+n+'form-group"></div>')},opened:function(){"instance"in this&&this.render_form(this.instance)}}),"azexo_param_types"in window)for(var Yt=0;Yt<window.azexo_param_types.length;Yt++){var Ht=window.azexo_param_types[Yt],Wt=function(){Wt.baseclass.apply(this,arguments)}
$(Ht.type,Wt),Ht.baseclass=Wt.baseclass,D(Wt.prototype,Ht)}if(window.azexo_add_css=function(t,n){var a=window.azexo_baseurl+t
...
for(var i=/\[\[([^\]]*)\]\]/g,o=0,s={};null!=(s=i.exec(n));){var r=J({type:"textfield",param_name:"param"+o,value:s[1]})
a.prototype.params.unshift(r),n=R(n,"[[param"+o+"]]",s.index,s[0].length),o++}a.prototype.template=n
for(var i=/\{\{([^\}]*)\}\}/g;null!=(s=i.exec(n));){var r=J({type:"textarea",param_name:"param"+o,value:s[1]})
a.prototype.params.unshift(r),n=R(n,"{{param"+o+"}}",s.index,s[0].length),o++}a.prototype.template=n
for(var i=/\(\(([^\)]*)\)\)/g;null!=(s=i.exec(n));){var r=J({type:"image",param_name:"param"+o,value:s[1]})
a.prototype.params.unshift(r),n=R(n,"((param"+o+"))",s.index,s[0].length),o++}a.prototype.template=n
for(var i=/\<\<([^\>]*)\>\>/g;null!=(s=i.exec(n));){var r=J({type:"link",param_name:"param"+o,value:s[1]})
...
if(o<K.prototype.max_nested_depth){if(t instanceof yt&&null==t.parent&&"az_row"!=n){var s=new lt(t,!1)
s.update_dom()
...
this.is_container&&(s+=this.has_content?this.get_content()+"[/"+a+"]":t+"[/"+a+"]")}return e[this.base]--,s},parse_shortcode:function(t){var n=_.keys(K.prototype.tags).join("|"),a=Mt.shortcode.regexp(n),i=e.trim(t).match(a)
if(_.isNull(i)){if(0==t.length)return
this.parse_shortcode('[az_row][az_column width="1/1"][az_text]'+t+"[/az_text][/az_column][/az_row]")}_.each(i,function(e){var a=e.match(qt(n)),i=a[5],o=RegExp("^[\\s]*\\[\\[?("+_.keys(K.prototype.tags).join("|")+")(?![\\w-])"),s=Mt.shortcode.attrs(a[3]),r=a[2]
if(!(this.get_nested_depth(r)>K.prototype.max_nested_depth)){if(this instanceof yt&&null==this.parent&&"az_row"!=r)return void this.parse_shortcode('[az_row][az_column width="1/1"]'+t+"[/az_column][/az_row]")
var l=et
...
n.js[e]=!0,window.azexo_add_external_js(e,t)},get_my_container:function(){return this instanceof yt?this:this.parent.get_my_container()},get_all_disallowed_elements:function(){if("parent"in this){var e=_.uniq(this.parent.get_all_disallowed_elements().concat(this.disallowed_elements))
...
t&&e(this.dom_element).append(t[1])}et.baseclass.prototype.render.apply(this,arguments)}}),!("azexo_baseurl"in window))if(e('script[src*="azexo_composer.js"]').length>0){var Ft=e('script[src*="azexo_composer.js"]').attr("src")
window.azexo_baseurl=Ft.slice(0,Ft.indexOf("azexo_composer.js"))}else if(e('script[src*="azexo_composer.min.js"]').length>0){var Ft=e('script[src*="azexo_composer.min.js"]').attr("src")
window.azexo_baseurl=Ft.slice(0,Ft.indexOf("azexo_composer.min.js"))}"azexo_online"in window||(window.azexo_online="http:"==window.location.protocol||"https:"==window.location.protocol),s=new G,"azexo_editor"in window||(window.azexo_editor=!1),nt(),at(function(){ot(),e.holdReady(!1)})
var $t=!1
...
0==e(t.dom_element).parents(".azexo-animations-disabled").length&&(t.out_timeout>0?e(t.dom_element).hasClass("animated")?(t.clear_animation(),t.set_in_timeout()):(clearTimeout(t.out_timeout),t.hidden_after_in||t.set_in_timeout()):t.set_in_timeout())},set_out_timeout:function(){var t=this
...
i.attrs.pos_left=parseInt(e(t).css("left"))/(e(a.dom_element).width()/100)+"%",i.attrs.pos_top=parseInt(e(t).css("top"))/(e(a.dom_element).height()/100)+"%",i.attrs.pos_width=parseInt(e(t).css("width"))/(e(a.dom_element).width()/100)+"%",i.attrs.pos_height=parseInt(e(t).css("height"))/(e(a.dom_element).height()/100)+"%",s.raiseEvent("update_element",n)}if(window.azexo_editor){var a=this
...
for(var o=0;o<n.children.length;o++)n.children[o].recursive_showed()
e(document).trigger("scroll")}})},clone:function(){yt.baseclass.prototype.clone.apply(this,arguments),this.rendered=!0},recursive_render:function(){t?(this.render(e,n,a),this.children=[]):yt.baseclass.prototype.recursive_render.apply(this,arguments),window.azexo_editor&&(this.show_controls(),this.update_sortable())},update_dom:function(){this.loaded_container!=this.attrs.container&&(this.children=[],e(this.dom_content_element).empty(),this.rendered=!1,null!=this.parent&&yt.baseclass.prototype.update_dom.apply(this,arguments))},showed:function(e){yt.baseclass.prototype.showed.apply(this,arguments)
var t=this
this.add_js({path:"jquery-waypoints/waypoints.min.js",loaded:"waypoint"in e.fn,callback:function(){e(t.dom_element).waypoint(function(){t.rendered||(t.rendered=!0,t.load_container())},{offset:"100%",triggerOnce:!0}),e(document).trigger("scroll")}})},render:function(e){this.dom_element=e('<div class="az-element az-container"><div class="az-ctnr"></div></div>'),this.dom_content_element=e(this.dom_element).find(".az-ctnr"),yt.baseclass.prototype.render.apply(this,arguments)}}),lt.prototype.params.push(J({type:"textfield",heading:p("Menu item title"),param_name:"menu_item_title",description:p("Title which will be used in scroll menu."),tab:p("Menu")})),Z("az_scroll_menu",!1,bt),D(bt.prototype,{name:p("Scroll Menu"),icon:"fa fa-sitemap",description:p("One page scroll menu"),params:[J({type:"image",heading:p("Logo"),param_name:"logo",description:p("Select image from media library.")}),J({type:"link",heading:p("Logo link"),param_name:"logo_link"})].concat(bt.prototype.params),showed:function(e,t,n){this.navbar_height=e(this.dom_element).find("."+t+"navbar").height(),bt.baseclass.prototype.showed.apply(this,arguments)
var a=this
...
s+="</ul>",e(o).append(s),e(this.dom_element).find("."+t+"container-fluid").append(a).append(o),bt.baseclass.prototype.render.apply(this,arguments)}}),rt("az_form",!0,wt),D(wt.prototype,{name:p("Form"),icon:"fa fa-envelope-o",description:p("Form container. Can contain form elements for user input and any number of any other elements types."),category:p("Layout"),params:[J({type:"textfield",heading:p("Name"),param_name:"name",description:p("Required."),required:!0}),J({type:"textfield",heading:p("Submit button title"),param_name:"submit_title",value:p("Submit")}),J({type:"textfield",heading:p("Submited message"),param_name:"submited_message",value:p("Submited")})].concat(wt.prototype.params),is_container:!0,show_settings_on_create:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><p>'+this.name+'</p><p class="'+n+"text-muted "+n+'small">'+this.description+"</p></div>"},get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p("You can add form element by mouse over this button: ")+'<span class="'+n+"glyphicon "+n+'glyphicon-plus-sign"></span> '+p("You can see all submissions by click on this button: ")+'<span class="'+n+"glyphicon "+n+'glyphicon-list-alt"></span></div></div>'},show_controls:function(){if(window.azexo_editor){wt.baseclass.prototype.show_controls.apply(this,arguments)
var t=this
...
for(var o in xt.prototype.form_elements){var s=xt.prototype.form_elements[o].prototype
