...
var S=e('<div class="'+n+'form-group"><label>'+p("File name")+'</label><div><input class="'+n+'form-control" name="name" type="text"></div><p class="'+n+'help-block">'+p('"html"-extension will be added during export process')+"</p></div>").appendTo(T).find('input[name="name"]').change(function(){var t=e(j).find("."+n+"active").text(),a=e(this).val()
vn[a]=vn[t],vn[t]=null,gn[a]=gn[t],gn[t]=null,e(j).find("a."+n+'active:contains("'+t+'")').text(a)
for(var o in vn)if(null!=vn[o])for(var i=0;i<vn[o].length;i++)e(vn[o][i].dom_content_element).find('[href="'+t+'.html"]').each(function(){e(this).attr("href",a+".html")})}),C=e('<div class="'+n+'form-group"><label>'+p("Title")+'</label><div><input class="'+n+'form-control" name="title" type="text"></div><p class="'+n+'help-block">'+p("")+"</p></div>").appendTo(T).find('input[name="title"]').change(function(){var t=e(j).find("."+n+"active").text()
