...
ut(g,!1,k),Y(k.prototype,{baseclass:k,template:y,baseurl:w,path:v,name:g,icon:"fa fa-cube",description:p(""),thumbnail:x,params:[lt({type:"html",heading:p("Content"),param_name:"content",value:""})].concat(k.prototype.params),show_settings_on_create:!1,is_container:!0,has_content:!0,section:z,category:p("Template-elements"),is_template_element:!0,editable:[".az-editable"].concat(i),attr_editable:[].concat(r),styleable:[".az-styleable"].concat(d),sortable:[".az-sortable"].concat(c),synchronizable:[".az-synchronizable"].concat(m),restoreable:[".az-restoreable"].concat(h),containable:[".az-containable"].concat(u),restore_nodes:{},contained_elements:{},show_controls:function(){function t(t,n,o,s,r){var l=[],m="",h="",u="",_=e.trim(e(t).text())
if(""!=_&&(_=e(t).html()),n){f=a()
var v=f.join(", ")
if(e(t).is(v)){for(var g=0;g<f.length;g++)if(e(t).is(f[g])){u=f[g].split("."),u.shift(),u=u.join(" ")
break}l.push(lt({type:"icon",heading:p("Icon"),param_name:"icon"}))}"IMG"!=e(t).prop("tagName")?""!=_&&l.push(lt({type:"textarea",heading:p("Content"),param_name:"content"})):(m=e(t).attr("src"),l.push(lt({type:"image",heading:p("Image"),param_name:"image",description:p("Select image from media library.")}))),"A"==e(t).prop("tagName")&&(h=e(t).attr("href"),l.push(lt({type:"link",heading:p("Link"),param_name:"link",description:p("Content link (url).")})))}for(var y in s)l.push(Object.keys(s[y]).length>0?"class"==y?lt({type:"checkbox",heading:y,param_name:"attr_"+y,value:s[y]}):lt({type:"dropdown",heading:y,param_name:"attr_"+y,value:s[y]}):lt({type:"textfield",heading:y,param_name:"attr_"+y}))
if(o){l.push(lt({type:"textfield",heading:p("Content classes"),param_name:"el_class",description:p("If you wish to style particular content element differently, then use this field to add a class name and then refer to it in your css file.")}))
var b=lt({type:"style",heading:p("Content style"),param_name:"style",description:p("Style options."),tab:p("Style")})
n||Object.keys(s).length>0?l.push(b):l.unshift(b)}e(t).removeClass("editable-highlight"),e(t).removeClass("styleable-highlight"),e(t).removeClass(u)
...
for(var z={content:_,link:h,image:m,el_class:w,style:x,icon:u},g=0;g<s.length;g++);for(var y in s)if(Object.keys(s[y]).length>0)if("class"==y){var k=[],w=e(t).attr(y).split(" ")
for(var j in s[y])w.indexOf(j)>=0&&k.push(j)
z["attr_"+y]=k.join(",")}else z["attr_"+y]=e(t).attr(y)
else z["attr_"+y]=e(t).attr(y)
st.prototype.show_editor(l,{name:p("Content"),attrs:z},function(a){n&&(""!=u&&(e(t).removeClass(u),a.el_class=a.el_class+" "+a.icon),"A"==e(t).prop("tagName")&&e(t).attr("href",a.link),"IMG"==e(t).prop("tagName")?e(t).attr("src",a.image):""!=_&&""!=a.content&&e(t).html(a.content)),o&&(e(t).attr("class",a.el_class),e(t).attr("style",a.style))
for(var l in s)if(Object.keys(s[l]).length>0)if("class"==l){var p=a["attr_"+l].split(",")
for(var m in s[l])p.indexOf(m)>=0?e(t).addClass(m):e(t).removeClass(m)}else e(t).attr(l,a["attr_"+l])
else e(t).attr(l,a["attr_"+l])
c.attrs.content=e(c.dom_content_element).html(),c.restore_content(),i(),d(),r()})}function o(t){var n=e(t).clone()
e(n).find("*").each(function(){for(var e=this;e.attributes.length>0;)e.removeAttribute(e.attributes[0].name)})
var a=e(n).html()
return a=a.replace(/\s*/g,"")}function i(){r()
for(var t=0;t<c.synchronizable.length;t++)e(c.dom_content_element).find(c.synchronizable[t]).each(function(){if(0==e(this).closest("[data-az-restore]").length){e(this).find(".editable-highlight").removeClass("editable-highlight"),e(this).find(".styleable-highlight").removeClass("styleable-highlight"),e(this).find(".sortable-highlight").removeClass("sortable-highlight"),e(this).find('[class=""]').removeAttr("class"),e(this).find('[style=""]').removeAttr("style")
var t=e(this).data("synchronized")
if(t)for(var n=0;n<t.length;n++)e(t[n]).html(e(this).html())
e(this).data("current-state")?e(document).trigger("azexo_synchronize",{from_node:this,old_state:e(this).data("current-state"),new_state:e(this).html()}):e(document).trigger("azexo_synchronize",{from_node:this,old_state:o(this),new_state:e(this).html()}),e(this).data("current-state",o(this)),c.attrs.content=e(c.dom_content_element).html(),c.restore_content()}})
d()}function r(){for(var t=0;t<c.sortable.length;t++)e(c.dom_content_element).find(c.sortable[t]).each(function(){e(this).hasClass("ui-sortable")&&e(this).data("sortable")&&(e(this).data("sortable",!1),e(this).sortable("destroy"),e(this).find(".ui-sortable-handle").removeClass("ui-sortable-handle"))})}function l(){for(var t=0;t<c.sortable.length;t++)e(c.dom_element).find(c.sortable[t]).each(function(){0==e(this).closest("[data-az-restore]").length&&(e(this).data("sortable",!0),e(this).sortable({items:"> *",placeholder:"az-sortable-placeholder",forcePlaceholderSize:!0,start:function(t,n){e(n.item).removeClass("sortable-highlight").find(".az-sortable-controls").remove()},update:function(){c.attrs.content=e(c.dom_content_element).html(),c.restore_content(),i()},over:function(e,t){t.placeholder.attr("class",t.helper.attr("class")),t.placeholder.removeClass("ui-sortable-helper"),t.placeholder.addClass("az-sortable-placeholder")}}))})}function d(){function t(e){for(var t={},n=e.split(","),a=0;a<n.length;a++){var o=n[a].split(":")[0]
if(o in t||(t[o]={}),2==n[a].split(":").length)for(var i=n[a].split(":")[1].split("/"),s=0;s<i.length;s++)t[o][i[s].split("=")[0]]=i[s].split("=")[1]}return t}function a(t){if(e(t).hasClass("sortable-highlight")){e(t).find(".az-sortable-controls").remove()
var a=e('<div class="az-sortable-controls"></div>').appendTo(t),o=e('<div class="az-sortable-clone '+n+"glyphicon "+n+'glyphicon-repeat" title="'+p("Clone")+'"></div>').appendTo(a).click(function(){return r(),e(t).removeClass("sortable-highlight").find(".az-sortable-controls").remove(),e(t).clone().insertAfter(t),g=[],y=null,c.attrs.content=e(c.dom_content_element).html(),c.restore_content(),i(),d(),!1})
e(o).css("line-height",e(o).height()+"px").css("font-size",e(o).height()/2+"px")
var s=e('<div class="az-sortable-remove '+n+"glyphicon "+n+'glyphicon-remove" title="'+p("Remove")+'"></div>').appendTo(a).click(function(){return r(),e(t).removeClass("sortable-highlight").find(".az-sortable-controls").remove(),e(t).remove(),g=[],y=null,c.attrs.content=e(c.dom_content_element).html(),c.restore_content(),i(),d(),!1})
e(s).css("line-height",e(s).height()+"px").css("font-size",e(s).height()/2+"px")}}for(var o=0;o<c.restoreable.length;o++)e(c.dom_element).find(c.restoreable[o]).off("mouseenter.az-restoreable").on("mouseenter.az-restoreable",function(){e(this).addClass("restoreable-highlight")}),e(c.dom_element).find(c.restoreable[o]).off("mouseleave.az-restoreable").on("mouseleave.az-restoreable",function(){e(this).removeClass("restoreable-highlight")}),e(c.dom_element).find(c.restoreable[o]).off("click.az-restoreable").on("click.az-restoreable",function(){if(e(this).is("[data-az-restore]")){var t=[]
t.push(lt({type:"html",heading:p("HTML"),param_name:"html"}))
var n=e(this).attr("data-az-restore"),a=c.restore_nodes[n]
return st.prototype.show_editor(t,{name:p("Content"),attrs:{html:a}},function(e){c.restore_nodes[n]=e.html,c.restore_content(),c.update_dom(),i()}),!1}})
for(var o=0;o<c.styleable.length;o++)e(c.dom_element).find(c.styleable[o]).off("mouseenter.az-styleable").on("mouseenter.az-styleable",function(){0==e(this).closest("[data-az-restore]").length&&e(this).addClass("styleable-highlight")}),e(c.dom_element).find(c.styleable[o]).off("mouseleave.az-styleable").on("mouseleave.az-styleable",function(){0==e(this).closest("[data-az-restore]").length&&e(this).removeClass("styleable-highlight")}),e(c.dom_element).find(c.styleable[o]).off("click.az-styleable").on("click.az-styleable",function(){if(0==e(this).closest("[data-az-restore]").length){if(0==e(this).parent().closest(".styleable-highlight, .editable-highlight").length)return s.edit_stack.push({node:this,edit:!1,style:!0,attrs:{}}),h(),!1
s.edit_stack.push({node:this,edit:!1,style:!0,attrs:{}}),setTimeout(function(){null==m&&s.edit_stack.length>0&&h()},0)}})
for(var o=0;o<c.editable.length;o++)e(c.dom_element).find(c.editable[o]).off("mouseenter.az-editable").on("mouseenter.az-editable",function(){0==e(this).closest("[data-az-restore]").length&&e(this).addClass("editable-highlight")}),e(c.dom_element).find(c.editable[o]).off("mouseleave.az-editable").on("mouseleave.az-editable",function(){0==e(this).closest("[data-az-restore]").length&&e(this).removeClass("editable-highlight")}),e(c.dom_element).find(c.editable[o]).off("click.az-editable").on("click.az-editable",function(){if(0==e(this).closest("[data-az-restore]").length){if(0==e(this).parent().closest(".styleable-highlight, .editable-highlight").length)return s.edit_stack.push({node:this,edit:!0,style:!0,attrs:{}}),h(),!1
s.edit_stack.push({node:this,edit:!0,style:!0,attrs:{}}),setTimeout(function(){null==m&&s.edit_stack.length>0&&h()},0)}})
for(var u={},o=0;o<c.attr_editable.length;o++){var _=c.attr_editable[o].split("|")[0],f=c.attr_editable[o].split("|")[1]
u[_]=e.extend({},u[_],t(f))}e(c.dom_element).find("[data-az-editable]").length>0&&(u["[data-az-editable]"]={})
for(var _ in u){var v=u[_]
e(c.dom_element).find(_).off("mouseenter.az-editable").on("mouseenter.az-editable",function(){0==e(this).closest("[data-az-restore]").length&&e(this).addClass("editable-highlight")}),e(c.dom_element).find(_).off("mouseleave.az-editable").on("mouseleave.az-editable",function(){0==e(this).closest("[data-az-restore]").length&&e(this).removeClass("editable-highlight")}),e(c.dom_element).find(_).each(function(){var n=v
"[data-az-editable]"==_&&(n=t(e(this).attr("data-az-editable"))),e(this).data("attr-editable")?e(this).data("attr-editable",e.extend({},e(this).data("attr-editable"),n)):e(this).data("attr-editable",v)}),e(c.dom_element).find(_).each(function(){function t(){if(0==e(n).closest("[data-az-restore]").length){if(0==e(n).parent().closest(".styleable-highlight, .editable-highlight").length)return s.edit_stack.push({node:n,edit:!1,style:!0,attrs:e(n).data("attr-editable")}),h(),!1
s.edit_stack.push({node:n,edit:!1,style:!0,attrs:e(n).data("attr-editable")}),setTimeout(function(){null==m&&s.edit_stack.length>0&&h()},0)}}var n=this
"IFRAME"==n.tagName?e(window).off("blur.az-attr-editable").on("blur.az-attr-editable",function(){e(n).hasClass("editable-highlight")&&t(null)}):e(n).off("click.az-attr-editable").on("click.az-attr-editable",t)})}var g=[],y=null,b=null
e(c.dom_element).off("mousemove.az-able").on("mousemove.az-able",function(){null!=y&&e(y).hasClass("sortable-highlight")&&(clearTimeout(b),b=setTimeout(function(){a(y)},1e3))})
for(var o=0;o<c.sortable.length;o++)!function(t){e(c.dom_element).find(c.sortable[t]).find("> *").off("mouseenter.az-sortable").on("mouseenter.az-sortable",function(){if(0==e(this).closest("[data-az-restore]").length){var t=this,n=g[g.length-1];(e(n).has(t).length||0==g.length)&&(e(c.dom_element).find(".az-sortable-controls").remove(),e(c.dom_element).find(".sortable-highlight").removeClass("sortable-highlight"),null!==y&&clearTimeout(b),e(t).addClass("sortable-highlight"),g.push(t),e.unique(g),y=t,b=setTimeout(function(){a(t)},1e3))}}),e(c.dom_element).find(c.sortable[t]).find("> *").off("mouseleave.az-sortable").on("mouseleave.az-sortable",function(){if(0==e(this).closest("[data-az-restore]").length){var t=this
e(c.dom_element).find(".az-sortable-controls").remove(),e(c.dom_element).find(".sortable-highlight").removeClass("sortable-highlight"),null!==y&&clearTimeout(b),g.pop(),g.length>0?(t=g[g.length-1],e(t).addClass("sortable-highlight"),y=t,b=setTimeout(function(){a(t)},1e3)):y=null}})}(o)
l()}if(window.azexo_editor){var c=this
ht.prototype.show_controls.apply(this,arguments)
var m=null,h=function(){if(s.edit_stack.length>0){var n=s.edit_stack.shift()
...
m=setTimeout(function(){clearInterval(a),m=null,e(n.node).css("outline-color",""),e(n.node).css("outline-width",""),e(n.node).css("outline-style",""),t(n.node,n.edit,n.style,n.attrs,function(){if(s.edit_stack.length>0){var t=e(n.node).width()*e(n.node).height(),a=e(s.edit_stack[0].node).width()*e(s.edit_stack[0].node).height()
2>a/t?h():s.edit_stack=[]}})},500)}}
e(document).on("azexo_synchronize",function(t,n){r()
for(var a=0;a<c.synchronizable.length;a++)e(c.dom_content_element).find(c.synchronizable[a]).each(function(){if(0==e(this).closest("[data-az-restore]").length&&(e(this).find(".editable-highlight").removeClass("editable-highlight"),e(this).find(".styleable-highlight").removeClass("styleable-highlight"),e(this).find(".sortable-highlight").removeClass("sortable-highlight"),e(this).find('[class=""]').removeAttr("class"),e(this).find('[style=""]').removeAttr("style"),this!=n.from_node&&o(this)==n.old_state)){var t=e(n.from_node).data("synchronized")
t||(t=[]),t.push(this),t=e.unique(t),e(n.from_node).data("synchronized",t),t=e(this).data("synchronized"),t||(t=[]),t.push(n.from_node),t=e.unique(t),e(this).data("synchronized",t),e(this).html(n.new_state),c.attrs.content=e(c.dom_content_element).html(),c.restore_content()}})
d()}),d(),i()}},restore_content:function(){var t=e("<div>"+this.attrs.content+"</div>")
