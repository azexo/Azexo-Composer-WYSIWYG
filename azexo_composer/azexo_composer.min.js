...
e(S).val(t),e(C).val(gn[t].title)}function r(t){var o=new Ut(null,!1)
...
for(var t in vn){var n=i(vn[t],!0,gn[t].title)
...
break}}c(d,i.pages[d].title)}s(i.current_page),e(j).find("a").removeClass(n+"active"),e(j).find('a:contains("'+i.current_page+'")').addClass(n+"active")})}function u(e,t){for(var n=[],a={},o=0;o<e.length;o++)n.push(it(e[o])),a[e[o].param_name]=e[o].value
at.prototype.show_editor(n,{name:"Theme",attrs:a},function(n){for(var a=0;a<e.length;a++)e[a].value=n[e[a].param_name]
t(e)})}function f(e,t){var n=[]
n.push(it({type:"javascript",heading:p("Configuration"),param_name:"configuration",value:e})),at.prototype.show_editor(n,{name:"Theme configuration",attrs:{configuration:e}},function(e){t(e.configuration)})}if(0==e("#az-exporter").length){window.links_select=function(e){var t={}
for(var n in gn)t[n+".html"]=gn[n].title
Q(t,e)}
...
vn[a]=vn[t],vn[t]=null,gn[a]=gn[t],gn[t]=null,e(j).find("a."+n+'active:contains("'+t+'")').text(a)}),C=e('<div class="'+n+'form-group"><label>'+p("Title")+'</label><div><input class="'+n+'form-control" name="title" type="text"></div><p class="'+n+'help-block">'+p("")+"</p></div>").appendTo(T).find("input").change(function(){var t=e(j).find("."+n+"active").text()
gn[t].title=e(this).val()})
vn.index=l,c("index","Home"),e(S).val("index"),e(C).val("Home")
...
t.settings=yn,t.current_page=e(S).val(),t.pages={}
...
e(n.dom_content_element).empty(),n.attach_children(),window.azexo_editor&&n.update_sortable(),n.recursive_showed()}}},create_template_elements:function(t){function a(t){function n(e){return 0==e.indexOf("azexo_elements")?window.azexo_baseurl+"../"+e:0!=e.indexOf("/")&&0!=e.indexOf("http://")&&0!=e.indexOf("https://")?window.azexo_baseurl+"../azexo_elements/"+a+"/"+e:e}var a=h.split("|")
a.pop(),a=a.join("/"),e(t).find("link[href]").each(function(){e(this).attr("href",n(e(this).attr("href")))}),e(t).find("script[src]").each(function(){e(this).attr("src",n(e(this).attr("src")))}),e(t).find("img[src]").each(function(){e(this).attr("src",n(e(this).attr("src")))}),e(t).find('[style*="background-image"]').each(function(){var t=e(this).attr("style").replace(/background-image[: ]*url\(([^\)]+)\) *;/,function(e,t){return e.replace(t,encodeURI(n(decodeURI(t))))})
...
var c=at.prototype.param_types.icon.prototype.icons.map(function(e){return e.replace(/^/,".").replace(/ /,".")}),m=c.join(", ")
...
Y(v.prototype,{name:_,icon:"fa fa-cube",description:p(""),thumbnail:f,params:[it({type:"html",heading:p("Content"),param_name:"content",value:u})].concat(v.prototype.params),show_settings_on_create:!1,is_container:!0,has_content:!0,section:y,category:"Template-elements",is_template_element:!0,editable:[".az-editable"].concat(o),styleable:[".az-styleable"].concat(i),sortable:[".az-sortable"].concat(r),synchronizable:[".az-synchronizable"].concat(d),show_controls:function(){function t(t,n,o,i){var s=[],d="",h="",_="",u=e.trim(e(t).text())
if(""!=u&&(u=e(t).html()),n){if(e(t).is(m)){for(var f=0;f<c.length;f++)if(e(t).is(c[f])){_=c[f].split("."),_.shift(),_=_.join(" ")
break}s.push(it({type:"icon",heading:p("Icon"),param_name:"icon"}))}"IMG"!=e(t).prop("tagName")?""!=u&&s.push(it({type:"textarea",heading:p("Content"),param_name:"content"})):(d=e(t).attr("src"),s.push(it({type:"image",heading:p("Image"),param_name:"image",description:p("Select image from media library.")}))),"A"==e(t).prop("tagName")&&(h=e(t).attr("href"),s.push(it({type:"link",heading:p("Link"),param_name:"link",description:p("Conent link (url).")})))}if(o){s.push(it({type:"textfield",heading:p("Content classes"),param_name:"el_class",description:p("If you wish to style particular content element differently, then use this field to add a class name and then refer to it in your css file.")}))
...
o.update_dom(),e(document).trigger("azexo_update_sorting",a)}},click_add_tab:function(e){return e.data.object.add_tab(),!1},add_tab:function(){var t=new Ct(this,!1)
t.update_dom(),this.update_dom(),e(this.dom_element).find('a[href="#'+t.id+'"]')[a+"tab"]("show")},showed:function(e,t,n){St.baseclass.prototype.showed.apply(this,arguments),e(this.dom_element).find("ul."+t+"nav-tabs li:first a")[n+"tab"]("show")},render:function(e,t){this.dom_element=e('<div class="az-element az-tabs '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>')
