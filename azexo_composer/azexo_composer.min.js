...
for(t=0;t<o.length;t++)if(n=o[t].substr(0,o[t].indexOf("=")),a=o[t].substr(o[t].indexOf("=")+1),n=n.replace(/^\s+|\s+$/g,""),n==e)return decodeURIComponent(a)}function V(t,n){var a="<select>"
...
return e(i).chosen({search_contains:!0,allow_single_deselect:!0}),e(i).change(function(){e(this).find("option:selected").each(function(){e(n).val(e(this).val())})}),e(i).parent().find(".chosen-container").width("100%"),e('<div><a class="direct-input" href="#">'+p("Direct input")+"</a></div>").insertBefore(i).click(function(){e(n).css("display","block"),e(i).parent().find(".chosen-container").remove(),e(i).remove(),e(this).remove()}),i}function G(t,n,a){var o='<select multiple="multiple">',i=""
...
n instanceof Rt&&e(n.dom_element).addClass("azexo-editor"),null==n.controls&&n.show_controls(),n.update_sortable()}e("#az-exporter").show()}else{for(var t in s.elements_instances){var n=s.elements_instances[t]
n instanceof Rt&&e(n.dom_element).removeClass("azexo-editor"),null!=n.controls&&e(n.controls).remove(),n.update_empty()}e("#az-exporter").hide()}}function mt(){"ajaxurl"in window||(!window.azexo_editor||window.azexo_online)&&delete window.azexo_editor,h(function(t){window.azexo_editor=t,e(function(){pt()}),!t&&"azexo_exporter"in window&&ut()})}function ht(t){e.holdReady(!0),"complete"===document.readyState?setTimeout(t):document.addEventListener?(document.addEventListener("DOMContentLoaded",t,!1),window.addEventListener("load",t,!1)):(document.attachEvent("onreadystatechange",t),window.attachEvent("onload",t))}function _t(o){if(e(o).length>0){var i=e(o).html(),s=/^\s*\<[\s\S]*\>\s*$/.exec(i)
...
e(o).replaceWith(r.dom_element),e(r.dom_element).attr("data-az-type",p),e(r.dom_element).attr("data-az-name",m),r.showed(e,n,a),window.azexo_editor&&r.show_controls()}return window.azexo_editor&&e(r.dom_element).addClass("azexo-editor"),r}return null}function ut(){e("#az-admin-modal").remove()
var t='<div class="'+n+'modal-header"><button type="button" class="'+n+'close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="'+n+'modal-title">'+p("Azexo Composer")+"</h4></div>",o='<div class="'+n+'modal-footer"><button type="button" class="'+n+"btn "+n+'btn-default" data-dismiss="modal">'+p("Close")+'</button><button type="button" class="save '+n+"btn "+n+'btn-primary">'+p("Save changes")+"</button></div>",i=e('<div id="az-admin-modal" class="'+n+'modal azexo"><div class="'+n+"modal-dialog "+n+'modal-lg"><div class="'+n+'modal-content">'+t+'<div class="'+n+'modal-body"></div>'+o+"</div></div></div>").prependTo("body"),s=null
P(function(t){t.length>0&&"0"!=t&&"false"!=t&&(s=e(t).on("keydown.azexo",function(t){13==t.keyCode&&e("#az-admin-modal").find(".save").click()}),e(i).find("."+n+"modal-body").append(s),window.azexo_editor&&e('<button type="button" class="'+n+"btn "+n+'btn-default" data-dismiss="modal">'+p("Logout")+"</button>").appendTo("#az-admin-modal .modal-footer").click(function(){X("azexo_password","",null),window.location.reload()}),e("#az-admin-modal").find(".save").click(function(){return A(s.serialize(),function(t){t&&window.location.reload(),e("#az-admin-modal")[a+"modal"]("hide")}),!1}),e("#az-admin-modal")[a+"modal"]("show"))})}function ft(){dn||(dn=!0,e(".az-container").each(function(){var e=_t(this)
e&&l.push(e)}),window.azexo_editor&&0==e("#azexo-clipboard").length&&e("body").prepend('<div id="azexo-clipboard" class="azexo-backend" style="display:none"></div>'),e("body").on("keydown.azexo",function(e){e.ctrlKey&&e.altKey&&ut()}))}function vt(){vt.baseclass.apply(this,arguments)}function gt(e,t,n){if(B(n,vt),n.prototype.base=e,n.prototype.is_container=t,vt.prototype.elements[e]=n,vt.prototype.tags[e]=n,t)for(var a=1;a<vt.prototype.max_nested_depth;a++)vt.prototype.tags[e+"_"+a]=n}function yt(){yt.baseclass.apply(this,arguments)}function bt(e,t){bt.baseclass.apply(this,arguments),this.columns="",t&&"boolean"==typeof t||this.set_columns("1/1"),this.attrs.device="sm"}function wt(e,t){wt.baseclass.call(this,e,t)}function xt(e,t){xt.baseclass.apply(this,arguments),this.linked_elements_index={},t&&"boolean"==typeof t||this.add_item(),this.attach_events()}function zt(){zt.baseclass.apply(this,arguments)}function kt(){kt.baseclass.apply(this,arguments)}function jt(e,t){jt.baseclass.apply(this,arguments),t&&"boolean"==typeof t||this.add_tab()}function Tt(){Tt.baseclass.apply(this,arguments)}function St(e,t){St.baseclass.apply(this,arguments),t&&"boolean"==typeof t||this.add_toggle()}function Ct(){Ct.baseclass.apply(this,arguments)}function Ot(e,t){Ot.baseclass.apply(this,arguments),t&&"boolean"==typeof t||this.add_slide()}function It(){It.baseclass.apply(this,arguments)}function Pt(e,t){Pt.baseclass.apply(this,arguments),t&&"boolean"==typeof t||this.add_step(),window.azexo_editor&&this.init_scroll_variables()}function At(){At.baseclass.apply(this,arguments)}function Rt(){Rt.baseclass.apply(this,arguments),this.rendered=!1,this.loaded_container=null,this.js={},this.css={}}function Dt(){Dt.baseclass.apply(this,arguments),this.menu_items={}
for(var t in s.elements_instances){var o=s.elements_instances[t]
o instanceof yt&&""!=o.attrs.menu_item_title&&(this.menu_items[t]=o.attrs.menu_item_title)}var i=this,r=function(t,o){e("body")[a+"scrollspy"]({target:"#"+i.id+".navbar-collapse",offset:i.navbar_height})
var r=s.get_element(o)
r instanceof yt&&(""!=r.attrs.menu_item_title?(i.menu_items[o]=r.attrs.menu_item_title,i.replace_render(),i.showed(e,n,a)):o in i.menu_items&&(delete i.menu_items[o],i.replace_render(),i.showed(e,n,a)))}
...
var r=s.get_element(o)
r instanceof yt&&(delete i.menu_items[o],i.replace_render(),i.showed(e,n,a))}),e(document).on("azexo_update_sorting",function(t,o){e("body")[a+"scrollspy"]({target:"#"+i.id+".navbar-collapse",offset:i.navbar_height})
var r=e(o.item).closest("[data-az-id]").attr("data-az-id"),l=s.get_element(r)
i.id==r&&e(l.dom_element).find("."+n+"navbar")[a+"affix"]({offset:{top:e(l.dom_element).find("."+n+"navbar").offset().top,bottom:0}})})}function Ut(){Ut.baseclass.apply(this,arguments)}function Nt(){Nt.baseclass.apply(this,arguments)}function Lt(e,t){B(t,Nt),t.prototype.base=e,Nt.prototype.elements[e]=t,Nt.prototype.tags[e]=t,Nt.prototype.form_elements[e]=t}function Et(){if("azexo_elements"in window)for(var e=0;e<window.azexo_elements.length;e++){var t=window.azexo_elements[e],n=function(){n.baseclass.apply(this,arguments)}
gt(t.base,t.is_container,n),t.baseclass=n.baseclass,t.params=t.params.concat(n.prototype.params),Y(n.prototype,t)
for(var a=0;a<n.prototype.params.length;a++){var o=n.prototype.params[a],i=at(o)
n.prototype.params[a]=i}}}function Mt(){if("azexo_form_elements"in window)for(var e=0;e<window.azexo_form_elements.length;e++){var t=window.azexo_form_elements[e],n=function(){n.baseclass.apply(this,arguments)}
Lt(t.base,n),t.baseclass=n.baseclass,t.params=t.params.concat(n.prototype.params),Y(n.prototype,t)
for(var a=0;a<n.prototype.params.length;a++){var o=n.prototype.params[a],i=at(o)
n.prototype.params[a]=i}}}function Bt(){if("azexo_extend"in window)for(var e in window.azexo_extend){var t=window.azexo_extend[e],n=[]
"params"in t&&(n=t.params),delete t.params
var a=lt.prototype.elements[e]
if(!("extended"in a)){a.extended=!0,Y(a.prototype,t)
for(var o=0;o<n.length;o++){var i=at(n[o])
a.prototype.params.push(i)}}}}function Yt(){(!window.azexo_editor||window.azexo_online)&&z(function(e){_.isObject(e)&&s.create_template_elements(e)})}function qt(){b(function(e){_.isObject(e)?s.create_cms_elements(e):s.cms_elements_loaded=!0})}function Ht(){function t(t){e(t).find("link[href]").each(function(){e(this).attr("href",Z(e(this).attr("href")))}),e(t).find("script[src]").each(function(){e(this).attr("src",Z(e(this).attr("src")))}),e(t).find("img[src]").each(function(){e(this).attr("src",Z(e(this).attr("src")))}),e(t).find('[style*="background-image"]').each(function(){var t=e(this).attr("style").replace(/background-image[: ]*url\(([^\)]+)\) *;/,function(e,t){return e.replace(t,encodeURI(Z(decodeURI(t))))})
e(this).attr("style",t)})}function o(e){for(var t="<style>",n=0;n<e.length;n++){var a=e[n].value
"integer_slider"==e[n].type&&(a+="px"),"image"==e[n].type&&(a='url("'+a+'")'),"selector"in e[n]&&"property"in e[n]&&(t+=e[n].selector+"{"+e[n].property+": "+a+";}")}return t+="</style>"}function i(n,a,i){for(var s={},r={},l=e("<div>"+mn+"</div>"),d=0;d<n.length;d++){var c=n[d],p=c.attrs.container.split("/")[0],m=c.attrs.container.split("/")[1],h=e(l).find('.az-container[data-az-type="'+p+'"][data-az-name="'+m+'"]')
...
e(l).append("<script type='text/javascript'> window.ajaxurl = '"+Z(window.ajaxurl)+"'; </script>"),e(l).append('<script type="text/javascript"> window.azexo_site_name = "'+_n+'"; </script>'),e(l).append(o(vn.theme))
...
e(S).val(t),e(C).val(fn[t].title)}function r(t){var o=new Rt(null,!1)
...
_n=t,un={},fn=i.pages,vn=i.settings,e(q).empty(),e(q).append(o(vn.theme)),e(j).empty()
for(var d in i.pages){un[d]=Array(l.length)
...
break}}c(d,i.pages[d].title)}s(i.current_page),e(j).find("a").removeClass(n+"active"),e(j).find('a:contains("'+i.current_page+'")').addClass(n+"active")})}function u(e,t){for(var n=[],a={},o=0;o<e.length;o++)n.push(at(e[o])),a[e[o].param_name]=e[o].value
...
un[a]=un[t],un[t]=null,fn[a]=fn[t],fn[t]=null,e(j).find("a."+n+'active:contains("'+t+'")').text(a)}),C=e('<div class="'+n+'form-group"><label>'+p("Title")+'</label><div><input class="'+n+'form-control" name="title" type="text"></div><p class="'+n+'help-block">'+p("")+"</p></div>").appendTo(T).find("input").change(function(){var t=e(j).find("."+n+"active").text()
fn[t].title=e(this).val()})
un.index=l,c("index","Home"),e(S).val("index"),e(C).val("Home")
var O=e('<div class="panel panel-default"><div class="panel-heading" role="tab" id="sites-heading"><h4 class="panel-title"><a data-toggle="collapse" href="#sites-collapse" aria-expanded="false" aria-controls="collapseOne" class="collapsed">'+p("Choose a site for edit")+'</a></h4></div><div id="sites-collapse" class="panel-collapse collapse" role="tabpanel" aria-labelledby="sites-heading" aria-expanded="false"><div class="panel-body"></div></div></div>').prependTo(y).find(".panel-body")
e("<hr>").appendTo(O)
...
for(var a=0;a<un[n].length;a++){var o=un[n][a].attrs.container
fn[n].containers[o]=btoa(v(encodeURIComponent(un[n][a].get_children_shortcode())))}}azexo_add_js({path:"js/json2.min.js",loaded:"JSON"in window,callback:function(){N(e(Y).find("option:selected").val(),JSON.stringify(t))}})}),B=!1
...
var t='<div class="'+n+'modal-header"><button type="button" class="'+n+'close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="'+n+'modal-title">'+p("FTP upload")+"</h4></div>",o='<div class="'+n+'modal-footer"><button type="button" class="'+n+"btn "+n+'btn-default" data-dismiss="modal">'+p("Close")+"</button></div>",i=e('<div id="az-ftp-modal" class="'+n+'modal azexo"><div class="'+n+"modal-dialog "+n+'modal-sm"><div class="'+n+'modal-content">'+t+'<div class="'+n+'modal-body"></div>'+o+"</div></div></div>").prependTo("body"),s=e(i).find("."+n+"modal-body"),r=e('<div class="'+n+'form-group"><label>'+p("Host")+'</label><div><input class="'+n+'form-control" name="host" type="text" value="'+vn.host+'"></div><p class="'+n+'help-block"></p></div>').appendTo(s).find("input"),l=e('<div class="'+n+'form-group"><label>'+p("Username")+'</label><div><input class="'+n+'form-control" name="username" type="text" value="'+vn.username+'"></div><p class="'+n+'help-block"></p></div>').appendTo(s).find("input"),c=e('<div class="'+n+'form-group"><label>'+p("Password")+'</label><div><input class="'+n+'form-control" name="password" type="password" value="'+vn.password+'"></div><p class="'+n+'help-block"></p></div>').appendTo(s).find("input"),m=e('<div class="'+n+'form-group"><label>'+p("Port")+'</label><div><input class="'+n+'form-control" name="port" type="text" value="'+vn.port+'"></div><p class="'+n+'help-block"></p></div>').appendTo(s).find("input"),h=e('<div class="'+n+'form-group"><label>'+p("Directory")+'</label><div><input class="'+n+'form-control" name="directory" type="text" value="'+vn.directory+'"></div><p class="'+n+'help-block"></p></div>').appendTo(s).find("input"),u=e('<button class="'+n+"btn "+n+'btn-primary">'+p("Choose upload directory")+"</button>").appendTo(s).click(function(){function t(n,a){if(e(f).empty().show(),e(y).empty().hide(),e(h).val(n),vn.directory=n,"."!=n){var o=n.split("/")
o.pop()
var i=o.join("/")
e('<li class="az-directory">'+p("< Up one level")+"</li>").appendTo(f).click(function(){E(vn.host,vn.username,vn.password,vn.port,i,function(e){t(i,e)})})
...
B=!1}else t.uploaded.length>0&&e(y).append('<div class="'+n+"alert "+n+'alert-info">'+t.uploaded[0]+" uploaded</div>"),t.count>0?(0==a&&(a=t.count),e(g).show().find(".progress-bar").css("width",(a-t.count)/a*100+"%"),B=!0,M(JSON.stringify({}),t.site_path,JSON.stringify(t.files),vn.host,vn.username,vn.password,vn.port,vn.directory,o)):(e(g).show().find(".progress-bar").css("width","100%"),e(y).append('<div class="'+n+"alert "+n+'alert-success">'+p("Done")+"</div>"),B=!1)}
B=!0,M(JSON.stringify(t),"",JSON.stringify([]),vn.host,vn.username,vn.password,vn.port,vn.directory,o)}})})
...
var tn={}
tn.shortcode={next:function(e,t,n){var a,o,i=tn.shortcode.regexp(e)
return i.lastIndex=n||0,(a=i.exec(t))?"["===a[1]&&"]"===a[7]?tn.shortcode.next(e,t,i.lastIndex):(o={index:a.index,content:a[0],shortcode:tn.shortcode.fromMatch(a)},a[1]&&(o.match=o.match.slice(1),o.index++),a[7]&&(o.match=o.match.slice(0,-1)),o):void 0},replace:function(e,t,n){return t.replace(tn.shortcode.regexp(e),function(e,t,a,o,i,s,r,l){if("["===t&&"]"===l)return e
var d=n(tn.shortcode.fromMatch(arguments))
return d?t+d+l:e})},string:function(e){return new tn.shortcode(e).string()},regexp:_.memoize(function(e){return RegExp("\\[(\\[?)("+e+")(?![\\w-])([^\\]\\/]*(?:\\/(?!\\])[^\\]\\/]*)*?)(?:(\\/)\\]|\\](?:([^\\[]*(?:\\[(?!\\/\\2\\])[^\\[]*)*)(\\[\\/\\2\\]))?)(\\]?)","g")}),attrs:_.memoize(function(e){var t,n,a={},o=[]
...
return e("#az-editor-modal")[a+"modal"]("hide"),i.call(o,n),!1}),e("#az-editor-modal").find('[data-dismiss="modal"]').click(function(){s.edit_stack=[]})
var w=e(window).scrollTop()
e(window).on("scroll.az-editor-modal",function(){e(window).scrollTop(w)}),e("#az-editor-modal")[a+"modal"]("show")},opened:function(){},closed:function(){},render:function(){}},nt("container",ot),Y(ot.prototype,{get_value:function(){return e(this.dom_element).find('input[name="'+this.param_name+'_type"]').val()+"/"+e(this.dom_element).find('input[name="'+this.param_name+'_name"]').val()},render:function(t){var a=t.split("/")[0],o=t.split("/")[1]
...
u(function(t){n=V(t,e(o.dom_element).find('input[name="'+o.param_name+'_type"]')),e(n).chosen().change(function(){f(e(this).val(),function(t){e(a).parent().find(".direct-input").click(),e(o.dom_element).find('input[name="'+o.param_name+'_name"]').val(""),a=V(t,e(o.dom_element).find('input[name="'+o.param_name+'_name"]'))})})}),f(t.split("/")[0],function(t){a=V(t,e(o.dom_element).find('input[name="'+o.param_name+'_name"]'))})}}),e.fn.deserialize=function(t){var n=e(this),a={}
...
x(t,function(t){e(n.dom_element).empty(),e(t).appendTo(n.dom_element),e(n.dom_element).find('[type="submit"]').remove(),n.form_value.length>0&&e(n.dom_element).deserialize(it(n.form_value))})},get_form:function(e){var t=e.get_value()
...
if(n instanceof ct){var a=n.attrs.content,o=/^\s*\<[\s\S]*\>\s*$/.exec(a)
o?lt.prototype.parse_html.call(n,a):lt.prototype.parse_shortcode.call(n,a)
...
var c=tt.prototype.param_types.icon.prototype.icons.map(function(e){return e.replace(/^/,".").replace(/ /,".")}),m=c.join(", ")
for(var h in t){var _=t[h].name,u=t[h].html
"ajaxurl"in window&&(u=e("<div>"+u+"</div>"),a(u),u=e(u).html())
var f=""
"thumbnail"in t[h]&&(f=t[h].thumbnail)
var v=function(){v.baseclass.apply(this,arguments)}
dt(_,!1,v)
var g=e("<div>"+u+"</div>"),y=e(g).find("."+n+"container, ."+n+"container-fluid").length>0
Y(v.prototype,{name:_,icon:"fa fa-cube",description:p(""),thumbnail:f,params:[at({type:"html",heading:p("Content"),param_name:"content",value:u})].concat(v.prototype.params),show_settings_on_create:!1,is_container:!0,has_content:!0,section:y,category:"Template-elements",is_template_element:!0,editable:[".az-editable"].concat(o),styleable:[".az-styleable"].concat(i),sortable:[".az-sortable"].concat(r),synchronizable:[".az-synchronizable"].concat(d),show_controls:function(){function t(t,n,o,i){var s=[],d="",h="",_="",u=e.trim(e(t).text())
if(""!=u&&(u=e(t).html()),n){if(e(t).is(m)){for(var f=0;f<c.length;f++)if(e(t).is(c[f])){_=c[f].split("."),_.shift(),_=_.join(" ")
break}s.push(at({type:"icon",heading:p("Icon"),param_name:"icon"}))}"IMG"!=e(t).prop("tagName")?""!=u&&s.push(at({type:"textarea",heading:p("Content"),param_name:"content"})):(d=e(t).attr("src"),s.push(at({type:"image",heading:p("Image"),param_name:"image",description:p("Select image from media library.")}))),"A"==e(t).prop("tagName")&&(h=e(t).attr("href"),s.push(at({type:"link",heading:p("Link"),param_name:"link",description:p("Conent link (url).")})))}if(o){s.push(at({type:"textfield",heading:p("Content classes"),param_name:"el_class",description:p("If you wish to style particular content element differently, then use this field to add a class name and then refer to it in your css file.")}))
var v=at({type:"style",heading:p("Content style"),param_name:"style",description:p("Style options."),tab:p("Style")})
n?s.push(v):s.unshift(v)}e(t).removeClass("editable-highlight"),e(t).removeClass("styleable-highlight"),e(t).removeClass(_)
var g=e(t).attr("class")
e(t).addClass(_),(void 0===g||g===!1)&&(g="")
var y=""
for(var b in t.style)e.isNumeric(b)&&(y=y+t.style[b]+": "+t.style.getPropertyValue(t.style[b])+"; ")
y=H(y),y=y.replace(/\-value\: /g,": "),y=y.replace("border-top-color","border-color"),y=y.replace("border-top-left-radius","border-radius"),y=y.replace("border-top-style","border-style"),tt.prototype.show_editor(s,{name:"Content",attrs:{content:u,link:h,image:d,el_class:g,style:y,icon:_}},function(s){n&&(""!=_&&(e(t).removeClass(_),s.el_class=s.el_class+" "+s.icon),"A"==e(t).prop("tagName")&&e(t).attr("href",s.link),"IMG"==e(t).prop("tagName")?e(t).attr("src",s.image):""!=u&&""!=s.content&&e(t).html(s.content)),o&&(e(t).attr("class",s.el_class),e(t).attr("style",s.style)),l.attrs.content=e(l.dom_content_element).html(),a(),r(),i()})}function n(t){var n=e(t).clone()
e(n).find("[class]").removeAttr("class"),e(n).find("[style]").removeAttr("style")
var a=e(n).html()
return a=a.replace(/\s*/g,"")}function a(){o()
for(var t=0;t<l.synchronizable.length;t++)e(l.dom_content_element).find(l.synchronizable[t]).each(function(){e(this).find(".editable-highlight").removeClass("editable-highlight"),e(this).find(".styleable-highlight").removeClass("styleable-highlight"),e(this).find(".sortable-highlight").removeClass("sortable-highlight"),e(this).find('[class=""]').removeAttr("class"),e(this).find('[style=""]').removeAttr("style")
var t=e(this).data("synchronized")
if(t)for(var a=0;a<t.length;a++)e(t[a]).html(e(this).html())
e(this).data("current-state")?e(document).trigger("azexo_synchronize",{from_node:this,old_state:e(this).data("current-state"),new_state:e(this).html()}):e(document).trigger("azexo_synchronize",{from_node:this,old_state:n(this),new_state:e(this).html()}),e(this).data("current-state",n(this)),l.attrs.content=e(l.dom_content_element).html()})
r()}function o(){for(var t=0;t<l.sortable.length;t++)e(l.dom_content_element).find(l.sortable[t]).hasClass("ui-sortable")&&(e(l.dom_content_element).find(l.sortable[t]).sortable("destroy"),e(l.dom_content_element).find(l.sortable[t]).find(".ui-sortable-handle").removeClass("ui-sortable-handle"))}function i(){for(var t=0;t<l.sortable.length;t++)e(l.dom_element).find(l.sortable[t]).sortable({items:"> *",placeholder:"az-sortable-placeholder",forcePlaceholderSize:!0,start:function(t,n){e(n.item).removeClass("sortable-highlight").find(".az-sortable-controls").remove()},update:function(){a()},over:function(e,t){t.placeholder.attr("class",t.helper.attr("class")),t.placeholder.removeClass("ui-sortable-helper"),t.placeholder.addClass("az-sortable-placeholder")}})}function r(){for(var t=0;t<l.styleable.length;t++)e(l.dom_element).find(l.styleable[t]).off("mouseenter.az-able").on("mouseenter.az-able",function(){e(this).addClass("styleable-highlight")}),e(l.dom_element).find(l.styleable[t]).off("mouseleave.az-able").on("mouseleave.az-able",function(){e(this).removeClass("styleable-highlight")}),e(l.dom_element).find(l.styleable[t]).off("click.az-able").on("click.az-able",function(){return 0==e(this).parent().closest(".styleable-highlight, .editable-highlight").length?(s.edit_stack.push({node:this,edit:!1,style:!0}),d(),!1):void s.edit_stack.push({node:this,edit:!1,style:!0})})
for(var t=0;t<l.editable.length;t++)e(l.dom_element).find(l.editable[t]).off("mouseenter.az-able").on("mouseenter.az-able",function(){e(this).addClass("editable-highlight")}),e(l.dom_element).find(l.editable[t]).off("mouseleave.az-able").on("mouseleave.az-able",function(){e(this).removeClass("editable-highlight")}),e(l.dom_element).find(l.editable[t]).off("click.az-able").on("click.az-able",function(){return 0==e(this).parent().closest(".styleable-highlight, .editable-highlight").length?(s.edit_stack.push({node:this,edit:!0,style:!0}),d(),!1):void s.edit_stack.push({node:this,edit:!0,style:!0})})
for(var t=0;t<l.sortable.length;t++)!function(t){function n(t){if(e(t).hasClass("sortable-highlight")){e(t).find(".az-sortable-controls").remove()
var n=e('<div class="az-sortable-controls"></div>').appendTo(t),i=e('<div class="az-sortable-clone glyphicon glyphicon-repeat"></div>').appendTo(n).click(function(){return o(),e(t).removeClass("sortable-highlight").find(".az-sortable-controls").remove(),e(t).clone().insertAfter(t),l.attrs.content=e(l.dom_content_element).html(),a(),r(),!1})
e(i).css("line-height",e(i).height()+"px").css("font-size",e(i).height()/2+"px")
var s=e('<div class="az-sortable-remove glyphicon glyphicon-remove"></div>').appendTo(n).click(function(){return o(),e(t).removeClass("sortable-highlight").find(".az-sortable-controls").remove(),e(t).remove(),l.attrs.content=e(l.dom_content_element).html(),a(),r(),!1})
e(s).css("line-height",e(s).height()+"px").css("font-size",e(s).height()/2+"px")}}var i=null
e(l.dom_element).find(l.sortable[t]).find("> *").off("mousemove.az-able").on("mousemove.az-able",function(){var t=this
e(t).hasClass("sortable-highlight")&&(clearTimeout(i),i=setTimeout(function(){n(t)},1e3))}),e(l.dom_element).find(l.sortable[t]).find("> *").off("mouseenter.az-able").on("mouseenter.az-able",function(){var t=this
e(this).addClass("sortable-highlight"),i=setTimeout(function(){n(t)},1e3)}),e(l.dom_element).find(l.sortable[t]).find("> *").off("mouseleave.az-able").on("mouseleave.az-able",function(){clearTimeout(i),e(this).removeClass("sortable-highlight"),e(this).find(".az-sortable-controls").remove()})}(t)
i()}if(window.azexo_editor){var l=this
v.baseclass.prototype.show_controls.apply(this,arguments)
var d=function(){if(s.edit_stack.length>0){var n=s.edit_stack.shift()
...
2>a/t?d():s.edit_stack=[]}})},500)}}
e(document).on("azexo_synchronize",function(t,a){o()
for(var i=0;i<l.synchronizable.length;i++)e(l.dom_content_element).find(l.synchronizable[i]).each(function(){if(e(this).find(".editable-highlight").removeClass("editable-highlight"),e(this).find(".styleable-highlight").removeClass("styleable-highlight"),e(this).find(".sortable-highlight").removeClass("sortable-highlight"),e(this).find('[class=""]').removeAttr("class"),e(this).find('[style=""]').removeAttr("style"),this!=a.from_node&&n(this)==a.old_state){var t=e(a.from_node).data("synchronized")
t||(t=[]),t.push(this),t=e.unique(t),e(a.from_node).data("synchronized",t),t=e(this).data("synchronized"),t||(t=[]),t.push(a.from_node),t=e.unique(t),e(this).data("synchronized",t),e(this).html(a.new_state),l.attrs.content=e(l.dom_content_element).html()}})
r()}),r(),a()}},showed:function(e,t){v.baseclass.prototype.showed.apply(this,arguments)
var n=this
if(n.section){var a=e(n.dom_element).parent().closest("."+t+"container, ."+t+"container-fluid"),o=e(n.dom_element).parentsUntil("."+t+"container, ."+t+"container-fluid"),i=e(n.dom_element).parent().closest(".az-popup-ctnr"),s=e(n.dom_element).parentsUntil(".az-popup-ctnr");(a.length>0&&0==i.length||a.length>0&&i.length>0&&o.length<s.length)&&e(n.dom_content_element).find("."+t+"container, ."+t+"container-fluid").each(function(){e(this).removeClass(t+"container"),e(this).removeClass(t+"container-fluid"),n.attrs.content=e(n.dom_content_element).html(),n.section=!1})}},render:function(e){this.dom_element=e('<div class="az-element az-template '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=e("<div></div>").appendTo(this.dom_element),e(this.attrs.content).appendTo(this.dom_content_element),v.baseclass.prototype.render.apply(this,arguments)}})}this.template_elements_loaded=!0,Bt(),this.try_render_unknown_elements(),e(function(){function a(t){if(1===Object.keys(t).length&&"_"in t)return null
var o=e('<ul class="'+n+'nav az-nav-list"></ul>')
for(var i in t)if("_"!=i){var r=e("<li></li>").appendTo(o),l=t[i]
...
var o=!1
return e(_).sortable({items:".az-thumbnail",connectWith:".az-ctnr",start:function(){o=!0,e(m).css("left","0px"),e(_).css("overflow-y","visible")},stop:function(){o=!1,e(m).css("left",""),e(m).removeClass("az-thumbnails"),e(_).css("overflow-y","scroll"),e(_).css("display","none")},update:function(t,n){for(var o=s.get_element(e(n.item).parent().closest("[data-az-id]").attr("data-az-id")),i=0,r=e(n.item).parent().find("[data-az-id], .az-thumbnail"),l=0;l<r.length;l++)if(e(r[l]).hasClass("az-thumbnail")){i=l
break}s.create_element(o,e(n.item).attr("data-az-base"),i,function(){})
...
d._.push(t[i])}var m=e('<div id="az-template-elements" class="az-left-sidebar"></div>').appendTo("body"),h=e('<div id="az-template-elements-welcome">'+p("For adding elements: click on plus-buttons or drag and drop elements from left panel.")+"</div>").appendTo(m)
e(m).hover(function(){e(h).remove()}),e("<h3>"+p("Elements")+"</h3>").appendTo(m),e("<hr>").appendTo(m),e(m).append(a(o))
...
w(t.instance,t.attrs.settings,n.attrs.container,function(n){e(t.dom_content_element).empty(),e(t.dom_content_element).append(n)})},{offset:"100%",triggerOnce:!0}),e(document).trigger("scroll")}})}},render:function(e){this.dom_element=e('<div class="az-element az-cms-element '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=e("<div></div>").appendTo(this.dom_element),o.baseclass.prototype.render.apply(this,arguments)}})}this.cms_elements_loaded=!0,Bt(),this.try_render_unknown_elements()},create_element:function(e,t,n,a){var o=e.get_nested_depth(t)
if(o<lt.prototype.max_nested_depth){var i=lt.prototype.elements[t]
if(e instanceof Rt&&null==e.parent&&!i.prototype.section){var s=new yt(e,n)
s.update_dom()
var r=new i(s,!1)
...
for(var l in lt.prototype.elements)lt.prototype.elements[l].prototype.hidden||"az_popup"!=t.base&&i.indexOf(lt.prototype.elements[l].prototype.base)>=0||(lt.prototype.elements[l].prototype.category in r?r[lt.prototype.elements[l].prototype.category].push(lt.prototype.elements[l]):r[lt.prototype.elements[l].prototype.category]=[lt.prototype.elements[l]])
...
else if(o instanceof kt)if(o.layer_number<o.children.length){var l=o.children[o.layer_number]
...
this.is_container&&(s+=this.has_content?this.get_content()+"[/"+a+"]":t+"[/"+a+"]")}return e[this.base]--,s},parse_shortcode:function(t){var n=_.keys(lt.prototype.tags).join("|"),a=tn.shortcode.regexp(n),o=e.trim(t).match(a)
if(_.isNull(o)){if(0==t.length)return
this.parse_shortcode("["==t.substring(0,1)&&"]"==t.slice(-1)?"[az_unknown]"+t+"[/az_unknown]":'[az_row][az_column width="1/1"][az_text]'+t+"[/az_text][/az_column][/az_row]")}_.each(o,function(e){var a=e.match(nn(n)),o=a[5],i=RegExp("^[\\s]*\\[\\[?("+_.keys(lt.prototype.tags).join("|")+")(?![\\w-])"),s=tn.shortcode.attrs(a[3]),r=a[2]
if(!(this.get_nested_depth(r)>lt.prototype.max_nested_depth)){var l=ct
if(r in lt.prototype.tags&&(l=lt.prototype.tags[r]),this instanceof Rt&&null==this.parent&&!l.prototype.section)return void this.parse_shortcode("[az_section]"+t+"[/az_section]")
var d=new l(this,!0)
...
if(0==e(n).children().closest_descendents("[data-azb]").length&&e.trim(e(n).html()).length>0){var o=new bt(a,!1)
o.children=[]
var i=new wt(o,!1),r=lt.prototype.elements.az_text,l=new r(i,!1)
l.attrs.content=e(n).html(),l.update_dom(),"update_empty"in a&&a.update_empty(),"update_empty"in i&&i.update_empty(),"update_empty"in o&&o.update_empty()}else e(n).children().closest_descendents("[data-azb]").each(function(){var n=e(this).attr("data-azb"),o=ct
n in lt.prototype.tags&&(o=lt.prototype.tags[n])
var i=new o(a,!0)
...
l.length>0&&(i.dom_content_element=e(l),i.has_content?i instanceof ct?(i.attrs.content=e(l).wrap("<div></div>").parent().html(),e(l).unwrap()):i.attrs.content=e(l).html():i.parse_html(l))}})},recursive_render:function(){for(var o=0;o<this.children.length;o++)this.children[o].recursive_render()
...
n.js[e]=!0,window.azexo_add_external_js(e,t)},get_my_container:function(){return this instanceof Rt?this:this.parent.get_my_container()},get_all_disallowed_elements:function(){if("parent"in this){var e=_.uniq(this.parent.get_all_disallowed_elements().concat(this.disallowed_elements))
...
""!=t&&(i=t,_.isObject(a[o])||(a[o]={}),a[o][t]=n)}var p="property"+s,m="property"+s+"value",h=e('<div class="row"><div class="select '+n+'col-xs-5">'+K(r,p,i)+'</div><div class="value '+n+'col-xs-5"><input class="'+n+'form-control" name="'+m+'" type="text" value="'+l+'"></div><div class="remove '+n+'col-xs-2"><button title="'+c("Remove")+'" type="button" class="control remove '+n+"btn "+n+"btn-danger "+n+"glyphicon "+n+'glyphicon-remove"> </button></div></div>').appendTo(t)
...
var o='<div class="'+n+'modal-header"><button type="button" class="'+n+'close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="'+n+'modal-title">'+p("Scroll animation settings")+"</h4></div>",i='<div class="'+n+'modal-footer"><button type="button" class="'+n+"btn "+n+'btn-default" data-dismiss="modal">'+p("Close")+'</button><button type="button" class="save '+n+"btn "+n+'btn-primary">'+p("Save changes")+"</button></div>",r=e('<div id="az-js-animation-modal" class="'+n+'modal azexo"><div class="'+n+"modal-dialog "+n+'modal-lg"><div class="'+n+'modal-content">'+o+'<div class="'+n+'modal-body"></div>'+i+"</div></div></div>").prependTo("body"),l=e('<div id="az-js-animation-tabs"><ul class="'+n+"nav "+n+'nav-tabs"><li><a href="#script" data-toggle="tab">'+p("Script")+'</a></li><li><a href="#wizards" data-toggle="tab">'+p("Wizards")+'</a></li></ul><div class="'+n+'tab-content"><div id="script" class="'+n+'tab-pane"></div><div id="wizards" class="'+n+'tab-pane"></div></div></div>')
...
if(e.length==a.children.length)for(var n=lt.prototype.tags[this.base],o=this.get_child_position(),t=0;t<e.length;t++)if(e[t].id!=this.parent.id){var i=e[t],s=new n(i,!0)
...
for(var o=0;o<t.children.length;o++)a.add_control(t.children[o])},showed:function(e,t){xt.baseclass.prototype.showed.apply(this,arguments)
var n=this
...
for(var r=0;r<o.children.length;r++)n(a.children[r],i)}kt.baseclass.prototype.showed.apply(this,arguments)
var a=this
...
e(a.dom_element).css("font-size",100*o+"%"),e(a.dom_content_element).css("height",a.attrs.height*o+"px"),n(a,o)}),e(window).trigger("resize"))},render:function(e){this.dom_element=e('<div class="az-element az-layers '+this.attrs.el_class+'" style="'+this.attrs.style+'"><div id="'+this.id+'" class="az-ctnr"></div></div>'),this.dom_content_element=e(this.dom_element).find(".az-ctnr"),e(this.dom_content_element).css("width",this.attrs.width),e(this.dom_content_element).css("height",this.attrs.height),kt.baseclass.prototype.render.apply(this,arguments)}}),gt("az_tabs",!0,jt),Y(jt.prototype,{name:p("Tabs"),icon:"fa fa-folder-o",description:p("Bootstrap content tabs. Every tab can contain any number of any types of elements."),category:p("Layout"),params:[].concat(jt.prototype.params),is_container:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},show_controls:function(){window.azexo_editor&&(jt.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".add").remove(),e(this.controls).find(".paste").remove(),e('<button title="'+c("Add tab")+'" class="control add-tab '+n+"btn "+n+"btn-primary "+n+"glyphicon "+n+'glyphicon-plus-sign" > </button>').appendTo(this.controls).click({object:this},this.click_add_tab))},update_sortable:function(){window.azexo_editor&&e(this.dom_element).sortable({axis:"x",items:"> ul > li",update:this.update_sorting,placeholder:"az-sortable-placeholder",forcePlaceholderSize:!0,over:function(e,t){t.placeholder.attr("class",t.helper.attr("class")),t.placeholder.removeClass("ui-sortable-helper"),t.placeholder.addClass("az-sortable-placeholder")}})},update_sorting:function(t,n){var a=s.get_element(e(this).attr("data-az-id"))
if(a){var o=e(this).sortable("option"),i=[]
e(this).find(o.items).each(function(){var t=e(this).find('a[data-toggle="tab"]').attr("href").replace("#","")
i.push(s.get_element(t))}),a.children=i
...
""!=this.parent.attrs.type&&(n=this.parent.attrs.type),this.dom_element=e('<div class="az-element az-toggle '+t+"panel "+n+" "+this.attrs.el_class+'" style="'+this.attrs.style+'"><div class="'+t+'panel-heading"><h4 class="'+t+'panel-title"><a data-toggle="collapse" data-parent="#'+this.parent.id+'" href="#'+this.id+'">'+this.attrs.title+'</a></h4></div><div id="'+this.id+'" class="'+t+"panel-collapse "+t+'collapse"><div class="'+t+'panel-body az-ctnr"></div></div></div>'),this.dom_content_element=e(this.dom_element).find("."+t+"panel-body"),Ct.baseclass.prototype.render.apply(this,arguments)}}),gt("az_carousel",!0,Ot),Y(Ot.prototype,{name:p("Carousel"),icon:"fa fa-ellipsis-h",description:p("Content carousel. Every slide of this element can contain any number of any types of elements. It can be used for create classic content slider."),category:p("Layout"),params:[at({type:"integer_slider",heading:p("Number items"),param_name:"items",min:"1",max:"10",value:"1"}),at({type:"checkbox",heading:p("Options"),param_name:"options",value:{navigation:p("Navigation"),auto_play:p("Auto play"),mouse:p("Mouse drag"),touch:p("Touch drag")}}),at({type:"dropdown",heading:p("Transition style"),param_name:"transition",value:{"":p("Default"),fade:p("fade"),backSlide:p("backSlide"),goDown:p("goDown"),fadeUp:p("fadeUp")}})].concat(Ot.prototype.params),is_container:!0,show_settings_on_create:!0,frontend_render:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},show_controls:function(){if(window.azexo_editor){Ot.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".add").remove(),e(this.controls).find(".paste").remove()
...
e.update_dom(),this.update_dom()},showed:function(e){Ot.baseclass.prototype.showed.apply(this,arguments),this.add_css("owl.carousel/owl-carousel/owl.carousel.css","owlCarousel"in e.fn,function(){}),this.add_css("owl.carousel/owl-carousel/owl.theme.css","owlCarousel"in e.fn,function(){}),this.add_css("owl.carousel/owl-carousel/owl.transitions.css","owlCarousel"in e.fn,function(){})
var t=this
...
d.config.visualScaling=d.config.visualScaling/i,e(d.dom_content_element).css("transform",o+" scale("+i+")")})}},update_sortable:function(){if(window.azexo_editor);},click_add_step:function(e){return e.data.object.add_step(),!1},add_step:function(){var e=new At(this,!0)
...
for(var i=0;i<n.children.length;i++)n.children[i].recursive_showed()
e(document).trigger("scroll")}s.try_render_unknown_elements()})},clone:function(){Rt.baseclass.prototype.clone.apply(this,arguments),this.rendered=!0},recursive_render:function(){t?(this.render(e,n,a),this.children=[]):Rt.baseclass.prototype.recursive_render.apply(this,arguments),window.azexo_editor&&(this.show_controls(),this.update_sortable())},update_dom:function(){this.loaded_container!=this.attrs.container&&(this.children=[],e(this.dom_content_element).empty(),this.rendered=!1,null!=this.parent&&Rt.baseclass.prototype.update_dom.apply(this,arguments))},showed:function(e){Rt.baseclass.prototype.showed.apply(this,arguments)
var t=this
null==this.parent?t.rendered||(t.rendered=!0,t.load_container()):this.add_js({path:"jquery-waypoints/waypoints.min.js",loaded:"waypoint"in e.fn,callback:function(){e(t.dom_element).waypoint(function(){t.rendered||(t.rendered=!0,t.load_container())},{offset:"100%",triggerOnce:!0}),e(document).trigger("scroll")}})},render:function(e){this.dom_element=e('<div class="az-element az-container"><div class="az-ctnr"></div></div>'),this.dom_content_element=e(this.dom_element).find(".az-ctnr"),Rt.baseclass.prototype.render.apply(this,arguments)}}),yt.prototype.params.push(at({type:"textfield",heading:p("Menu item title"),param_name:"menu_item_title",description:p("Title which will be used in scroll menu."),tab:p("Menu")})),dt("az_scroll_menu",!1,Dt),Y(Dt.prototype,{name:p("Scroll Menu"),icon:"fa fa-sitemap",description:p("One page scroll menu"),params:[at({type:"image",heading:p("Logo"),param_name:"logo",description:p("Select image from media library.")}),at({type:"link",heading:p("Logo link"),param_name:"logo_link"})].concat(Dt.prototype.params),showed:function(e,t,n){this.navbar_height=e(this.dom_element).find("."+t+"navbar").height(),Dt.baseclass.prototype.showed.apply(this,arguments)
var a=this
...
for(var i in Nt.prototype.form_elements){var s=Nt.prototype.form_elements[i].prototype
o+='<button title="'+c("Add")+" "+s.name+'" class="control '+n+"btn "+n+"btn-default "+s.icon+'" data-az-element="'+i+'"></button>'}o+="</div>"
var r=e('<button title="'+c("Add form field")+'" class="control set-columns '+n+"btn "+n+"btn-primary "+n+"glyphicon "+n+'glyphicon-plus-sign"> </button>').appendTo(this.controls)[a+"popover"]({animation:!1,placement:n+"right",html:"true",trigger:"manual",content:o}).hover(function(){e(this)[a+"popover"]("show"),e(t.controls).find("."+n+"popover .control").each(function(){e(this).click(function(){var n=e(this).attr("data-az-element"),a=lt.prototype.elements[n],o=new a(t,!1)
return o.update_dom(),t.update_dom(),t.update_empty(),o.show_settings_on_create&&o.edit(),!1})}),e(t.dom_element).mouseleave(function(){e(r)[a+"popover"]("hide"),e(r).css("display","")})})}},update_sortable:function(){window.azexo_editor&&e(this.dom_content_element).sortable({items:"> .az-element",connectWith:".az-form .az-ctnr",handle:"> .controls > .drag-and-drop",update:this.update_sorting,placeholder:"az-sortable-placeholder",forcePlaceholderSize:!0,over:function(e,t){t.placeholder.attr("class",t.helper.attr("class")),t.placeholder.removeClass("ui-sortable-helper"),t.placeholder.addClass("az-sortable-placeholder")}})},click_show_submissions:function(e){return e.data.object.show_submissions(),!1},show_submissions:function(){var t=this,o=t.get_my_container(),i=o.attrs.container.split("/")[0]
