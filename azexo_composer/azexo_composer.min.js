...
i=s.get_element(r),a++}if(e(".controls").css("visibility","hidden").css("opacity","0"),e(".control").css("opacity","0"),e(".az-element").removeClass("az-highlight"),o)t.right_click_number=0
else if(i instanceof mt)if(i.layer_number<i.children.length){var l=i.children[i.layer_number]
e(l.dom_element).find(" > .controls").css("visibility","visible").css("opacity","1").find(" > .control").css("opacity","1"),e(l.dom_element).addClass("az-highlight"),t.right_click_number--,i.layer_number++}else e(i.dom_element).find(" > .controls").css("visibility","visible").css("opacity","1").find(" > .control").css("opacity","1"),e(i.dom_element).addClass("az-highlight"),i.layer_number=0
