...
e(n.dom_content_element).empty(),n.attach_children(),window.azexo_editor&&n.update_sortable(),n.recursive_showed()}}},create_template_elements:function(t){function a(t){function n(e){return 0==e.indexOf("azexo_elements")?window.azexo_baseurl+"../"+e:0!=e.indexOf("/")&&0!=e.indexOf("http://")&&0!=e.indexOf("https://")?window.azexo_baseurl+"../azexo_elements/"+a+"/"+e:e}var a=v.split("|")
a.pop(),a=a.join("/")
for(var i in o){var s=o[i]
e(t).find(i).each(function(){e(this).attr(s,n(e(this).attr(s)))})}e(t).find("[data-az-url]").each(function(){var t=e(this).attr("data-az-url")
e(this).attr(t,n(e(this).attr(t)))}),e(t).find('[style*="background-image"]').each(function(){var t=e(this).attr("style").replace(/background-image[: ]*url\(([^\)]+)\) *;/,function(e,t){return e.replace(t,encodeURI(n(decodeURI(t))))})
e(this).attr("style",t)})}var o={"link[href]":"href","script[src]":"src","img[src]":"src"}
...
var u=at.prototype.param_types.icon.prototype.icons.map(function(e){return e.replace(/^/,".").replace(/ /,".")}),f=u.join(", ")
for(var v in t){var g=t[v].name,y=t[v].html
"ajaxurl"in window&&(y=e("<div>"+y+"</div>"),a(y),y=e(y).html())
var b=""
"thumbnail"in t[v]&&(b=t[v].thumbnail)
var w=function(){w.baseclass.apply(this,arguments)}
pt(g,!1,w)
var x=e("<div>"+y+"</div>"),z=e(x).find("."+n+"container, ."+n+"container-fluid, .az-rootable").length>0
Y(w.prototype,{name:g,icon:"fa fa-cube",description:p(""),thumbnail:b,params:[it({type:"html",heading:p("Content"),param_name:"content",value:y})].concat(w.prototype.params),show_settings_on_create:!1,is_container:!0,has_content:!0,section:z,category:"Template-elements",is_template_element:!0,editable:[".az-editable"].concat(i),styleable:[".az-styleable"].concat(r),sortable:[".az-sortable"].concat(d),synchronizable:[".az-synchronizable"].concat(c),restoreable:[".az-restoreable"].concat(m),containable:[".az-containable"].concat(h),restore_nodes:{},contained_elements:{},show_controls:function(){function t(t,n,a,i){var s=[],r="",c="",m="",h=e.trim(e(t).text())
if(""!=h&&(h=e(t).html()),n){if(e(t).is(f)){for(var _=0;_<u.length;_++)if(e(t).is(u[_])){m=u[_].split("."),m.shift(),m=m.join(" ")
break}s.push(it({type:"icon",heading:p("Icon"),param_name:"icon"}))}"IMG"!=e(t).prop("tagName")?""!=h&&s.push(it({type:"textarea",heading:p("Content"),param_name:"content"})):(r=e(t).attr("src"),s.push(it({type:"image",heading:p("Image"),param_name:"image",description:p("Select image from media library.")}))),"A"==e(t).prop("tagName")&&(c=e(t).attr("href"),s.push(it({type:"link",heading:p("Link"),param_name:"link",description:p("Conent link (url).")})))}if(a){s.push(it({type:"textfield",heading:p("Content classes"),param_name:"el_class",description:p("If you wish to style particular content element differently, then use this field to add a class name and then refer to it in your css file.")}))
...
y=H(y),y=y.replace(/\-value\: /g,": "),y=y.replace("border-top-color","border-color"),y=y.replace("border-top-left-radius","border-radius"),y=y.replace("border-top-style","border-style"),at.prototype.show_editor(s,{name:"Content",attrs:{content:h,link:c,image:r,el_class:g,style:y,icon:m}},function(s){n&&(""!=m&&(e(t).removeClass(m),s.el_class=s.el_class+" "+s.icon),"A"==e(t).prop("tagName")&&e(t).attr("href",s.link),"IMG"==e(t).prop("tagName")?e(t).attr("src",s.image):""!=h&&""!=s.content&&e(t).html(s.content)),a&&(e(t).attr("class",s.el_class),e(t).attr("style",s.style)),d.attrs.content=e(d.dom_content_element).html(),d.restore_content(),o(),l(),i()})}function a(t){var n=e(t).clone()
...
l()}function i(){for(var t=0;t<d.sortable.length;t++)e(d.dom_content_element).find(d.sortable[t]).each(function(){e(this).hasClass("ui-sortable")&&e(this).sortable("instance")&&(e(this).sortable("destroy"),e(this).find(".ui-sortable-handle").removeClass("ui-sortable-handle"))})}function r(){for(var t=0;t<d.sortable.length;t++)e(d.dom_element).find(d.sortable[t]).each(function(){0==e(this).closest("[data-az-restore]").length&&e(this).sortable({items:"> *",placeholder:"az-sortable-placeholder",forcePlaceholderSize:!0,start:function(t,n){e(n.item).removeClass("sortable-highlight").find(".az-sortable-controls").remove()},update:function(){d.attrs.content=e(d.dom_content_element).html(),d.restore_content(),o()},over:function(e,t){t.placeholder.attr("class",t.helper.attr("class")),t.placeholder.removeClass("ui-sortable-helper"),t.placeholder.addClass("az-sortable-placeholder")}})})}function l(){function t(t){if(e(t).hasClass("sortable-highlight")){e(t).find(".az-sortable-controls").remove()
...
return at.prototype.show_editor(t,{name:"Content",attrs:{html:a}},function(e){d.restore_nodes[n]=e.html,d.restore_content(),d.update_dom(),o()}),!1}})
...
w.baseclass.prototype.show_controls.apply(this,arguments)
...
e(document).trigger("azexo_restore",{dom:t}),this.attrs.content=e(t).html()},restore:function(){w.baseclass.prototype.restore.apply(this,arguments)
for(var t in this.restore_nodes)e(this.dom_element).find('[data-az-restore="'+t+'"]').html(this.restore_nodes[t])
e(document).trigger("azexo_restore",{dom:this.dom_element}),e(this.dom_element).find("[data-az-restore]").removeAttr("data-az-restore")},showed:function(e,t){w.baseclass.prototype.showed.apply(this,arguments)
var n=this
...
this.attrs.content=e(n).html(),e(this.attrs.content).appendTo(this.dom_content_element),w.baseclass.prototype.render.apply(this,arguments)}})}this.template_elements_loaded=!0,qt(),this.try_render_unknown_elements(),e(function(){function a(t){if(1===Object.keys(t).length&&"_"in t)return null
