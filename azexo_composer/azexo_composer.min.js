...
i.id==r&&e(l.dom_element).find("."+n+"navbar")[a+"affix"]({offset:{top:e(l.dom_element).find("."+n+"navbar").offset().top,bottom:0}})})}function Bt(){Bt.baseclass.apply(this,arguments)}function Yt(){Yt.baseclass.apply(this,arguments)}function qt(e,t){B(t,Yt),t.prototype.base=e,Yt.prototype.elements[e]=t,Yt.prototype.tags[e]=t,Yt.prototype.form_elements[e]=t}function Ht(){if("azexo_elements"in window)for(var e=0;e<window.azexo_elements.length;e++){var t=window.azexo_elements[e],n=function(){n.baseclass.apply(this,arguments)}
...
""!=e&&null!=e&&h(e)})
e('<button class="'+n+"btn "+n+'btn-danger">'+p("Delete")+"</button>").appendTo(P).click(function(){L(e(q).find("option:selected").val()),e(q).find("option:selected").remove(),e(q).trigger("change")})
...
"current_site"==i[0]&&(a=decodeURIComponent(i[1]))}"create-new-site"==a?e(R).click():0==e(q).find('[value="'+a+'"]').length?h(a):(e(q).find('option[value="'+a+'"]').prop("selected","selected"),u(a))})
...
h in m?m[h].push(u):m[h]=[u],e.unique(m[h])}for(var h in m){var _=m[h]
...
var e=this
"impress"in e.parent&&e.parent.impress.initStep(e.dom_element.get(0))},remove:function(){Lt.baseclass.prototype.remove.apply(this,arguments),this.parent.update_dom()},render:function(e){this.dom_element=e('<div id="'+this.id+'" class="az-element az-step az-ctnr step '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),e(this.dom_element).css("width",this.attrs.width),e(this.dom_element).css("height",this.attrs.height),e(this.dom_element).attr("data-x",this.attrs.x),e(this.dom_element).attr("data-y",this.attrs.y),e(this.dom_element).attr("data-z",this.attrs.z),e(this.dom_element).attr("data-rotate-x",this.attrs.rotate_x),e(this.dom_element).attr("data-rotate-y",this.attrs.rotate_y),e(this.dom_element).attr("data-rotate",this.attrs.rotate_z),e(this.dom_element).attr("data-scale",this.attrs.scale),this.dom_content_element=this.dom_element,Lt.baseclass.prototype.render.apply(this,arguments)}}),zt("az_container",!0,Mt),Y(Mt.prototype,{name:p("Container"),icon:"fa fa-archive",description:p("AJAX loaded content from server. Content can be edited and saved to server."),category:p("Layout"),params:[lt({type:"container",heading:p("Container"),param_name:"container",description:p("Type and name used as identificator to save container on server."),value:"/"})].concat(Mt.prototype.params),show_settings_on_create:!0,is_container:!0,hidden:!window.azexo_online,saveable:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},get_empty:function(){return'<div class="az-empty"><div class="top '+n+'well"><strong>'+p("Click to put an element here.")+'</strong></div><div class="top-right '+n+'well"><h1>↗</h1><span class="'+n+"glyphicon "+n+'glyphicon-eye-open"></span>'+p(" - toggle editor helpers.")+' <span class="'+n+"glyphicon "+n+'glyphicon-play-circle"></span>'+p(" - toggle animation engine to not hinder editing.")+' <span class="'+n+"glyphicon "+n+'glyphicon-save"></span>'+p(" - save results of editing on server.")+"</div></div>"},show_controls:function(){if(window.azexo_editor){var t=this
