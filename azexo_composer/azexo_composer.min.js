...
e(t).val('<div class="az-element az-container" data-az-type="'+i+'" data-az-name="'+o+'">'+a+"</div>")}e(t).html(e(t).val())}})}})},e(document).on("azexo_add_element",n.save_container),e(document).on("azexo_edited_element",n.save_container),e(document).on("azexo_update_element",n.save_container),e(document).on("azexo_delete_element",n.save_container),e(document).on("azexo_update_sorting",n.save_container)}})},show:function(){this.each(function(){})},hide:function(){this.each(function(){var t=e(this).data("azexo_composer")
...
var v=!1
e(d.dom_element).on("mousedown",function(t){if(t.target==t.currentTarget){v=!0,h.prevX=t.pageX,h.prevY=t.pageY
var n=e(d.dom_content_element).find("> div")
d.transition_duration=e(n).css("transition-duration"),e(n).css("transition-duration","0s"),d.transition_delay=e(n).css("transition-delay"),e(n).css("transition-delay","0s")}}),e(document).off("mouseup.az_presentation"+d.id),e(document).on("mouseup.az_presentation"+d.id,function(){if(v){var t=e(d.dom_content_element).find("> div")
e(t).css("transition-duration",d.transition_duration),e(t).css("transition-delay",d.transition_delay)}v=!1}),e(document).off("mousemove.az_presentation"+d.id),e(document).on("mousemove.az_presentation"+d.id,function(n){if(v){var a=e(d.dom_content_element).find("> div");("0s"!=e(a).css("transition-duration")||"0s"!=e(a).css("transition-delay"))&&(d.transition_duration=e(a).css("transition-duration"),e(a).css("transition-duration","0s"),d.transition_delay=e(a).css("transition-delay"),e(a).css("transition-delay","0s")),n.preventDefault(),n.stopPropagation()
