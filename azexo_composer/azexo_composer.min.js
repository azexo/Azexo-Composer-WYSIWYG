...
Y(v.prototype,{name:_,icon:"fa fa-cube",description:p(""),thumbnail:f,params:[at({type:"html",heading:p("Content"),param_name:"content",value:u})].concat(v.prototype.params),show_settings_on_create:!1,is_container:!0,has_content:!0,section:y,category:"Template-elements",is_template_element:!0,editable:[".az-editable"].concat(o),styleable:[".az-styleable"].concat(i),sortable:[".az-sortable"].concat(r),synchronizable:[".az-synchronizable"].concat(d),show_controls:function(){function t(t,a,o,s){var l=[],d="",h="",_="",u=e.trim(e(t).text())
if(""!=u&&(u=e(t).html()),a){if(e(t).is(m)){for(var f=0;f<c.length;f++)if(e(t).is(c[f])){_=c[f].split("."),_.shift(),_=_.join(" ")
break}l.push(at({type:"icon",heading:p("Icon"),param_name:"icon"}))}"IMG"!=e(t).prop("tagName")?""!=u&&l.push(at({type:"textarea",heading:p("Content"),param_name:"content"})):(d=e(t).attr("src"),l.push(at({type:"image",heading:p("Image"),param_name:"image",description:p("Select image from media library.")}))),"A"==e(t).prop("tagName")&&(h=e(t).attr("href"),l.push(at({type:"link",heading:p("Link"),param_name:"link",description:p("Conent link (url).")})))}if(o){l.push(at({type:"textfield",heading:p("Content classes"),param_name:"el_class",description:p("If you wish to style particular content element differently, then use this field to add a class name and then refer to it in your css file.")}))
var v=at({type:"style",heading:p("Content style"),param_name:"style",description:p("Style options."),tab:p("Style")})
a?l.push(v):l.unshift(v)}e(t).removeClass("editable-highlight"),e(t).removeClass("styleable-highlight"),e(t).removeClass(_)
...
y=H(y),y=y.replace(/\-value\: /g,": "),y=y.replace("border-top-color","border-color"),y=y.replace("border-top-left-radius","border-radius"),y=y.replace("border-top-style","border-style"),tt.prototype.show_editor(l,{name:"Content",attrs:{content:u,link:h,image:d,el_class:g,style:y,icon:_}},function(l){a&&(""!=_&&(e(t).removeClass(_),l.el_class=l.el_class+" "+l.icon),"A"==e(t).prop("tagName")&&e(t).attr("href",l.link),"IMG"==e(t).prop("tagName")?e(t).attr("src",l.image):""!=u&&""!=l.content&&e(t).html(l.content)),o&&(e(t).attr("class",l.el_class),e(t).attr("style",l.style)),r.attrs.content=e(r.dom_content_element).html(),n(),i(),s()})}function n(){a()
for(var t=0;t<r.synchronizable.length;t++)e(r.dom_content_element).find(r.synchronizable[t]).each(function(){e(this).find(".editable-highlight").removeClass("editable-highlight"),e(this).find(".styleable-highlight").removeClass("styleable-highlight"),e(this).find(".sortable-highlight").removeClass("sortable-highlight"),e(this).find('[class=""]').removeAttr("class"),e(this).find('[style=""]').removeAttr("style")
var t=e(this).data("synchronized")
if(t)for(var n=0;n<t.length;n++)e(t[n]).html(e(this).html())
e(this).data("current-state")?e(document).trigger("azexo_synchronize",{from_node:this,old_state:e(this).data("current-state"),new_state:e(this).html()}):e(document).trigger("azexo_synchronize",{from_node:this,old_state:e(this).html(),new_state:e(this).html()}),e(this).data("current-state",e(this).html()),r.attrs.content=e(r.dom_content_element).html()})
i()}function a(){for(var t=0;t<r.sortable.length;t++)e(r.dom_content_element).find(r.sortable[t]).hasClass("ui-sortable")&&(e(r.dom_content_element).find(r.sortable[t]).sortable("destroy"),e(r.dom_content_element).find(r.sortable[t]).find(".ui-sortable-handle").removeClass("ui-sortable-handle"))}function o(){for(var t=0;t<r.sortable.length;t++)e(r.dom_element).find(r.sortable[t]).sortable({items:"> *",placeholder:"az-sortable-placeholder",forcePlaceholderSize:!0,start:function(t,n){e(n.item).removeClass("sortable-highlight").find(".az-sortable-controls").remove()},update:function(){n()},over:function(e,t){t.placeholder.attr("class",t.helper.attr("class")),t.placeholder.removeClass("ui-sortable-helper"),t.placeholder.addClass("az-sortable-placeholder")}})}function i(){for(var t=0;t<r.styleable.length;t++)e(r.dom_element).find(r.styleable[t]).off("mouseenter.az-able").on("mouseenter.az-able",function(){e(this).addClass("styleable-highlight")}),e(r.dom_element).find(r.styleable[t]).off("mouseleave.az-able").on("mouseleave.az-able",function(){e(this).removeClass("styleable-highlight")}),e(r.dom_element).find(r.styleable[t]).off("click.az-able").on("click.az-able",function(){return 0==e(this).parent().closest(".styleable-highlight, .editable-highlight").length?(s.edit_stack.push({node:this,edit:!1,style:!0}),l(),!1):void s.edit_stack.push({node:this,edit:!1,style:!0})})
for(var t=0;t<r.editable.length;t++)e(r.dom_element).find(r.editable[t]).off("mouseenter.az-able").on("mouseenter.az-able",function(){e(this).addClass("editable-highlight")}),e(r.dom_element).find(r.editable[t]).off("mouseleave.az-able").on("mouseleave.az-able",function(){e(this).removeClass("editable-highlight")}),e(r.dom_element).find(r.editable[t]).off("click.az-able").on("click.az-able",function(){return 0==e(this).parent().closest(".styleable-highlight, .editable-highlight").length?(s.edit_stack.push({node:this,edit:!0,style:!0}),l(),!1):void s.edit_stack.push({node:this,edit:!0,style:!0})})
for(var t=0;t<r.sortable.length;t++)!function(t){function o(t){if(e(t).hasClass("sortable-highlight")){e(t).find(".az-sortable-controls").remove()
var o=e('<div class="az-sortable-controls"></div>').appendTo(t),s=e('<div class="az-sortable-clone glyphicon glyphicon-repeat"></div>').appendTo(o).click(function(){return a(),e(t).removeClass("sortable-highlight").find(".az-sortable-controls").remove(),e(t).clone().insertAfter(t),r.attrs.content=e(r.dom_content_element).html(),n(),i(),!1})
e(s).css("line-height",e(s).height()+"px").css("font-size",e(s).height()/2+"px")
var l=e('<div class="az-sortable-remove glyphicon glyphicon-remove"></div>').appendTo(o).click(function(){return a(),e(t).removeClass("sortable-highlight").find(".az-sortable-controls").remove(),e(t).remove(),r.attrs.content=e(r.dom_content_element).html(),n(),i(),!1})
e(l).css("line-height",e(l).height()+"px").css("font-size",e(l).height()/2+"px")}}var s=null
e(r.dom_element).find(r.sortable[t]).find("> *").off("mousemove.az-able").on("mousemove.az-able",function(){var t=this
e(t).hasClass("sortable-highlight")&&(clearTimeout(s),s=setTimeout(function(){o(t)},1e3))}),e(r.dom_element).find(r.sortable[t]).find("> *").off("mouseenter.az-able").on("mouseenter.az-able",function(){var t=this
e(this).addClass("sortable-highlight"),s=setTimeout(function(){o(t)},1e3)}),e(r.dom_element).find(r.sortable[t]).find("> *").off("mouseleave.az-able").on("mouseleave.az-able",function(){clearTimeout(s),e(this).removeClass("sortable-highlight"),e(this).find(".az-sortable-controls").remove()})}(t)
o()}if(window.azexo_editor){var r=this
v.baseclass.prototype.show_controls.apply(this,arguments)
var l=function(){if(s.edit_stack.length>0){var n=s.edit_stack.shift()
...
2>a/t?l():s.edit_stack=[]}})},500)}}
e(document).on("azexo_synchronize",function(t,n){a()
for(var o=0;o<r.synchronizable.length;o++)e(r.dom_content_element).find(r.synchronizable[o]).each(function(){if(e(this).find(".editable-highlight").removeClass("editable-highlight"),e(this).find(".styleable-highlight").removeClass("styleable-highlight"),e(this).find(".sortable-highlight").removeClass("sortable-highlight"),e(this).find('[class=""]').removeAttr("class"),e(this).find('[style=""]').removeAttr("style"),this!=n.from_node&&e(this).html()==n.old_state){var t=e(n.from_node).data("synchronized")
t||(t=[]),t.push(this),t=e.unique(t),e(n.from_node).data("synchronized",t),t=e(this).data("synchronized"),t||(t=[]),t.push(n.from_node),t=e.unique(t),e(this).data("synchronized",t),e(this).html(n.new_state),r.attrs.content=e(r.dom_content_element).html()}})
i()}),i(),n()}},showed:function(e,t){v.baseclass.prototype.showed.apply(this,arguments)
var n=this
