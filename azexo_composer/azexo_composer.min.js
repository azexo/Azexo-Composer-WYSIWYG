!function(e,t,n,a,o,i,s,r,l,d){function c(e){return"azexo_title"in window&&e in window.azexo_title?window.azexo_title[e]:p(e)}function p(e){return"azexo_t"in window?window.azexo_t(e):e}function m(){return"azexo_lang"in window?window.azexo_lang:"en"}function h(t){return"azexo_editor"in window?void t(window.azexo_editor):void(window.azexo_online?"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_login",url:window.location.href,password:N("azexo_password")},dataType:"json",cache:!1,context:this}).done(function(e){t(e)}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"login",password:N("azexo_password")},dataType:"json",cache:!1,context:this}).done(function(e){t(e)}):t(!1))}function u(t){"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_get_container_types",url:window.location.href},dataType:"json",cache:!1,context:this}).done(function(e){t(e)}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"get_container_types"},dataType:"json",cache:!1,context:this}).done(function(e){t(e)})}function f(t,n){"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_get_container_names",container_type:t,url:window.location.href},dataType:"json",cache:!1,context:this}).done(function(e){n(e)}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"get_container_names",container_type:t},dataType:"json",cache:!1,context:this}).done(function(e){n(e)})}function v(t,n,a){"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_save_container",type:t,name:n,shortcode:a},dataType:"json",cache:!1,context:this}).done(function(e){}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"container_save",type:t,name:n,shortcode:a},dataType:"json",cache:!1,context:this}).done(function(e){})}function g(t,n,a){if(d.hasOwnProperty(t+"/"+n))return void a(d[t+"/"+n])
...
a(decodeURIComponent(atob(e)))}})}function y(t){return"azexo_cms_element_names"in window?void t(window.azexo_cms_element_names):void(window.azexo_online&&"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_get_cms_element_names",url:window.location.href},dataType:"json",cache:!1,context:this}).done(function(e){t(e)}).fail(function(){t(!1)}):t(!1))}function b(t,n,a,o){"ajaxurl"in window&&e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_load_cms_element",name:t,settings:n,container:a},cache:!window.azexo_editor}).done(function(e){o(e)})}function w(t,n){"ajaxurl"in window&&e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_get_cms_element_settings",name:t,url:window.location.href},cache:!window.azexo_editor}).done(function(e){n(e)})}function x(t){if("azexo_template_elements"in window){for(var n in window.azexo_template_elements)window.azexo_template_elements[n]=decodeURIComponent(atob(window.azexo_template_elements[n]))
...
e.ajax({url:a,cache:!1}).done(function(e){n(e)}).fail(function(){n("")})}}function j(t,n){"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_save_template",url:window.location.href,name:t,template:n},cache:!1,context:this}).done(function(){}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"save_template",name:t,template:n},cache:!1,context:this}).done(function(){})}function T(t){"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_delete_template",url:window.location.href,name:t},cache:!1,context:this}).done(function(){}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"delete_template",name:t},cache:!1,context:this}).done(function(){})}function O(t){window.azexo_online?"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_get_recaptcha_publickey"},cache:!1,context:this}).done(function(e){t(e)}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"get_recaptcha_publickey"},cache:!1,context:this}).done(function(e){t(e)}):t("")}function S(t,n,a,o,i){window.azexo_online?"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_submit_form",container_type:t,container_name:n,name:a,values:o},dataType:"json",cache:!1,context:this}).done(function(e){i(e)}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"submit_form",name:a,values:o},dataType:"json",cache:!1,context:this}).done(function(e){i(e)}):i("")}function C(t,n,a,o){window.azexo_online?"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_load_submissions",container_type:t,container_name:n,name:a},dataType:"json",cache:!1,context:this}).done(function(e){o(e)}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"load_submissions",name:a},dataType:"json",cache:!1,context:this}).done(function(e){o(e)}):o("")}function I(t){window.azexo_online?"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_get_settings_form",url:window.location.href},cache:!1,context:this}).done(function(e){t(e)}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"get_settings_form"},cache:!1,context:this}).done(function(e){t(e)}):t("")}function E(t,n){window.azexo_online?"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_submit_settings_form",url:window.location.href,values:t},dataType:"json",cache:!1,context:this}).done(function(e){n(e)}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"submit_settings_form",values:t},dataType:"json",cache:!1,context:this}).done(function(e){n(e)}):n("")}function P(e,t){var n=function(){}
n.prototype=t.prototype,e.prototype=new n,e.prototype.constructor=e,e.baseclass=t}function D(e,t){var n={}
for(var a in t)(void 0===n[a]||n[a]!=t[a])&&(e[a]=t[a])
if(document.all&&!document.isOpera){var o=t.toString
"function"==typeof o&&o!=e.toString&&o!=n.toString&&"\nfunction toString() {\n    [native code]\n}\n"!=o&&(e.toString=t.toString)}return e}function R(e,t,n,a){return 0>n&&(n+=e.length),a=void 0!==a?a:e.length,0>a&&(a=a+e.length-n),e.slice(0,n)+t.substr(0,a)+t.slice(a)+e.slice(n+a)}function L(e,t){var a=n+"col-"+t+"-",o=e?e.split("/"):[1,1],i=_.range(1,13),s=!_.isUndefined(o[0])&&_.indexOf(i,parseInt(o[0],10))>=0?parseInt(o[0],10):!1,r=!_.isUndefined(o[1])&&_.indexOf(i,parseInt(o[1],10))>=0?parseInt(o[1],10):!1
return s!==!1&&r!==!1?a+12*s/r:a+"12"}function A(e){return _.isString(e)?e.replace(/(\`{2})/g,'"'):e}function U(e){return decodeURIComponent((e+"").replace(/%(?![\da-f]{2})/gi,function(){return"%25"}))}function B(e,t,n){var a=new Date
a.setDate(a.getDate()+n)
var o=encodeURIComponent(t)+(null===n?"":"; expires="+a.toUTCString())
document.cookie=e+"="+o}function N(e){var t,n,a,o=document.cookie.split(";")
for(t=0;t<o.length;t++)if(n=o[t].substr(0,o[t].indexOf("=")),a=o[t].substr(o[t].indexOf("=")+1),n=n.replace(/^\s+|\s+$/g,""),n==e)return decodeURIComponent(a)}function M(t,n){var a="<select>"
...
return e(i).chosen({search_contains:!0,allow_single_deselect:!0}),e(i).change(function(){e(this).find("option:selected").each(function(){e(n).val(e(this).val())})}),e(i).parent().find(".chosen-container").width("100%"),e('<div><a class="direct-input" href="#">'+p("Direct input")+"</a></div>").insertBefore(i).click(function(){e(n).css("display","block"),e(i).parent().find(".chosen-container").remove(),e(i).remove(),e(this).remove()}),i}function q(t,n,a){var o='<select multiple="multiple">',i=""
...
return n&&11==n[7].length?n[7]:!1}function H(e,t,a){var o='<select name="'+t+'" class="'+n+'form-control">'
o+='<option value="">'+p("Please select")+"</option>"
for(var i in e)o+=i==a?'<option value="'+i+'" selected>'+e[i]+"</option>":'<option value="'+i+'">'+e[i]+"</option>"
return o+="/<select>"}function W(e){return'<div class="'+n+"alert "+n+"alert-warning "+n+"fade "+n+'in" role="alert"><button type="button" class="'+n+'close" data-dismiss="alert"><span aria-hidden="true">×</span><span class="'+n+'sr-only">'+p("Close")+"</span></button>"+e+"</div>"}function F(){this.dom_element=null,this.heading="",this.description="",this.param_name="",this.required=!1,this.admin_label="",this.holder="",this.wrapper_class="",this.value=null,this.can_be_empty=!1,this.hidden=!1,this.tab="",this.dependency={},"create"in this&&this.create()}function $(e,t){P(t,F),t.prototype.type=e,F.prototype.param_types[e]=t}function J(e){if(e.type in F.prototype.param_types){var t=new F.prototype.param_types[e.type]
return D(t,e),t}var t=new F
return D(t,e),t}function V(){V.baseclass.apply(this,arguments)}function X(e){var t=document.createElement("div")
...
n instanceof wt&&e(n.dom_element).removeClass("azexo-editor"),null!=n.controls&&e(n.controls).remove(),n.update_empty()}}function nt(){"ajaxurl"in window||(!window.azexo_editor||window.azexo_online)&&delete window.azexo_editor,h(function(e){window.azexo_editor=e,tt()})}function at(t){e.holdReady(!0),"complete"===document.readyState?setTimeout(t):document.addEventListener?(document.addEventListener("DOMContentLoaded",t,!1),window.addEventListener("load",t,!1)):(document.attachEvent("onreadystatechange",t),window.attachEvent("onload",t))}function ot(o){var i=e(o).html(),s=/^\s*\<[\s\S]*\>\s*$/.exec(i)
if(s||""==i){e(o).find("> script").detach().appendTo("head"),e(o).find("> link[href]").detach().appendTo("head")
var r=new wt(null,!1)
r.attrs.container=e(o).attr("data-az-type")+"/"+e(o).attr("data-az-name"),r.dom_element=e(o),e(r.dom_element).attr("data-az-id",r.id),r.dom_content_element=e(o),e(r.dom_element).css("display",""),e(r.dom_element).addClass("azexo"),r.parse_html(r.dom_content_element),r.html_content=!0,r.loaded_container=r.attrs.container
...
c=e.unique(c.split(" ")).join(" "),e(r.dom_element).attr("class",c),e(r.dom_element).attr("style",e(o).attr("style")),e(r.dom_element).css("display",""),e(r.dom_element).addClass("azexo"),e(o).replaceWith(r.dom_element),r.showed(e,n,a),window.azexo_editor&&r.show_controls()}return window.azexo_editor&&e(r.dom_element).addClass("azexo-editor"),r}function it(){Vt||(Vt=!0,e(".az-container").each(function(){var e=ot(this)
...
var o='<div class="'+n+'modal-header"><button type="button" class="'+n+'close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="'+n+'modal-title">'+p("Admin area")+"</h4></div>",i='<div class="'+n+'modal-footer"><button type="button" class="'+n+"btn "+n+'btn-default" data-dismiss="modal">'+p("Close")+'</button><button type="button" class="save '+n+"btn "+n+'btn-primary">'+p("Save changes")+"</button></div>",s=e('<div id="az-admin-modal" class="'+n+'modal azexo"><div class="'+n+"modal-dialog "+n+'modal-lg"><div class="'+n+'modal-content">'+o+'<div class="'+n+'modal-body"></div>'+i+"</div></div></div>").prependTo("body"),r=null
window.azexo_editor?I(function(t){t.length>0&&"0"!=t&&"false"!=t&&(r=e(t),e(s).find("."+n+"modal-body").append(r),e('<button type="button" class="'+n+"btn "+n+'btn-default" data-dismiss="modal">'+p("Logout")+"</button>").appendTo("#az-admin-modal .modal-footer").click(function(){B("azexo_password","",null),window.azexo_editor=!1,tt()}),e("#az-admin-modal").find(".save").click(function(){return E(r.serialize(),function(){e("#az-admin-modal")[a+"modal"]("hide")}),!1}),e("#az-admin-modal")[a+"modal"]("show"))}):(r=e("<form></form>").append('<div class="'+n+'form-group"><label>'+p("Login")+'</label><div><input class="'+n+'form-control" name="password" type="password" placeholder="'+p("Please enter password here")+'" ></div><p class="'+n+'help-block">'+p("")+"</p></div>"),e(s).find("."+n+"modal-body").append(r),e("#az-admin-modal").find(".save").click(function(){return B("azexo_password",e("#az-admin-modal").find('[name="password"]').val(),null),nt(),e("#az-admin-modal")[a+"modal"]("hide"),!1}),e("#az-admin-modal")[a+"modal"]("show"))}}))}function st(){st.baseclass.apply(this,arguments)}function rt(e,t,n){if(P(n,st),n.prototype.base=e,n.prototype.is_container=t,st.prototype.elements[e]=n,st.prototype.tags[e]=n,t)for(var a=1;a<st.prototype.max_nested_depth;a++)st.prototype.tags[e+"_"+a]=n}function lt(e,t){lt.baseclass.apply(this,arguments),this.columns="",t||this.set_columns("1/1"),this.attrs.device="sm"}function dt(e,t){dt.baseclass.call(this,e,t)}function ct(e,t){ct.baseclass.apply(this,arguments),this.linked_elements_index={},t||this.add_item(),this.attach_events()}function pt(){pt.baseclass.apply(this,arguments)}function mt(){mt.baseclass.apply(this,arguments)}function ht(e,t){ht.baseclass.apply(this,arguments),t||this.add_tab()}function _t(){_t.baseclass.apply(this,arguments)}function ut(e,t){ut.baseclass.apply(this,arguments),t||this.add_toggle()}function ft(){ft.baseclass.apply(this,arguments)}function vt(e,t){vt.baseclass.apply(this,arguments),t||this.add_slide()}function gt(){gt.baseclass.apply(this,arguments)}function yt(e,t){yt.baseclass.apply(this,arguments),t||this.add_step()}function bt(){bt.baseclass.apply(this,arguments)}function wt(){wt.baseclass.apply(this,arguments),this.rendered=!1,this.loaded_container=null,this.js={},this.css={}}function xt(){xt.baseclass.apply(this,arguments),this.menu_items={}
for(var t in s.elements_instances){var o=s.elements_instances[t]
o instanceof lt&&""!=o.attrs.menu_item_title&&(this.menu_items[t]=o.attrs.menu_item_title)}var i=this,r=function(t,o){e("body")[a+"scrollspy"]({target:"#"+i.id+".navbar-collapse",offset:i.navbar_height})
var r=s.get_element(o)
r instanceof lt&&(""!=r.attrs.menu_item_title?(i.menu_items[o]=r.attrs.menu_item_title,i.replace_render(),i.showed(e,n,a)):o in i.menu_items&&(delete i.menu_items[o],i.replace_render(),i.showed(e,n,a)))}
s.attachEvent("add_element",function(e,t){r(e,t.id)}),s.attachEvent("edited_element",r),s.attachEvent("delete_element",function(t,o){e("body")[a+"scrollspy"]({target:"#"+i.id+".navbar-collapse",offset:i.navbar_height})
var r=s.get_element(o)
r instanceof lt&&(delete i.menu_items[o],i.replace_render(),i.showed(e,n,a))}),s.attachEvent("update_sorting",function(t,o){e("body")[a+"scrollspy"]({target:"#"+i.id+".navbar-collapse",offset:i.navbar_height})
var r=e(o.item).closest("[data-az-id]").attr("data-az-id"),l=s.get_element(r)
i.id==r&&e(l.dom_element).find("."+n+"navbar")[a+"affix"]({offset:{top:e(l.dom_element).find("."+n+"navbar").offset().top,bottom:0}})})}function zt(){zt.baseclass.apply(this,arguments)}function kt(){kt.baseclass.apply(this,arguments)}function jt(e,t){P(t,kt),t.prototype.base=e,kt.prototype.elements[e]=t,kt.prototype.tags[e]=t,kt.prototype.form_elements[e]=t}function Tt(){if("azexo_elements"in window)for(var e=0;e<window.azexo_elements.length;e++){var t=window.azexo_elements[e],n=function(){n.baseclass.apply(this,arguments)}
rt(t.base,t.is_container,n),t.baseclass=n.baseclass,t.params=t.params.concat(n.prototype.params),D(n.prototype,t)
for(var a=0;a<n.prototype.params.length;a++){var o=n.prototype.params[a],i=J(o)
n.prototype.params[a]=i}}}function Ot(){if("azexo_form_elements"in window)for(var e=0;e<window.azexo_form_elements.length;e++){var t=window.azexo_form_elements[e],n=function(){n.baseclass.apply(this,arguments)}
jt(t.base,n),t.baseclass=n.baseclass,t.params=t.params.concat(n.prototype.params),D(n.prototype,t)
for(var a=0;a<n.prototype.params.length;a++){var o=n.prototype.params[a],i=J(o)
n.prototype.params[a]=i}}}function St(){if("azexo_extend"in window)for(var e in window.azexo_extend){var t=window.azexo_extend[e],n=t.params
t.params={}
var a=K.prototype.elements[e]
D(a.prototype,t)
for(var o=0;o<n.length;o++){var i=J(n[o])
a.prototype.params.push(i)}}}function Ct(){(!window.azexo_editor||window.azexo_online)&&x(function(e){_.isObject(e)&&s.create_template_elements(e)})}function It(){y(function(e){_.isObject(e)&&s.create_cms_elements(e)})}window.azexo_backend=!0
var Et=(""+arguments.callee).replace(/((\/\/.*$)|(\/\*[\s\S]*?\*\/)|(\s))/gm,"").match(/^function\s*[^\(]*\(\s*([^\)]*)\)/m)[1].split(/,/),Pt=Et[0],Dt=Et[1],Rt=Et[2],Lt=Et[3],At=Et[4],Ut=Et[5],Bt=Et[6],Nt=Et[7],Mt=Et[8],qt=Et[9]
...
var Yt={}
Yt.shortcode={next:function(e,t,n){var a,o,i=Yt.shortcode.regexp(e)
return i.lastIndex=n||0,(a=i.exec(t))?"["===a[1]&&"]"===a[7]?Yt.shortcode.next(e,t,i.lastIndex):(o={index:a.index,content:a[0],shortcode:Yt.shortcode.fromMatch(a)},a[1]&&(o.match=o.match.slice(1),o.index++),a[7]&&(o.match=o.match.slice(0,-1)),o):void 0},replace:function(e,t,n){return t.replace(Yt.shortcode.regexp(e),function(e,t,a,o,i,s,r,l){if("["===t&&"]"===l)return e
var d=n(Yt.shortcode.fromMatch(arguments))
return d?t+d+l:e})},string:function(e){return new Yt.shortcode(e).string()},regexp:_.memoize(function(e){return RegExp("\\[(\\[?)("+e+")(?![\\w-])([^\\]\\/]*(?:\\/(?!\\])[^\\]\\/]*)*?)(?:(\\/)\\]|\\](?:([^\\[]*(?:\\[(?!\\/\\2\\])[^\\[]*)*)(\\[\\/\\2\\]))?)(\\]?)","g")}),attrs:_.memoize(function(e){var t,n,a={},o=[]
...
for(var u in d){c++
for(var v=e('<div id="az-editor-tab-'+c+'" class="'+n+'tab-pane"></div>'),g=0;g<d[u].length;g++)d[u][g].render(o.attrs[d[u][g].param_name]),e(v).append(d[u][g].dom_element)
e(f).append(v)}e(m).append(f),e(l).find("."+n+"modal-body").append(m),e('#az-editor-tabs a[href="#az-editor-tab-1"]')[a+"tab"]("show"),e('#az-editor-modal input[name="el_class"]').each(function(){q(K.prototype.el_classes,this," ")})
...
return i.call(o,n),e("#az-editor-modal")[a+"modal"]("hide"),!1}),e("#az-editor-modal")[a+"modal"]("show")},opened:function(){},closed:function(){},render:function(){}},$("container",V),D(V.prototype,{get_value:function(){return e(this.dom_element).find('input[name="'+this.param_name+'_type"]').val()+"/"+e(this.dom_element).find('input[name="'+this.param_name+'_name"]').val()},render:function(t){var a=t.split("/")[0],o=t.split("/")[1]
...
u(function(t){n=M(t,e(o.dom_element).find('input[name="'+o.param_name+'_type"]')),e(n).chosen().change(function(){f(e(this).val(),function(t){e(a).parent().find(".direct-input").click(),e(o.dom_element).find('input[name="'+o.param_name+'_name"]').val(""),a=M(t,e(o.dom_element).find('input[name="'+o.param_name+'_name"]'))})})}),f(t.split("/")[0],function(t){a=M(t,e(o.dom_element).find('input[name="'+o.param_name+'_name"]'))})}}),e.fn.deserialize=function(t){var n=e(this),a={}
return e.each(t.split("&"),function(){var e=this.split("="),t=U(e[0]),n=e.length>1?U(e[1]):null
t in a||(a[t]=[]),a[t].push(n)}),e.each(a,function(e,t){n.find("[name='"+e+"']").val(t[0].replace(/\+/g," ")),"on"==t[0].replace(/\+/g," ")&&n.find("[type='checkbox'][name='"+e+"']").attr("checked","checked"),n.find("select[name='"+e+"'] > option").removeAttr("selected"),n.find("select[name='"+e+"'] > option[value='"+t+"']").prop("selected","selected")}),e("input:checkbox:checked,input:radio:checked").each(function(){e(this).attr("name")in a||(this.checked=!1)}),this},$("cms_settings",Q),D(Q.prototype,{get_value:function(){return e(this.dom_element).find("form").serialize()},render_form:function(t){var n=this
w(t,function(t){e(n.dom_element).empty(),e(t).appendTo(n.dom_element),n.form_value.length>0&&e(n.dom_element).deserialize(X(n.form_value))})},get_form:function(e){var t=e.get_value()
t.length>0&&this.render_form(t)},render:function(t){this.form_value=t,this.dom_element=e('<div class="'+n+'form-group"></div>')},opened:function(){"instance"in this&&this.render_form(this.instance)}}),"azexo_param_types"in window)for(var Wt=0;Wt<window.azexo_param_types.length;Wt++){var Ft=window.azexo_param_types[Wt],$t=function(){$t.baseclass.apply(this,arguments)}
$(Ft.type,$t),Ft.baseclass=$t.baseclass,D($t.prototype,Ft)}if(window.azexo_add_css=function(t,n){var a=window.azexo_baseurl+t
...
for(var n=0;n<t.length;n++)t[n]()}},n.appendChild(a)},EventObject=function(){},EventObject.prototype={_eventList:{},_getEvent:function(e,t){if(!this._eventList[e]){if(!t)return null
this._eventList[e]=[]}return this._eventList[e]},attachEvent:function(e,t){var n=this._getEvent(e,!0)
n.push(t)},detachEvent:function(e,t){var n=this._getEvent(e)
if(n){var a=function(e,t){for(var n=e.length;n<e.length;n++)if(e[n]&&e[n]===t)return n
return-1},o=a(n,t)
o>-1&&n.splice(o,1)}},raiseEvent:function(e,t){var n=this._getEventHandler(e)
n&&n(this,t)},_getEventHandler:function(e){var t=this._getEvent(e,!1)
if(!t||0===t.length)return null
var n=function(e,n){for(var a=0;a<t.length;a++)t[a](e,n)}
return n}},G.prototype=new EventObject,D(G.prototype,{elements_instances:{},elements_instances_by_an_name:{},template_elements_loaded:!1,cms_elements_loaded:!1,try_render_unknown_elements:function(){if(this.template_elements_loaded&&this.cms_elements_loaded)for(var t in s.elements_instances){var n=s.elements_instances[t]
if(n instanceof et){var a=n.attrs.content,o=/^\s*\<[\s\S]*\>\s*$/.exec(a)
o?K.prototype.parse_html.call(n,a):K.prototype.parse_shortcode.call(n,a)
for(var i=0;i<n.children.length;i++)n.children[i].recursive_render()
e(n.dom_element).empty()
for(var i=0;i<n.children.length;i++)e(n.dom_element).append(n.children[i].dom_element)
...
rt(t,!1,a),D(a.prototype,{name:t,icon:"fa fa-cube",description:p(""),template:n,params:[].concat(a.prototype.params),show_settings_on_create:!0,has_content:!0,category:"Template-elements",render:function(e){for(var t=this.template,n=0;n<this.params.length;n++){var o=this.attrs[this.params[n].param_name]
"textfield"==this.params[n].type&&(t=t.replace("[["+this.params[n].param_name+"]]",o)),"textarea"==this.params[n].type&&(t=t.replace("{{"+this.params[n].param_name+"}}",o)),"image"==this.params[n].type&&(t=t.replace("(("+this.params[n].param_name+"))",o)),"link"==this.params[n].type&&(t=t.replace("<<"+this.params[n].param_name+">>",o))}this.dom_element=e('<div class="az-element az-template '+this.attrs.el_class+'" style="'+this.attrs.style+'">'+t+"</div>"),this.dom_content_element=this.dom_element,a.baseclass.prototype.render.apply(this,arguments)}})
for(var o=/\[\[([^\]]*)\]\]/g,i=0,s={};null!=(s=o.exec(n));){var r=J({type:"textfield",param_name:"param"+i,value:s[1]})
a.prototype.params.unshift(r),n=R(n,"[[param"+i+"]]",s.index,s[0].length),i++}a.prototype.template=n
for(var o=/\{\{([^\}]*)\}\}/g;null!=(s=o.exec(n));){var r=J({type:"textarea",param_name:"param"+i,value:s[1]})
a.prototype.params.unshift(r),n=R(n,"{{param"+i+"}}",s.index,s[0].length),i++}a.prototype.template=n
for(var o=/\(\(([^\)]*)\)\)/g;null!=(s=o.exec(n));){var r=J({type:"image",param_name:"param"+i,value:s[1]})
a.prototype.params.unshift(r),n=R(n,"((param"+i+"))",s.index,s[0].length),i++}a.prototype.template=n
for(var o=/\<\<([^\>]*)\>\>/g;null!=(s=o.exec(n));){var r=J({type:"link",param_name:"param"+i,value:s[1]})
a.prototype.params.unshift(r),n=R(n,"<<param"+i+">>",s.index,s[0].length),i++}a.prototype.template=n}this.template_elements_loaded=!0,this.try_render_unknown_elements()},create_cms_elements:function(e){for(var t in e){var a="az_"+t,o=function(){o.baseclass.apply(this,arguments)}
rt(a,!1,o),D(o.prototype,{name:e[t],icon:"fa fa-cube",description:p(""),category:"CMS",instance:t,params:[J({type:"cms_settings",heading:p("Settings"),param_name:"settings",instance:t})].concat(o.prototype.params),show_settings_on_create:!0,is_container:!0,has_content:!0,is_cms_element:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+"pull-left "+n+'text-overflow" data-az-element="'+this.base+'"><i class="'+n+"text-primary "+this.icon+'"></i><div class="'+n+'small">'+this.name+"</div></div>"},get_content:function(){return""},showed:function(e){if(o.baseclass.prototype.showed.apply(this,arguments),"content"in this.attrs&&""!=this.attrs.content)e(this.dom_content_element).append(this.attrs.content),this.attrs.content=""
else{var t=this
...
b(t.instance,t.attrs.settings,n.attrs.container,function(n){e(t.dom_content_element).empty(),e(t.dom_content_element).append(n)})},{offset:"100%",triggerOnce:!0}),e(document).trigger("scroll")}})}},render:function(e){this.dom_element=e('<div class="az-element az-cms-element '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=e("<div></div>").appendTo(this.dom_element),o.baseclass.prototype.render.apply(this,arguments)}})}this.cms_elements_loaded=!0,this.try_render_unknown_elements()},make_elements_modal:function(t,o){var i=t.get_all_disallowed_elements(),s={}
for(var r in K.prototype.elements)K.prototype.elements[r].prototype.hidden||i.indexOf(K.prototype.elements[r].prototype.base)>=0||(K.prototype.elements[r].prototype.category in s?s[K.prototype.elements[r].prototype.category].push(K.prototype.elements[r]):s[K.prototype.elements[r].prototype.category]=[K.prototype.elements[r]])
...
var f='<div class="'+n+'modal-header"><button type="button" class="'+n+'close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="'+n+'modal-title">'+p("Elements list")+"</h4></div>",v=e('<div id="az-elements-modal" class="'+n+'modal azexo" style="display:none"><div class="'+n+"modal-dialog "+n+'modal-lg"><div class="'+n+'modal-content">'+f+'<div class="'+n+'modal-body"></div></div></div></div>')
e("body").prepend(v),e(v).find("."+n+"modal-body").append(l),e(l).find("> ul a:first")[a+"tab"]("show"),e(v).find("[data-az-element]").click(function(){var n=e(this).attr("data-az-element"),i=t.get_nested_depth(n)
if(i<K.prototype.max_nested_depth){if(t instanceof wt&&null==t.parent&&"az_row"!=n){var s=new lt(t,!1)
s.update_dom()
var r=K.prototype.elements[n],l=new r(s.children[0],!1)
o(l),l.update_dom(),t.update_empty(),s.children[0].update_empty(),s.update_empty()}else{var r=K.prototype.elements[n],l=new r(t,!1)
o(l),l.update_dom(),t.update_empty()}e("#az-elements-modal")[a+"modal"]("hide"),l.show_settings_on_create&&l.edit()}else alert(p("Element can not be added. Max nested depth reached."))}),window.azexo_online&&e(l).find('a[href="#az-elements-tab-templates"]').on("shown."+a+"bs.tab",function(){z(function(o){var i=e(l).find("#az-elements-tab-templates")
e(i).empty()
for(var s=0;s<o.length;s++){var r=o[s],d='<div class="'+n+"well "+n+"text-center "+n+"pull-left "+n+'text-overflow" data-az-template="'+r+'"><i class="'+n+'text-primary fa fa-cubes"></i><h4>'+r+"</h4></div>"
d=e(d).appendTo(i).click(function(){var n=e(this).attr("data-az-template")
k(n,function(n){var o=t.children.length
...
for(var a=1,o=t,i=!1;a<t.right_click_number;){if(!(e(o.dom_element).parent().closest("[data-az-id]").length>0)){i=!0
break}var r=e(o.dom_element).parent().closest("[data-az-id]").attr("data-az-id")
o=s.get_element(r),a++}if(e(".controls").css("visibility","hidden").css("opacity","0"),e(".control").css("opacity","0"),e(".az-element").removeClass("highlight"),i)t.right_click_number=0
else if(o instanceof mt)if(o.layer_number<o.children.length){var l=o.children[o.layer_number]
e(l.dom_element).find(" > .controls").css("visibility","visible").css("opacity","1").find(" > .control").css("opacity","1"),e(l.dom_element).addClass("highlight"),t.right_click_number--,o.layer_number++}else e(o.dom_element).find(" > .controls").css("visibility","visible").css("opacity","1").find(" > .control").css("opacity","1"),e(o.dom_element).addClass("highlight"),o.layer_number=0
else e(o.dom_element).find(" > .controls").css("visibility","visible").css("opacity","1").find(" > .control").css("opacity","1"),e(o.dom_element).addClass("highlight")
return!1}}),e(this.dom_element).mouseenter(function(){t.right_click_number=0,t instanceof mt&&(t.layer_number=0)}),e(this.dom_element).mouseleave(function(){e(t.dom_element).hasClass("highlight")&&(e(".controls").css("visibility","").css("opacity",""),e(".control").css("opacity",""),e(".az-element").removeClass("highlight"))}),t.show_parent_controls&&_.defer(function(){function n(t){"none"==e(t.parent.controls).find(".btn:not(span)").css("display")?e(t.controls).find(".btn:not(span)").css("display","inline-block"):e(t.controls).find(".btn:not(span)").css("display","none"),"none"==e(t.controls).find(".btn:not(span)").css("display")?e(t.parent.controls).find(".btn:not(span)").css("display","inline-block"):e(t.parent.controls).find(".btn:not(span)").css("display","none"),e(t.parent.controls).attr("data-az-cid",e(t.dom_element).attr("data-az-id"))
var n=e(t.dom_element).offset()
n.top=n.top-parseInt(e(t.dom_element).css("margin-top")),e(t.parent.controls).offset(n),n.left=n.left+e(t.parent.controls).width(),e(t.controls).offset(n)}e(t.dom_element).off("mouseenter").on("mouseenter",function(){window.azexo_editor&&(e(t.parent.controls).css("display","block"),n(t))}),e(t.dom_element).off("mouseleave").on("mouseleave",function(){window.azexo_editor&&e(t.controls).css("display","")}),setInterval(function(){if(window.azexo_editor){e(t.dom_element).is(":hover")||e(t.parent.controls).is(":hover")||e(t.controls).css("display",""),e(t.dom_element).is(":hover")&&(n(t),e(t.controls).css("visibility","visibile"),e(t.controls).css("opacity","1"))
var a=s.get_element(e(t.parent.controls).attr("data-az-cid"))
_.isUndefined(a)||e(t.parent.controls).css("display",e(a.controls).css("display")),_.isUndefined(e(t.parent.controls).data("spc"))&&(e(t.parent.controls).off("mouseenter").on("mouseenter",function(){var t=s.get_element(e(this).closest("[data-az-cid]").attr("data-az-cid"))
e(t.controls).css("display","block")}),e(t.parent.controls).data("spc",!0))}},100),e(t.controls).find("span").off("click").on("click",function(){e(t.controls).find(".btn:not(span)").css("display","inline-block"),e(t.parent.controls).find(".btn:not(span)").css("display","none"),n(t)}),e(t.parent.controls).find("span").off("click").on("click",function(){var t=s.get_element(e(this).closest("[data-az-cid]").attr("data-az-cid"))
e(t.parent.controls).find(".btn:not(span)").css("display","inline-block"),e(t.controls).find(".btn:not(span)").css("display","none"),n(t)}),e(t.controls).find("span").trigger("click")})}},get_empty:function(){return'<div class="az-empty"><div class="top '+n+'well"><strong>'+p("Click to put an element here.")+"</strong></div></div>"},update_empty:function(){if(window.azexo_editor)if(0==this.children.length&&this.is_container&&!this.has_content||this.has_content&&""==this.attrs.content){e(this.dom_content_element).find("> .az-empty").remove()
...
null!=t&&(this.render(e,n,a),e(t).replaceWith(this.dom_element),null!=o&&e(this.dom_content_element).replaceWith(o)),window.azexo_editor&&this.show_controls()},update_dom:function(){this.detach_children(),e(this.dom_element).remove(),this.parent.detach_children(),this.render(e,n,a),this.attach_children(),window.azexo_editor&&this.show_controls(),this.parent.attach_children(),window.azexo_editor&&(this.update_sortable(),this.update_empty()),this.showed(e,n,a)},showed:function(e){"pos_left"in this.attrs&&e(this.dom_element).css("left",this.attrs.pos_left),"pos_right"in this.attrs&&e(this.dom_element).css("right",this.attrs.pos_right),"pos_top"in this.attrs&&e(this.dom_element).css("top",this.attrs.pos_top),"pos_bottom"in this.attrs&&e(this.dom_element).css("bottom",this.attrs.pos_bottom),"pos_width"in this.attrs&&e(this.dom_element).css("width",this.attrs.pos_width),"pos_height"in this.attrs&&e(this.dom_element).css("height",this.attrs.pos_height),"pos_zindex"in this.attrs&&e(this.dom_element).css("z-index",this.attrs.pos_zindex),"hover_style"in this.attrs&&""!=this.attrs.hover_style&&(e("head").append("<style>.hover-style-"+this.id+":hover { "+this.attrs.hover_style+" } </style>"),e(this.dom_element).addClass("hover-style-"+this.id))},render:function(e){e(this.dom_element).attr("data-az-id",this.id)},update_data:function(){e(this.dom_element).attr("data-azb",this.base)
...
n.source=s.get_element(e(this).closest("[data-az-id]").attr("data-az-id")),n.from_pos=a.get_child_position(),n.source.update_sorting_children(),n.target=s.get_element(e(n.item).parent().closest("[data-az-id]").attr("data-az-id")),n.source.id!=n.target.id&&n.target.update_sorting_children(),n.to_pos=a.get_child_position(),s.raiseEvent("update_sorting",n)},click_edit:function(e){return e.data.object.edit(),!1},edit:function(){F.prototype.show_editor(this.params,this,this.edited)},edited:function(e){for(var t in e)this.attrs[t]=A(e[t])
this.update_dom(),s.raiseEvent("edited_element",this.id)},attrs2string:function(){for(var e="",t=0;t<this.params.length;t++){var n=this.params[t]
...
if("content"===t.param_name&&"html"==t.type)return btoa(encodeURIComponent(this.attrs.content))}return this.attrs.content},set_content:function(e){for(var t=A(e),n=0;n<this.params.length;n++){var a=this.params[n]
if("content"===a.param_name&&"html"==a.type)return t=decodeURIComponent(atob(t.replace(/^#E\-8_/,""))),void(this.attrs.content=t)}this.attrs.content=t},parse_attrs:function(e){for(var t=0;t<this.params.length;t++){var n=this.params[t]
if(n.param_name in e)if(n.safe)this.attrs[n.param_name]=A(e[n.param_name])
else{var a=A(e[n.param_name])
this.attrs[n.param_name]=decodeURIComponent(atob(a.replace(/^#E\-8_/,"")))}else"value"in n&&_.isString(n.value)&&(this.attrs[n.param_name]=n.value)}for(var o in e)o in this.attrs||(this.attrs[o]=e[o])
s.raiseEvent("edited_element",this.id)},get_nested_depth:function(e){var t=0
...
this.is_container&&(s+=this.has_content?this.get_content()+"[/"+a+"]":t+"[/"+a+"]")}return e[this.base]--,s},parse_shortcode:function(t){var n=_.keys(K.prototype.tags).join("|"),a=Yt.shortcode.regexp(n),o=e.trim(t).match(a)
if(_.isNull(o)){if(0==t.length)return
this.parse_shortcode('[az_row][az_column width="1/1"][az_text]'+t+"[/az_text][/az_column][/az_row]")}_.each(o,function(e){var a=e.match(Ht(n)),o=a[5],i=RegExp("^[\\s]*\\[\\[?("+_.keys(K.prototype.tags).join("|")+")(?![\\w-])"),s=Yt.shortcode.attrs(a[3]),r=a[2]
...
if(0==e(n).children().closest_descendents("[data-azb]").length&&e.trim(e(n).html()).length>0){var o=new lt(a,!1)
o.children=[]
var i=new dt(o,!1),r=K.prototype.elements.az_text,l=new r(i,!1)
l.attrs.content=e(n).html(),l.update_dom(),"update_empty"in a&&a.update_empty(),"update_empty"in i&&i.update_empty(),"update_empty"in o&&o.update_empty()}else e(n).children().closest_descendents("[data-azb]").each(function(){var n=e(this).attr("data-azb"),o=et
n in K.prototype.tags&&(o=K.prototype.tags[n])
var i=new o(a,!0)
...
l.length>0&&(i.dom_content_element=e(l),i.has_content?i instanceof et?(i.attrs.content=e(l).wrap("<div></div>").parent().html(),e(l).unwrap()):i.attrs.content=e(l).html():i.parse_html(l))}})},recursive_render:function(){for(var o=0;o<this.children.length;o++)this.children[o].recursive_render()
...
return e}return this.disallowed_elements}},Z("az_unknown",!0,et),D(et.prototype,{has_content:!0,hidden:!0,show_controls:function(){},update_empty:function(){},render:function(e){if(this.dom_element=e('<div class = "az-element"></div>'),this.dom_content_element=this.dom_element,"content"in this.attrs){var t=/\[[^\]]*\]([^\[]*)\[\/[^\]]*\]/.exec(this.attrs.content)
t&&e(this.dom_element).append(t[1])}et.baseclass.prototype.render.apply(this,arguments)}}),!("azexo_baseurl"in window))if(e('script[src*="azexo_composer.js"]').length>0){var Jt=e('script[src*="azexo_composer.js"]').attr("src")
window.azexo_baseurl=Jt.slice(0,Jt.indexOf("azexo_composer.js"))}else if(e('script[src*="azexo_composer.min.js"]').length>0){var Jt=e('script[src*="azexo_composer.min.js"]').attr("src")
window.azexo_baseurl=Jt.slice(0,Jt.indexOf("azexo_composer.min.js"))}"azexo_online"in window||(window.azexo_online="http:"==window.location.protocol||"https:"==window.location.protocol),s=new G,"azexo_editor"in window||(window.azexo_editor=!1),nt(),at(function(){it(),e.holdReady(!1)})
var Vt=!1
...
var o=null
e(a).find("> .az-container[data-az-type][data-az-name]").length>0?o=e(a).children().insertAfter(t):(o=e('<div class="az-element az-container" data-az-type="textarea" data-az-name="'+Math.random().toString(36).substr(2)+'"></div>').insertAfter(t),o.append(e(a).html())),window.azexo_title["Save container"]=p("Generate HTML and JS for all elements which placed in current container element.")
var n=ot(o)
e(t).data("azexo_composer",n),n.save_container=function(){azexo_add_js({path:"js/json2.min.js",loaded:"JSON"in window,callback:function(){_.defer(function(){if(n.id in s.elements_instances){var a=n.attrs.container.split("/")[1],o=n.get_container_html()
e(t).val('<div class="az-element az-container" data-az-type="textarea" data-az-name="'+a+'">'+o+"</div>")}})}})},s.attachEvent("add_element",n.save_container),s.attachEvent("edited_element",n.save_container),s.attachEvent("update_element",n.save_container),s.attachEvent("delete_element",n.save_container),s.attachEvent("update_sorting",n.save_container)}})},show:function(){this.each(function(){})},hide:function(){this.each(function(){var t=e(this).data("azexo_composer")
...
var Xt={none:p("No animation"),bounce:p("bounce"),flash:p("flash"),pulse:p("pulse"),rubberBand:p("rubberBand"),shake:p("shake"),swing:p("swing"),tada:p("tada"),wobble:p("wobble"),bounceIn:p("bounceIn"),bounceInDown:p("bounceInDown"),bounceInLeft:p("bounceInLeft"),bounceInRight:p("bounceInRight"),bounceInUp:p("bounceInUp"),bounceOut:p("bounceOut"),bounceOutDown:p("bounceOutDown"),bounceOutLeft:p("bounceOutLeft"),bounceOutRight:p("bounceOutRight"),bounceOutUp:p("bounceOutUp"),fadeIn:p("fadeIn"),fadeInDown:p("fadeInDown"),fadeInDownBig:p("fadeInDownBig"),fadeInLeft:p("fadeInLeft"),fadeInLeftBig:p("fadeInLeftBig"),fadeInRight:p("fadeInRight"),fadeInRightBig:p("fadeInRightBig"),fadeInUp:p("fadeInUp"),fadeInUpBig:p("fadeInUpBig"),fadeOut:p("fadeOut"),fadeOutDown:p("fadeOutDown"),fadeOutDownBig:p("fadeOutDownBig"),fadeOutLeft:p("fadeOutLeft"),fadeOutLeftBig:p("fadeOutLeftBig"),fadeOutRight:p("fadeOutRight"),fadeOutRightBig:p("fadeOutRightBig"),fadeOutUp:p("fadeOutUp"),fadeOutUpBig:p("fadeOutUpBig"),flip:p("flip"),flipInX:p("flipInX"),flipInY:p("flipInY"),flipOutX:p("flipOutX"),flipOutY:p("flipOutY"),lightSpeedIn:p("lightSpeedIn"),lightSpeedOut:p("lightSpeedOut"),rotateIn:p("rotateIn"),rotateInDownLeft:p("rotateInDownLeft"),rotateInDownRight:p("rotateInDownRight"),rotateInUpLeft:p("rotateInUpLeft"),rotateInUpRight:p("rotateInUpRight"),rotateOut:p("rotateOut"),rotateOutDownLeft:p("rotateOutDownLeft"),rotateOutDownRight:p("rotateOutDownRight"),rotateOutUpLeft:p("rotateOutUpLeft"),rotateOutUpRight:p("rotateOutUpRight"),slideInDown:p("slideInDown"),slideInLeft:p("slideInLeft"),slideInRight:p("slideInRight"),slideOutLeft:p("slideOutLeft"),slideOutRight:p("slideOutRight"),slideOutUp:p("slideOutUp"),slideInUp:p("slideInUp"),slideOutDown:p("slideOutDown"),hinge:p("hinge"),rollIn:p("rollIn"),rollOut:p("rollOut"),zoomIn:p("zoomIn"),zoomInDown:p("zoomInDown"),zoomInLeft:p("zoomInLeft"),zoomInRight:p("zoomInRight"),zoomInUp:p("zoomInUp"),zoomOut:p("zoomOut"),zoomOutDown:p("zoomOutDown"),zoomOutLeft:p("zoomOutLeft"),zoomOutRight:p("zoomOutRight"),zoomOutUp:p("zoomOutUp")}
P(st,K),D(st.prototype,{params:[J({type:"dropdown",heading:p("Animation start"),param_name:"an_start",tab:p("Animation"),value:{"":p("No animation"),appear:p("On appear"),hover:p("On hover"),click:p("On click"),trigger:p("On trigger")}}),J({type:"dropdown",heading:p("Animation in"),param_name:"an_in",tab:p("Animation"),value:Xt,dependency:{element:"an_start",value:["appear","hover","click","trigger"]}}),J({type:"dropdown",heading:p("Animation out"),param_name:"an_out",tab:p("Animation"),value:Xt,dependency:{element:"an_start",value:["hover","trigger"]}}),J({type:"checkbox",heading:p("Hidden"),param_name:"an_hidden",tab:p("Animation"),value:{before_in:p("Before in-animation"),after_in:p("After in-animation")},dependency:{element:"an_start",value:["appear","hover","click","trigger"]}}),J({type:"checkbox",heading:p("Infinite?"),param_name:"an_infinite",tab:p("Animation"),value:{yes:p("Yes, please")},dependency:{element:"an_start",value:["appear","hover","click","trigger"]}}),J({type:"integer_slider",heading:p("Duration"),param_name:"an_duration",tab:p("Animation"),max:"3000",description:p("In milliseconds."),value:"1000",dependency:{element:"an_start",value:["appear","hover","click","trigger"]}}),J({type:"integer_slider",heading:p("In-delay"),param_name:"an_in_delay",tab:p("Animation"),max:"10000",description:p("In milliseconds."),value:"0",dependency:{element:"an_start",value:["appear","hover","click","trigger"]}}),J({type:"integer_slider",heading:p("Out-delay"),param_name:"an_out_delay",tab:p("Animation"),max:"10000",description:p("In milliseconds."),value:"0",dependency:{element:"an_start",value:["hover","trigger"]}}),J({type:"integer_slider",heading:p("Parent number"),param_name:"an_parent",tab:p("Animation"),max:"10",min:"0",description:p("Define the number of Parent Containers the animation should attempt to break away from."),value:"1",dependency:{element:"an_start",value:["hover","click"]}}),J({type:"dropdown",heading:p("Animation fill mode"),param_name:"an_fill_mode",tab:p("Animation"),value:{"":p("Default"),forwards:p("Forwards"),backwards:p("Backwards"),both:p("Both"),none:p("None")},description:p('"FORWARDS" - after the animation ends (determined by animation-iteration-count), the animation will apply the property values for the time the animation ended; "BACKWARDS" - The animation will apply the property values defined in the keyframe that will start the first iteration of the animation, during the period defined by animation-delay. These are either the values of the from keyframe (when animation-direction is "normal" or "alternate") or those of the to keyframe (when animation-direction is "reverse" or "alternate-reverse"); "BOTH" - the animation will follow the rules for both forwards and backwards. That is, it will extend the animation properties in both directions; "NONE" - The animation will not apply any styles to the target before or after it is executing.'),dependency:{element:"an_start",value:["appear","hover","click","trigger"]}}),J({type:"textfield",heading:p("Name for animations"),param_name:"an_name",hidden:!0}),J({type:"textfield",heading:p("Animation scenes"),param_name:"an_scenes",hidden:!0})].concat(st.prototype.params),set_in_timeout:function(){var t=this
t.in_timeout=setTimeout(function(){e(t.dom_element).css("opacity",""),e(t.dom_element).removeClass("animated"),e(t.dom_element).removeClass(t.attrs.an_in),e(t.dom_element).removeClass(t.attrs.an_out),e(t.dom_element).css("animation-duration",t.attrs.an_duration+"ms"),e(t.dom_element).css("-webkit-animation-duration",t.attrs.an_duration+"ms"),e(t.dom_element).css("animation-fill-mode",t.attrs.an_fill_mode),e(t.dom_element).css("-webkit-animation-fill-mode",t.attrs.an_fill_mode),e(t.dom_element).addClass("animated"),"yes"==t.attrs.an_infinite&&e(t.dom_element).addClass("infinite"),e(t.dom_element).addClass(t.attrs.an_in)},Math.round(t.attrs.an_in_delay))},start_in_animation:function(){var t=this
0==e(t.dom_element).parents(".azexo-animations-disabled").length&&"none"!=t.attrs.an_in&&""!=t.attrs.an_in&&(t.out_timeout>0?e(t.dom_element).hasClass("animated")?(t.clear_animation(),t.set_in_timeout()):(clearTimeout(t.out_timeout),t.hidden_after_in||t.set_in_timeout()):t.set_in_timeout())},set_out_timeout:function(){var t=this
t.out_timeout=setTimeout(function(){e(t.dom_element).css("opacity",""),e(t.dom_element).removeClass("animated"),e(t.dom_element).removeClass(t.attrs.an_in),e(t.dom_element).removeClass(t.attrs.an_out),e(t.dom_element).css("animation-duration",t.attrs.an_duration+"ms"),e(t.dom_element).css("-webkit-animation-duration",t.attrs.an_duration+"ms"),e(t.dom_element).css("animation-fill-mode",t.attrs.an_fill_mode),e(t.dom_element).css("-webkit-animation-fill-mode",t.attrs.an_fill_mode),e(t.dom_element).addClass("animated"),"yes"==t.attrs.an_infinite&&e(t.dom_element).addClass("infinite"),e(t.dom_element).addClass(t.attrs.an_out)},Math.round(t.attrs.an_out_delay))},start_out_animation:function(){var t=this
0==e(t.dom_element).parents(".azexo-animations-disabled").length&&"none"!=t.attrs.an_out&&""!=t.attrs.an_out&&(t.in_timeout>0?e(t.dom_element).hasClass("animated")?(t.clear_animation(),t.set_out_timeout()):(clearTimeout(t.in_timeout),t.hidden_before_in||t.set_out_timeout()):t.set_out_timeout())},clear_animation:function(){e(this.dom_element).hasClass(this.attrs.an_in)&&(this.inned=!0,this.hidden_before_in&&e(this.dom_element).css("opacity","1"),this.hidden_after_in&&e(this.dom_element).css("opacity","0")),e(this.dom_element).hasClass(this.attrs.an_out)&&(this.inned=!1,this.hidden_before_in&&e(this.dom_element).css("opacity","0"),this.hidden_after_in&&e(this.dom_element).css("opacity","1")),e(this.dom_element).css("animation-duration",""),e(this.dom_element).css("-webkit-animation-duration",""),e(this.dom_element).css("animation-fill-mode",""),e(this.dom_element).css("-webkit-animation-fill-mode",""),e(this.dom_element).removeClass("animated"),e(this.dom_element).removeClass("infinite"),""==this.attrs.an_fill_mode&&(e(this.dom_element).removeClass(this.attrs.an_in),e(this.dom_element).removeClass(this.attrs.an_out))},end_animation:function(){this.in_timeout=0,this.out_timeout=0,e(this.dom_element).hasClass(this.attrs.an_in)&&("hover"!=this.attrs.an_start||this.hover||this.start_out_animation()),e(this.dom_element).hasClass(this.attrs.an_out)&&("hover"==this.attrs.an_start&&this.hover&&this.start_in_animation(),this.clear_animation())},trigger_start_in_animation:function(){if("trigger"==this.attrs.an_start)this.start_in_animation()
...
else for(var e=0;e<this.children.length;e++)"trigger_start_out_animation"in this.children[e]&&this.children[e].trigger_start_out_animation()},css_animation:function(){var t=this
e(t.dom_element).on("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",function(){t.end_animation()}),t.hidden_before_in=_.indexOf(t.attrs.an_hidden.split(","),"before_in")>=0,t.hidden_after_in=_.indexOf(t.attrs.an_hidden.split(","),"after_in")>=0,t.hidden_before_in&&e(t.dom_element).css("opacity","0"),t.hidden_after_in&&e(t.dom_element).css("opacity","1")
var n=t.attrs.an_parent
""==n&&(n=1),n=Math.round(n)
for(var a=0,o=e(t.dom_element);n>a;)o=e(o).parent().closest("[data-az-id]"),a++
this.add_css("animate.css/animate.min.css",!1,function(){switch(t.attrs.an_start){case"click":e(o).click(function(){e(t.dom_element).hasClass("animated")||t.start_in_animation()})
break
case"appear":t.add_js({path:"jquery-waypoints/waypoints.min.js",loaded:"waypoint"in e.fn,callback:function(){e(t.dom_element).waypoint(function(){e(t.dom_element).hasClass("animated")||t.start_in_animation()},{offset:"100%",triggerOnce:!0}),e(document).trigger("scroll")}})
break
case"hover":t.inned=!1,e(o).on("mouseenter",function(){t.hover=!0,t.start_in_animation()}),e(o).on("mouseleave",function(){t.hover=!1,t.start_out_animation()})
break
case"trigger":}})},show_controls:function(){var t=this
window.azexo_editor&&(st.baseclass.prototype.show_controls.apply(this,arguments),e('<button title="'+c("Scroll animation")+'" class="control scroll-animation '+n+"btn "+n+"btn-warning "+n+"glyphicon "+n+'glyphicon-sort"> </button>').appendTo(this.controls).click(function(){e("#az-scroll-animation-modal").remove()
var o='<div class="'+n+'modal-header"><button type="button" class="'+n+'close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="'+n+'modal-title">'+p("Scroll animation settings")+"</h4></div>",i='<div class="'+n+'modal-footer"><button type="button" class="'+n+"btn "+n+'btn-default" data-dismiss="modal">'+p("Close")+'</button><button type="button" class="save '+n+"btn "+n+'btn-primary">'+p("Save changes")+"</button></div>",r=e('<div id="az-scroll-animation-modal" class="'+n+'modal azexo"><div class="'+n+"modal-dialog "+n+'modal-lg"><div class="'+n+'modal-content">'+o+'<div class="'+n+'modal-body"></div>'+i+"</div></div></div>").prependTo("body"),l=e('<div id="az-scroll-animation-tabs"><ul class="'+n+"nav "+n+'nav-tabs"><li><a href="#script" data-toggle="tab">'+p("Script")+'</a></li><li><a href="#wizards" data-toggle="tab">'+p("Wizards")+'</a></li></ul><div class="'+n+'tab-content"><div id="script" class="'+n+'tab-pane"></div><div id="wizards" class="'+n+'tab-pane"></div></div></div>')
e(r).find("."+n+"modal-body").append(l)
var d=e('<div id="az-scroll-animation-form" class="'+n+'clearfix"><div class="tree '+n+'col-sm-5"></div><div class="options '+n+'col-sm-7"></div></div>')
return e(l).find("#script").append(d),e('#az-scroll-animation-tabs a[href="#script"]')[a+"tab"]("show"),azexo_add_css("jstree/dist/themes/default/style.min.css",function(){}),e(d).find(".tree").append('<div class="'+n+'form-group an-name"><label>'+p("Name")+'</label><div><input class="'+n+'form-control" name="an_name" type="text" value="'+t.an_name+'" required ></div><p class="'+n+'help-block">'+p("Name to identify this element in scroll animations")+"</p></div>"),azexo_add_js({path:"jstree/dist/jstree.min.js",loaded:"jstree"in e.fn,callback:function(){function o(t){e(d).find(".options").empty(),e(d).find(".options").append('<div class="'+n+'form-group"><label>'+p("Time line")+'</label><div class="'+n+'radio"><label><input type="radio" name="time" value="scroll">'+p("Scroll position")+'</label></div><div class="'+n+'radio"><label><input type="radio" name="time" value="real">'+p("Real time")+"</label></div></div>"),e(d).find('.options [name="time"]').on("change",function(){"scroll"==e(this).val()?(e(d).find(".options ."+n+"form-group.duration").css("display","block"),e(d).find(".options ."+n+"form-group.repeat, .options ."+n+"form-group.repeatdelay").css("display","none"),g[t].duration=e(d).find('.options [name="duration"]').val(),x.jstree("edit",t,p("Scene")+":"+g[t].duration+"|"+g[t].offset+"|"+g[t].triggerHook)):(e(d).find(".options ."+n+"form-group.duration").css("display","none"),e(d).find(".options ."+n+"form-group.repeat, .options ."+n+"form-group.repeatdelay").css("display","block"),g[t].duration="0",x.jstree("edit",t,p("Scene")+":"+g[t].duration+"|"+g[t].offset+"|"+g[t].triggerHook))}),"0"==g[t].duration?e(d).find('.options [name="time"][value="real"]').attr("checked","checked"):e(d).find('.options [name="time"][value="scroll"]').attr("checked","checked"),e(d).find(".options").append('<div class="'+n+'form-group duration"><label>'+p("Duration")+'</label><div><input class="'+n+'form-control" name="duration" type="text" value="'+g[t].duration+'"></div><p class="'+n+'help-block">'+p("The duration of the scene in pixels")+"</p></div>"),e(d).find('.options [name="duration"]').on("change",function(){g[t].duration=e(this).val(),x.jstree("edit",t,p("Scene")+":"+g[t].duration+"|"+g[t].offset+"|"+g[t].triggerHook)}),e(d).find(".options").append('<div class="'+n+'form-group offset"><label>'+p("Offset")+'</label><div><input class="'+n+'form-control" name="offset" type="text" value="'+g[t].offset+'"></div><p class="'+n+'help-block">'+p("Offset Value (in pixels) for the Trigger Position.")+"</p></div>"),e(d).find('.options [name="offset"]').on("change",function(){g[t].offset=e(this).val(),x.jstree("edit",t,p("Scene")+":"+g[t].duration+"|"+g[t].offset+"|"+g[t].triggerHook)}),"0"==g[t].duration&&e(d).find(".options ."+n+"form-group.duration").css("display","none"),e(d).find(".options").append('<div class="'+n+'form-group repeat"><label>'+p("Repeat")+'</label><div class="'+n+'checkbox"><label><input type="checkbox" name="indefinite"> '+p("repeat indefinitely")+'</label></div><div><input class="'+n+'form-control" name="repeat" type="text" value="'+g[t].repeat+'"></div><p class="'+n+'help-block">'+p("Number of times that the timeline should repeat after its first iteration")+"</p></div>"),e(d).find('.options [name="repeat"]').on("change",function(){g[t].repeat=e(this).val()}),e(d).find('.options [name="indefinite"]').on("change",function(){e(this).prop("checked")?(g[t].repeat="-1",e(d).find(".options ."+n+"form-group.repeat ."+n+"form-control").css("display","none")):(g[t].repeat=e(d).find('.options [name="repeat"]').val(),g[t].repeat<0&&(e(d).find('.options [name="repeat"]').val("0"),g[t].repeat=0),e(d).find(".options ."+n+"form-group.repeat ."+n+"form-control").css("display","block"))}),"-1"==g[t].repeat?(e(d).find('.options [name="indefinite"]').attr("checked","checked"),e(d).find(".options ."+n+"form-group.repeat ."+n+"form-control").css("display","none")):e(d).find(".options ."+n+"form-group.repeat ."+n+"form-control").css("display","block"),e(d).find(".options").append('<div class="'+n+'form-group repeatdelay"><label>'+p("Repeat delay")+'</label><div><input class="'+n+'form-control" name="repeatDelay" type="text" value="'+g[t].repeatDelay+'"></div><p class="'+n+'help-block">'+p("Amount of time in seconds between repeats.")+"</p></div>"),e(d).find('.options [name="repeatDelay"]').on("change",function(){g[t].repeatDelay=e(this).val()}),"0"!=g[t].duration&&(e(d).find(".options ."+n+"form-group.repeat").css("display","none"),e(d).find(".options ."+n+"form-group.repeatdelay").css("display","none"))
var a=["onEnter","onCenter","onLeave"]
a=_.object(a,a),e(d).find(".options").append('<div class="'+n+'form-group"><label>'+p("Trigger hook")+"</label><div>"+H(a,"trigger-hook",g[t].triggerHook)+'</div><p class="'+n+'help-block">'+p("Trigger hook")+"</p></div>"),e(d).find('.options [name="trigger-hook"]').on("change",function(){g[t].triggerHook=e(this).val(),x.jstree("edit",t,p("Scene")+":"+g[t].duration+"|"+g[t].offset+"|"+g[t].triggerHook)}),e(d).find(".options").append('<div class="'+n+'form-group"><label>'+p("Pin")+"</label><div>"+H(_.object(_.keys(s.elements_instances_by_an_name),_.keys(s.elements_instances_by_an_name)),"pin",g[t].pin)+'</div><p class="'+n+'help-block">'+p("Pin element")+"</p></div>"),e(d).find('.options [name="pin"]').on("change",function(){g[t].pin=e(this).val()})}function i(e){var n=x.jstree("create_node","#",{type:"scene",text:p("Scene")+":"+e+"|0|0.5",state:{opened:!0}},"last")
t.an_scenes.push({duration:e,offset:0,triggerHook:"onCenter",timeline:[],repeat:"0",repeatDelay:"0"}),g[n]=t.an_scenes[t.an_scenes.length-1],y[n]="scene",m(n)}function r(){e(d).find(".options").empty()}function m(e){var t=x.jstree("get_children_dom",e).length,n=x.jstree("create_node",e,{type:"step",text:p("Step")+":"+t,state:{opened:!0}},"last")
g[e].timeline.push({tweens:[]}),g[n]=g[e].timeline[g[e].timeline.length-1],y[n]="step",b[n]=e,u(n)}function h(t){function a(t,a,o){function i(t,i,l){function d(){var t=e(h).find('[name="'+p+'"]').val()
""!=i&&i!=t&&delete a[o][i]
var n=e(h).find('[name="'+m+'"]').val()
""!=t&&(i=t,_.isObject(a[o])||(a[o]={}),a[o][t]=n)}var p="property"+s,m="property"+s+"value",h=e('<div class="row"><div class="select '+n+'col-xs-5">'+H(r,p,i)+'</div><div class="value '+n+'col-xs-5"><input class="'+n+'form-control" name="'+m+'" type="text" value="'+l+'"></div><div class="remove '+n+'col-xs-2"><button title="'+c("Remove")+'" type="button" class="control remove '+n+"btn "+n+"btn-danger "+n+"glyphicon "+n+'glyphicon-remove"> </button></div></div>').appendTo(t)
...
e('<button title="'+c("Add property")+'" class="add-property '+n+"btn "+n+'btn-default">'+p("Add property")+"</button>").appendTo(e(l).find(".add-property")).click(function(){i(e(l).find(".properties"),"","")})}var o=b[b[t]]
e(d).find(".options").empty(),e(d).find(".options").append('<div class="'+n+'form-group"><label>'+p("Target")+"</label><div>"+H(_.object(_.keys(s.elements_instances_by_an_name),_.keys(s.elements_instances_by_an_name)),"target",g[t].target)+'</div><p class="'+n+'help-block">'+p("Target element")+"</p></div>"),e(d).find('.options [name="target"]').on("change",function(){g[t].target=e(this).val(),x.jstree("edit",t,p("Tween")+":"+g[t].target+"|"+g[t].duration)}),e(d).find(".options").append('<div class="'+n+'form-group duration"><label>'+p("Duration")+'</label><div><input class="'+n+'form-control" name="duration" type="text" value="'+g[t].duration+'"></div><p class="'+n+'help-block">'+p("Duration of the tween in seconds.")+"</p></div>"),e(d).find('.options [name="duration"]').on("change",function(){g[t].duration=e(this).val(),x.jstree("edit",t,p("Tween")+":"+g[t].target+"|"+g[t].duration)}),e(d).find(".options").append('<div class="'+n+'form-group"><label>'+p("From")+'</label><div class="from"></div><p class="'+n+'help-block">'+p("From")+"</p></div>"),a(e(d).find(".options .from"),g[t].from,"css"),e(d).find(".options").append('<div class="'+n+'form-group"><label>'+p("To")+'</label><div class="to"></div><p class="'+n+'help-block">'+p("To")+"</p></div>"),a(e(d).find(".options .to"),g[t].to,"css")
for(var i=["Linear","Power0","Power1","Power2","Power3","Power4","Quad","Cubic","Quart","Quint","Strong","Elastic","Back","Bounce","SlowMo","SteppedEase","Circ","Expo","Sine"],r=[],l=0;l<i.length;l++)r.push(i[l]+".easeNone"),r.push(i[l]+".easeIn"),r.push(i[l]+".easeOut"),r.push(i[l]+".easeInOut")
r=_.object(r,r),e(d).find(".options").append('<div class="'+n+'form-group"><label>'+p("Ease")+"</label><div>"+H(r,"ease",g[t].ease)+'</div><p class="'+n+'help-block">'+p("Ease")+"</p></div>"),e(d).find('.options [name="ease"]').on("change",function(){g[t].ease=e(this).val()}),e(d).find('.options [name="ease"]').chosen({search_contains:!0}),e(d).find(".options").append('<div class="'+n+'form-group delay"><label>'+p("Delay")+'</label><div><input class="'+n+'form-control" name="delay" type="text" value="'+g[t].delay+'"></div><p class="'+n+'help-block">'+p("Amount of delay in seconds before the tween should begin.")+"</p></div>"),e(d).find('.options [name="delay"]').on("change",function(){g[t].delay=e(this).val()}),"0"!=g[o].duration&&(e(d).find(".options ."+n+"form-group.duration").css("display","none"),e(d).find(".options ."+n+"form-group.delay").css("display","none"))}function u(e){var t=x.jstree("create_node",e,{type:"tween",text:p("Tween")+":|1",state:{opened:!0}},"last")
g[e].tweens.push({target:"",duration:1,from:{},to:{},ease:"Linear.easeNone",delay:"0"}),g[t]=g[e].tweens[g[e].tweens.length-1],y[t]="tween",b[t]=e}function f(e){switch(y[e]){case"scene":var n=t.an_scenes.indexOf(g[e])
if(n>-1)return[n]
break
case"step":var n=t.an_scenes.indexOf(g[b[e]])
if(n>-1){var a=t.an_scenes[n].timeline.indexOf(g[e])
if(a>-1)return[n,a]}break
case"tween":var n=t.an_scenes.indexOf(g[b[b[e]]])
if(n>-1){var a=t.an_scenes[n].timeline.indexOf(g[b[e]])
if(a>-1){var o=t.an_scenes[n].timeline[a].tweens.indexOf(g[e])
if(o>-1)return[n,a,o]}}}return!1}function v(){for(var e=0;e<t.an_scenes.length;e++){var n=x.jstree("create_node","#",{type:"scene",text:p("Scene")+":"+t.an_scenes[e].duration+"|"+t.an_scenes[e].offset+"|"+t.an_scenes[e].triggerHook,state:{opened:!0}},"last")
g[n]=t.an_scenes[e],y[n]="scene"
for(var a=0;a<t.an_scenes[e].timeline.length;a++){var o=x.jstree("create_node",n,{type:"step",text:p("Step")+":"+a,state:{opened:!0}},"last")
g[o]=t.an_scenes[e].timeline[a],y[o]="step",b[o]=n
for(var i=0;i<t.an_scenes[e].timeline[a].tweens.length;i++){var s=x.jstree("create_node",o,{type:"tween",text:p("Tween")+":"+t.an_scenes[e].timeline[a].tweens[i].target+"|"+t.an_scenes[e].timeline[a].tweens[i].duration,state:{opened:!0}},"last")
g[s]=t.an_scenes[e].timeline[a].tweens[i],y[s]="tween",b[s]=o}}}}var g={},y={},b={},w=e('<div class="'+n+"btn-group "+n+'btn-group-xs"></div>').appendTo(e(d).find(".tree"))
e('<button title="'+c("Add scene")+'" class="add-scene '+n+"btn "+n+'btn-default">'+p("Add scene")+"</button>").appendTo(w).click(function(){var e=window.prompt(p("Enter duration of new scene:"),100)
""!=e&&null!=e&&i(e)}),e('<button title="'+c("Add timeline step")+'" class="add-step '+n+"btn "+n+'btn-default" disabled>'+p("Add step")+"</button>").appendTo(w).click(function(){var e=x.jstree("get_selected")
m(e[0])}),e('<button title="'+c("Add tween")+'" class="add-tween '+n+"btn "+n+'btn-default" disabled>'+p("Add tween")+"</button>").appendTo(w).click(function(){var e=x.jstree("get_selected")
u(e[0])}),e('<button title="'+c("Delete")+'" class="delete '+n+"btn "+n+'btn-default">'+p("Delete")+"</button>").appendTo(w).click(function(){var e=x.jstree("get_selected")
e.length>0&&x.jstree("delete_node",e[0])})
var x=e('<div id="jstree"></div>').appendTo(e(d).find(".tree")).jstree({core:{check_callback:function(){return!0},multiple:!1,animation:0},types:{"#":{valid_children:["scene"]},scene:{icon:n+"glyphicon "+n+"glyphicon-play",valid_children:["step"]},step:{icon:n+"glyphicon "+n+"glyphicon-step-forward",valid_children:["tween"]},tween:{icon:n+"glyphicon "+n+"glyphicon-leaf",valid_children:[]}},plugins:["dnd","types"]}).on("changed.jstree",function(t,n){for(var a=0;a<n.selected.length;a++){var i=n.instance.get_node(n.selected[a]).id
switch(y[i]){case"scene":e(w).find(".add-step").removeAttr("disabled"),e(w).find(".add-tween").attr("disabled","disabled"),o(i)
break
case"step":e(w).find(".add-step").attr("disabled","disabled"),e(w).find(".add-tween").removeAttr("disabled"),r(i)
break
case"tween":e(w).find(".add-step").attr("disabled","disabled"),e(w).find(".add-tween").attr("disabled","disabled"),h(i)
break
default:e(w).find(".add-step").attr("disabled","disabled"),e(w).find(".add-tween").attr("disabled","disabled")}}}).on("delete_node.jstree",function(e,n){var a=(n.node.id,f(n.node.id))
switch(a.length){case 1:t.an_scenes.splice(a[0],1)
break
case 2:t.an_scenes[a[0]].timeline.splice(a[1],1)
break
case 3:t.an_scenes[a[0]].timeline[a[1]].tweens.splice(a[2],1)}}).on("move_node.jstree",function(e,n){var a=f(n.node.id)
...
e("#jstree .jstree-node").each(function(){x.jstree("delete_node",e(this).attr("id"))}),t.an_scenes=u,v(),e('#az-scroll-animation-tabs a[href="#script"]')[a+"tab"]("show")}else e(l).find("#wizard-form").prepend(W(p("Animated target element must be child of the current element.")))})}})}}),e("#az-scroll-animation-modal").find(".save").click(function(){return e(d).find('.tree [name="an_name"]'),""==e(d).find('.tree [name="an_name"]').val()?(e(d).find(".tree .an-name").addClass("has-error"),!1):(azexo_add_js({path:"js/json2.min.js",loaded:"JSON"in window,callback:function(){t.an_name=e(d).find('.tree [name="an_name"]').val(),""!=t.an_name&&(t.attrs.an_name=t.an_name,s.elements_instances_by_an_name[t.an_name]=t,e(t.dom_element).attr("data-an-name",t.an_name)),t.attrs.an_scenes=btoa(encodeURIComponent(JSON.stringify(t.an_scenes))),t.update_scroll_animation()}}),e("#az-scroll-animation-modal")[a+"modal"]("hide"),s.raiseEvent("edited_element",t.id),!1)}),e("#az-scroll-animation-modal")[a+"modal"]("show"),!1}))},update_scroll_animation:function(){var t=this
...
if(t.scroll_magic_scenes=[],0==e(t.dom_element).parents(".azexo-animations-disabled").length)for(var a=0;a<t.an_scenes.length;a++){var n={triggerElement:'[data-az-id="'+t.id+'"]',duration:t.an_scenes[a].duration,offset:t.an_scenes[a].offset,triggerHook:t.an_scenes[a].triggerHook},o=new ScrollScene(n).addTo(r)
...
var n={}
"0"==t.an_scenes[a].duration&&(n={repeat:parseInt(t.an_scenes[a].repeat),repeatDelay:parseFloat(t.an_scenes[a].repeatDelay)})
for(var i=new TimelineMax(n),s=0;s<t.an_scenes[a].timeline.length;s++){for(var l=[],d=0;d<t.an_scenes[a].timeline[s].tweens.length;d++){var c='[data-an-name="'+t.an_scenes[a].timeline[s].tweens[d].target+'"]',p=_.keys(t.an_scenes[a].timeline[s].tweens[d].from),m=_.keys(t.an_scenes[a].timeline[s].tweens[d].to)
if(0==p.length&&m.length>0){var h=t.an_scenes[a].timeline[s].tweens[d].to
h.ease=t.an_scenes[a].timeline[s].tweens[d].ease,h.delay=parseFloat(t.an_scenes[a].timeline[s].tweens[d].delay),l.push(TweenMax.to(c,t.an_scenes[a].timeline[s].tweens[d].duration,h))}if(p.length>0&&0==m.length){var u=t.an_scenes[a].timeline[s].tweens[d].from
u.ease=t.an_scenes[a].timeline[s].tweens[d].ease,u.delay=parseFloat(t.an_scenes[a].timeline[s].tweens[d].delay),l.push(TweenMax.from(c,t.an_scenes[a].timeline[s].tweens[d].duration,u))}if(p.length>0&&m.length>0){var u=t.an_scenes[a].timeline[s].tweens[d].from
u.ease=t.an_scenes[a].timeline[s].tweens[d].ease,u.delay=t.an_scenes[a].timeline[s].tweens[d].delay
var h=t.an_scenes[a].timeline[s].tweens[d].to
h.ease=t.an_scenes[a].timeline[s].tweens[d].ease,h.delay=parseFloat(t.an_scenes[a].timeline[s].tweens[d].delay),l.push(TweenMax.fromTo(c,t.an_scenes[a].timeline[s].tweens[d].duration,u,h))}}i.add(l)}o.setTween(i)}}})},showed:function(e){st.baseclass.prototype.showed.apply(this,arguments),this.an_scenes=[],"an_scenes"in this.attrs&&""!=this.attrs.an_scenes&&(this.an_scenes=e.parseJSON(decodeURIComponent(atob(this.attrs.an_scenes))),this.update_scroll_animation()),"an_start"in this.attrs&&""!=this.attrs.an_start&&"no"!=this.attrs.an_start&&this.css_animation()},render:function(e){this.an_name="","an_name"in this.attrs&&""!=this.attrs.an_name&&(this.an_name=this.attrs.an_name,s.elements_instances_by_an_name[this.an_name]=this,e(this.dom_element).attr("data-an-name",this.an_name)),st.baseclass.prototype.render.apply(this,arguments)}}),rt("az_row",!0,lt),D(lt.prototype,{name:p("Row"),icon:"fa fa-table",description:p("One row to implement a table layout with responsive ability. You can choose number of columns and thier widths. Used by default."),category:p("Layout"),params:[J({type:"dropdown",heading:p("Device"),param_name:"device",value:{xs:p("Extra small devices Phones (<768px)"),sm:p("Small devices Tablets (≥768px)"),md:p("Medium devices Desktops (≥992px)"),lg:p("Large devices Desktops (≥1200px)")},description:p("Bootstrap responsive grid system")}),J({type:"dropdown",heading:p("Background Effect"),param_name:"effect",tab:p("Background Effects"),value:{"":p("Simple Image"),fixed:p("Fixed Image"),parallax:p("Parallax Image"),youtube:p("YouTube Video")},description:p("Select the effect you want to apply to the row background.")}),J({type:"integer_slider",heading:p("Parallax speed"),param_name:"parallax_speed",tab:p("Background Effects"),value:20,dependency:{element:"effect",value:["parallax"]}}),J({type:"checkbox",heading:p("Video Play Options"),param_name:"video_options",tab:p("Background Effects"),description:p("Select options for the video."),value:{loop:p("Loop"),mute:p("Muted")},dependency:{element:"effect",value:["youtube"]}}),J({type:"textfield",heading:p("YouTube Video URL"),param_name:"video_youtube",tab:p("Background Effects"),description:p("Enter the YouTube video URL."),dependency:{element:"effect",value:["youtube"]}}),J({type:"textfield",heading:p("Start Time in seconds"),param_name:"video_start",tab:p("Background Effects"),description:p("Enter time in seconds from where video start to play."),value:"0",dependency:{element:"effect",value:["youtube"]}}),J({type:"textfield",heading:p("Stop Time in seconds"),param_name:"video_stop",tab:p("Background Effects"),description:p("Enter time in seconds where video ends."),value:"0",dependency:{element:"effect",value:["youtube"]}})].concat(lt.prototype.params),is_container:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},show_controls:function(){if(window.azexo_editor){lt.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".add").remove(),e(this.controls).find(".paste").remove()
...
s.attachEvent("add_element",function(t,a){var o=s.get_element(a.id),i=n.get_item(o)
null!=i&&(i.parent.linked_elements_index[o.id]=o),(o.parent.id in n.linked_elements_index||"az_item"==o.base)&&("element_adding"in n||(n.element_adding=!0,n.add_control(o),a.parse&&"az_column"!=o.base||o.synchronize(),e(o.parent.dom_content_element).hasClass("ui-sortable")&&o.id!=i.id&&e(o.parent.dom_content_element).sortable("option","containment",i.dom_content_element),delete n.element_adding))}),s.attachEvent("edited_element",function(e,n){t(!0,n)}),s.attachEvent("update_element",function(e,n){t(!1,n)}),s.attachEvent("delete_element",function(e,t){var a=s.get_element(t),o=n.get_item(a)
...
delete o.parent.linked_elements_index[a.id],delete n.element_deleting}}),s.attachEvent("update_sorting",function(t,a){var o=e(a.item).closest("[data-az-id]").attr("data-az-id")
...
if(e.length==a.children.length)for(var n=K.prototype.tags[this.base],o=this.get_child_position(),t=0;t<e.length;t++)if(e[t].id!=this.parent.id){var i=e[t],s=new n(i,!0)
...
""!=this.parent.attrs.type&&(n=this.parent.attrs.type),this.dom_element=e('<div class="az-element az-toggle '+t+"panel "+n+" "+this.attrs.el_class+'" style="'+this.attrs.style+'"><div class="'+t+'panel-heading"><h4 class="'+t+'panel-title"><a data-toggle="collapse" data-parent="#'+this.parent.id+'" href="#'+this.id+'">'+this.attrs.title+'</a></h4></div><div id="'+this.id+'" class="'+t+"panel-collapse "+t+'collapse"><div class="'+t+'panel-body az-ctnr"></div></div></div>'),this.dom_content_element=e(this.dom_element).find("."+t+"panel-body"),ft.baseclass.prototype.render.apply(this,arguments)}}),rt("az_carousel",!0,vt),D(vt.prototype,{name:p("Carousel"),icon:"fa fa-ellipsis-h",description:p("Content carousel. Every slide of this element can contain any number of any types of elements. It can be used for create classic content slider."),category:p("Layout"),params:[J({type:"integer_slider",heading:p("Number items"),param_name:"items",min:"1",max:"10",value:"1"}),J({type:"checkbox",heading:p("Options"),param_name:"options",value:{navigation:p("Navigation"),auto_play:p("Auto play"),mouse:p("Mouse drag"),touch:p("Touch drag")}}),J({type:"dropdown",heading:p("Transition style"),param_name:"transition",value:{"":p("Default"),fade:p("fade"),backSlide:p("backSlide"),goDown:p("goDown"),fadeUp:p("fadeUp")}})].concat(vt.prototype.params),is_container:!0,show_settings_on_create:!0,frontend_render:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},show_controls:function(){if(window.azexo_editor){vt.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".add").remove(),e(this.controls).find(".paste").remove()
e('<button title="'+c("Add slide")+'" class="control add-toggle '+n+"btn "+n+"btn-primary "+n+"glyphicon "+n+'glyphicon-plus-sign" > </button>').appendTo(this.controls).click({object:this},this.click_add_slide)}},update_sortable:function(){},click_add_slide:function(e){return e.data.object.add_slide(),!1},add_slide:function(){var e=new gt(this,!0)
e.update_dom(),this.update_dom()},showed:function(e){vt.baseclass.prototype.showed.apply(this,arguments),this.add_css("owl.carousel/owl-carousel/owl.carousel.css","owlCarousel"in e.fn,function(){}),this.add_css("owl.carousel/owl-carousel/owl.theme.css","owlCarousel"in e.fn,function(){}),this.add_css("owl.carousel/owl-carousel/owl.transitions.css","owlCarousel"in e.fn,function(){})
var t=this
...
if(!_.isUndefined(l))for(var d=0;d<l.children.length;d++)"trigger_start_out_animation"in l.children[d]&&l.children[d].trigger_start_out_animation()}for(var o=0;o<a.length;o++)if(a[o]<n.length){var i=n[a[o]],r=e(i).attr("data-az-id"),l=s.get_element(r)
...
e(t.dom_content_element).owlCarousel({singleItem:"1"==t.attrs.items,items:t.attrs.items,navigation:_.indexOf(t.attrs.options.split(","),"navigation")>=0,autoPlay:_.indexOf(t.attrs.options.split(","),"auto_play")>=0,mouseDrag:_.indexOf(t.attrs.options.split(","),"mouse")>=0,touchDrag:_.indexOf(t.attrs.options.split(","),"touch")>=0,transitionStyle:""==t.attrs.transition?!1:t.attrs.transition,stopOnHover:!0,afterAction:function(){n(this.owl)},beforeMove:function(){},afterMove:function(){},startDragging:function(){}}),n(t.dom_content_element.data("owlCarousel"))}})},render:function(e){this.dom_element=e('<div id="'+this.id+'" class="az-element az-carousel '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=e("<div></div>").appendTo(this.dom_element),vt.baseclass.prototype.render.apply(this,arguments)}}),Z("az_slide",!0,gt),D(gt.prototype,{name:p("Slide"),params:[].concat(gt.prototype.params),hidden:!0,frontend_render:!0,is_container:!0,show_parent_controls:!0,get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p("Settings for this carousel element and for current slide. ")+'<span class="'+n+"glyphicon "+n+'glyphicon-plus-sign"></span>'+p(" - add a new slide.")+"</div></div>"},show_controls:function(){window.azexo_editor&&(gt.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".clone").remove(),e(this.controls).find(".drag-and-drop").remove(),e('<span class="control '+n+"btn "+n+"btn-primary "+n+'glyphicon">'+this.name+"</span>").prependTo(this.controls))},get_my_shortcode:function(){return this.get_children_shortcode()},edited:function(){gt.baseclass.prototype.edited.apply(this,arguments),this.parent.update_dom()},render:function(e){var t="panel-default"
""!=this.parent.attrs.type&&(t=this.parent.attrs.type),this.dom_element=e('<div class="az-element az-slide '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=this.dom_element,gt.baseclass.prototype.render.apply(this,arguments)}}),rt("az_presentation",!0,yt),D(yt.prototype,{name:p("Presentation"),icon:"fa fa-file-powerpoint-o",description:p("Content 3D-presentation. Every step of presentation can contain any number of any types of elements."),category:p("Layout"),params:[J({type:"integer_slider",heading:p("Perspective"),param_name:"perspective",min:"0",max:"10000",value:"1000"}),J({type:"integer_slider",heading:p("Transition duration"),param_name:"duration",min:"0",max:"10000",value:"1000"})].concat(yt.prototype.params),is_container:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},show_controls:function(){if(window.azexo_editor){vt.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".add").remove(),e(this.controls).find(".paste").remove()
e('<button title="'+c("Add step")+'" class="control add-toggle '+n+"btn "+n+"btn-primary "+n+"glyphicon "+n+'glyphicon-plus-sign" > </button>').appendTo(this.controls).click({object:this},this.click_add_step)}},click_add_step:function(e){return e.data.object.add_step(),!1},add_step:function(){var e=new bt(this,!0)
e.update_dom(),this.update_dom()},showed:function(e){yt.baseclass.prototype.showed.apply(this,arguments)
var t=this
this.add_js({path:"js/impress.js",loaded:"impress"in window,callback:function(){window.impress(t.id).init(),t.dom_element.get(0).addEventListener("impress:stepenter",function(t){var n=e(t.target).attr("data-az-id"),a=s.get_element(n)
if(!_.isUndefined(a))for(var o=0;o<a.children.length;o++)"trigger_start_out_animation"in a.children[o]&&a.children[o].trigger_start_in_animation()},!1),t.dom_element.get(0).addEventListener("impress:stepleave",function(t){var n=e(t.target).attr("data-az-id"),a=s.get_element(n)
if(!_.isUndefined(a))for(var o=0;o<a.children.length;o++)"trigger_start_in_animation"in a.children[o]&&a.children[o].trigger_start_out_animation()},!1)}})},render:function(e){this.dom_element=e('<div id="'+this.id+'" class="az-element az-presentation '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=this.dom_element,yt.baseclass.prototype.render.apply(this,arguments)}}),Z("az_step",!0,bt),D(bt.prototype,{name:p("Step"),params:[J({type:"integer_slider",heading:p("Width"),param_name:"width",min:"1",max:"10000",value:"900"}),J({type:"integer_slider",heading:p("Height"),param_name:"height",min:"1",max:"10000",value:"700"}),J({type:"integer_slider",heading:p("X coordinate"),param_name:"data_x",min:"0",max:"10000",value:"0"}),J({type:"integer_slider",heading:p("Y coordinate"),param_name:"data_y",min:"0",max:"10000",value:"0"}),J({type:"integer_slider",heading:p("Z coordinate"),param_name:"data_z",min:"0",max:"10000",value:"0"}),J({type:"integer_slider",heading:p("X rotate"),param_name:"data_rotate_x",min:"-180",max:"180",value:"0"}),J({type:"integer_slider",heading:p("Y rotate"),param_name:"data_rotate_y",min:"-180",max:"180",value:"0"}),J({type:"integer_slider",heading:p("Z rotate"),param_name:"data_rotate_z",min:"-180",max:"180",value:"0"}),J({type:"integer_slider",heading:p("Scale"),param_name:"data_scale",min:"1",max:"100",value:"1"})].concat(bt.prototype.params),hidden:!0,is_container:!0,show_parent_controls:!0,disallowed_elements:["az_presentation"],get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p("Settings for this presentation element and for current step. ")+'<span class="'+n+"glyphicon "+n+'glyphicon-plus-sign"></span>'+p(" - add a new step.")+"</div></div>"},show_controls:function(){window.azexo_editor&&(bt.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".drag-and-drop").remove(),e('<span class="control '+n+"btn "+n+"btn-primary "+n+'glyphicon">'+this.name+"</span>").prependTo(this.controls))},get_my_shortcode:function(){return this.get_children_shortcode()},clone:function(){var t=bt.baseclass.prototype.get_my_shortcode.apply(this,arguments)
e("#azexo-clipboard").html(btoa(encodeURIComponent(t))),this.parent.paste(this.parent.children.length),this.parent.update_dom()},edited:function(){bt.baseclass.prototype.edited.apply(this,arguments),this.parent.update_dom()},render:function(e){this.dom_element=e('<div class="az-element az-step step '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),e(this.dom_element).css("width",this.attrs.width),e(this.dom_element).css("height",this.attrs.height),e(this.dom_element).attr("data-x",this.attrs.data_x),e(this.dom_element).attr("data-y",this.attrs.data_y),e(this.dom_element).attr("data-z",this.attrs.data_z),e(this.dom_element).attr("data-rotate-x",this.attrs.data_rotate_x),e(this.dom_element).attr("data-rotate-y",this.attrs.data_rotate_y),e(this.dom_element).attr("data-rotate-z",this.attrs.data_rotate_z),e(this.dom_element).attr("data-scale",this.attrs.data_scale),this.dom_content_element=this.dom_element,bt.baseclass.prototype.render.apply(this,arguments)}}),rt("az_container",!0,wt),D(wt.prototype,{name:p("Container"),icon:"fa fa-archive",description:p("AJAX loaded content from server. Content can be edited and saved to server."),category:p("Layout"),params:[J({type:"container",heading:p("Container"),param_name:"container",description:p("Type and name used as identificator to save container on server."),value:"/"})].concat(wt.prototype.params),show_settings_on_create:!0,is_container:!0,hidden:!window.azexo_online,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},get_empty:function(){return'<div class="az-empty"><div class="top '+n+'well"><strong>'+p("Click to put an element here.")+'</strong></div><div class="top-right '+n+'well"><h1>↗</h1><span class="'+n+"glyphicon "+n+'glyphicon-eye-open"></span>'+p(" - toggle editor helpers.")+' <span class="'+n+"glyphicon "+n+'glyphicon-play-circle"></span>'+p(" - toggle animation engine to not hinder editing.")+' <span class="'+n+"glyphicon "+n+'glyphicon-save"></span>'+p(" - save results of editing on server.")+"</div></div>"},show_controls:function(){if(window.azexo_editor){var t=this
wt.baseclass.prototype.show_controls.apply(this,arguments),null==this.parent&&(e('<button title="'+c("Toggle editor")+'" class="control toggle-editor '+n+"btn "+n+"btn-default "+n+"glyphicon "+n+'glyphicon-eye-open" > </button>').appendTo(this.controls).click(function(){return e(t.dom_element).toggleClass("azexo-editor"),!1}),e('<button title="'+c("Toggle animations")+'" class="control toggle-animations '+n+"btn "+n+"btn-default "+n+"glyphicon "+n+'glyphicon-play-circle" > </button>').appendTo(this.controls).click(function(){return e(t.dom_element).toggleClass("azexo-animations-disabled"),!1}),e(this.controls).removeClass(n+"btn-group-xs"),e(this.controls).find(".edit").remove(),e(this.controls).find(".copy").remove(),e(this.controls).find(".clone").remove(),e(this.controls).find(".remove").remove(),e(this.controls).find(".scroll-animation").remove(),e(this.controls).find(".drag-and-drop").attr("title",""),e(this.controls).find(".drag-and-drop").removeClass(n+"glyphicon"),e(this.controls).find(".drag-and-drop").removeClass(n+"glyphicon-move"),e(this.controls).find(".drag-and-drop").removeClass("drag-and-drop")),e('<button title="'+c("Save container")+'" class="control save-container '+n+"btn "+n+"btn-success "+n+"glyphicon "+n+'glyphicon-save" > </button>').appendTo(this.controls).click({object:this},this.click_save_container)}},get_my_shortcode:function(){return this.get_children_shortcode()},get_container_html:function(){function t(e,t,n){return n&&!e.hasOwnProperty(t)?"":t+": "+e[t]+",\n"}function o(e,t,n){return n&&!e.hasOwnProperty(t)?"":t+": "+JSON.stringify(e[t])+",\n"}function i(n,a){var i="{"
...
"an_scenes"in t.attrs&&""!=t.attrs.an_scenes&&(n.an_scenes=!0),"an_start"in t.attrs&&""!=t.attrs.an_start&&"no"!=t.attrs.an_start&&(n.an_start=!0)
...
var k=""
return(h(b)||"an_start"in x||"an_scenes"in x)&&(k='<script type="text/javascript">\n//<![CDATA[\n'+f()+"//]]>\n</script>\n"),y(b)+u(b)+v(b)+k+e(z).html()},click_save_container:function(e){return e.data.object.save_container(),!1},save_container:function(){var e=this
azexo_add_js({path:"js/json2.min.js",loaded:"JSON"in window,callback:function(){var t=e.get_container_html()
v(e.attrs.container.split("/")[0],e.attrs.container.split("/")[1],t)}})},load_container:function(){var n=this
""!=this.attrs.container&&g(this.attrs.container.split("/")[0],this.attrs.container.split("/")[1],function(a){var o=/^\s*\<[\s\S]*\>\s*$/.exec(a)
if(o){n.loaded_container=n.attrs.container,e(a).appendTo(n.dom_content_element),n.parse_html(n.dom_content_element),e(n.dom_element).attr("data-az-id",n.id),n.html_content=!0
for(var i=0;i<n.children.length;i++)n.children[i].recursive_render()
...
var t=this
this.add_js({path:"jquery-waypoints/waypoints.min.js",loaded:"waypoint"in e.fn,callback:function(){e(t.dom_element).waypoint(function(){t.rendered||(t.rendered=!0,t.load_container())},{offset:"100%",triggerOnce:!0}),e(document).trigger("scroll")}})},render:function(e){this.dom_element=e('<div class="az-element az-container"><div class="az-ctnr"></div></div>'),this.dom_content_element=e(this.dom_element).find(".az-ctnr"),wt.baseclass.prototype.render.apply(this,arguments)}}),lt.prototype.params.push(J({type:"textfield",heading:p("Menu item title"),param_name:"menu_item_title",description:p("Title which will be used in scroll menu."),tab:p("Menu")})),Z("az_scroll_menu",!1,xt),D(xt.prototype,{name:p("Scroll Menu"),icon:"fa fa-sitemap",description:p("One page scroll menu"),params:[J({type:"image",heading:p("Logo"),param_name:"logo",description:p("Select image from media library.")}),J({type:"link",heading:p("Logo link"),param_name:"logo_link"})].concat(xt.prototype.params),showed:function(e,t,n){this.navbar_height=e(this.dom_element).find("."+t+"navbar").height(),xt.baseclass.prototype.showed.apply(this,arguments)
var a=this
...
s+="</ul>",e(i).append(s),e(this.dom_element).find("."+t+"container-fluid").append(a).append(i),xt.baseclass.prototype.render.apply(this,arguments)}}),rt("az_form",!0,zt),D(zt.prototype,{name:p("Form"),icon:"fa fa-envelope-o",description:p("Form container. Can contain form elements for user input and any number of any other elements types."),category:p("Layout"),params:[J({type:"textfield",heading:p("Name"),param_name:"name",description:p("Required."),required:!0}),J({type:"textfield",heading:p("Submit button title"),param_name:"submit_title",value:p("Submit")}),J({type:"textfield",heading:p("Submited message"),param_name:"submited_message",value:p("Submited")})].concat(zt.prototype.params),is_container:!0,hidden:!window.azexo_online,show_settings_on_create:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><p>'+this.name+'</p><p class="'+n+"text-muted "+n+'small">'+this.description+"</p></div>"},get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p("You can add form element by mouse over this button: ")+'<span class="'+n+"glyphicon "+n+'glyphicon-plus-sign"></span> '+p("You can see all submissions by click on this button: ")+'<span class="'+n+"glyphicon "+n+'glyphicon-list-alt"></span></div></div>'},show_controls:function(){if(window.azexo_editor){zt.baseclass.prototype.show_controls.apply(this,arguments)
var t=this
...
for(var d in o){var c=e.parseJSON(o[d])
for(var m in c)m in l||(l[m]=!0)}var h=[]
for(var d in o){var c=e.parseJSON(o[d]),_={}
...
var t=this
this.add_external_js("http://www.google.com/recaptcha/api/js/recaptcha_ajax.js",function(){"recaptcha_publickey"in window?Recaptcha.create(window.recaptcha_publickey,"captcha_"+t.id,{theme:"clean"}):O(function(e){Recaptcha.create(e,"captcha_"+t.id,{theme:"clean"})})}),e(t.dom_element).submit(function(){var n=t.get_my_container()
return S(n.attrs.container.split("/")[0],n.attrs.container.split("/")[1],t.attrs.name,e(t.dom_element).serialize(),function(e){e&&t.dom_element.prepend(W(t.attrs.submited_message))}),!1})},render:function(e,t){this.dom_element=e('<form class="az-element az-form '+this.attrs.el_class+'" style="'+this.attrs.style+'" role="form" enctype="multipart/form-data"></form>'),this.dom_content_element=e('<div class="az-ctnr"></div>').appendTo(this.dom_element),e('<div class="'+t+'form-group"><div id="captcha_'+this.id+'"></div></div>').appendTo(this.dom_element),e('<div class="'+t+'form-group"><button class="'+t+"btn "+t+"btn-lg "+t+'btn-primary" type="submit">'+this.attrs.submit_title+"</button></div>").appendTo(this.dom_element),zt.baseclass.prototype.render.apply(this,arguments)}}),P(kt,st),D(kt.prototype,{form_elements:{},show_parent_controls:!0,params:[J({type:"textfield",heading:p("Name"),param_name:"name",description:p("Required."),required:!0}),J({type:"checkbox",heading:p("Field is required?"),param_name:"required",value:{yes:p("Yes, please")}})].concat(kt.prototype.params)}),Tt(),Ot(),St(),Ct(),It()}(window.jQuery,!1,"","",{},{},{},null,[],{})