...
if(!_.isUndefined(a))for(var i=0;i<a.children.length;i++)"trigger_start_in_animation"in a.children[i]&&a.children[i].trigger_start_out_animation()},!1),e(n.dom_element).find("> ."+t+"pagination > li > ."+t+"prev").click(function(){return n.impress.prev(),!1}),e(n.dom_element).find("> ."+t+"pagination > li > ."+t+"next").click(function(){return n.impress.next(),!1}),e(n.dom_element).find("> ."+t+"pagination > li > .goto").click(function(){return n.impress.goto(e(this).attr("data-step")),!1}),window.azexo_editor||e(n.dom_content_element).find(".az-step").each(function(){e(this).on("wheel mousewheel",function(t){if(e(this).hasClass("active")){if(this.offsetHeight==this.scrollHeight)return t.originalEvent.wheelDelta<0?(n.impress.next(),!1):(n.impress.prev(),!1)
