...
var b=g.indexOf("az-rootable")>=0,w=function(){function t(t){function n(e){return 0==e.indexOf("azexo_elements")?window.azexo_baseurl+"../"+e:0!=e.indexOf("/")&&0!=e.indexOf("http://")&&0!=e.indexOf("https://")?window.azexo_baseurl+"../azexo_elements/"+o+"/"+e:e}var o=f.split("|")
o.pop(),o=o.join("/")
...
e(this).attr("style",t)})}for(var n=0;n<this.baseclass.prototype.params.length;n++)if("content"==this.baseclass.prototype.params[n].param_name&&""==this.baseclass.prototype.params[n].value){if("ajaxurl"in window){var o=e("<div>"+this.template+"</div>")
t(o),o=e(o).html(),this.baseclass.prototype.params[n].value=o}break}ct.apply(this,arguments)}
pt(v,!1,w),Y(w.prototype,{baseclass:w,template:g,name:v,icon:"fa fa-cube",description:p(""),thumbnail:y,params:[it({type:"html",heading:p("Content"),param_name:"content",value:""})].concat(w.prototype.params),show_settings_on_create:!1,is_container:!0,has_content:!0,section:b,category:"Template-elements",is_template_element:!0,editable:[".az-editable"].concat(o),styleable:[".az-styleable"].concat(i),sortable:[".az-sortable"].concat(r),synchronizable:[".az-synchronizable"].concat(d),restoreable:[".az-restoreable"].concat(c),containable:[".az-containable"].concat(m),restore_nodes:{},contained_elements:{},show_controls:function(){function t(t,n,a,i){var s=[],r="",c="",m="",_=e.trim(e(t).text())
