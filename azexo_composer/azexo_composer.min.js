...
e.impress.setTransformationCallback(function(t){e.config.visualScaling=t.scale,e.config.rotation=~~t.rotate.z})},showed:function(e,t){yt.baseclass.prototype.showed.apply(this,arguments)
var n=this
this.add_js({path:"js/impress.js",loaded:"impress"in window,callback:function(){function a(e,t){var a={x:0,y:0},i=n.config.rotation/180*Math.PI,o=Math.cos(i),s=Math.sin(i)
return a.x=(e*o-t*s)*n.config.visualScaling,a.y=(e*s+t*o)*n.config.visualScaling,a}n.state={editing:!1,$node:!1,data:{x:0,y:0,rotate:0,scale:0}},n.config={rotateStep:.1,scaleStep:.01,visualScaling:10,setTransformationCallback:!1},n.defaults={x:0,y:0,rotate:0,scale:1},n.mouse={prevX:!1,prevY:!1,activeFunction:!1},n.handlers={},n.handlers.move=function(e,t){var i=a(e,t)
n.state.data.x=n.state.data.x?n.state.data.x+i.x:i.x,n.state.data.y=n.state.data.y?n.state.data.y+i.y:i.y},n.handlers.scale=function(e){n.state.data.scale-=-e*n.config.scaleStep*n.config.visualScaling/10},n.handlers.rotate=function(e){n.state.data.rotate-=-e*n.config.rotateStep},"impress"in n||(n.impress=window.impress(n.id)),n.impress.init(),n.impress_init(),n.impress.goto(n.children[0].id),n.dom_element.get(0).addEventListener("impress:stepenter",function(t){var n=e(t.target).attr("data-az-id"),a=s.get_element(n)
