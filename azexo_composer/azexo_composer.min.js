...
e&&l.push(e)}),window.azexo_editor&&0==e("#azexo-clipboard").length&&e("body").prepend('<div id="azexo-clipboard" style="display:none"></div>'),e("body").keydown(function(t){if(t.ctrlKey&&t.altKey){e("#az-admin-modal").remove()
