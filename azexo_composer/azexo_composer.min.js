...
h=h.join(", "),h in c||(c[h]=[]),c[h].push(m)}for(var h in c){var _={type:"colorpicker",tab:p("Colors"),heading:c[h].join("/")+" "+r,description:h,param_name:"color"+r,value:d,selector:h,property:c[h]}
l.push(_),r++}}var f=[],v=[]
