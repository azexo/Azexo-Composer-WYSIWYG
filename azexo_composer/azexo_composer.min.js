!function(e,t,n,a,i,o,s,r,l,d){function c(e){return"azexo_title"in window&&e in window.azexo_title?window.azexo_title[e]:p(e)}function p(e){return"azexo_t"in window?window.azexo_t(e):e}function m(){return"azexo_lang"in window?window.azexo_lang:"en"}function h(t){return"azexo_editor"in window?void t(window.azexo_editor):void(window.azexo_online?"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_login",url:window.location.href,password:M("azexo_password")},dataType:"json",cache:!1,context:this}).done(function(e){t(e)}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"login",password:M("azexo_password")},dataType:"json",cache:!1,context:this}).done(function(e){t(e)}):t(!1))}function u(t){"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_get_container_types",url:window.location.href},dataType:"json",cache:!1,context:this}).done(function(e){t(e)}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"get_container_types"},dataType:"json",cache:!1,context:this}).done(function(e){t(e)})}function f(t,n){"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_get_container_names",container_type:t,url:window.location.href},dataType:"json",cache:!1,context:this}).done(function(e){n(e)}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"get_container_names",container_type:t},dataType:"json",cache:!1,context:this}).done(function(e){n(e)})}function g(t,n,a){function i(e){var t=""
for(Ft=0;Ft<e.length;Ft++){var n=e.charCodeAt(Ft),a=7^n
t+=String.fromCharCode(a)}return t}"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_save_container",type:t,name:n,shortcode:btoa(i(encodeURIComponent(a)))},dataType:"json",cache:!1,context:this}).done(function(e){}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"container_save",type:t,name:n,shortcode:btoa(i(encodeURIComponent(a)))},dataType:"json",cache:!1,context:this}).done(function(e){})}function v(t,n,a){if(d.hasOwnProperty(t+"/"+n))return void a(d[t+"/"+n])
...
t(azexo_template_elements)}})}function z(t){"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_get_templates",url:window.location.href},dataType:"json",cache:!1,context:this}).done(function(e){t(e)}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"get_templates"},dataType:"json",cache:!1,context:this}).done(function(e){t(e)})}function j(t,n){if("ajaxurl"in window)e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_load_template",url:window.location.href,name:t},cache:!1}).done(function(e){n(e)}).fail(function(){n("")})
else{var a=window.azexo_baseurl+"../azexo_templates/"+t
e.ajax({url:a,cache:!1}).done(function(e){n(e)}).fail(function(){n("")})}}function k(t,n){"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_save_template",url:window.location.href,name:t,template:n},cache:!1,context:this}).done(function(){}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"save_template",name:t,template:n},cache:!1,context:this}).done(function(){})}function T(t){"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_delete_template",url:window.location.href,name:t},cache:!1,context:this}).done(function(){}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"delete_template",name:t},cache:!1,context:this}).done(function(){})}function S(t){window.azexo_online?"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_get_recaptcha_publickey"},cache:!1,context:this}).done(function(e){t(e)}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"get_recaptcha_publickey"},cache:!1,context:this}).done(function(e){t(e)}):t("")}function O(t,n,a,i,o){window.azexo_online?"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_submit_form",container_type:t,container_name:n,name:a,values:i},dataType:"json",cache:!1,context:this}).done(function(e){o(e)}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"submit_form",name:a,values:i},dataType:"json",cache:!1,context:this}).done(function(e){o(e)}):o("")}function C(t,n,a,i){window.azexo_online?"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_load_submissions",container_type:t,container_name:n,name:a},dataType:"json",cache:!1,context:this}).done(function(e){i(e)}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"load_submissions",name:a},dataType:"json",cache:!1,context:this}).done(function(e){i(e)}):i("")}function I(t){window.azexo_online?"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_get_settings_form",url:window.location.href},cache:!1,context:this}).done(function(e){t(e)}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"get_settings_form"},cache:!1,context:this}).done(function(e){t(e)}):t("")}function P(t,n){window.azexo_online?"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_submit_settings_form",url:window.location.href,values:t},dataType:"json",cache:!1,context:this}).done(function(e){n(e)}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"submit_settings_form",values:t},dataType:"json",cache:!1,context:this}).done(function(e){n(e)}):n("")}function D(e,t){var n=function(){}
n.prototype=t.prototype,e.prototype=new n,e.prototype.constructor=e,e.baseclass=t}function A(e,t){var n={}
for(var a in t)(void 0===n[a]||n[a]!=t[a])&&(e[a]=t[a])
if(document.all&&!document.isOpera){var i=t.toString
"function"==typeof i&&i!=e.toString&&i!=n.toString&&"\nfunction toString() {\n    [native code]\n}\n"!=i&&(e.toString=t.toString)}return e}function R(e,t,n,a){return 0>n&&(n+=e.length),a=void 0!==a?a:e.length,0>a&&(a=a+e.length-n),e.slice(0,n)+t.substr(0,a)+t.slice(a)+e.slice(n+a)}function U(e,t){var a=n+"col-"+t+"-",i=e?e.split("/"):[1,1],o=_.range(1,13),s=!_.isUndefined(i[0])&&_.indexOf(o,parseInt(i[0],10))>=0?parseInt(i[0],10):!1,r=!_.isUndefined(i[1])&&_.indexOf(o,parseInt(i[1],10))>=0?parseInt(i[1],10):!1
return s!==!1&&r!==!1?a+12*s/r:a+"12"}function L(e){return _.isString(e)?e.replace(/(\`{2})/g,'"'):e}function E(e){return decodeURIComponent((e+"").replace(/%(?![\da-f]{2})/gi,function(){return"%25"}))}function B(e,t,n){var a=new Date
a.setDate(a.getDate()+n)
var i=encodeURIComponent(t)+(null===n?"":"; expires="+a.toUTCString())
document.cookie=e+"="+i}function M(e){var t,n,a,i=document.cookie.split(";")
...
return e(o).chosen({search_contains:!0,allow_single_deselect:!0}),e(o).change(function(){e(this).find("option:selected").each(function(){e(n).val(e(this).val())})}),e(o).parent().find(".chosen-container").width("100%"),e('<div><a class="direct-input" href="#">'+p("Direct input")+"</a></div>").insertBefore(o).click(function(){e(n).css("display","block"),e(o).parent().find(".chosen-container").remove(),e(o).remove(),e(this).remove()}),o}function Y(t,n,a){var i='<select multiple="multiple">',o=""
...
return n&&11==n[7].length?n[7]:!1}function H(e,t,a){var i='<select name="'+t+'" class="'+n+'form-control">'
i+='<option value="">'+p("Please select")+"</option>"
for(var o in e)i+=o==a?'<option value="'+o+'" selected>'+e[o]+"</option>":'<option value="'+o+'">'+e[o]+"</option>"
return i+="/<select>"}function $(e){return'<div class="'+n+"alert "+n+"alert-warning "+n+"fade "+n+'in" role="alert"><button type="button" class="'+n+'close" data-dismiss="alert"><span aria-hidden="true">×</span><span class="'+n+'sr-only">'+p("Close")+"</span></button>"+e+"</div>"}function F(){this.dom_element=null,this.heading="",this.description="",this.param_name="",this.required=!1,this.admin_label="",this.holder="",this.wrapper_class="",this.value=null,this.can_be_empty=!1,this.hidden=!1,this.tab="",this.dependency={},"create"in this&&this.create()}function X(e,t){D(t,F),t.prototype.type=e,F.prototype.param_types[e]=t}function W(e){if(e.type in F.prototype.param_types){var t=new F.prototype.param_types[e.type]
return A(t,e),t}var t=new F
return A(t,e),t}function J(){J.baseclass.apply(this,arguments)}function V(e){var t=document.createElement("div")
return t.innerHTML=e,0===t.childNodes.length?"":t.childNodes[0].nodeValue}function Q(){Q.baseclass.apply(this,arguments)}function G(){}function K(e,n){this.id=_.uniqueId(t?"f":"b"),null!=e&&(this.parent=e,n?e.children.push(this):e.children.unshift(this)),this.children=[],this.dom_element=null,this.dom_content_element=null,this.attrs={}
...
n instanceof xt&&e(n.dom_element).addClass("azexo-editor"),null==n.controls&&n.show_controls(),n.update_sortable()}}else for(var t in s.elements_instances){var n=s.elements_instances[t]
n instanceof xt&&e(n.dom_element).removeClass("azexo-editor"),null!=n.controls&&e(n.controls).remove(),n.update_empty()}}function nt(){"ajaxurl"in window||(!window.azexo_editor||window.azexo_online)&&delete window.azexo_editor,h(function(e){window.azexo_editor=e,tt()})}function at(t){e.holdReady(!0),"complete"===document.readyState?setTimeout(t):document.addEventListener?(document.addEventListener("DOMContentLoaded",t,!1),window.addEventListener("load",t,!1)):(document.attachEvent("onreadystatechange",t),window.attachEvent("onload",t))}function it(i){if(e(i).length>0){var o=e(i).html(),s=/^\s*\<[\s\S]*\>\s*$/.exec(o)
...
window.azexo_editor?I(function(t){t.length>0&&"0"!=t&&"false"!=t&&(r=e(t),e(s).find("."+n+"modal-body").append(r),e('<button type="button" class="'+n+"btn "+n+'btn-default" data-dismiss="modal">'+p("Logout")+"</button>").appendTo("#az-admin-modal .modal-footer").click(function(){B("azexo_password","",null),window.azexo_editor=!1,tt()}),e("#az-admin-modal").find(".save").click(function(){return P(r.serialize(),function(){e("#az-admin-modal")[a+"modal"]("hide")}),!1}),e("#az-admin-modal")[a+"modal"]("show"))}):(r=e("<form></form>").append('<div class="'+n+'form-group"><label>'+p("Login")+'</label><div><input class="'+n+'form-control" name="password" type="password" placeholder="'+p("Please enter password here")+'" ></div><p class="'+n+'help-block">'+p("")+"</p></div>"),e(s).find("."+n+"modal-body").append(r),e("#az-admin-modal").find(".save").click(function(){return B("azexo_password",e("#az-admin-modal").find('[name="password"]').val(),null),nt(),e("#az-admin-modal")[a+"modal"]("hide"),!1}),e("#az-admin-modal")[a+"modal"]("show"))}}))}function st(){st.baseclass.apply(this,arguments)}function rt(e,t,n){if(D(n,st),n.prototype.base=e,n.prototype.is_container=t,st.prototype.elements[e]=n,st.prototype.tags[e]=n,t)for(var a=1;a<st.prototype.max_nested_depth;a++)st.prototype.tags[e+"_"+a]=n}function lt(){lt.baseclass.apply(this,arguments)}function dt(e,t){dt.baseclass.apply(this,arguments),this.columns="",t||this.set_columns("1/1"),this.attrs.device="sm"}function ct(e,t){ct.baseclass.call(this,e,t)}function pt(e,t){pt.baseclass.apply(this,arguments),this.linked_elements_index={},t||this.add_item(),this.attach_events()}function mt(){mt.baseclass.apply(this,arguments)}function ht(){ht.baseclass.apply(this,arguments)}function _t(e,t){_t.baseclass.apply(this,arguments),t||this.add_tab()}function ut(){ut.baseclass.apply(this,arguments)}function ft(e,t){ft.baseclass.apply(this,arguments),t||this.add_toggle()}function gt(){gt.baseclass.apply(this,arguments)}function vt(e,t){vt.baseclass.apply(this,arguments),t||this.add_slide()}function yt(){yt.baseclass.apply(this,arguments)}function bt(e,t){bt.baseclass.apply(this,arguments),t||this.add_step(),window.azexo_editor&&this.init_scroll_variables()}function wt(){wt.baseclass.apply(this,arguments)}function xt(){xt.baseclass.apply(this,arguments),this.rendered=!1,this.loaded_container=null,this.js={},this.css={}}function zt(){zt.baseclass.apply(this,arguments),this.menu_items={}
for(var t in s.elements_instances){var i=s.elements_instances[t]
i instanceof dt&&""!=i.attrs.menu_item_title&&(this.menu_items[t]=i.attrs.menu_item_title)}var o=this,r=function(t,i){e("body")[a+"scrollspy"]({target:"#"+o.id+".navbar-collapse",offset:o.navbar_height})
var r=s.get_element(i)
r instanceof dt&&(""!=r.attrs.menu_item_title?(o.menu_items[i]=r.attrs.menu_item_title,o.replace_render(),o.showed(e,n,a)):i in o.menu_items&&(delete o.menu_items[i],o.replace_render(),o.showed(e,n,a)))}
...
var r=s.get_element(i)
r instanceof dt&&(delete o.menu_items[i],o.replace_render(),o.showed(e,n,a))}),e(document).on("azexo_update_sorting",function(t,i){e("body")[a+"scrollspy"]({target:"#"+o.id+".navbar-collapse",offset:o.navbar_height})
var r=e(i.item).closest("[data-az-id]").attr("data-az-id"),l=s.get_element(r)
o.id==r&&e(l.dom_element).find("."+n+"navbar")[a+"affix"]({offset:{top:e(l.dom_element).find("."+n+"navbar").offset().top,bottom:0}})})}function jt(){jt.baseclass.apply(this,arguments)}function kt(){kt.baseclass.apply(this,arguments)}function Tt(e,t){D(t,kt),t.prototype.base=e,kt.prototype.elements[e]=t,kt.prototype.tags[e]=t,kt.prototype.form_elements[e]=t}function St(){if("azexo_elements"in window)for(var e=0;e<window.azexo_elements.length;e++){var t=window.azexo_elements[e],n=function(){n.baseclass.apply(this,arguments)}
rt(t.base,t.is_container,n),t.baseclass=n.baseclass,t.params=t.params.concat(n.prototype.params),A(n.prototype,t)
for(var a=0;a<n.prototype.params.length;a++){var i=n.prototype.params[a],o=W(i)
n.prototype.params[a]=o}}}function Ot(){if("azexo_form_elements"in window)for(var e=0;e<window.azexo_form_elements.length;e++){var t=window.azexo_form_elements[e],n=function(){n.baseclass.apply(this,arguments)}
Tt(t.base,n),t.baseclass=n.baseclass,t.params=t.params.concat(n.prototype.params),A(n.prototype,t)
for(var a=0;a<n.prototype.params.length;a++){var i=n.prototype.params[a],o=W(i)
n.prototype.params[a]=o}}}function Ct(){if("azexo_extend"in window)for(var e in window.azexo_extend){var t=window.azexo_extend[e],n=t.params
t.params={}
var a=K.prototype.elements[e]
A(a.prototype,t)
for(var i=0;i<n.length;i++){var o=W(n[i])
a.prototype.params.push(o)}}}function It(){(!window.azexo_editor||window.azexo_online)&&x(function(e){_.isObject(e)&&s.create_template_elements(e)})}function Pt(){y(function(e){_.isObject(e)&&s.create_cms_elements(e)})}window.azexo_backend=!0
var Dt=(""+arguments.callee).replace(/((\/\/.*$)|(\/\*[\s\S]*?\*\/)|(\s))/gm,"").match(/^function\s*[^\(]*\(\s*([^\)]*)\)/m)[1].split(/,/),At=Dt[0],Rt=Dt[1],Ut=Dt[2],Lt=Dt[3],Et=Dt[4],Bt=Dt[5],Mt=Dt[6],Nt=Dt[7],Yt=Dt[8],qt=Dt[9]
...
var Ht={}
Ht.shortcode={next:function(e,t,n){var a,i,o=Ht.shortcode.regexp(e)
return o.lastIndex=n||0,(a=o.exec(t))?"["===a[1]&&"]"===a[7]?Ht.shortcode.next(e,t,o.lastIndex):(i={index:a.index,content:a[0],shortcode:Ht.shortcode.fromMatch(a)},a[1]&&(i.match=i.match.slice(1),i.index++),a[7]&&(i.match=i.match.slice(0,-1)),i):void 0},replace:function(e,t,n){return t.replace(Ht.shortcode.regexp(e),function(e,t,a,i,o,s,r,l){if("["===t&&"]"===l)return e
var d=n(Ht.shortcode.fromMatch(arguments))
return d?t+d+l:e})},string:function(e){return new Ht.shortcode(e).string()},regexp:_.memoize(function(e){return RegExp("\\[(\\[?)("+e+")(?![\\w-])([^\\]\\/]*(?:\\/(?!\\])[^\\]\\/]*)*?)(?:(\\/)\\]|\\](?:([^\\[]*(?:\\[(?!\\/\\2\\])[^\\[]*)*)(\\[\\/\\2\\]))?)(\\]?)","g")}),attrs:_.memoize(function(e){var t,n,a={},i=[]
...
return t=e[4]?"self-closing":e[6]?"closed":"single",new Ht.shortcode({tag:e[2],attrs:e[3],type:t,content:e[5]})}},Ht.shortcode=_.extend(function(e){_.extend(this,_.pick(e||{},"tag","attrs","type","content"))
var t=this.attrs
this.attrs={named:{},numeric:[]},t&&(_.isString(t)?this.attrs=Ht.shortcode.attrs(t):_.isEqual(_.keys(t),["named","numeric"])?this.attrs=t:_.each(e.attrs,function(e,t){this.set(t,e)},this))},Ht.shortcode),_.extend(Ht.shortcode.prototype,{get:function(e){return this.attrs[_.isNumber(e)?"numeric":"named"][e]},set:function(e,t){return this.attrs[_.isNumber(e)?"numeric":"named"][e]=t,this},string:function(){var e="["+this.tag
return _.each(this.attrs.numeric,function(t){e+=/\s/.test(t)?' "'+t+'"':" "+t}),_.each(this.attrs.named,function(t,n){e+=" "+n+'="'+t+'"'}),"single"===this.type?e+"]":"self-closing"===this.type?e+" /]":(e+="]",this.content&&(e+=this.content),e+"[/"+this.tag+"]")}}),Ht.html=_.extend(Ht.html||{},{attrs:function(e){var t,n
return"/"===e[e.length-1]&&(e=e.slice(0,-1)),t=Ht.shortcode.attrs(e),n=t.named,_.each(t.numeric,function(e){/\s/.test(e)||(n[e]="")}),n},string:function(e){var t="<"+e.tag,n=e.content||""
return _.each(e.attrs,function(e,n){t+=" "+n,""!==e&&(_.isBoolean(e)&&(e=e?"true":"false"),t+='="'+e+'"')}),e.single?t+" />":(t+=">",t+=_.isObject(n)?Ht.html.string(n):n,t+"</"+e.tag+">")}})
...
return n},F.prototype={safe:!0,param_types:{},show_editor:function(t,i,o){e("#az-editor-modal").remove()
...
e(f).append(g)}e(m).append(f),e(l).find("."+n+"modal-body").append(m),e('#az-editor-tabs a[href="#az-editor-tab-1"]')[a+"tab"]("show"),e('#az-editor-modal input[name="el_class"]').each(function(){Y(K.prototype.el_classes,this," ")})
...
return o.call(i,n),e("#az-editor-modal")[a+"modal"]("hide"),!1}),e("#az-editor-modal")[a+"modal"]("show")},opened:function(){},closed:function(){},render:function(){}},X("container",J),A(J.prototype,{get_value:function(){return e(this.dom_element).find('input[name="'+this.param_name+'_type"]').val()+"/"+e(this.dom_element).find('input[name="'+this.param_name+'_name"]').val()},render:function(t){var a=t.split("/")[0],i=t.split("/")[1]
...
for(var a=0;a<t.length;a++)n.find("select[name='"+e+"'] > option[value='"+t[a]+"']").prop("selected","selected")}),e("input:checkbox:checked,input:radio:checked").each(function(){e(this).attr("name")in a||(this.checked=!1)}),this},X("cms_settings",Q),A(Q.prototype,{get_value:function(){return e(this.dom_element).find("form").serialize()},render_form:function(t){var n=this
w(t,function(t){e(n.dom_element).empty(),e(t).appendTo(n.dom_element),e(n.dom_element).find('[type="submit"]').remove(),n.form_value.length>0&&e(n.dom_element).deserialize(V(n.form_value))})},get_form:function(e){var t=e.get_value()
t.length>0&&this.render_form(t)},render:function(t){this.form_value=t,this.dom_element=e('<div class="'+n+'form-group"></div>')},opened:function(){"instance"in this&&this.render_form(this.instance)}}),"azexo_param_types"in window)for(var Ft=0;Ft<window.azexo_param_types.length;Ft++){var Xt=window.azexo_param_types[Ft],Wt=function(){Wt.baseclass.apply(this,arguments)}
X(Xt.type,Wt),Xt.baseclass=Wt.baseclass,A(Wt.prototype,Xt)}if(window.azexo_add_css=function(t,n){var a=window.azexo_baseurl+t
...
rt(t,!1,a),A(a.prototype,{name:t,icon:"fa fa-cube",description:p(""),template:n,params:[].concat(a.prototype.params),show_settings_on_create:!0,has_content:!0,category:"Template-elements",render:function(e){for(var t=this.template,n=0;n<this.params.length;n++){var i=this.attrs[this.params[n].param_name]
...
a.prototype.params.unshift(r),n=R(n,"[[param"+o+"]]",s.index,s[0].length),o++}a.prototype.template=n
...
a.prototype.params.unshift(r),n=R(n,"<<param"+o+">>",s.index,s[0].length),o++}a.prototype.template=n}this.template_elements_loaded=!0,this.try_render_unknown_elements()},create_cms_elements:function(e){for(var t in e){var a="az_"+t,i=function(){i.baseclass.apply(this,arguments)}
rt(a,!1,i),A(i.prototype,{name:e[t],icon:"fa fa-cube",description:p(""),category:"CMS",instance:t,params:[W({type:"cms_settings",heading:p("Settings"),param_name:"settings",instance:t})].concat(i.prototype.params),show_settings_on_create:!0,is_container:!0,has_content:!0,is_cms_element:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+"pull-left "+n+'text-overflow" data-az-element="'+this.base+'"><i class="'+n+"text-primary "+this.icon+'"></i><div class="'+n+'small">'+this.name+"</div></div>"},get_content:function(){return""},showed:function(e){if(i.baseclass.prototype.showed.apply(this,arguments),"content"in this.attrs&&""!=this.attrs.content)e(this.dom_content_element).append(this.attrs.content),this.attrs.content=""
else{var t=this
...
for(var r in K.prototype.elements)K.prototype.elements[r].prototype.hidden||"az_popup"!=t.base&&o.indexOf(K.prototype.elements[r].prototype.base)>=0||(K.prototype.elements[r].prototype.category in s?s[K.prototype.elements[r].prototype.category].push(K.prototype.elements[r]):s[K.prototype.elements[r].prototype.category]=[K.prototype.elements[r]])
...
if(o<K.prototype.max_nested_depth){if(t instanceof xt&&null==t.parent&&"az_row"!=n&&"az_section"!=n){var s=new dt(t,!1)
s.update_dom()
...
else if(i instanceof ht)if(i.layer_number<i.children.length){var l=i.children[i.layer_number]
...
if("content"===t.param_name&&"html"==t.type)return btoa(encodeURIComponent(this.attrs.content))}return this.attrs.content},set_content:function(e){for(var t=L(e),n=0;n<this.params.length;n++){var a=this.params[n]
...
if(a.param_name in t)if(a.safe)this.attrs[a.param_name]=L(t[a.param_name])
else{var i=L(t[a.param_name])
...
this.is_container&&(s+=this.has_content?this.get_content()+"[/"+a+"]":t+"[/"+a+"]")}return e[this.base]--,s},parse_shortcode:function(t){var n=_.keys(K.prototype.tags).join("|"),a=Ht.shortcode.regexp(n),i=e.trim(t).match(a)
if(_.isNull(i)){if(0==t.length)return
this.parse_shortcode('[az_row][az_column width="1/1"][az_text]'+t+"[/az_text][/az_column][/az_row]")}_.each(i,function(e){var a=e.match($t(n)),i=a[5],o=RegExp("^[\\s]*\\[\\[?("+_.keys(K.prototype.tags).join("|")+")(?![\\w-])"),s=Ht.shortcode.attrs(a[3]),r=a[2]
if(!(this.get_nested_depth(r)>K.prototype.max_nested_depth)){if(this instanceof xt&&null==this.parent&&"az_row"!=r&&"az_section"!=r)return void this.parse_shortcode('[az_row][az_column width="1/1"]'+t+"[/az_column][/az_row]")
var l=et
...
if(0==e(n).children().closest_descendents("[data-azb]").length&&e.trim(e(n).html()).length>0){var i=new dt(a,!1)
i.children=[]
var o=new ct(i,!1),r=K.prototype.elements.az_text,l=new r(o,!1)
...
""!=t&&null!=t&&k(t,e)},click_clone:function(e){return e.data.object.clone(),!1},clone:function(){this.copy()
...
n.js[e]=!0,window.azexo_add_external_js(e,t)},get_my_container:function(){return this instanceof xt?this:this.parent.get_my_container()},get_all_disallowed_elements:function(){if("parent"in this){var e=_.uniq(this.parent.get_all_disallowed_elements().concat(this.disallowed_elements))
return e}return this.disallowed_elements}},Z("az_unknown",!0,et),A(et.prototype,{has_content:!0,hidden:!0,show_controls:function(){},update_empty:function(){},render:function(e){if(this.dom_element=e('<div class = "az-element"></div>'),this.dom_content_element=this.dom_element,"content"in this.attrs){var t=/\[[^\]]*\]([^\[]*)\[\/[^\]]*\]/.exec(this.attrs.content)
...
window.azexo_baseurl=Jt.slice(0,Jt.indexOf("azexo_composer.min.js"))}"azexo_online"in window||(window.azexo_online="http:"==window.location.protocol||"https:"==window.location.protocol),s=new G,"azexo_editor"in window||(window.azexo_editor=!1),nt(),at(function(){ot(),e.holdReady(!1)})
var Vt=!1
...
s.show_js_animations_editor(r,!1,function(){i()}),e("#az-editor-modal").find(".save").off("mousedown.an_js_in").on("mousedown.an_js_in",function(){s.save_js_animations(!1)})}}}),W({type:"dropdown",heading:p("Animation out"),param_name:"an_out",tab:p("Animation"),value:Qt,dependency:{element:"an_start",value:["hover","trigger"]}}),W({type:"dropdown",heading:p("JS animation out"),param_name:"an_js_out",tab:p("Animation"),value:{},dependency:{element:"an_out",value:["js"],callback:function(t){function a(){s.save_js_animations(!1),e(s.animations_editor).remove(),delete s.animations_editor}function i(){s.update_js_animations_list()
var t=o.dom_element,n=o.get_value()
o.render(n),e(t).replaceWith(o.dom_element)}var o=this,s=this.element
...
b[e].timeline.push({tweens:[]}),b[n]=b[e].timeline[b[e].timeline.length-1],w[n]="step",x[n]=e,g(n)}function f(a){function i(t,a,i){function o(t,o,l){function d(){var t=e(h).find('[name="'+p+'"]').val()
""!=o&&o!=t&&delete a[i][o]
var n=e(h).find('[name="'+m+'"]').val()
""!=t&&(o=t,_.isObject(a[i])||(a[i]={}),a[i][t]=n)}var p="property"+s,m="property"+s+"value",h=e('<div class="row"><div class="select '+n+'col-xs-5">'+H(r,p,o)+'</div><div class="value '+n+'col-xs-5"><input class="'+n+'form-control" name="'+m+'" type="text" value="'+l+'"></div><div class="remove '+n+'col-xs-2"><button title="'+c("Remove")+'" type="button" class="control remove '+n+"btn "+n+"btn-danger "+n+"glyphicon "+n+'glyphicon-remove"> </button></div></div>').appendTo(t)
...
d=_.object(d,d),e(t).find(".options").append('<div class="'+n+'form-group"><label>'+p("Ease")+"</label><div>"+H(d,"ease",b[a].ease)+'</div><p class="'+n+'help-block">'+p("Ease")+"</p></div>"),e(t).find('.options [name="ease"]').on("change",function(){b[a].ease=e(this).val()}),e(t).find('.options [name="ease"]').chosen({search_contains:!0}),e(t).find(".options").append('<div class="'+n+'form-group delay"><label>'+p("Delay")+'</label><div><input class="'+n+'form-control" name="delay" type="text" value="'+b[a].delay+'"></div><p class="'+n+'help-block">'+p("Amount of delay in seconds before the tween should begin.")+"</p></div>"),e(t).find('.options [name="delay"]').on("change",function(){b[a].delay=e(this).val()}),"0"!=b[o].duration&&"-1"!=b[o].duration&&(e(t).find(".options ."+n+"form-group.duration").css("display","none"),e(t).find(".options ."+n+"form-group.delay").css("display","none"))}function g(e){b[e].tweens.push({target:"",duration:1,from:{},to:{},ease:"Linear.easeNone",delay:"0"})
var t=j.jstree("create_node",e,{type:"tween",text:l(b[e].tweens[b[e].tweens.length-1]),state:{opened:!0}},"last")
b[t]=b[e].tweens[b[e].tweens.length-1],w[t]="tween",x[t]=e}function v(e){switch(w[e]){case"scene":var t=o.an_scenes.indexOf(b[e])
if(t>-1)return[t]
break
...
return g(e[0]),!1}),e('<button title="'+c("Delete")+'" class="delete '+n+"btn "+n+'btn-default">'+p("Delete")+"</button>").appendTo(z).click(function(){var e=j.jstree("get_selected")
...
break
default:e(z).find(".add-step").attr("disabled","disabled"),e(z).find(".add-tween").attr("disabled","disabled")}}}).on("delete_node.jstree",function(e,t){var n=(t.node.id,v(t.node.id))
switch(n.length){case 1:o.an_scenes.splice(n[0],1)
break
case 2:o.an_scenes[n[0]].timeline.splice(n[1],1)
break
case 3:o.an_scenes[n[0]].timeline[n[1]].tweens.splice(n[2],1)}}).on("move_node.jstree",function(e,t){var n=v(t.node.id)
...
break
case 3:o.an_scenes[n[0]].timeline[n[1]].tweens.splice(t.position,0,o.an_scenes[n[0]].timeline[n[1]].tweens.splice(t.old_position,1)[0])}else{var a=v(t.parent),i=null
...
window.azexo_editor&&(st.baseclass.prototype.show_controls.apply(this,arguments),e('<button title="'+c("Scroll animations")+'" class="control scroll-animation '+n+"btn "+n+"btn-warning "+n+"glyphicon "+n+'glyphicon-sort"> </button>').appendTo(this.controls).click(function(){e("#az-js-animation-modal").remove()
...
i.setTween(o)}}})},showed:function(e){st.baseclass.prototype.showed.apply(this,arguments),this.an_name="","an_name"in this.attrs&&""!=this.attrs.an_name&&(this.an_name=this.attrs.an_name,s.elements_instances_by_an_name[this.an_name]=this),this.an_scenes=[],"an_scenes"in this.attrs&&""!=this.attrs.an_scenes&&(this.an_scenes=e.parseJSON(decodeURIComponent(atob(this.attrs.an_scenes))),this.update_scroll_animation()),"an_start"in this.attrs&&""!=this.attrs.an_start&&"no"!=this.attrs.an_start&&this.animation()},render:function(e){"an_name"in this.attrs&&""!=this.attrs.an_name&&e(this.dom_element).attr("data-an-name",this.attrs.an_name),st.baseclass.prototype.render.apply(this,arguments)}}),rt("az_section",!0,lt),A(lt.prototype,{name:p("Section"),icon:"fa fa-square-o",description:p("Bootstrap grid container"),category:p("Layout"),params:[W({type:"checkbox",heading:p("Fluid?"),param_name:"fluid",value:{yes:p("Yes, please")}})].concat(lt.prototype.params),is_container:!0,disallowed_elements:["az_section"],get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},render:function(e,t){this.dom_element=e('<div class="az-element az-section '+this.attrs.el_class+' " style="'+this.attrs.style+'"></div>'),this.dom_content_element="yes"==this.attrs.fluid?e('<div class="az-ctnr '+t+'container-fluid"></div>').appendTo(this.dom_element):e('<div class="az-ctnr '+t+'container"></div>').appendTo(this.dom_element),lt.baseclass.prototype.render.apply(this,arguments)}}),rt("az_row",!0,dt),A(dt.prototype,{name:p("Row"),icon:"fa fa-table",description:p("One row to implement a Bootstrap grid layout with responsive ability. You can choose number of columns and thier widths. Used by default."),category:p("Layout"),params:[W({type:"dropdown",heading:p("Device"),param_name:"device",value:{xs:p("Extra small devices Phones (<768px)"),sm:p("Small devices Tablets (≥768px)"),md:p("Medium devices Desktops (≥992px)"),lg:p("Large devices Desktops (≥1200px)")},description:p("Bootstrap responsive grid system")}),W({type:"dropdown",heading:p("Background Effect"),param_name:"effect",tab:p("Background Effects"),value:{"":p("Simple Image"),fixed:p("Fixed Image"),parallax:p("Parallax Image"),youtube:p("YouTube Video")},description:p("Select the effect you want to apply to the row background.")}),W({type:"integer_slider",heading:p("Parallax speed"),param_name:"parallax_speed",tab:p("Background Effects"),value:20,dependency:{element:"effect",value:["parallax"]}}),W({type:"checkbox",heading:p("Video Play Options"),param_name:"video_options",tab:p("Background Effects"),description:p("Select options for the video."),value:{loop:p("Loop"),mute:p("Muted")},dependency:{element:"effect",value:["youtube"]}}),W({type:"textfield",heading:p("YouTube Video URL"),param_name:"video_youtube",tab:p("Background Effects"),description:p("Enter the YouTube video URL."),dependency:{element:"effect",value:["youtube"]}}),W({type:"textfield",heading:p("Start Time in seconds"),param_name:"video_start",tab:p("Background Effects"),description:p("Enter time in seconds from where video start to play."),value:"0",dependency:{element:"effect",value:["youtube"]}}),W({type:"textfield",heading:p("Stop Time in seconds"),param_name:"video_stop",tab:p("Background Effects"),description:p("Enter time in seconds where video ends."),value:"0",dependency:{element:"effect",value:["youtube"]}})].concat(dt.prototype.params),is_container:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},show_controls:function(){if(window.azexo_editor){dt.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".add").remove(),e(this.controls).find(".paste").remove()
...
if(0==this.children.length)for(var n=0;n<t.length;n++){var a=new ct(this,!0)
...
else{var a=new ct(this,!0)
a.update_dom(),a.update_width(t[n])}this.update_sortable()},showed:function(e){dt.baseclass.prototype.showed.apply(this,arguments)
var t=this
...
this.add_css("jquery.mb.YTPlayer/css/YTPlayer.css","mb_YTPlayer"in e.fn,function(){}),this.add_js_list({paths:["jquery.mb.YTPlayer/inc/jquery.mb.YTPlayer.js","jquery-waypoints/waypoints.min.js"],loaded:"waypoint"in e.fn&&"mb_YTPlayer"in e.fn,callback:function(){e(t.dom_element).waypoint(function(){e(t.dom_element).attr("data-property","{videoURL:'"+q(t.attrs.video_youtube)+"',containment:'#"+t.id+"', showControls:false, autoPlay:true, loop:"+n+", mute:"+a+", startAt:"+t.attrs.video_start+", stopAt:"+t.attrs.video_stop+", opacity:1, addRaster:false, quality:'default'}"),e(t.dom_element).mb_YTPlayer(),e(t.dom_element).playYTP()},{offset:"100%",triggerOnce:!0}),e(document).trigger("scroll")}})}},render:function(e,t){this.dom_element=e('<div id="'+this.id+'" class="az-element az-row '+t+"row "+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=this.dom_element,dt.baseclass.prototype.render.apply(this,arguments)}}),Z("az_column",!0,ct),A(ct.prototype,{name:p("Column"),params:[W({type:"textfield",heading:p("Column with"),param_name:"width",hidden:!0})].concat(ct.prototype.params),hidden:!0,is_container:!0,show_parent_controls:!0,get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p("Settings for this row and current column. You can choose columns layout by mouse over (or click) this button: ")+'<span class="'+n+"glyphicon "+n+'glyphicon-th"></span></div></div>'},show_controls:function(){window.azexo_editor&&(ct.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".clone").remove(),e(this.controls).find(".copy").remove(),e(this.controls).find(".remove").remove())},get_my_shortcode:function(){return this.get_children_shortcode()},update_width:function(t){e(this.dom_element).removeClass(U(this.attrs.width,this.parent.attrs.device)),this.attrs.width=t,e(this.dom_element).addClass(U(this.attrs.width,this.parent.attrs.device)),e(document).trigger("azexo_update_element",this.id)},render:function(e){this.dom_element=e('<div class="az-element az-ctnr az-column '+this.attrs.el_class+" "+U(this.attrs.width,this.parent.attrs.device)+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=this.dom_element,ct.baseclass.prototype.render.apply(this,arguments)}}),rt("az_grid",!0,pt),A(pt.prototype,{name:p("Grid"),icon:"fa fa-th-large",description:p("Grid with filter by tags. Every item of grid can contain any number of any types of elements."),category:p("Layout"),params:[W({type:"integer_slider",heading:p("Columns number"),param_name:"columns_number",min:"1",max:"20",value:"3"}),W({type:"checkbox",heading:p("Masonry grid?"),param_name:"masonry",value:{yes:p("Yes, please")}})].concat(pt.prototype.params),is_container:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},update_sortable:function(){function t(e,t){t.placeholder.attr("class",t.helper.attr("class")),t.placeholder.css("width",t.helper.css("width")),t.placeholder.css("height",t.helper.css("height")),t.placeholder.removeClass("ui-sortable-helper"),t.placeholder.addClass("az-sortable-placeholder")}if(window.azexo_editor){var n=this
e(this.dom_element).find("> ul").sortable({items:"> .az-item",connectWith:".az-grid > ul",handle:"> .controls > .drag-and-drop",update:n.update_sorting,placeholder:"az-sortable-placeholder",forcePlaceholderSize:!0,start:t,over:t})}},update_sorting:function(){pt.baseclass.prototype.update_sorting.apply(this,arguments)
for(var t=s.get_element(e(this).closest("[data-az-id]").attr("data-az-id")),n=0;n<t.children.length;n++)t.children[n].update_empty()},show_controls:function(){window.azexo_editor&&(pt.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".add").remove(),e(this.controls).find(".paste").remove(),e(this.controls).find(".clone").remove(),azexo_add_js({path:"js/json2.min.js",loaded:"JSON"in window,callback:function(){}}))},click_add_item:function(e){return e.data.object.add_item(),!1},add_item:function(){var e=new mt(this,!0)
...
for(var i=0;i<t.children.length;i++)a.add_control(t.children[i])},showed:function(e,t){pt.baseclass.prototype.showed.apply(this,arguments)
var n=this
...
i.update_dom(),e(document).trigger("azexo_update_sorting",n)},click_add_tab:function(e){return e.data.object.add_tab(),!1},add_tab:function(){var t=new ut(this,!1)
t.update_dom(),this.update_dom(),e(this.dom_element).find('a[href="#'+t.id+'"]')[a+"tab"]("show")},showed:function(e,t,n){_t.baseclass.prototype.showed.apply(this,arguments),e(this.dom_element).find("ul."+t+"nav-tabs li:first a")[n+"tab"]("show")},render:function(e,t){this.dom_element=e('<div class="az-element az-tabs '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>')
...
this.dom_content_element=e(i).appendTo(this.dom_element),_t.baseclass.prototype.render.apply(this,arguments)}}),Z("az_tab",!0,ut),A(ut.prototype,{name:p("Tab"),params:[W({type:"textfield",heading:p("Tab title"),param_name:"title",value:p("Title")})].concat(ut.prototype.params),hidden:!0,is_container:!0,show_parent_controls:!0,get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p("Settings for this tabs element and for current tab element. ")+'<span class="'+n+"glyphicon "+n+'glyphicon-plus-sign"></span>'+p(" - add a new tab.")+" "+p("Tabs headers are draggable. You can enter tab title by click on this button: ")+'<span class="'+n+"glyphicon "+n+'glyphicon-pencil"></span></div></div>'},show_controls:function(){window.azexo_editor&&(ut.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".drag-and-drop").remove(),e('<span class="control '+n+"btn "+n+"btn-primary "+n+'glyphicon">'+this.name+"</span>").prependTo(this.controls))},get_my_shortcode:function(){return this.get_children_shortcode()},edited:function(){ut.baseclass.prototype.edited.apply(this,arguments),this.parent.update_dom(),e('a[href="#'+this.id+'"]')[a+"tab"]("show")},clone:function(){var t=ut.baseclass.prototype.get_my_shortcode.apply(this,arguments)
e("#azexo-clipboard").html(btoa(encodeURIComponent(t))),this.parent.paste(this.parent.children.length),this.parent.update_dom()},remove:function(){ut.baseclass.prototype.remove.apply(this,arguments),this.parent.update_dom()},render:function(e,t){this.dom_element=e('<div id="'+this.id+'" class="az-element az-ctnr az-tab '+t+"tab-pane "+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=this.dom_element,ut.baseclass.prototype.render.apply(this,arguments)}}),rt("az_accordion",!0,ft),A(ft.prototype,{name:p("Accordion"),icon:"fa fa-bars",description:p("Bootstrap content accordion. Every toggle of this element can contain any number of any types of elements."),category:p("Layout"),params:[W({type:"dropdown",heading:p("Type"),param_name:"type",value:{"panel-default":p("Default"),"panel-primary":p("Primary"),"panel-success":p("Success"),"panel-info":p("Info"),"panel-warning":p("Warning"),"panel-danger":p("Danger")}}),W({type:"checkbox",heading:p("Collapsed?"),param_name:"collapsed",value:{yes:p("Yes, please")}})].concat(ft.prototype.params),is_container:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},show_controls:function(){window.azexo_editor&&(ft.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".add").remove(),e(this.controls).find(".paste").remove(),e('<button title="'+c("Add toggle")+'" class="control add-toggle '+n+"btn "+n+"btn-primary "+n+"glyphicon "+n+'glyphicon-plus-sign" > </button>').appendTo(this.controls).click({object:this},this.click_add_toggle))},update_sortable:function(){window.azexo_editor&&e(this.dom_element).sortable({axis:"y",items:"> .az-toggle",handle:"> .controls > .drag-and-drop",update:this.update_sorting,placeholder:"az-sortable-placeholder",forcePlaceholderSize:!0,over:function(e,t){t.placeholder.attr("class",t.helper.attr("class")),t.placeholder.removeClass("ui-sortable-helper"),t.placeholder.addClass("az-sortable-placeholder")}})},click_add_toggle:function(e){return e.data.object.add_toggle(),!1},add_toggle:function(){var e=new gt(this,!1)
e.update_dom(),this.update_dom()},update_dom:function(){for(var e=0;e<this.children.length;e++)this.children[e].update_dom()
ft.baseclass.prototype.update_dom.apply(this,arguments)},showed:function(e,t,n){ft.baseclass.prototype.showed.apply(this,arguments),e(this.dom_element).find("> .az-toggle > ."+t+"in").removeClass(t+"in"),e(this.dom_element).find("> .az-toggle > ."+t+"collapse:not(:first)")[n+"collapse"]({toggle:!1,parent:"#"+this.id}),e(this.dom_element).find("> .az-toggle > ."+t+"collapse:first")[n+"collapse"]({toggle:"yes"!=this.attrs.collapsed,parent:"#"+this.id})},render:function(e,t){this.dom_element=e('<div id="'+this.id+'" class="az-element az-accordion '+t+"panel-group "+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=this.dom_element,ft.baseclass.prototype.render.apply(this,arguments)}}),Z("az_toggle",!0,gt),A(gt.prototype,{name:p("Toggle"),params:[W({type:"textfield",heading:p("Toggle title"),param_name:"title",value:p("Title")})].concat(gt.prototype.params),hidden:!0,is_container:!0,show_parent_controls:!0,get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p("Settings for this accordion element and for current toggle. ")+'<span class="'+n+"glyphicon "+n+'glyphicon-plus-sign"></span>'+p(" - add a new toggle. You can enter toggle title by click on this button: ")+'<span class="'+n+"glyphicon "+n+'glyphicon-pencil"></span></div></div>'},get_my_shortcode:function(){return this.get_children_shortcode()},clone:function(){var t=gt.baseclass.prototype.get_my_shortcode.apply(this,arguments)
...
""!=this.parent.attrs.type&&(n=this.parent.attrs.type),this.dom_element=e('<div class="az-element az-toggle '+t+"panel "+n+" "+this.attrs.el_class+'" style="'+this.attrs.style+'"><div class="'+t+'panel-heading"><h4 class="'+t+'panel-title"><a data-toggle="collapse" data-parent="#'+this.parent.id+'" href="#'+this.id+'">'+this.attrs.title+'</a></h4></div><div id="'+this.id+'" class="'+t+"panel-collapse "+t+'collapse"><div class="'+t+'panel-body az-ctnr"></div></div></div>'),this.dom_content_element=e(this.dom_element).find("."+t+"panel-body"),gt.baseclass.prototype.render.apply(this,arguments)}}),rt("az_carousel",!0,vt),A(vt.prototype,{name:p("Carousel"),icon:"fa fa-ellipsis-h",description:p("Content carousel. Every slide of this element can contain any number of any types of elements. It can be used for create classic content slider."),category:p("Layout"),params:[W({type:"integer_slider",heading:p("Number items"),param_name:"items",min:"1",max:"10",value:"1"}),W({type:"checkbox",heading:p("Options"),param_name:"options",value:{navigation:p("Navigation"),auto_play:p("Auto play"),mouse:p("Mouse drag"),touch:p("Touch drag")}}),W({type:"dropdown",heading:p("Transition style"),param_name:"transition",value:{"":p("Default"),fade:p("fade"),backSlide:p("backSlide"),goDown:p("goDown"),fadeUp:p("fadeUp")}})].concat(vt.prototype.params),is_container:!0,show_settings_on_create:!0,frontend_render:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},show_controls:function(){if(window.azexo_editor){vt.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".add").remove(),e(this.controls).find(".paste").remove()
e('<button title="'+c("Add slide")+'" class="control add-toggle '+n+"btn "+n+"btn-primary "+n+"glyphicon "+n+'glyphicon-plus-sign" > </button>').appendTo(this.controls).click({object:this},this.click_add_slide)}},update_sortable:function(){},click_add_slide:function(e){return e.data.object.add_slide(),!1},add_slide:function(){var e=new yt(this,!0)
...
e(t.dom_content_element).owlCarousel({singleItem:"1"==t.attrs.items,items:t.attrs.items,navigation:_.indexOf(t.attrs.options.split(","),"navigation")>=0,autoPlay:_.indexOf(t.attrs.options.split(","),"auto_play")>=0,mouseDrag:_.indexOf(t.attrs.options.split(","),"mouse")>=0,touchDrag:_.indexOf(t.attrs.options.split(","),"touch")>=0,transitionStyle:""==t.attrs.transition?!1:t.attrs.transition,stopOnHover:!0,afterAction:function(){n(this.owl)},beforeMove:function(){},afterMove:function(){},startDragging:function(){}}),n(t.dom_content_element.data("owlCarousel"))}})},render:function(e){this.dom_element=e('<div id="'+this.id+'" class="az-element az-carousel '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=e("<div></div>").appendTo(this.dom_element),vt.baseclass.prototype.render.apply(this,arguments)}}),Z("az_slide",!0,yt),A(yt.prototype,{name:p("Slide"),params:[].concat(yt.prototype.params),hidden:!0,frontend_render:!0,is_container:!0,show_parent_controls:!0,get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p("Settings for this carousel element and for current slide. ")+'<span class="'+n+"glyphicon "+n+'glyphicon-plus-sign"></span>'+p(" - add a new slide.")+"</div></div>"},show_controls:function(){window.azexo_editor&&(yt.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".clone").remove(),e(this.controls).find(".drag-and-drop").remove(),e('<span class="control '+n+"btn "+n+"btn-primary "+n+'glyphicon">'+this.name+"</span>").prependTo(this.controls))},get_my_shortcode:function(){return this.get_children_shortcode()},edited:function(){yt.baseclass.prototype.edited.apply(this,arguments),this.parent.update_dom()},render:function(e){var t="panel-default"
""!=this.parent.attrs.type&&(t=this.parent.attrs.type),this.dom_element=e('<div class="az-element az-slide '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=this.dom_element,yt.baseclass.prototype.render.apply(this,arguments)}}),rt("az_presentation",!0,bt),A(bt.prototype,{name:p("Presentation"),icon:"fa fa-file-powerpoint-o",description:p("Content presentation. Every step of presentation can contain any number of any types of elements."),category:p("Layout"),params:[W({type:"integer_slider",heading:p("Height"),param_name:"height",min:"0",max:"2000",value:"900"}),W({type:"checkbox",heading:p("Options"),param_name:"options",value:{navigation:p("Navigation"),auto_play:p("Auto play"),full_filling:p("Full filling available area")}}),W({type:"integer_slider",heading:p("Transition duration"),param_name:"duration",min:"0",max:"10000",value:"1000"})].concat(bt.prototype.params),is_container:!0,highlighted:!1,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},init_scroll_variables:function(){this.hover=!1,this.scroll_top=0,this.transition_duration="0s",this.transition_delay="0s"},show_controls:function(){function t(e,t){var n={x:0,y:0},a=d.config.rotation/180*Math.PI,i=Math.cos(a),o=Math.sin(a)
...
d.config.visualScaling=d.config.visualScaling/o,e(d.dom_content_element).css("transform",i+" scale("+o+")")})}},update_sortable:function(){if(window.azexo_editor);},click_add_step:function(e){return e.data.object.add_step(),!1},add_step:function(){var e=new wt(this,!0)
...
else bt.baseclass.prototype.attach_children.apply(this,arguments)},edited:function(){bt.baseclass.prototype.edited.apply(this,arguments),this.update_dom()},showed:function(e,t){bt.baseclass.prototype.showed.apply(this,arguments)
var n=this
...
""!=this.children[a-1].attrs.name&&(i=this.children[a-1].attrs.name),e('<li><a href="#" class="goto" data-step="'+this.children[a-1].id+'">'+i+"</a></li>").appendTo(n)}e('<li><a href="#" class="'+t+'next">&raquo;</a></li>').appendTo(n)}bt.baseclass.prototype.render.apply(this,arguments)}}),Z("az_step",!0,wt),A(wt.prototype,{name:p("Step"),params:[W({type:"textfield",heading:p("Name"),param_name:"name"}),W({type:"checkbox",heading:p("Options"),param_name:"options",value:{dummy:p("Dummy")}}),W({type:"integer_slider",heading:p("Width"),param_name:"width",min:"1",max:"100000",value:"900"}),W({type:"integer_slider",heading:p("Height"),param_name:"height",min:"1",max:"100000",value:"700"}),W({type:"integer_slider",heading:p("X coordinate"),param_name:"x",min:"-100000",max:"100000",value:"0"}),W({type:"integer_slider",heading:p("Y coordinate"),param_name:"y",min:"-100000",max:"100000",value:"0"}),W({type:"integer_slider",heading:p("Z coordinate"),param_name:"z",min:"-10000",max:"10000",value:"0"}),W({type:"integer_slider",heading:p("X rotate"),param_name:"rotate_x",min:"-180",max:"180",value:"0"}),W({type:"integer_slider",heading:p("Y rotate"),param_name:"rotate_y",min:"-180",max:"180",value:"0"}),W({type:"integer_slider",heading:p("Z rotate"),param_name:"rotate_z",min:"-180",max:"180",value:"0"}),W({type:"integer_slider",heading:p("Scale"),param_name:"scale",min:"0",max:"1000",value:"1",step:"0.01"})].concat(wt.prototype.params),hidden:!0,is_container:!0,show_parent_controls:!0,disallowed_elements:["az_presentation"],highlighted:!1,get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p('Settings for this presentation element and for current step. Press on "Space" button to going through steps. ')+'<span class="'+n+"glyphicon "+n+'glyphicon-plus-sign"></span>'+p(" - add a new step.")+"</div></div>"},get_my_shortcode:function(){return this.get_children_shortcode()},show_controls:function(){wt.baseclass.prototype.show_controls.apply(this,arguments),window.azexo_editor&&(e(this.controls).find(".drag-and-drop").remove(),e('<span class="control '+n+"btn "+n+"btn-primary "+n+'glyphicon">'+this.name+"</span>").prependTo(this.controls))},update_sortable:function(){if(window.azexo_editor){var t=this
e(this.dom_element).resizable({stop:function(){t.attrs.width=e(t.dom_element).width(),t.attrs.height=e(t.dom_element).height(),e(document).trigger("azexo_update_element",t.id),"impress"in t.parent&&t.impress.initStep(t.dom_element.get(0))}})}},clone:function(){var t=wt.baseclass.prototype.get_my_shortcode.apply(this,arguments)
e("#azexo-clipboard").html(btoa(encodeURIComponent(t)))
for(var n=0;n<this.parent.children.length;n++)if(this.parent.children[n].id==this.id){this.parent.paste(n)
break}this.parent.update_dom()},edited:function(){wt.baseclass.prototype.edited.apply(this,arguments)
var e=this
"impress"in e.parent&&e.parent.impress.initStep(e.dom_element.get(0))},remove:function(){wt.baseclass.prototype.remove.apply(this,arguments),this.parent.update_dom()},render:function(e){this.dom_element=e('<div id="'+this.id+'" class="az-element az-step step '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),e(this.dom_element).css("width",this.attrs.width),e(this.dom_element).css("height",this.attrs.height),e(this.dom_element).attr("data-x",this.attrs.x),e(this.dom_element).attr("data-y",this.attrs.y),e(this.dom_element).attr("data-z",this.attrs.z),e(this.dom_element).attr("data-rotate-x",this.attrs.rotate_x),e(this.dom_element).attr("data-rotate-y",this.attrs.rotate_y),e(this.dom_element).attr("data-rotate",this.attrs.rotate_z),e(this.dom_element).attr("data-scale",this.attrs.scale),this.dom_content_element=this.dom_element,wt.baseclass.prototype.render.apply(this,arguments)}}),rt("az_container",!0,xt),A(xt.prototype,{name:p("Container"),icon:"fa fa-archive",description:p("AJAX loaded content from server. Content can be edited and saved to server."),category:p("Layout"),params:[W({type:"container",heading:p("Container"),param_name:"container",description:p("Type and name used as identificator to save container on server."),value:"/"})].concat(xt.prototype.params),show_settings_on_create:!0,is_container:!0,hidden:!window.azexo_online,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},get_empty:function(){return'<div class="az-empty"><div class="top '+n+'well"><strong>'+p("Click to put an element here.")+'</strong></div><div class="top-right '+n+'well"><h1>↗</h1><span class="'+n+"glyphicon "+n+'glyphicon-eye-open"></span>'+p(" - toggle editor helpers.")+' <span class="'+n+"glyphicon "+n+'glyphicon-play-circle"></span>'+p(" - toggle animation engine to not hinder editing.")+' <span class="'+n+"glyphicon "+n+'glyphicon-save"></span>'+p(" - save results of editing on server.")+"</div></div>"},show_controls:function(){if(window.azexo_editor){var t=this
xt.baseclass.prototype.show_controls.apply(this,arguments),null==this.parent&&(e('<button title="'+c("Toggle editor")+'" class="control toggle-editor '+n+"btn "+n+"btn-default "+n+"glyphicon "+n+'glyphicon-eye-open" > </button>').appendTo(this.controls).click(function(){return e(t.dom_element).toggleClass("azexo-editor"),!1}),e('<button title="'+c("Toggle animations")+'" class="control toggle-animations '+n+"btn "+n+"btn-default "+n+"glyphicon "+n+'glyphicon-play-circle" > </button>').appendTo(this.controls).click(function(){return e(t.dom_element).toggleClass("azexo-animations-disabled"),!1}),e(this.controls).removeClass(n+"btn-group-xs"),e(this.controls).find(".edit").remove(),e(this.controls).find(".copy").remove(),e(this.controls).find(".clone").remove(),e(this.controls).find(".remove").remove(),e(this.controls).find(".js-animation").remove(),e(this.controls).find(".drag-and-drop").attr("title",""),e(this.controls).find(".drag-and-drop").removeClass(n+"glyphicon"),e(this.controls).find(".drag-and-drop").removeClass(n+"glyphicon-move"),e(this.controls).find(".drag-and-drop").removeClass("drag-and-drop")),e('<button title="'+c("Save container")+'" class="control save-container '+n+"btn "+n+"btn-success "+n+"glyphicon "+n+'glyphicon-save" > </button>').appendTo(this.controls).click({object:this},this.click_save_container)}},get_my_shortcode:function(){return this.get_children_shortcode()},get_container_html:function(){function t(e,t,n){return n&&!e.hasOwnProperty(t)?"":t+": "+e[t]+",\n"}function i(e,t,n){return n&&!e.hasOwnProperty(t)?"":t+": "+JSON.stringify(e[t])+",\n"}function o(n,a){var o="{"
...
return t}function f(){var t="(function("+At+") {\n"
if(t+="if('azexo_backend' in window) return;\n",t+="var "+Rt+" = true;\n",t+="var "+Ut+" = '"+n+"';var "+Lt+" = '"+a+"';\n",t+=""+p+"\n",t+=""+m+"\n",t+=""+v+"\n",t+=""+D+"\n",t+=""+A+"\n",t+=""+R+"\n",t+=""+L+"\n",t+=At+".fn.closest_descendents = "+e.fn.closest_descendents+" \n",t+=""+F+"\n",t+=F.name+".prototype.safe = true;\n",t+=F.name+".prototype.param_types = {};\n",t+=""+W+"\n",t+="window.azexo_add_css="+window.azexo_add_css+"\n",t+="window.azexo_add_js="+window.azexo_add_js+"\n",t+="window.azexo_add_js_list="+window.azexo_add_js_list+"\n",t+="var "+Et+" = {};\n",t+="var "+Bt+" = {};\n",t+="window.azexo_add_external_js="+window.azexo_add_external_js+"\n",t+=""+G+"\n",t+=G.name+".prototype.elements_instances = {};\n",t+=G.name+".prototype.elements_instances_by_an_name = {};\n",t+=s(G,"get_element",!0),t+=s(G,"delete_element",!0),t+=s(G,"add_element",!0),t+=""+K+"\n",t+=K.name+".prototype.p = '"+n+"';\n",t+=K.name+".prototype.fp = '"+a+"';\n",t+=K.name+".prototype.elements = {};\n",t+=K.name+".prototype.tags = {};\n",t+=r(K),t+=s(K,"get_hover_style",!0),t+=s(K,"showed",!0),t+=s(K,"render",!0),t+=s(K,"recursive_render",!0),t+=s(K,"replace_render",!0),t+=s(K,"update_dom",!0),t+=s(K,"attach_children",!0),t+=s(K,"detach_children",!0),t+=s(K,"recursive_showed",!0),t+=s(K,"parse_attrs",!0),t+=s(K,"parse_html",!0),t+=s(K,"add_css",!0),t+=s(K,"add_js_list",!0),t+=s(K,"add_js",!0),t+=s(K,"add_external_js",!0),t+=s(K,"get_my_container",!0),"an_start"in x&&(t+=s(K,"trigger_start_in_animation",!0),t+=s(K,"trigger_start_out_animation",!0)),t+=""+Z+"\n",t+=""+et+"\n",t+=Z.name+"('az_unknown', true, "+et.name+");\n",t+="window.azexo_baseurl = '"+window.azexo_baseurl+"';\n","azexo_lang"in window&&(t+="window.azexo_lang = '"+window.azexo_lang+"';\n"),"recaptcha_publickey"in window&&(t+="window.recaptcha_publickey = '"+window.recaptcha_publickey+"';\n"),t+="window.azexo_online = (window.location.protocol == 'http:' || window.location.protocol == 'https:');\n",t+="var "+Mt+" = new "+G.name+"();\n",t+="var "+Nt+" = null;\n",t+="window.azexo_editor = false;\n",t+="var "+Yt+" = [];\n",t+="var "+qt+" = {};\n",t+=""+it+"\n",t+=""+st+"\n",t+=D.name+"("+st.name+", "+K.name+");\n",t+=r(st),"an_start"in x&&(t+=s(st,"set_in_timeout",!0),t+=s(st,"start_in_animation",!0),t+=s(st,"set_out_timeout",!0),t+=s(st,"start_out_animation",!0),t+=s(st,"clear_animation",!0),t+=s(st,"end_animation",!0),t+=s(st,"trigger_start_in_animation",!0),t+=s(st,"trigger_start_out_animation",!0),t+=s(st,"animation",!0)),("an_scenes"in x||"an_js"in x)&&(t+=s(st,"make_timeline",!0)),"an_scenes"in x&&(t+=s(st,"update_scroll_animation",!0)),"an_letters"in x&&(t+=s(st,"animation_letters",!0)),("an_start"in x||"an_scenes"in x)&&(t+=s(st,"showed",!0)),t+=s(st,"render",!0),t+=""+rt+"\n",t+=""+kt+"\n",t+=D.name+"("+kt.name+", "+st.name+");\n",t+=kt.name+".prototype.form_elements = {};\n",t+=""+Tt+"\n",lt.prototype.base in w&&(t+=""+lt+"\n",t+=rt.name+"('"+lt.prototype.base+"', true, "+lt.name+");\n",t+=r(lt)),dt.prototype.base in w&&(t+=""+dt+"\n",t+=rt.name+"('"+dt.prototype.base+"', true, "+dt.name+");\n",t+=r(dt),t+=s(dt,"showed",!0),t+=dt.name+".prototype.set_columns = function(columns){};\n",t+=""+ct+"\n",t+=Z.name+"('"+ct.prototype.base+"', true, "+ct.name+");\n",t+=r(ct),t+=s(ct,"showed",!0)),pt.prototype.base in w&&(t+=""+pt+"\n",t+=rt.name+"('"+pt.prototype.base+"', true, "+pt.name+");\n",t+=r(pt),t+=pt.name+".prototype.attach_events = function(){};\n",t+=s(pt,"showed",!0),t+=s(pt,"render",!0),t+=""+mt+"\n",t+=Z.name+"('"+mt.prototype.base+"', true, "+mt.name+");\n",t+=r(mt),t+=s(mt,"showed",!0),t+=s(mt,"render",!0)),ht.prototype.base in w&&(t+=""+ht+"\n",t+=rt.name+"('"+ht.prototype.base+"', true, "+ht.name+");\n",t+=r(ht),t+=s(ht,"showed",!0)),_t.prototype.base in w&&(t+=""+_t+"\n",t+=rt.name+"('"+_t.prototype.base+"', true, "+_t.name+");\n",t+=r(_t),t+=s(_t,"showed",!0),t+=s(_t,"render",!0),t+=""+ut+"\n",t+=Z.name+"('"+ut.prototype.base+"', true, "+ut.name+");\n",t+=r(ut),t+=s(ut,"render",!0)),ft.prototype.base in w&&(t+=""+ft+"\n",t+=rt.name+"('"+ft.prototype.base+"', true, "+ft.name+");\n",t+=r(ft),t+=s(ft,"showed",!0),t+=s(ft,"render",!0),t+=""+gt+"\n",t+=Z.name+"('"+gt.prototype.base+"', true, "+gt.name+");\n",t+=r(gt),t+=s(gt,"render",!0),t+=s(gt,"showed",!0)),vt.prototype.base in w&&(t+=""+vt+"\n",t+=rt.name+"('"+vt.prototype.base+"', true, "+vt.name+");\n",t+=r(vt),t+=vt.name+".prototype.frontend_render = true;\n",t+=s(vt,"showed",!0),t+=s(vt,"render",!0),t+=""+yt+"\n",t+=Z.name+"('"+yt.prototype.base+"', true, "+yt.name+");\n",t+=r(yt),t+=yt.name+".prototype.frontend_render = true;\n",t+=s(yt,"showed",!0),t+=s(yt,"render",!0)),bt.prototype.base in w&&(t+=""+bt+"\n",t+=rt.name+"('"+bt.prototype.base+"', true, "+bt.name+");\n",t+=r(bt),t+=bt.name+".prototype.frontend_render = true;\n",t+=s(bt,"showed",!0),t+=s(bt,"render",!0),t+=""+wt+"\n",t+=Z.name+"('"+wt.prototype.base+"', true, "+wt.name+");\n",t+=r(wt)),xt.prototype.base in w&&(t+=""+xt+"\n",t+=rt.name+"('"+xt.prototype.base+"', true, "+xt.name+");\n",t+=r(xt),t+=s(xt,"showed",!0),t+=s(xt,"load_container",!0),t+=s(xt,"update_dom",!0),t+=s(xt,"render",!0),t+=s(xt,"recursive_render",!0)),zt.prototype.base in w&&(t+=""+zt+"\n",t+=Z.name+"('"+zt.prototype.base+"', false, "+zt.name+");\n",t+=r(zt),t+=s(zt,"showed",!0)),jt.prototype.base in w&&(t+=""+O+"\n",t+=""+jt+"\n",t+=rt.name+"('"+jt.prototype.base+"', true, "+jt.name+");\n",t+=r(jt),t+=s(jt,"showed",!0),t+=""+S+"\n"),"azexo_elements"in window){t+="window.azexo_elements = [];\n"
...
for(var i=0;i<window.azexo_extend.length;i++)t+="window.azexo_extend.push("+o(window.azexo_extend[i],!0)+");\n"}if(t+=""+St+"\n",t+=St.name+"();\n",t+=""+Ot+"\n",t+=Ot.name+"();\n",t+=""+Ct+"\n",t+=Ct.name+"();\n",window.azexo_online)hashCode=function(e){return e.split("").reduce(function(e,t){return e=(e<<5)-e+t.charCodeAt(0),e&e},0)},t+=At+"(document).ready(function(){"+it.name+"("+At+"('[data-az-hash=\""+hashCode(t)+"\"]'));});\n"
else{var d=b.attrs.container.split("/")[0],c=b.attrs.container.split("/")[1]
t+=At+"(document).ready(function(){"+it.name+"("+At+"('[data-az-type=\""+d+'"][data-az-name="'+c+"\"]'));});\n"}return t+="})(window.jQuery);\n"}function g(e){var t=""
...
e(z).find(".az-element > .controls").remove(),e(z).find("> .controls").remove(),e(z).find(".az-step-controls").remove(),e(z).find(".az-empty").remove(),e(z).find(".ui-resizable-e").remove(),e(z).find(".ui-resizable-s").remove(),e(z).find(".ui-resizable-se").remove(),e(z).find(".ui-draggable").removeClass("ui-draggable"),e(z).find(".ui-resizable").removeClass("ui-resizable"),e(z).find(".ui-sortable").removeClass("ui-sortable"),e(z).find(".az-element.az-container > .az-ctnr").empty(),e(z).find(".az-element.az-cms-element").empty()
var j=""
return(h(b)||"an_start"in x||"an_scenes"in x)&&(j='<script type="text/javascript">\n//<![CDATA[\n'+f()+"//]]>\n</script>\n"),y(b)+u(b)+g(b)+j+e(z).html()},click_save_container:function(e){return e.data.object.save_container(),!1},save_container:function(){var e=this
...
for(var o=0;o<n.children.length;o++)n.children[o].recursive_showed()
e(document).trigger("scroll")}})},clone:function(){xt.baseclass.prototype.clone.apply(this,arguments),this.rendered=!0},recursive_render:function(){t?(this.render(e,n,a),this.children=[]):xt.baseclass.prototype.recursive_render.apply(this,arguments),window.azexo_editor&&(this.show_controls(),this.update_sortable())},update_dom:function(){this.loaded_container!=this.attrs.container&&(this.children=[],e(this.dom_content_element).empty(),this.rendered=!1,null!=this.parent&&xt.baseclass.prototype.update_dom.apply(this,arguments))},showed:function(e){xt.baseclass.prototype.showed.apply(this,arguments)
var t=this
this.add_js({path:"jquery-waypoints/waypoints.min.js",loaded:"waypoint"in e.fn,callback:function(){e(t.dom_element).waypoint(function(){t.rendered||(t.rendered=!0,t.load_container())},{offset:"100%",triggerOnce:!0}),e(document).trigger("scroll")}})},render:function(e){this.dom_element=e('<div class="az-element az-container"><div class="az-ctnr"></div></div>'),this.dom_content_element=e(this.dom_element).find(".az-ctnr"),xt.baseclass.prototype.render.apply(this,arguments)}}),dt.prototype.params.push(W({type:"textfield",heading:p("Menu item title"),param_name:"menu_item_title",description:p("Title which will be used in scroll menu."),tab:p("Menu")})),Z("az_scroll_menu",!1,zt),A(zt.prototype,{name:p("Scroll Menu"),icon:"fa fa-sitemap",description:p("One page scroll menu"),params:[W({type:"image",heading:p("Logo"),param_name:"logo",description:p("Select image from media library.")}),W({type:"link",heading:p("Logo link"),param_name:"logo_link"})].concat(zt.prototype.params),showed:function(e,t,n){this.navbar_height=e(this.dom_element).find("."+t+"navbar").height(),zt.baseclass.prototype.showed.apply(this,arguments)
var a=this
...
s+="</ul>",e(o).append(s),e(this.dom_element).find("."+t+"container-fluid").append(a).append(o),zt.baseclass.prototype.render.apply(this,arguments)}}),rt("az_form",!0,jt),A(jt.prototype,{name:p("Form"),icon:"fa fa-envelope-o",description:p("Form container. Can contain form elements for user input and any number of any other elements types."),category:p("Layout"),params:[W({type:"textfield",heading:p("Name"),param_name:"name",description:p("Required."),required:!0}),W({type:"textfield",heading:p("Submit button title"),param_name:"submit_title",value:p("Submit")}),W({type:"textfield",heading:p("Submited message"),param_name:"submited_message",value:p("Submited")})].concat(jt.prototype.params),is_container:!0,hidden:!window.azexo_online,show_settings_on_create:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><p>'+this.name+'</p><p class="'+n+"text-muted "+n+'small">'+this.description+"</p></div>"},get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p("You can add form element by mouse over this button: ")+'<span class="'+n+"glyphicon "+n+'glyphicon-plus-sign"></span> '+p("You can see all submissions by click on this button: ")+'<span class="'+n+"glyphicon "+n+'glyphicon-list-alt"></span></div></div>'},show_controls:function(){if(window.azexo_editor){jt.baseclass.prototype.show_controls.apply(this,arguments)
var t=this
...
C(i.attrs.container.split("/")[0],i.attrs.container.split("/")[1],t.attrs.name,function(i){e("#az-form-modal").remove()
...
return O(n.attrs.container.split("/")[0],n.attrs.container.split("/")[1],t.attrs.name,e(t.dom_element).serialize(),function(e){e&&t.dom_element.prepend($(t.attrs.submited_message))}),!1})},render:function(e,t){this.dom_element=e('<form class="az-element az-form '+this.attrs.el_class+'" style="'+this.attrs.style+'" role="form" enctype="multipart/form-data"></form>'),this.dom_content_element=e('<div class="az-ctnr"></div>').appendTo(this.dom_element),e('<div class="'+t+'form-group"><div id="captcha_'+this.id+'"></div></div>').appendTo(this.dom_element),e('<div class="'+t+'form-group"><button class="'+t+"btn "+t+"btn-lg "+t+'btn-primary" type="submit">'+this.attrs.submit_title+"</button></div>").appendTo(this.dom_element),jt.baseclass.prototype.render.apply(this,arguments)}}),D(kt,st),A(kt.prototype,{form_elements:{},show_parent_controls:!0,params:[W({type:"textfield",heading:p("Name"),param_name:"name",description:p("Required."),required:!0}),W({type:"checkbox",heading:p("Field is required?"),param_name:"required",value:{yes:p("Yes, please")}})].concat(kt.prototype.params)}),St(),Ot(),Ct(),It(),Pt()}(window.jQuery,!1,"","",{},{},{},null,[],{})