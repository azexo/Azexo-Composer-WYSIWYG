...
for($t=0;$t<e.length;$t++){var n=e.charCodeAt($t),a=7^n
...
return s!==!1&&r!==!1?a+12*s/r:a+"12"}function L(e){return _.isString(e)?e.replace(/(\`{2})/g,'"'):e}function E(e){return decodeURIComponent((e+"").replace(/%(?![\da-f]{2})/gi,function(){return"%25"}))}function M(e,t,n){var a=new Date
...
return A(t,e),t}function W(){W.baseclass.apply(this,arguments)}function V(e){var t=document.createElement("div")
...
o.id==r&&e(l.dom_element).find("."+n+"navbar")[a+"affix"]({offset:{top:e(l.dom_element).find("."+n+"navbar").offset().top,bottom:0}})})}function zt(){zt.baseclass.apply(this,arguments)}function jt(){jt.baseclass.apply(this,arguments)}function kt(e,t){D(t,jt),t.prototype.base=e,jt.prototype.elements[e]=t,jt.prototype.tags[e]=t,jt.prototype.form_elements[e]=t}function Tt(){if("azexo_elements"in window)for(var e=0;e<window.azexo_elements.length;e++){var t=window.azexo_elements[e],n=function(){n.baseclass.apply(this,arguments)}
...
kt(t.base,n),t.baseclass=n.baseclass,t.params=t.params.concat(n.prototype.params),A(n.prototype,t)
for(var a=0;a<n.prototype.params.length;a++){var i=n.prototype.params[a],o=J(i)
...
var Pt=(""+arguments.callee).replace(/((\/\/.*$)|(\/\*[\s\S]*?\*\/)|(\s))/gm,"").match(/^function\s*[^\(]*\(\s*([^\)]*)\)/m)[1].split(/,/),Dt=Pt[0],At=Pt[1],Rt=Pt[2],Ut=Pt[3],Lt=Pt[4],Et=Pt[5],Mt=Pt[6],Bt=Pt[7],Nt=Pt[8],Yt=Pt[9]
...
return o.call(i,n),e("#az-editor-modal")[a+"modal"]("hide"),!1}),e("#az-editor-modal")[a+"modal"]("show")},opened:function(){},closed:function(){},render:function(){}},X("container",W),A(W.prototype,{get_value:function(){return e(this.dom_element).find('input[name="'+this.param_name+'_type"]').val()+"/"+e(this.dom_element).find('input[name="'+this.param_name+'_name"]').val()},render:function(t){var a=t.split("/")[0],i=t.split("/")[1]
...
t.length>0&&this.render_form(t)},render:function(t){this.form_value=t,this.dom_element=e('<div class="'+n+'form-group"></div>')},opened:function(){"instance"in this&&this.render_form(this.instance)}}),"azexo_param_types"in window)for(var $t=0;$t<window.azexo_param_types.length;$t++){var Ft=window.azexo_param_types[$t],Xt=function(){Xt.baseclass.apply(this,arguments)}
X(Ft.type,Xt),Ft.baseclass=Xt.baseclass,A(Xt.prototype,Ft)}if(window.azexo_add_css=function(t,n){var a=window.azexo_baseurl+t
...
var n=it(i)
e(t).data("azexo_composer",n),n.save_container=function(){azexo_add_js({path:"js/json2.min.js",loaded:"JSON"in window,callback:function(){_.defer(function(){if(n.id in s.elements_instances){var a=n.get_container_html()
...
for(var t in s.elements_instances_by_an_name)for(var n=0;n<s.elements_instances_by_an_name[t].an_scenes.length;n++)"-1"==s.elements_instances_by_an_name[t].an_scenes[n].duration&&(e[t+"-"+n]=n+" "+p("scene in")+" "+t+" "+p("animations set"))
...
o.animations_editor=e('<div class="tree '+n+'col-sm-5"></div><div class="options '+n+'col-sm-7"></div>').appendTo(t),azexo_add_css("jstree/dist/themes/default/style.min.css",function(){})
var r=""
...
var d=o.an_scenes.length-1,c=o.an_name
i({id:c+"-"+d,title:d+" "+p("scene in")+" "+c+" "+p("animations set")})}}function h(){e(t).find(".options").empty()}function u(e){var t=j.jstree("get_children_dom",e).length,n=j.jstree("create_node",e,{type:"step",text:p("Step")+":"+t,state:{opened:!0}},"last")
...
if(a>-1)return[t,n,a]}}}return!1}function y(){for(var e=0;e<o.an_scenes.length;e++){var t=j.jstree("create_node","#",{type:"scene",text:r(o.an_scenes[e]),state:{opened:!0}},"last")
b[t]=o.an_scenes[e],w[t]="scene"
for(var n=0;n<o.an_scenes[e].timeline.length;n++){var a=j.jstree("create_node",t,{type:"step",text:p("Step")+":"+n,state:{opened:!0}},"last")
b[a]=o.an_scenes[e].timeline[n],w[a]="step",x[a]=t
for(var i=0;i<o.an_scenes[e].timeline[n].tweens.length;i++){var s=j.jstree("create_node",a,{type:"tween",text:l(o.an_scenes[e].timeline[n].tweens[i]),state:{opened:!0}},"last")
b[s]=o.an_scenes[e].timeline[n].tweens[i],w[s]="tween",x[s]=a}}}}var b={},w={},x={}
...
""!=this.children[a-1].attrs.name&&(i=this.children[a-1].attrs.name),e('<li><a href="#" class="goto" data-step="'+this.children[a-1].id+'">'+i+"</a></li>").appendTo(n)}e('<li><a href="#" class="'+t+'next">&raquo;</a></li>').appendTo(n)}yt.baseclass.prototype.render.apply(this,arguments)}}),Z("az_step",!0,bt),A(bt.prototype,{name:p("Step"),params:[J({type:"textfield",heading:p("Name"),param_name:"name"}),J({type:"checkbox",heading:p("Options"),param_name:"options",value:{dummy:p("Dummy")}}),J({type:"integer_slider",heading:p("Width"),param_name:"width",min:"1",max:"100000",value:"900"}),J({type:"integer_slider",heading:p("Height"),param_name:"height",min:"1",max:"100000",value:"700"}),J({type:"integer_slider",heading:p("X coordinate"),param_name:"x",min:"-100000",max:"100000",value:"0"}),J({type:"integer_slider",heading:p("Y coordinate"),param_name:"y",min:"-100000",max:"100000",value:"0"}),J({type:"integer_slider",heading:p("Z coordinate"),param_name:"z",min:"-10000",max:"10000",value:"0"}),J({type:"integer_slider",heading:p("X rotate"),param_name:"rotate_x",min:"-180",max:"180",value:"0"}),J({type:"integer_slider",heading:p("Y rotate"),param_name:"rotate_y",min:"-180",max:"180",value:"0"}),J({type:"integer_slider",heading:p("Z rotate"),param_name:"rotate_z",min:"-180",max:"180",value:"0"}),J({type:"integer_slider",heading:p("Scale"),param_name:"scale",min:"0",max:"1000",value:"1",step:"0.01"})].concat(bt.prototype.params),hidden:!0,is_container:!0,show_parent_controls:!0,disallowed_elements:["az_presentation"],highlighted:!1,get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p('Settings for this presentation element and for current step. Press on "Space" button to going through steps. ')+'<span class="'+n+"glyphicon "+n+'glyphicon-plus-sign"></span>'+p(" - add a new step.")+"</div></div>"},get_my_shortcode:function(){return this.get_children_shortcode()},show_controls:function(){bt.baseclass.prototype.show_controls.apply(this,arguments),window.azexo_editor&&(e(this.controls).find(".drag-and-drop").remove(),e('<span class="control '+n+"btn "+n+"btn-primary "+n+'glyphicon">'+this.name+"</span>").prependTo(this.controls))},update_sortable:function(){if(window.azexo_editor){var t=this
...
for(var i=0;i<window.azexo_extend.length;i++)t+="window.azexo_extend.push("+o(window.azexo_extend[i],!0)+");\n"}if(t+=""+Tt+"\n",t+=Tt.name+"();\n",t+=""+St+"\n",t+=St.name+"();\n",t+=""+Ot+"\n",t+=Ot.name+"();\n",window.azexo_online)hashCode=function(e){return e.split("").reduce(function(e,t){return e=(e<<5)-e+t.charCodeAt(0),e&e},0)},t+=Dt+"(document).ready(function(){"+it.name+"("+Dt+"('[data-az-hash=\""+hashCode(t)+"\"]'));});\n"
else{var d=b.attrs.container.split("/")[0],c=b.attrs.container.split("/")[1]
t+=Dt+"(document).ready(function(){"+it.name+"("+Dt+"('[data-az-type=\""+d+'"][data-az-name="'+c+"\"]'));});\n"}return t+="})(window.jQuery);\n"}function v(e){var t=""
...
for(var o in jt.prototype.form_elements){var s=jt.prototype.form_elements[o].prototype
