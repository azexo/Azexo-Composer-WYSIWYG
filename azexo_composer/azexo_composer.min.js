...
P(function(t){t.length>0&&"0"!=t&&"false"!=t&&(s=e(t).on("keydown.azexo",function(t){13==t.keyCode&&e("#az-admin-modal").find(".save").click()}),e(i).find("."+n+"modal-body").append(s),window.azexo_editor&&e('<button type="button" class="'+n+"btn "+n+'btn-default" data-dismiss="'+n+'modal">'+p("Logout")+"</button>").appendTo("#az-admin-modal .modal-footer").click(function(){X("azexo_password","",null),window.location.reload()}),e("#az-admin-modal").find(".save").click(function(){return A(s.serialize(),function(t){t&&window.location.reload(),e("#az-admin-modal")[a+"modal"]("hide")}),!1}),e("#az-admin-modal")[a+"modal"]("show"))})}function ft(){dn||(dn=!0,e(".az-container").each(function(){var e=_t(this)
...
B=!1}else t.uploaded.length>0&&e(y).append('<div class="'+n+"alert "+n+'alert-info">'+t.uploaded[0]+" uploaded</div>"),t.count>0?(0==a&&(a=t.count),e(g).show().find("."+n+"progress-bar").css("width",(a-t.count)/a*100+"%"),B=!0,M(JSON.stringify({}),t.site_path,JSON.stringify(t.files),vn.host,vn.username,vn.password,vn.port,vn.directory,o)):(e(g).show().find("."+n+"progress-bar").css("width","100%"),e(y).append('<div class="'+n+"alert "+n+'alert-success">'+p("Done")+"</div>"),B=!1)}
...
dt(_,!1,v)
var g=e("<div>"+u+"</div>"),y=e(g).find("."+n+"container, ."+n+"container-fluid, .az-rootable").length>0
...
r()}function o(){for(var t=0;t<l.sortable.length;t++)e(l.dom_content_element).find(l.sortable[t]).hasClass("ui-sortable")&&(e(l.dom_content_element).find(l.sortable[t]).sortable("destroy"),e(l.dom_content_element).find(l.sortable[t]).find(".ui-sortable-handle").removeClass("ui-sortable-handle"))}function i(){for(var t=0;t<l.sortable.length;t++)e(l.dom_element).find(l.sortable[t]).sortable({items:"> *",placeholder:"az-sortable-placeholder",forcePlaceholderSize:!0,start:function(t,n){e(n.item).removeClass("sortable-highlight").find(".az-sortable-controls").remove()},update:function(){a()},over:function(e,t){t.placeholder.attr("class",t.helper.attr("class")),t.placeholder.removeClass("ui-sortable-helper"),t.placeholder.addClass("az-sortable-placeholder")}})}function r(){function t(t){if(e(t).hasClass("sortable-highlight")){e(t).find(".az-sortable-controls").remove()
var n=e('<div class="az-sortable-controls"></div>').appendTo(t),i=e('<div class="az-sortable-clone glyphicon glyphicon-repeat" title="'+p("Clone")+'"></div>').appendTo(n).click(function(){return o(),e(t).removeClass("sortable-highlight").find(".az-sortable-controls").remove(),e(t).clone().insertAfter(t),l.attrs.content=e(l.dom_content_element).html(),a(),r(),!1})
e(i).css("line-height",e(i).height()+"px").css("font-size",e(i).height()/2+"px")
var s=e('<div class="az-sortable-remove glyphicon glyphicon-remove" title="'+p("Remove")+'"></div>').appendTo(n).click(function(){return o(),e(t).removeClass("sortable-highlight").find(".az-sortable-controls").remove(),e(t).remove(),l.attrs.content=e(l.dom_content_element).html(),a(),r(),!1})
e(s).css("line-height",e(s).height()+"px").css("font-size",e(s).height()/2+"px")}}for(var n=0;n<l.styleable.length;n++)e(l.dom_element).find(l.styleable[n]).off("mouseenter.az-able").on("mouseenter.az-able",function(){e(this).addClass("styleable-highlight")}),e(l.dom_element).find(l.styleable[n]).off("mouseleave.az-able").on("mouseleave.az-able",function(){e(this).removeClass("styleable-highlight")}),e(l.dom_element).find(l.styleable[n]).off("click.az-able").on("click.az-able",function(){return 0==e(this).parent().closest(".styleable-highlight, .editable-highlight").length?(s.edit_stack.push({node:this,edit:!1,style:!0}),d(),!1):void s.edit_stack.push({node:this,edit:!1,style:!0})})
for(var n=0;n<l.editable.length;n++)e(l.dom_element).find(l.editable[n]).off("mouseenter.az-able").on("mouseenter.az-able",function(){e(this).addClass("editable-highlight")}),e(l.dom_element).find(l.editable[n]).off("mouseleave.az-able").on("mouseleave.az-able",function(){e(this).removeClass("editable-highlight")}),e(l.dom_element).find(l.editable[n]).off("click.az-able").on("click.az-able",function(){return 0==e(this).parent().closest(".styleable-highlight, .editable-highlight").length?(s.edit_stack.push({node:this,edit:!0,style:!0}),d(),!1):void s.edit_stack.push({node:this,edit:!0,style:!0})})
var c=[],m=null,h=null
e(l.dom_element).off("mousemove.az-able").on("mousemove.az-able",function(){null!=m&&e(m).hasClass("sortable-highlight")&&(clearTimeout(h),h=setTimeout(function(){t(m)},1e3))})
for(var n=0;n<l.sortable.length;n++)!function(n){e(l.dom_element).find(l.sortable[n]).find("> *").off("mouseenter.az-able").on("mouseenter.az-able",function(){var n=this
e(l.dom_element).find(".az-sortable-controls").remove(),e(l.dom_element).find(".sortable-highlight").removeClass("sortable-highlight"),null!==m&&clearTimeout(h),e(n).addClass("sortable-highlight"),c.push(n),m=n,h=setTimeout(function(){t(n)},1e3)}),e(l.dom_element).find(l.sortable[n]).find("> *").off("mouseleave.az-able").on("mouseleave.az-able",function(){var n=this
e(l.dom_element).find(".az-sortable-controls").remove(),e(l.dom_element).find(".sortable-highlight").removeClass("sortable-highlight"),null!==m&&clearTimeout(h),c.pop(),c.length>0?(n=c[c.length-1],e(n).addClass("sortable-highlight"),m=n,h=setTimeout(function(){t(n)},1e3)):m=null})}(n)
...
i>40&&t>i?e(this.controls).css("top",i):i>t?e(this.controls).css("top",t-40):e(this.controls).css("top",40)}}},update_controls_zindex:function(){function t(t){var n=parseInt(e(t).css("z-index"))
return e(t).parent().find("*").each(function(){var t=parseInt(e(this).css("z-index"))
t>n&&(n=t)}),n}var n=t(this.controls)
e(this.controls).css("z-index",n+1)},show_controls:function(){if(window.azexo_editor){var t=this
...
o.update_dom(),e(document).trigger("azexo_update_sorting",a)}},click_add_tab:function(e){return e.data.object.add_tab(),!1},add_tab:function(){var t=new Tt(this,!1)
