...
e(document).trigger("azexo_restore",{dom:t}),this.attrs.content=e(t).html()},get_content:function(){return this.restore_content(),this.attrs.content},restore:function(t){ht.prototype.restore.apply(this,arguments)
for(var n in this.restore_nodes)e(t).find('[data-az-restore="'+n+'"]').html(this.restore_nodes[n])
