...
e.ajax({url:a,cache:!1}).done(function(e){n(e)}).fail(function(){n("")})}}function j(t,n){"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_save_template",url:window.location.href,name:t,template:n},cache:!1,context:this}).done(function(){}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"save_template",name:t,template:n},cache:!1,context:this}).done(function(){})}function T(t){"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_delete_template",url:window.location.href,name:t},cache:!1,context:this}).done(function(){}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"delete_template",name:t},cache:!1,context:this}).done(function(){})}function O(t){window.azexo_online?"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_get_recaptcha_publickey"},cache:!1,context:this}).done(function(e){t(e)}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"get_recaptcha_publickey"},cache:!1,context:this}).done(function(e){t(e)}):t("")}function S(t,n,a,i,o){window.azexo_online?"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_submit_form",container_type:t,container_name:n,name:a,values:i},dataType:"json",cache:!1,context:this}).done(function(e){o(e)}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"submit_form",name:a,values:i},dataType:"json",cache:!1,context:this}).done(function(e){o(e)}):o("")}function C(t,n,a,i){window.azexo_online?"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_load_submissions",container_type:t,container_name:n,name:a},dataType:"json",cache:!1,context:this}).done(function(e){i(e)}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"load_submissions",name:a},dataType:"json",cache:!1,context:this}).done(function(e){i(e)}):i("")}function I(t){window.azexo_online?"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_get_settings_form",url:window.location.href},cache:!1,context:this}).done(function(e){t(e)}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"get_settings_form"},cache:!1,context:this}).done(function(e){t(e)}):t("")}function E(t,n){window.azexo_online?"ajaxurl"in window?e.ajax({type:"POST",url:window.ajaxurl,data:{action:"azexo_submit_settings_form",url:window.location.href,values:t},dataType:"json",cache:!1,context:this}).done(function(e){n(e)}):e.ajax({type:"POST",url:window.azexo_baseurl+"ajax.php",data:{action:"submit_settings_form",values:t},dataType:"json",cache:!1,context:this}).done(function(e){n(e)}):n("")}function P(e,t){var n=function(){}
...
"function"==typeof i&&i!=e.toString&&i!=n.toString&&"\nfunction toString() {\n    [native code]\n}\n"!=i&&(e.toString=t.toString)}return e}function R(e,t,n,a){return 0>n&&(n+=e.length),a=void 0!==a?a:e.length,0>a&&(a=a+e.length-n),e.slice(0,n)+t.substr(0,a)+t.slice(a)+e.slice(n+a)}function A(e,t){var a=n+"col-"+t+"-",i=e?e.split("/"):[1,1],o=_.range(1,13),s=!_.isUndefined(i[0])&&_.indexOf(o,parseInt(i[0],10))>=0?parseInt(i[0],10):!1,r=!_.isUndefined(i[1])&&_.indexOf(o,parseInt(i[1],10))>=0?parseInt(i[1],10):!1
return s!==!1&&r!==!1?a+12*s/r:a+"12"}function L(e){return _.isString(e)?e.replace(/(\`{2})/g,'"'):e}function U(e){return decodeURIComponent((e+"").replace(/%(?![\da-f]{2})/gi,function(){return"%25"}))}function B(e,t,n){var a=new Date
a.setDate(a.getDate()+n)
var i=encodeURIComponent(t)+(null===n?"":"; expires="+a.toUTCString())
document.cookie=e+"="+i}function N(e){var t,n,a,i=document.cookie.split(";")
for(t=0;t<i.length;t++)if(n=i[t].substr(0,i[t].indexOf("=")),a=i[t].substr(i[t].indexOf("=")+1),n=n.replace(/^\s+|\s+$/g,""),n==e)return decodeURIComponent(a)}function M(t,n){var a="<select>"
...
s.attachEvent("add_element",function(e,t){r(e,t.id)}),s.attachEvent("edited_element",r),s.attachEvent("delete_element",function(t,i){e("body")[a+"scrollspy"]({target:"#"+o.id+".navbar-collapse",offset:o.navbar_height})
var r=s.get_element(i)
r instanceof lt&&(delete o.menu_items[i],o.replace_render(),o.showed(e,n,a))}),s.attachEvent("update_sorting",function(t,i){e("body")[a+"scrollspy"]({target:"#"+o.id+".navbar-collapse",offset:o.navbar_height})
var r=e(i.item).closest("[data-az-id]").attr("data-az-id"),l=s.get_element(r)
o.id==r&&e(l.dom_element).find("."+n+"navbar")[a+"affix"]({offset:{top:e(l.dom_element).find("."+n+"navbar").offset().top,bottom:0}})})}function zt(){zt.baseclass.apply(this,arguments)}function kt(){kt.baseclass.apply(this,arguments)}function jt(e,t){P(t,kt),t.prototype.base=e,kt.prototype.elements[e]=t,kt.prototype.tags[e]=t,kt.prototype.form_elements[e]=t}function Tt(){if("azexo_elements"in window)for(var e=0;e<window.azexo_elements.length;e++){var t=window.azexo_elements[e],n=function(){n.baseclass.apply(this,arguments)}
rt(t.base,t.is_container,n),t.baseclass=n.baseclass,t.params=t.params.concat(n.prototype.params),D(n.prototype,t)
for(var a=0;a<n.prototype.params.length;a++){var i=n.prototype.params[a],o=X(i)
...
for(var a=0;a<n.prototype.params.length;a++){var i=n.prototype.params[a],o=X(i)
n.prototype.params[a]=o}}}function St(){if("azexo_extend"in window)for(var e in window.azexo_extend){var t=window.azexo_extend[e],n=t.params
t.params={}
var a=K.prototype.elements[e]
D(a.prototype,t)
for(var i=0;i<n.length;i++){var o=X(n[i])
a.prototype.params.push(o)}}}function Ct(){(!window.azexo_editor||window.azexo_online)&&x(function(e){_.isObject(e)&&s.create_template_elements(e)})}function It(){y(function(e){_.isObject(e)&&s.create_cms_elements(e)})}window.azexo_backend=!0
var Et=(""+arguments.callee).replace(/((\/\/.*$)|(\/\*[\s\S]*?\*\/)|(\s))/gm,"").match(/^function\s*[^\(]*\(\s*([^\)]*)\)/m)[1].split(/,/),Pt=Et[0],Dt=Et[1],Rt=Et[2],At=Et[3],Lt=Et[4],Ut=Et[5],Bt=Et[6],Nt=Et[7],Mt=Et[8],Yt=Et[9]
...
e(f).append(v)}e(m).append(f),e(l).find("."+n+"modal-body").append(m),e('#az-editor-tabs a[href="#az-editor-tab-1"]')[a+"tab"]("show"),e('#az-editor-modal input[name="el_class"]').each(function(){Y(K.prototype.el_classes,this," ")})
...
t.length>0&&this.render_form(t)},render:function(t){this.form_value=t,this.dom_element=e('<div class="'+n+'form-group"></div>')},opened:function(){"instance"in this&&this.render_form(this.instance)}}),"azexo_param_types"in window)for(var $t=0;$t<window.azexo_param_types.length;$t++){var Ft=window.azexo_param_types[$t],Wt=function(){Wt.baseclass.apply(this,arguments)}
W(Ft.type,Wt),Ft.baseclass=Wt.baseclass,D(Wt.prototype,Ft)}if(window.azexo_add_css=function(t,n){var a=window.azexo_baseurl+t
...
return-1},i=a(n,t)
i>-1&&n.splice(i,1)}},raiseEvent:function(e,t){var n=this._getEventHandler(e)
...
rt(t,!1,a),D(a.prototype,{name:t,icon:"fa fa-cube",description:p(""),template:n,params:[].concat(a.prototype.params),show_settings_on_create:!0,has_content:!0,category:"Template-elements",render:function(e){for(var t=this.template,n=0;n<this.params.length;n++){var i=this.attrs[this.params[n].param_name]
...
for(var i=/\[\[([^\]]*)\]\]/g,o=0,s={};null!=(s=i.exec(n));){var r=X({type:"textfield",param_name:"param"+o,value:s[1]})
a.prototype.params.unshift(r),n=R(n,"[[param"+o+"]]",s.index,s[0].length),o++}a.prototype.template=n
for(var i=/\{\{([^\}]*)\}\}/g;null!=(s=i.exec(n));){var r=X({type:"textarea",param_name:"param"+o,value:s[1]})
a.prototype.params.unshift(r),n=R(n,"{{param"+o+"}}",s.index,s[0].length),o++}a.prototype.template=n
for(var i=/\(\(([^\)]*)\)\)/g;null!=(s=i.exec(n));){var r=X({type:"image",param_name:"param"+o,value:s[1]})
a.prototype.params.unshift(r),n=R(n,"((param"+o+"))",s.index,s[0].length),o++}a.prototype.template=n
for(var i=/\<\<([^\>]*)\>\>/g;null!=(s=i.exec(n));){var r=X({type:"link",param_name:"param"+o,value:s[1]})
...
if(n.param_name in e)if(n.safe)this.attrs[n.param_name]=L(e[n.param_name])
else{var a=L(e[n.param_name])
this.attrs[n.param_name]=decodeURIComponent(atob(a.replace(/^#E\-8_/,"")))}else"value"in n&&_.isString(n.value)&&(this.attrs[n.param_name]=n.value)}for(var i in e)i in this.attrs||(this.attrs[i]=e[i])
...
this.is_container&&(s+=this.has_content?this.get_content()+"[/"+a+"]":t+"[/"+a+"]")}return e[this.base]--,s},parse_shortcode:function(t){var n=_.keys(K.prototype.tags).join("|"),a=qt.shortcode.regexp(n),i=e.trim(t).match(a)
if(_.isNull(i)){if(0==t.length)return
this.parse_shortcode('[az_row][az_column width="1/1"][az_text]'+t+"[/az_text][/az_column][/az_row]")}_.each(i,function(e){var a=e.match(Ht(n)),i=a[5],o=RegExp("^[\\s]*\\[\\[?("+_.keys(K.prototype.tags).join("|")+")(?![\\w-])"),s=qt.shortcode.attrs(a[3]),r=a[2]
...
t&&e(this.dom_element).append(t[1])}et.baseclass.prototype.render.apply(this,arguments)}}),!("azexo_baseurl"in window))if(e('script[src*="azexo_composer.js"]').length>0){var Xt=e('script[src*="azexo_composer.js"]').attr("src")
window.azexo_baseurl=Xt.slice(0,Xt.indexOf("azexo_composer.js"))}else if(e('script[src*="azexo_composer.min.js"]').length>0){var Xt=e('script[src*="azexo_composer.min.js"]').attr("src")
window.azexo_baseurl=Xt.slice(0,Xt.indexOf("azexo_composer.min.js"))}"azexo_online"in window||(window.azexo_online="http:"==window.location.protocol||"https:"==window.location.protocol),s=new G,"azexo_editor"in window||(window.azexo_editor=!1),nt(),at(function(){ot(),e.holdReady(!1)})
var Jt=!1
...
e(t).val('<div class="az-element az-container" data-az-type="textarea" data-az-name="'+a+'">'+i+"</div>")}})}})},s.attachEvent("add_element",n.save_container),s.attachEvent("edited_element",n.save_container),s.attachEvent("update_element",n.save_container),s.attachEvent("delete_element",n.save_container),s.attachEvent("update_sorting",n.save_container)}})},show:function(){this.each(function(){})},hide:function(){this.each(function(){var t=e(this).data("azexo_composer")
...
this.add_css("animate.css/animate.min.css",!1,function(){switch(t.attrs.an_start){case"click":e(i).click(function(){e(t.dom_element).hasClass("animated")||t.start_in_animation()})
break
...
break
case"hover":t.inned=!1,e(i).on("mouseenter",function(){t.hover=!0,t.start_in_animation()}),e(i).on("mouseleave",function(){t.hover=!1,t.start_out_animation()})
break
...
var i='<div class="'+n+'modal-header"><button type="button" class="'+n+'close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="'+n+'modal-title">'+p("Scroll animation settings")+"</h4></div>",o='<div class="'+n+'modal-footer"><button type="button" class="'+n+"btn "+n+'btn-default" data-dismiss="modal">'+p("Close")+'</button><button type="button" class="save '+n+"btn "+n+'btn-primary">'+p("Save changes")+"</button></div>",r=e('<div id="az-scroll-animation-modal" class="'+n+'modal azexo"><div class="'+n+"modal-dialog "+n+'modal-lg"><div class="'+n+'modal-content">'+i+'<div class="'+n+'modal-body"></div>'+o+"</div></div></div>").prependTo("body"),l=e('<div id="az-scroll-animation-tabs"><ul class="'+n+"nav "+n+'nav-tabs"><li><a href="#script" data-toggle="tab">'+p("Script")+'</a></li><li><a href="#wizards" data-toggle="tab">'+p("Wizards")+'</a></li></ul><div class="'+n+'tab-content"><div id="script" class="'+n+'tab-pane"></div><div id="wizards" class="'+n+'tab-pane"></div></div></div>')
...
g[e].timeline.push({tweens:[]}),g[n]=g[e].timeline[g[e].timeline.length-1],y[n]="step",b[n]=e,u(n)}function h(t){function a(t,a,i){function o(t,o,l){function d(){var t=e(h).find('[name="'+p+'"]').val()
""!=o&&o!=t&&delete a[i][o]
...
e('<button title="'+c("Add property")+'" class="add-property '+n+"btn "+n+'btn-default">'+p("Add property")+"</button>").appendTo(e(l).find(".add-property")).click(function(){o(e(l).find(".properties"),"","")})}var i=b[b[t]]
...
for(var o=["Linear","Power0","Power1","Power2","Power3","Power4","Quad","Cubic","Quart","Quint","Strong","Elastic","Back","Bounce","SlowMo","SteppedEase","Circ","Expo","Sine"],r=[],l=0;l<o.length;l++)r.push(o[l]+".easeNone"),r.push(o[l]+".easeIn"),r.push(o[l]+".easeOut"),r.push(o[l]+".easeInOut")
r=_.object(r,r),e(d).find(".options").append('<div class="'+n+'form-group"><label>'+p("Ease")+"</label><div>"+H(r,"ease",g[t].ease)+'</div><p class="'+n+'help-block">'+p("Ease")+"</p></div>"),e(d).find('.options [name="ease"]').on("change",function(){g[t].ease=e(this).val()}),e(d).find('.options [name="ease"]').chosen({search_contains:!0}),e(d).find(".options").append('<div class="'+n+'form-group delay"><label>'+p("Delay")+'</label><div><input class="'+n+'form-control" name="delay" type="text" value="'+g[t].delay+'"></div><p class="'+n+'help-block">'+p("Amount of delay in seconds before the tween should begin.")+"</p></div>"),e(d).find('.options [name="delay"]').on("change",function(){g[t].delay=e(this).val()}),"0"!=g[i].duration&&(e(d).find(".options ."+n+"form-group.duration").css("display","none"),e(d).find(".options ."+n+"form-group.delay").css("display","none"))}function u(e){var t=x.jstree("create_node",e,{type:"tween",text:p("Tween")+":|1",state:{opened:!0}},"last")
...
if(a>-1){var i=t.an_scenes[n].timeline[a].tweens.indexOf(g[e])
if(i>-1)return[n,a,i]}}}return!1}function v(){for(var e=0;e<t.an_scenes.length;e++){var n=x.jstree("create_node","#",{type:"scene",text:p("Scene")+":"+t.an_scenes[e].duration+"|"+t.an_scenes[e].offset+"|"+t.an_scenes[e].triggerHook,state:{opened:!0}},"last")
g[n]=t.an_scenes[e],y[n]="scene"
for(var a=0;a<t.an_scenes[e].timeline.length;a++){var i=x.jstree("create_node",n,{type:"step",text:p("Step")+":"+a,state:{opened:!0}},"last")
g[i]=t.an_scenes[e].timeline[a],y[i]="step",b[i]=n
for(var o=0;o<t.an_scenes[e].timeline[a].tweens.length;o++){var s=x.jstree("create_node",i,{type:"tween",text:p("Tween")+":"+t.an_scenes[e].timeline[a].tweens[o].target+"|"+t.an_scenes[e].timeline[a].tweens[o].duration,state:{opened:!0}},"last")
g[s]=t.an_scenes[e].timeline[a].tweens[o],y[s]="tween",b[s]=i}}}}var g={},y={},b={},w=e('<div class="'+n+"btn-group "+n+'btn-group-xs"></div>').appendTo(e(d).find(".tree"))
...
""!=e&&null!=e&&o(e)}),e('<button title="'+c("Add timeline step")+'" class="add-step '+n+"btn "+n+'btn-default" disabled>'+p("Add step")+"</button>").appendTo(w).click(function(){var e=x.jstree("get_selected")
...
switch(y[o]){case"scene":e(w).find(".add-step").removeAttr("disabled"),e(w).find(".add-tween").attr("disabled","disabled"),i(o)
break
case"step":e(w).find(".add-step").attr("disabled","disabled"),e(w).find(".add-tween").removeAttr("disabled"),r(o)
break
case"tween":e(w).find(".add-step").attr("disabled","disabled"),e(w).find(".add-tween").attr("disabled","disabled"),h(o)
break
...
break
case 3:t.an_scenes[a[0]].timeline[a[1]].tweens.splice(n.position,0,t.an_scenes[a[0]].timeline[a[1]].tweens.splice(n.old_position,1)[0])}else{var i=f(n.parent),o=null
...
if(t.scroll_magic_scenes=[],0==e(t.dom_element).parents(".azexo-animations-disabled").length)for(var a=0;a<t.an_scenes.length;a++){var n={triggerElement:'[data-az-id="'+t.id+'"]',duration:t.an_scenes[a].duration,offset:t.an_scenes[a].offset,triggerHook:t.an_scenes[a].triggerHook},i=new ScrollScene(n).addTo(r)
...
for(var o=new TimelineMax(n),s=0;s<t.an_scenes[a].timeline.length;s++){for(var l=[],d=0;d<t.an_scenes[a].timeline[s].tweens.length;d++){var c='[data-an-name="'+t.an_scenes[a].timeline[s].tweens[d].target+'"]',p=_.keys(t.an_scenes[a].timeline[s].tweens[d].from),m=_.keys(t.an_scenes[a].timeline[s].tweens[d].to)
...
h.ease=t.an_scenes[a].timeline[s].tweens[d].ease,h.delay=parseFloat(t.an_scenes[a].timeline[s].tweens[d].delay),l.push(TweenMax.fromTo(c,t.an_scenes[a].timeline[s].tweens[d].duration,u,h))}}o.add(l)}i.setTween(o)}}})},showed:function(e){st.baseclass.prototype.showed.apply(this,arguments),this.an_scenes=[],"an_scenes"in this.attrs&&""!=this.attrs.an_scenes&&(this.an_scenes=e.parseJSON(decodeURIComponent(atob(this.attrs.an_scenes))),this.update_scroll_animation()),"an_start"in this.attrs&&""!=this.attrs.an_start&&"no"!=this.attrs.an_start&&this.css_animation()},render:function(e){this.an_name="","an_name"in this.attrs&&""!=this.attrs.an_name&&(this.an_name=this.attrs.an_name,s.elements_instances_by_an_name[this.an_name]=this,e(this.dom_element).attr("data-an-name",this.an_name)),st.baseclass.prototype.render.apply(this,arguments)}}),rt("az_row",!0,lt),D(lt.prototype,{name:p("Row"),icon:"fa fa-table",description:p("One row to implement a table layout with responsive ability. You can choose number of columns and thier widths. Used by default."),category:p("Layout"),params:[X({type:"dropdown",heading:p("Device"),param_name:"device",value:{xs:p("Extra small devices Phones (<768px)"),sm:p("Small devices Tablets (≥768px)"),md:p("Medium devices Desktops (≥992px)"),lg:p("Large devices Desktops (≥1200px)")},description:p("Bootstrap responsive grid system")}),X({type:"dropdown",heading:p("Background Effect"),param_name:"effect",tab:p("Background Effects"),value:{"":p("Simple Image"),fixed:p("Fixed Image"),parallax:p("Parallax Image"),youtube:p("YouTube Video")},description:p("Select the effect you want to apply to the row background.")}),X({type:"integer_slider",heading:p("Parallax speed"),param_name:"parallax_speed",tab:p("Background Effects"),value:20,dependency:{element:"effect",value:["parallax"]}}),X({type:"checkbox",heading:p("Video Play Options"),param_name:"video_options",tab:p("Background Effects"),description:p("Select options for the video."),value:{loop:p("Loop"),mute:p("Muted")},dependency:{element:"effect",value:["youtube"]}}),X({type:"textfield",heading:p("YouTube Video URL"),param_name:"video_youtube",tab:p("Background Effects"),description:p("Enter the YouTube video URL."),dependency:{element:"effect",value:["youtube"]}}),X({type:"textfield",heading:p("Start Time in seconds"),param_name:"video_start",tab:p("Background Effects"),description:p("Enter time in seconds from where video start to play."),value:"0",dependency:{element:"effect",value:["youtube"]}}),X({type:"textfield",heading:p("Stop Time in seconds"),param_name:"video_stop",tab:p("Background Effects"),description:p("Enter time in seconds where video ends."),value:"0",dependency:{element:"effect",value:["youtube"]}})].concat(lt.prototype.params),is_container:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},show_controls:function(){if(window.azexo_editor){lt.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".add").remove(),e(this.controls).find(".paste").remove()
...
s.attachEvent("add_element",function(t,a){var i=s.get_element(a.id),o=n.get_item(i)
null!=o&&(o.parent.linked_elements_index[i.id]=i),(i.parent.id in n.linked_elements_index||"az_item"==i.base)&&("element_adding"in n||(n.element_adding=!0,n.add_control(i),a.parse&&"az_column"!=i.base||i.synchronize(),e(i.parent.dom_content_element).hasClass("ui-sortable")&&i.id!=o.id&&e(i.parent.dom_content_element).sortable("option","containment",o.dom_content_element),delete n.element_adding))}),s.attachEvent("edited_element",function(e,n){t(!0,n)}),s.attachEvent("update_element",function(e,n){t(!1,n)}),s.attachEvent("delete_element",function(e,t){var a=s.get_element(t),i=n.get_item(a)
...
delete i.parent.linked_elements_index[a.id],delete n.element_deleting}}),s.attachEvent("update_sorting",function(t,a){var i=e(a.item).closest("[data-az-id]").attr("data-az-id")
...
a(t)}},stop:function(){i.attrs.width=parseInt(e(i.dom_content_element).css("width"))/(e(i.dom_element).width()/100)+"%",i.attrs.height=e(i.dom_content_element).height()}})
...
i.update_dom(),s.raiseEvent("update_sorting",n)},click_add_tab:function(e){return e.data.object.add_tab(),!1},add_tab:function(){var t=new _t(this,!1)
...
""!=this.parent.attrs.type&&(n=this.parent.attrs.type),this.dom_element=e('<div class="az-element az-toggle '+t+"panel "+n+" "+this.attrs.el_class+'" style="'+this.attrs.style+'"><div class="'+t+'panel-heading"><h4 class="'+t+'panel-title"><a data-toggle="collapse" data-parent="#'+this.parent.id+'" href="#'+this.id+'">'+this.attrs.title+'</a></h4></div><div id="'+this.id+'" class="'+t+"panel-collapse "+t+'collapse"><div class="'+t+'panel-body az-ctnr"></div></div></div>'),this.dom_content_element=e(this.dom_element).find("."+t+"panel-body"),ft.baseclass.prototype.render.apply(this,arguments)}}),rt("az_carousel",!0,vt),D(vt.prototype,{name:p("Carousel"),icon:"fa fa-ellipsis-h",description:p("Content carousel. Every slide of this element can contain any number of any types of elements. It can be used for create classic content slider."),category:p("Layout"),params:[X({type:"integer_slider",heading:p("Number items"),param_name:"items",min:"1",max:"10",value:"1"}),X({type:"checkbox",heading:p("Options"),param_name:"options",value:{navigation:p("Navigation"),auto_play:p("Auto play"),mouse:p("Mouse drag"),touch:p("Touch drag")}}),X({type:"dropdown",heading:p("Transition style"),param_name:"transition",value:{"":p("Default"),fade:p("fade"),backSlide:p("backSlide"),goDown:p("goDown"),fadeUp:p("fadeUp")}})].concat(vt.prototype.params),is_container:!0,show_settings_on_create:!0,frontend_render:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},show_controls:function(){if(window.azexo_editor){vt.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".add").remove(),e(this.controls).find(".paste").remove()
...
""!=this.parent.attrs.type&&(t=this.parent.attrs.type),this.dom_element=e('<div class="az-element az-slide '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=this.dom_element,gt.baseclass.prototype.render.apply(this,arguments)}}),rt("az_presentation",!0,yt),D(yt.prototype,{name:p("Presentation"),icon:"fa fa-file-powerpoint-o",description:p("Content presentation. Every step of presentation can contain any number of any types of elements."),category:p("Layout"),params:[X({type:"integer_slider",heading:p("Height"),param_name:"height",min:"0",max:"2000",value:"900"}),X({type:"checkbox",heading:p("Options"),param_name:"options",value:{navigation:p("Navigation"),auto_play:p("Auto play")}}),X({type:"integer_slider",heading:p("Perspective"),param_name:"perspective",min:"0",max:"10000",value:"1000"}),X({type:"integer_slider",heading:p("Transition duration"),param_name:"duration",min:"0",max:"10000",value:"1000"})].concat(yt.prototype.params),is_container:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},show_controls:function(){if(window.azexo_editor){vt.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".add").remove(),e(this.controls).find(".paste").remove()
e('<button title="'+c("Add step")+'" class="control add-toggle '+n+"btn "+n+"btn-primary "+n+"glyphicon "+n+'glyphicon-plus-sign" > </button>').appendTo(this.controls).click({object:this},this.click_add_step)}},update_sortable:function(){if(window.azexo_editor);},click_add_step:function(e){return e.data.object.add_step(),!1},add_step:function(){var e=new bt(this,!0)
...
else yt.baseclass.prototype.attach_children.apply(this,arguments)},edited:function(){yt.baseclass.prototype.edited.apply(this,arguments),this.update_dom()},impress_init:function(){var e=this
e.impress.setTransformationCallback(function(t){e.config.visualScaling=t.scale,e.config.rotation=~~t.rotate.z})},showed:function(e){yt.baseclass.prototype.showed.apply(this,arguments)
var t=this
this.add_js({path:"js/impress.js",loaded:"impress"in window,callback:function(){function n(e,n){var a={x:0,y:0},i=t.config.rotation/180*Math.PI,o=Math.cos(i),s=Math.sin(i)
return a.x=(e*o-n*s)*t.config.visualScaling,a.y=(e*s+n*o)*t.config.visualScaling,a}t.state={editing:!1,$node:!1,data:{x:0,y:0,rotate:0,scale:0}},t.config={rotateStep:.1,scaleStep:.01,visualScaling:10,setTransformationCallback:!1},t.defaults={x:0,y:0,rotate:0,scale:1},t.mouse={prevX:!1,prevY:!1,activeFunction:!1},t.handlers={},t.handlers.move=function(e,a){var i=n(e,a)
t.state.data.x=t.state.data.x?t.state.data.x+i.x:i.x,t.state.data.y=t.state.data.y?t.state.data.y+i.y:i.y},t.handlers.scale=function(e){t.state.data.scale-=-e*t.config.scaleStep*t.config.visualScaling/10},t.handlers.rotate=function(e){t.state.data.rotate-=-e*t.config.rotateStep},"impress"in t||(t.impress=window.impress(t.id)),t.impress.init(),t.impress_init(),t.impress.goto(t.children[0].id),t.dom_element.get(0).addEventListener("impress:stepenter",function(t){var n=e(t.target).attr("data-az-id"),a=s.get_element(n)
if(!_.isUndefined(a))for(var i=0;i<a.children.length;i++)"trigger_start_out_animation"in a.children[i]&&a.children[i].trigger_start_in_animation()},!1),t.dom_element.get(0).addEventListener("impress:stepleave",function(t){var n=e(t.target).attr("data-az-id"),a=s.get_element(n)
if(!_.isUndefined(a))for(var i=0;i<a.children.length;i++)"trigger_start_in_animation"in a.children[i]&&a.children[i].trigger_start_out_animation()},!1),e(t.dom_element).find("> .pagination > li > .prev").click(function(){return t.impress.prev(),!1}),e(t.dom_element).find("> .pagination > li > .next").click(function(){return t.impress.next(),!1}),e(t.dom_element).find("> .pagination > li > .goto").click(function(){return t.impress.goto(e(this).attr("data-step")),!1}),"auto_play"in t&&clearInterval(t.auto_play),_.indexOf(t.attrs.options.split(","),"auto_play")>=0&&(t.auto_play=setInterval(function(){t.impress.next()},5e3))}})},render:function(e){if(delete this.impress,this.dom_element=e('<div class="az-element az-presentation '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),e(this.dom_element).css("height",this.attrs.height+"px"),e(this.dom_element).css("overflow","hidden"),this.dom_content_element=e('<div id="'+this.id+'"></div>').appendTo(this.dom_element),e(this.dom_content_element).attr("data-perspective",this.attrs.perspective),e(this.dom_content_element).attr("data-transition-duration",this.attrs.duration),_.indexOf(this.attrs.options.split(","),"navigation")>=0){var t=e('<ul class="pagination"></ul>').appendTo(this.dom_element)
e('<li><a href="#" class="prev">&laquo;</a></li>').appendTo(t)
for(var n=1;n<=this.children.length;n++)e('<li><a href="#" class="goto" data-step="'+this.children[n-1].id+'">'+n+"</a></li>").appendTo(t)
e('<li><a href="#" class="prev">&raquo;</a></li>').appendTo(t)}yt.baseclass.prototype.render.apply(this,arguments)}}),Z("az_step",!0,bt),D(bt.prototype,{name:p("Step"),params:[X({type:"integer_slider",heading:p("Width"),param_name:"width",min:"1",max:"10000",value:"900"}),X({type:"integer_slider",heading:p("Height"),param_name:"height",min:"1",max:"10000",value:"700"}),X({type:"integer_slider",heading:p("X coordinate"),param_name:"x",min:"0",max:"10000",value:"0"}),X({type:"integer_slider",heading:p("Y coordinate"),param_name:"y",min:"0",max:"10000",value:"0"}),X({type:"integer_slider",heading:p("Z coordinate"),param_name:"z",min:"0",max:"10000",value:"0"}),X({type:"integer_slider",heading:p("X rotate"),param_name:"rotate_x",min:"-180",max:"180",value:"0"}),X({type:"integer_slider",heading:p("Y rotate"),param_name:"rotate_y",min:"-180",max:"180",value:"0"}),X({type:"integer_slider",heading:p("Z rotate"),param_name:"rotate_z",min:"-180",max:"180",value:"0"}),X({type:"integer_slider",heading:p("Scale"),param_name:"scale",min:"0",max:"10",value:"1",step:"0.01"})].concat(bt.prototype.params),hidden:!0,is_container:!0,show_parent_controls:!0,disallowed_elements:["az_presentation"],get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p("Settings for this presentation element and for current step. ")+'<span class="'+n+"glyphicon "+n+'glyphicon-plus-sign"></span>'+p(" - add a new step.")+"</div></div>"},get_my_shortcode:function(){return this.get_children_shortcode()},show_controls:function(){function t(){var t=s.get_element(e(l.state.$node[0]).closest("[data-az-id]").attr("data-az-id"))
t.attrs.x=""+l.state.data.x,t.attrs.y=""+l.state.data.y,t.attrs.rotate_z=""+l.state.data.rotate,t.attrs.scale=""+l.state.data.scale}function a(){l.state.data.x=parseFloat(l.state.$node[0].dataset.x)||l.defaults.x,l.state.data.y=parseFloat(l.state.$node[0].dataset.y)||l.defaults.y,l.state.data.scale=parseFloat(l.state.$node[0].dataset.scale)||l.defaults.scale,l.state.data.rotate=parseFloat(l.state.$node[0].dataset.rotate)||l.defaults.rotate,t()}function i(){clearTimeout(d),d=setTimeout(function(){l.state.$node[0].dataset.scale=l.state.data.scale,l.state.$node[0].dataset.rotate=l.state.data.rotate,l.state.$node[0].dataset.x=l.state.data.x,l.state.$node[0].dataset.y=l.state.data.y,l.impress.initStep(l.state.$node[0]),t()},20)}function o(e){e.preventDefault(),e.stopPropagation()
var t=e.pageX-l.mouse.prevX,n=e.pageY-l.mouse.prevY
return l.mouse.prevX=e.pageX,l.mouse.prevY=e.pageY,l.mouse.activeFunction&&(l.mouse.activeFunction(t,n),i()),!1}if(bt.baseclass.prototype.show_controls.apply(this,arguments),window.azexo_editor){var r=this
e('<button title="'+c("Scale")+'" class="control scale action '+n+"btn "+n+"btn-primary "+n+"glyphicon "+n+'glyphicon-resize-full" > </button>').appendTo(this.controls),e('<button title="'+c("Rotate")+'" class="control rotate action '+n+"btn "+n+"btn-primary "+n+"glyphicon "+n+'glyphicon-refresh" > </button>').appendTo(this.controls),e(r.controls).find(".drag-and-drop").addClass("action")
var l=r.parent,d=null
e(r.controls).on("mousedown",".action",function(t){return l.state.$node=e(r.dom_element),t.preventDefault(),e(this).hasClass("drag-and-drop")&&(l.mouse.activeFunction=l.handlers.move),e(this).hasClass("scale")&&(l.mouse.activeFunction=l.handlers.scale),e(this).hasClass("rotate")&&(l.mouse.activeFunction=l.handlers.rotate),a(),l.mouse.prevX=t.pageX,l.mouse.prevY=t.pageY,e(document).on("mousemove.handler1",o),!1}),e(document).on("mouseup",function(){l.mouse.activeFunction=!1,e(document).off("mousemove.handler1")})}},update_sortable:function(){if(window.azexo_editor){var t=this
e(this.dom_element).resizable({stop:function(){t.attrs.width=e(t.dom_element).width(),t.attrs.height=e(t.dom_element).height(),"impress"in t.parent&&t.impress.initStep(t.dom_element.get(0))}})}},clone:function(){var t=bt.baseclass.prototype.get_my_shortcode.apply(this,arguments)
e("#azexo-clipboard").html(btoa(encodeURIComponent(t)))
for(var n=0;n<this.parent.children.length;n++)if(this.parent.children[n].id==this.id){this.parent.paste(n)
break}this.parent.update_dom()},edited:function(){bt.baseclass.prototype.edited.apply(this,arguments)
var e=this
"impress"in e.parent&&e.parent.impress.initStep(e.dom_element.get(0))},remove:function(){bt.baseclass.prototype.remove.apply(this,arguments),this.parent.update_dom()},render:function(e){this.dom_element=e('<div id="'+this.id+'" class="az-element az-step step '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),e(this.dom_element).css("width",this.attrs.width),e(this.dom_element).css("height",this.attrs.height),e(this.dom_element).attr("data-x",this.attrs.x),e(this.dom_element).attr("data-y",this.attrs.y),e(this.dom_element).attr("data-z",this.attrs.z),e(this.dom_element).attr("data-rotate-x",this.attrs.rotate_x),e(this.dom_element).attr("data-rotate-y",this.attrs.rotate_y),e(this.dom_element).attr("data-rotate",this.attrs.rotate_z),e(this.dom_element).attr("data-scale",this.attrs.scale),this.dom_content_element=this.dom_element,bt.baseclass.prototype.render.apply(this,arguments)}}),rt("az_container",!0,wt),D(wt.prototype,{name:p("Container"),icon:"fa fa-archive",description:p("AJAX loaded content from server. Content can be edited and saved to server."),category:p("Layout"),params:[X({type:"container",heading:p("Container"),param_name:"container",description:p("Type and name used as identificator to save container on server."),value:"/"})].concat(wt.prototype.params),show_settings_on_create:!0,is_container:!0,hidden:!window.azexo_online,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},get_empty:function(){return'<div class="az-empty"><div class="top '+n+'well"><strong>'+p("Click to put an element here.")+'</strong></div><div class="top-right '+n+'well"><h1>↗</h1><span class="'+n+"glyphicon "+n+'glyphicon-eye-open"></span>'+p(" - toggle editor helpers.")+' <span class="'+n+"glyphicon "+n+'glyphicon-play-circle"></span>'+p(" - toggle animation engine to not hinder editing.")+' <span class="'+n+"glyphicon "+n+'glyphicon-save"></span>'+p(" - save results of editing on server.")+"</div></div>"},show_controls:function(){if(window.azexo_editor){var t=this
...
for(var c=0;c<window.azexo_extend.length;c++)t+="window.azexo_extend.push("+o(window.azexo_extend[c],!0)+");\n"}return t+=""+Tt+"\n",t+=Tt.name+"();\n",t+=""+Ot+"\n",t+=Ot.name+"();\n",t+=""+St+"\n",t+=St.name+"();\n",t+="})(window.jQuery);\n"}function v(e){var t=""
...
""!=this.attrs.container&&g(this.attrs.container.split("/")[0],this.attrs.container.split("/")[1],function(a){var i=/^\s*\<[\s\S]*\>\s*$/.exec(a)
...
var t=this
this.add_js({path:"jquery-waypoints/waypoints.min.js",loaded:"waypoint"in e.fn,callback:function(){e(t.dom_element).waypoint(function(){t.rendered||(t.rendered=!0,t.load_container())},{offset:"100%",triggerOnce:!0}),e(document).trigger("scroll")}})},render:function(e){this.dom_element=e('<div class="az-element az-container"><div class="az-ctnr"></div></div>'),this.dom_content_element=e(this.dom_element).find(".az-ctnr"),wt.baseclass.prototype.render.apply(this,arguments)}}),lt.prototype.params.push(X({type:"textfield",heading:p("Menu item title"),param_name:"menu_item_title",description:p("Title which will be used in scroll menu."),tab:p("Menu")})),Z("az_scroll_menu",!1,xt),D(xt.prototype,{name:p("Scroll Menu"),icon:"fa fa-sitemap",description:p("One page scroll menu"),params:[X({type:"image",heading:p("Logo"),param_name:"logo",description:p("Select image from media library.")}),X({type:"link",heading:p("Logo link"),param_name:"logo_link"})].concat(xt.prototype.params),showed:function(e,t,n){this.navbar_height=e(this.dom_element).find("."+t+"navbar").height(),xt.baseclass.prototype.showed.apply(this,arguments)
var a=this
...
s+="</ul>",e(o).append(s),e(this.dom_element).find("."+t+"container-fluid").append(a).append(o),xt.baseclass.prototype.render.apply(this,arguments)}}),rt("az_form",!0,zt),D(zt.prototype,{name:p("Form"),icon:"fa fa-envelope-o",description:p("Form container. Can contain form elements for user input and any number of any other elements types."),category:p("Layout"),params:[X({type:"textfield",heading:p("Name"),param_name:"name",description:p("Required."),required:!0}),X({type:"textfield",heading:p("Submit button title"),param_name:"submit_title",value:p("Submit")}),X({type:"textfield",heading:p("Submited message"),param_name:"submited_message",value:p("Submited")})].concat(zt.prototype.params),is_container:!0,hidden:!window.azexo_online,show_settings_on_create:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><p>'+this.name+'</p><p class="'+n+"text-muted "+n+'small">'+this.description+"</p></div>"},get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p("You can add form element by mouse over this button: ")+'<span class="'+n+"glyphicon "+n+'glyphicon-plus-sign"></span> '+p("You can see all submissions by click on this button: ")+'<span class="'+n+"glyphicon "+n+'glyphicon-list-alt"></span></div></div>'},show_controls:function(){if(window.azexo_editor){zt.baseclass.prototype.show_controls.apply(this,arguments)
var t=this
