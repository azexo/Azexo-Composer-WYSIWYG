...
e(document).trigger("azexo_restore",{dom:t}),this.attrs.content=e(t).html()},restore:function(t){ct.prototype.restore.apply(this,arguments)
for(var n in this.restore_nodes)e(t).find('[data-az-restore="'+n+'"]').html(this.restore_nodes[n])
e(document).trigger("azexo_restore",{dom:t}),e(t).find("[data-az-restore]").removeAttr("data-az-restore")},showed:function(e,t){ct.prototype.showed.apply(this,arguments)
var n=this
