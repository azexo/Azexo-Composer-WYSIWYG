...
if("important"in t[a]&&t[a].important&&(c=" !important"),_.isArray(t[a].property))for(var p=0;p<t[a].property.length;p++)l+=t[a].selector+"{"+t[a].property[p]+": "+o+c+";}"
else l+=t[a].selector+"{"+t[a].property+": "+o+c+";}"}}else if(""!=o&&3==o.split("|").length){var i=o.split("|")[0],r=o.split("|")[2]
if("selector"in t[a]){var c=""
"important"in t[a]&&t[a].important&&(c=" !important")
var m=""
r.indexOf(",")<0&&(m="font-weight: "+r+c+";"),l+=t[a].selector+"{font-family: "+i+c+"; "+m+"}"}}}return l+="</style>"}function i(){e(F).detach(),e(F).appendTo("body"),e(F).empty(),e(F).append(o(xn.theme))}function s(n,a,i){for(var s={},r={},l=e("<div>"+vn+"</div>"),d=0;d<n.length;d++){var c=n[d],p=c.attrs.container.split("/")[0],m=c.attrs.container.split("/")[1],h=e(l).find('.az-container[data-az-type="'+p+'"][data-az-name="'+m+'"]')
...
e(S).val(t),e(O).val(wn[t].title)}function d(t){var o=new Lt(null,!1)
...
if(n.indexOf(d)>=0){var c=r.style.getPropertyValue(r.style[l]),p=c.match(/rgb\((\d+),\s*(\d+),\s*(\d+)\)/)
if(null!=p){var m=$(p[1],p[2],p[3])
m[1]>t&&(c in a||(a[c]={}),d in a[c]||(a[c][d]=[]),a[c][d].push(r.selectorText))}}}}}return a}function n(e,t){var n=Math.abs(e[0]-t[0]),a=Math.abs(1-e[0]-t[0]),o=Math.abs(e[0]-(1-t[0]))
...
this.attrs.content=e(n).html(),e(this.attrs.content).appendTo(this.dom_content_element),ht.prototype.render.apply(this,arguments)}})}this.template_elements_loaded=!0,Jt(),this.try_render_unknown_elements(),e(function(){function a(t){if(_.isArray(t))return null
var o=e('<ul class="'+n+'nav az-nav-list"></ul>')
for(var i in t)if("_"!=i){var r=e("<li></li>").appendTo(o).on("mouseenter",function(){e(this).find("> .az-nav-list").css("display","block")}),l=t[i],d=i
0==d.indexOf("_")&&(d=d.replace("_","")),function(t){e('<a href="#">'+d+"</a>").appendTo(r).click(function(){function n(t){if(_.isArray(t))for(var a=0;a<t.length;a++)e('<div class="az-thumbnail" data-az-base="'+t[a].name+'" style="background-image: url('+encodeURI(t[a].thumbnail)+'); background-position: center center; background-size: cover;"></div>').appendTo(v)
else for(var o in t)n(t[o])}var a=this
e(v).empty(),e(v).css("display","block"),e(u).addClass("az-thumbnails"),n(t),e(u).off("mouseleave").on("mouseleave",function(){o||(e(u).css("left",""),e(u).removeClass("az-thumbnails"),e(v).css("overflow-y","scroll"),e(v).css("display","none"))})
var o=!1,i=0
return e(v).sortable({items:".az-thumbnail",connectWith:".az-ctnr",start:function(){o=!0,e(u).css("left","0px"),e(v).css("overflow-y","visible"),i=e(window).scrollTop(),e(window).on("scroll.template-elements-sortable",function(){e(window).scrollTop(i)})},stop:function(){o=!1,e(u).css("left",""),e(u).removeClass("az-thumbnails"),e(v).css("overflow-y","scroll"),e(v).css("display","none"),e(window).off("scroll.template-elements-sortable")},update:function(t,n){for(var o=s.get_element(e(n.item).parent().closest("[data-az-id]").attr("data-az-id")),r=0,l=e(n.item).parent().find("[data-az-id], .az-thumbnail"),d=0;d<l.length;d++)if(e(l[d]).hasClass("az-thumbnail")){r=d
break}s.create_element(o,e(n.item).attr("data-az-base"),r,function(){})
e(n.item).detach(),e(a).click(),e(window).scrollTop(i)},placeholder:"az-sortable-placeholder",forcePlaceholderSize:!0,over:function(e,t){t.placeholder.attr("class",t.helper.attr("class")),t.placeholder.removeClass("ui-sortable-helper"),t.placeholder.addClass("az-sortable-placeholder")}}),!1})}(l),e(r).append(a(t[i]))}return o}if(window.azexo_editor&&Object.keys(t).length>0&&l.length>0){var o={}
for(var i in t){var r=/data-az-tags=\"([^"]+)\"/.exec(t[i].html),d=[]
d=r?r[1].split(","):[""]
var c=i.split("|")
c.pop()
for(var m=o,h=0;h<c.length;h++)c[h]in m||(m[c[h]]={}),m=m[c[h]]
for(var h=0;h<d.length;h++)"_"+d[h]in m||(m["_"+d[h]]=[]),m["_"+d[h]].push(t[i])}var u=e('<div id="az-template-elements" class="az-left-sidebar azexo"></div>').appendTo("body"),f=e('<div id="az-template-elements-welcome" class="azexo">'+p("For adding elements: click on plus-buttons or drag and drop elements from left panel.")+"</div>").appendTo(u)
e(u).hover(function(){e(f).remove()}),e("<h3>"+p("Elements")+"</h3>").appendTo(u),e("<hr>").appendTo(u),e(u).append(a(o)),e(u).find("> .az-nav-list > li").on("mouseleave",function(){e(this).find(".az-nav-list").css("display","none")})
var v=e('<div id="az-thumbnails"></div>').appendTo(u)}})},create_cms_elements:function(e){for(var t in e){var a="az_"+t,o=function(){o.baseclass.apply(this,arguments)}
...
for(var i=0;i<n.children.length;i++)n.children[i].recursive_showed()
e(document).trigger("scroll")}s.try_render_unknown_elements()})},clone:function(){Lt.baseclass.prototype.clone.apply(this,arguments),this.rendered=!0},recursive_render:function(){t?(this.render(e,n,a),this.children=[]):Lt.baseclass.prototype.recursive_render.apply(this,arguments),window.azexo_editor&&(this.show_controls(),this.update_sortable())},update_dom:function(){this.loaded_container!=this.attrs.container&&(this.children=[],e(this.dom_content_element).empty(),this.rendered=!1,null!=this.parent&&Lt.baseclass.prototype.update_dom.apply(this,arguments))},showed:function(e){Lt.baseclass.prototype.showed.apply(this,arguments)
var t=this
