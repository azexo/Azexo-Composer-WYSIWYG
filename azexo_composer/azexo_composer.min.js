...
e.each(gn,function(){_=_+this.name+'"'+this.value+'" '}),t(l),e(l).find(".azexo-backend").remove(),e(l).find(".azexo-editor").removeClass("azexo-editor"),e(l).find(".ui-sortable").removeClass("ui-sortable"),"azexo_export_filter"in window&&window.azexo_export_filter(l),e(l).append(o(xn.theme))
...
e('<button class="az-theme-settings '+n+"btn "+n+'btn-default">'+p("Theme")+"</button>").appendTo(j).click(function(){return f(xn.theme,function(e){xn.theme=e,i()}),!1}),e('<button class="'+n+"btn "+n+'btn-default">'+p("Configuration")+"</button>").appendTo(j).click(function(){return azexo_add_js({path:"js/json2.min.js",loaded:"JSON"in window,callback:function(){function t(){for(var t=0,n=["color","background-color","border-left-color","border-right-color","border-top-color","border-bottom-color","outline-color"],a={},o=0;o<document.styleSheets.length;o++){var i=document.styleSheets[o]
if("href"in i&&null!=i.href&&i.href.indexOf("azexo_elements")>=0)for(var s=0;s<i.cssRules.length;s++){var r=i.cssRules[s]
if(r instanceof CSSStyleRule)for(var l in r.style)if(e.isNumeric(l)){var d=r.style[l]
