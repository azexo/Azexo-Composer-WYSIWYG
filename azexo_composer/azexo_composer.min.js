...
_.isUndefined(t)||e(t.controls).css("display","block")}),e(t.parent.controls).data("spc",!0))}},100),e(t.controls).find("span").off("click").on("click",function(){e(t.controls).find("."+n+"btn:not(span)").css("display","inline-block"),e(t.parent.controls).find("."+n+"btn:not(span)").css("display","none"),a(t)}),e(t.parent.controls).find("span").off("click").on("click",function(){e(t.parent.controls).find("."+n+"btn:not(span)").css("display","inline-block")
var i=s.get_element(e(this).closest("[data-az-cid]").attr("data-az-cid"))
_.isUndefined(i)||(e(i.controls).find("."+n+"btn:not(span)").css("display","none"),a(i))}),e(t.controls).find("span").trigger("click")})}},get_empty:function(){return'<div class="az-empty"><div class="top '+n+'well"><strong>'+p("Click to put an element here.")+"</strong></div></div>"},update_empty:function(){if(window.azexo_editor)if(0==this.children.length&&this.is_container&&!this.has_content||this.has_content&&""==this.attrs.content){e(this.dom_content_element).find("> .az-empty").remove()
