...
s.show_js_animations_editor(r,!1,function(){i()}),e("#az-editor-modal").find(".save").off("mousedown.an_js_in").on("mousedown.an_js_in",function(){s.save_js_animations(!1)})}}}),W({type:"dropdown",heading:p("Animation out"),param_name:"an_out",tab:p("Animation"),value:Vt,dependency:{element:"an_start",value:["hover","trigger"]}}),W({type:"dropdown",heading:p("JS animation out"),param_name:"an_js_out",tab:p("Animation"),value:{},dependency:{element:"an_out",value:["js"],callback:function(t){function a(){s.save_js_animations(!1),e(s.animations_editor).remove(),delete s.animations_editor}function i(){s.update_js_animations_list()
var t=o.dom_element,n=o.get_value()
o.render(n),e(t).replaceWith(o.dom_element)}var o=this,s=this.element
...
""!=this.parent.attrs.type&&(t=this.parent.attrs.type),this.dom_element=e('<div class="az-element az-slide '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=this.dom_element,gt.baseclass.prototype.render.apply(this,arguments)}}),rt("az_presentation",!0,yt),A(yt.prototype,{name:p("Presentation"),icon:"fa fa-file-powerpoint-o",description:p("Content presentation. Every step of presentation can contain any number of any types of elements."),category:p("Layout"),params:[W({type:"integer_slider",heading:p("Height"),param_name:"height",min:"0",max:"2000",value:"900"}),W({type:"checkbox",heading:p("Options"),param_name:"options",value:{navigation:p("Navigation"),auto_play:p("Auto play"),full_filling:p("Full filling available area")}}),W({type:"integer_slider",heading:p("Transition duration"),param_name:"duration",min:"0",max:"10000",value:"1000"})].concat(yt.prototype.params),is_container:!0,highlighted:!1,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},init_scroll_variables:function(){this.hover=!1,this.scroll_top=0,this.transition_duration="0s",this.transition_delay="0s"},show_controls:function(){function t(e,t){var n={x:0,y:0},a=d.config.rotation/180*Math.PI,i=Math.cos(a),o=Math.sin(a)
