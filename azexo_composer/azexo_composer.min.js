...
u=setTimeout(function(){clearInterval(n),u=null,e(t.node).css("outline-color",""),e(t.node).css("outline-width",""),e(t.node).css("outline-style",""),i(t.node,t.edit,t.style,t.attrs,function(){_()})},500)}function i(t,n,o,i,s){var r=[],d="",c="",u="",_=e.trim(e(t).text())
if(""!=_&&(_=e(t).html()),n){f=a()
var v=f.join(", ")
if(e(t).is(v)){for(var g=0;g<f.length;g++)if(e(t).is(f[g])){u=f[g].split("."),u.shift(),u=u.join(" ")
break}r.push(lt({type:"icon",heading:p("Icon"),param_name:"icon"}))}"IMG"!=e(t).prop("tagName")?""!=_&&r.push(lt({type:"textarea",heading:p("Content"),param_name:"content"})):(d=e(t).attr("src"),r.push(lt({type:"image",heading:p("Image"),param_name:"image",description:p("Select image from media library.")}))),"A"==e(t).prop("tagName")&&(c=e(t).attr("href"),r.push(lt({type:"link",heading:p("Link"),param_name:"link",description:p("Content link (url).")})))}for(var y in i)r.push(Object.keys(i[y]).length>0?"class"==y?lt({type:"checkbox",heading:y,param_name:"attr_"+y,value:i[y]}):lt({type:"dropdown",heading:y,param_name:"attr_"+y,value:i[y]}):lt({type:"textfield",heading:y,param_name:"attr_"+y}))
if(o){r.push(lt({type:"textfield",heading:p("Content classes"),param_name:"el_class",description:p("If you wish to style particular content element differently, then use this field to add a class name and then refer to it in your css file.")}))
var b=lt({type:"style",heading:p("Content style"),param_name:"style",description:p("Style options."),tab:p("Style")})
n||Object.keys(i).length>0?r.push(b):r.unshift(b)}e(t).removeClass("editable-highlight"),e(t).removeClass("styleable-highlight"),e(t).removeClass(u)
var w=e(t).attr("class")
e(t).addClass(u),(void 0===w||w===!1)&&(w="")
var x=""
for(var y in t.style)e.isNumeric(y)&&(x=x+t.style[y]+": "+t.style.getPropertyValue(t.style[y])+"; ")
x=F(x),x=x.replace(/\-value\: /g,": "),x=x.replace("border-top-color","border-color"),x=x.replace("border-top-left-radius","border-radius"),x=x.replace("border-top-style","border-style"),x=x.replace("background-position-x: 50%; background-position-y: 50%;","background-position: center;"),x=x.replace("background-position-x: 50%; background-position-y: 100%;","background-position: center bottom;"),x=x.replace("background-position-x: 0px; background-position-y: 0px;","background-position: 0 0;"),x=x.replace("background-repeat-x: repeat; background-repeat-y: repeat;","background-repeat: repeat;"),x=x.replace("background-repeat-x: no-repeat; background-repeat-y: no-repeat;","background-repeat: no-repeat;"),x=x.replace("background-repeat-x: repeat;","background-repeat: repeat-x;")
for(var z={content:_,link:c,image:d,el_class:w,style:x,icon:u},g=0;g<i.length;g++);for(var y in i)if(Object.keys(i[y]).length>0)if("class"==y){var k=[],w=e(t).attr(y).split(" ")
for(var j in i[y])w.indexOf(j)>=0&&k.push(j)
z["attr_"+y]=k.join(",")}else z["attr_"+y]=e(t).attr(y)
else z["attr_"+y]=e(t).attr(y)
st.prototype.show_editor(r,{name:p("Content"),attrs:z},function(a){n&&(""!=u&&(e(t).removeClass(u),a.el_class=a.el_class+" "+a.icon),"A"==e(t).prop("tagName")&&e(t).attr("href",a.link),"IMG"==e(t).prop("tagName")?e(t).attr("src",a.image):""!=_&&""!=a.content&&e(t).html(a.content)),o&&(e(t).attr("class",a.el_class),e(t).attr("style",a.style))
for(var r in i)if(Object.keys(i[r]).length>0)if("class"==r){var d=a["attr_"+r].split(",")
for(var c in i[r])d.indexOf(c)>=0?e(t).addClass(c):e(t).removeClass(c)}else e(t).attr(r,a["attr_"+r])
else e(t).attr(r,a["attr_"+r])
h.attrs.content=e(h.dom_content_element).html(),h.restore_content(),l(),m(),s()})}function r(t){var n=e(t).clone()
...
for(var i=0;i<h.styleable.length;i++)e(h.dom_element).find(h.styleable[i]).off("mouseenter.az-styleable").on("mouseenter.az-styleable",function(){0==e(this).closest("[data-az-restore]").length&&e(this).addClass("styleable-highlight")}),e(h.dom_element).find(h.styleable[i]).off("mouseleave.az-styleable").on("mouseleave.az-styleable",function(){0==e(this).closest("[data-az-restore]").length&&e(this).removeClass("styleable-highlight")}),e(h.dom_element).find(h.styleable[i]).off("click.az-styleable").on("click.az-styleable",function(n){if(0==e(this).closest("[data-az-restore]").length){if(0==e(this).parent().closest(".styleable-highlight, .editable-highlight").length)return t({node:this,edit:!1,style:!0,attrs:{}}),_(n),!1
t({node:this,edit:!1,style:!0,attrs:{}}),setTimeout(function(){null==u&&s.edit_stack.length>0&&_(n)},0)}})
for(var i=0;i<h.editable.length;i++)e(h.dom_element).find(h.editable[i]).off("mouseenter.az-editable").on("mouseenter.az-editable",function(){0==e(this).closest("[data-az-restore]").length&&e(this).addClass("editable-highlight")}),e(h.dom_element).find(h.editable[i]).off("mouseleave.az-editable").on("mouseleave.az-editable",function(){0==e(this).closest("[data-az-restore]").length&&e(this).removeClass("editable-highlight")}),e(h.dom_element).find(h.editable[i]).off("click.az-editable").on("click.az-editable",function(n){if(0==e(this).closest("[data-az-restore]").length){if(0==e(this).parent().closest(".styleable-highlight, .editable-highlight").length)return t({node:this,edit:!0,style:!0,attrs:{}}),_(n),!1
t({node:this,edit:!0,style:!0,attrs:{}}),setTimeout(function(){null==u&&s.edit_stack.length>0&&_(n)},0)}})
for(var r={},i=0;i<h.attr_editable.length;i++){var f=h.attr_editable[i].split("|")[0],v=h.attr_editable[i].split("|")[1]
r[f]=e.extend({},r[f],a(v))}e(h.dom_element).find("[data-az-editable]").length>0&&(r["[data-az-editable]"]={})
for(var f in r){var g=r[f]
e(h.dom_element).find(f).off("mouseenter.az-editable").on("mouseenter.az-editable",function(){0==e(this).closest("[data-az-restore]").length&&e(this).addClass("editable-highlight")}),e(h.dom_element).find(f).off("mouseleave.az-editable").on("mouseleave.az-editable",function(){0==e(this).closest("[data-az-restore]").length&&e(this).removeClass("editable-highlight")}),e(h.dom_element).find(f).each(function(){var t=g
"[data-az-editable]"==f&&(t=a(e(this).attr("data-az-editable"))),e(this).data("attr-editable")?e(this).data("attr-editable",e.extend({},e(this).data("attr-editable"),t)):e(this).data("attr-editable",g)}),e(h.dom_element).find(f).each(function(){function n(n){if(0==e(a).closest("[data-az-restore]").length){if(0==e(a).parent().closest(".styleable-highlight, .editable-highlight").length)return t({node:a,edit:!1,style:!1,attrs:e(a).data("attr-editable")}),_(n),!1
t({node:a,edit:!1,style:!1,attrs:e(a).data("attr-editable")}),setTimeout(function(){null==u&&s.edit_stack.length>0&&_(n)},0)}}var a=this
...
var u=null,_=function(t){if(e(".az-edit-select").remove(),s.edit_stack.length>1){for(var a=e('<div class="az-edit-select '+n+'btn-group-vertical"></div>').appendTo("body"),i=0;i<s.edit_stack.length;i++){var r=s.edit_stack[i],l=""
