...
n[i].subsets=n[i].subsets.concat(s.split(",")),e.unique(n[i].subsets),n[i].variants=n[i].variants.concat(r.split(",")),e.unique(n[i].variants)}var l="<style>"
...
e('<li class="'+n+"glyphicon "+n+'glyphicon-move" data-section-id="'+o.id+'">'+o.base+"</li>").appendTo(g).click(function(){var t=e(this).attr("data-section-id"),n=s.get_element(t)
