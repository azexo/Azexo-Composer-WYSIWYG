...
e(d.dom_element).find(".az-sortable-controls").remove(),e(d.dom_element).find(".sortable-highlight").removeClass("sortable-highlight"),null!==v&&clearTimeout(g),e(n).addClass("sortable-highlight"),f.push(n),v=n,g=setTimeout(function(){t(n)},1e3)}}),e(d.dom_element).find(d.sortable[n]).find("> *").off("mouseleave.az-sortable").on("mouseleave.az-sortable",function(){if(0==e(this).closest("[data-az-restore]").length){var n=this
