...
var m=at.prototype.param_types.icon.prototype.icons.map(function(e){return e.replace(/^/,".").replace(/ /,".")}),h=m.join(", ")
for(var u in t){var f=t[u].name,v=t[u].html
"ajaxurl"in window&&(v=e("<div>"+v+"</div>"),a(v),v=e(v).html())
var g=""
"thumbnail"in t[u]&&(g=t[u].thumbnail)
var y=function(){y.baseclass.apply(this,arguments)}
pt(f,!1,y)
var b=e("<div>"+v+"</div>"),w=e(b).find("."+n+"container, ."+n+"container-fluid, .az-rootable").length>0
Y(y.prototype,{name:f,icon:"fa fa-cube",description:p(""),thumbnail:g,params:[it({type:"html",heading:p("Content"),param_name:"content",value:v})].concat(y.prototype.params),show_settings_on_create:!1,is_container:!0,has_content:!0,section:w,category:"Template-elements",is_template_element:!0,editable:[".az-editable"].concat(o),styleable:[".az-styleable"].concat(i),sortable:[".az-sortable"].concat(r),synchronizable:[".az-synchronizable"].concat(d),restoreable:[".az-restoreable"].concat(c),restore_nodes:{},show_controls:function(){function t(t,n,o,i){var s=[],d="",c="",_="",u=e.trim(e(t).text())
if(""!=u&&(u=e(t).html()),n){if(e(t).is(h)){for(var f=0;f<m.length;f++)if(e(t).is(m[f])){_=m[f].split("."),_.shift(),_=_.join(" ")
break}s.push(it({type:"icon",heading:p("Icon"),param_name:"icon"}))}"IMG"!=e(t).prop("tagName")?""!=u&&s.push(it({type:"textarea",heading:p("Content"),param_name:"content"})):(d=e(t).attr("src"),s.push(it({type:"image",heading:p("Image"),param_name:"image",description:p("Select image from media library.")}))),"A"==e(t).prop("tagName")&&(c=e(t).attr("href"),s.push(it({type:"link",heading:p("Link"),param_name:"link",description:p("Conent link (url).")})))}if(o){s.push(it({type:"textfield",heading:p("Content classes"),param_name:"el_class",description:p("If you wish to style particular content element differently, then use this field to add a class name and then refer to it in your css file.")}))
...
y=H(y),y=y.replace(/\-value\: /g,": "),y=y.replace("border-top-color","border-color"),y=y.replace("border-top-left-radius","border-radius"),y=y.replace("border-top-style","border-style"),at.prototype.show_editor(s,{name:"Content",attrs:{content:u,link:c,image:d,el_class:g,style:y,icon:_}},function(s){n&&(""!=_&&(e(t).removeClass(_),s.el_class=s.el_class+" "+s.icon),"A"==e(t).prop("tagName")&&e(t).attr("href",s.link),"IMG"==e(t).prop("tagName")?e(t).attr("src",s.image):""!=u&&""!=s.content&&e(t).html(s.content)),o&&(e(t).attr("class",s.el_class),e(t).attr("style",s.style)),l.attrs.content=e(l.dom_content_element).html(),l.restore_content(),a(),r(),i()})}function n(t){var n=e(t).clone()
...
var n=e('<div class="az-sortable-controls"></div>').appendTo(t),i=e('<div class="az-sortable-clone glyphicon glyphicon-repeat" title="'+p("Clone")+'"></div>').appendTo(n).click(function(){return o(),e(t).removeClass("sortable-highlight").find(".az-sortable-controls").remove(),e(t).clone().insertAfter(t),l.attrs.content=e(l.dom_content_element).html(),l.restore_content(),a(),r(),!1})
e(i).css("line-height",e(i).height()+"px").css("font-size",e(i).height()/2+"px")
var s=e('<div class="az-sortable-remove glyphicon glyphicon-remove" title="'+p("Remove")+'"></div>').appendTo(n).click(function(){return o(),e(t).removeClass("sortable-highlight").find(".az-sortable-controls").remove(),e(t).remove(),l.attrs.content=e(l.dom_content_element).html(),l.restore_content(),a(),r(),!1})
e(s).css("line-height",e(s).height()+"px").css("font-size",e(s).height()/2+"px")}}for(var n=0;n<l.restoreable.length;n++)e(l.dom_element).find(l.restoreable[n]).off("mouseenter.az-restoreable").on("mouseenter.az-restoreable",function(){e(this).addClass("restoreable-highlight")}),e(l.dom_element).find(l.restoreable[n]).off("mouseleave.az-restoreable").on("mouseleave.az-restoreable",function(){e(this).removeClass("restoreable-highlight")}),e(l.dom_element).find(l.restoreable[n]).off("click.az-restoreable").on("click.az-restoreable",function(){if(e(this).hasAttr("data-az-restore")){var t=[]
t.push(it({type:"html",heading:p("HTML"),param_name:"html"}))
var n=e(this).attr("data-az-restore"),a=this.restore_nodes[n]
return at.prototype.show_editor(t,{name:"Content",attrs:{html:a}},function(e){l.restore_nodes[n]=e.html,l.restore_content()}),!1}})
for(var n=0;n<l.styleable.length;n++)e(l.dom_element).find(l.styleable[n]).off("mouseenter.az-styleable").on("mouseenter.az-styleable",function(){e(this).addClass("styleable-highlight")}),e(l.dom_element).find(l.styleable[n]).off("mouseleave.az-styleable").on("mouseleave.az-styleable",function(){e(this).removeClass("styleable-highlight")}),e(l.dom_element).find(l.styleable[n]).off("click.az-styleable").on("click.az-styleable",function(){return 0==e(this).parent().closest(".styleable-highlight, .editable-highlight, .restoreable-highlight").length?(s.edit_stack.push({node:this,edit:!1,style:!0}),d(),!1):void s.edit_stack.push({node:this,edit:!1,style:!0})})
for(var n=0;n<l.editable.length;n++)e(l.dom_element).find(l.editable[n]).off("mouseenter.az-editable").on("mouseenter.az-editable",function(){e(this).addClass("editable-highlight")}),e(l.dom_element).find(l.editable[n]).off("mouseleave.az-editable").on("mouseleave.az-editable",function(){e(this).removeClass("editable-highlight")}),e(l.dom_element).find(l.editable[n]).off("click.az-editable").on("click.az-editable",function(){return 0==e(this).parent().closest(".styleable-highlight, .editable-highlight, .restoreable-highlight").length?(s.edit_stack.push({node:this,edit:!0,style:!0}),d(),!1):void s.edit_stack.push({node:this,edit:!0,style:!0})})
var c=[],m=null,h=null
...
for(var n=0;n<l.sortable.length;n++)!function(n){e(l.dom_element).find(l.sortable[n]).find("> *").off("mouseenter.az-sortable").on("mouseenter.az-sortable",function(){var n=this
e(l.dom_element).find(".az-sortable-controls").remove(),e(l.dom_element).find(".sortable-highlight").removeClass("sortable-highlight"),null!==m&&clearTimeout(h),e(n).addClass("sortable-highlight"),c.push(n),m=n,h=setTimeout(function(){t(n)},1e3)}),e(l.dom_element).find(l.sortable[n]).find("> *").off("mouseleave.az-sortable").on("mouseleave.az-sortable",function(){var n=this
...
y.baseclass.prototype.show_controls.apply(this,arguments)
...
t||(t=[]),t.push(this),t=e.unique(t),e(a.from_node).data("synchronized",t),t=e(this).data("synchronized"),t||(t=[]),t.push(a.from_node),t=e.unique(t),e(this).data("synchronized",t),e(this).html(a.new_state),l.attrs.content=e(l.dom_content_element).html(),l.restore_content()}})
r()}),r(),a()}},restore_content:function(){var t="<div>"+this.attrs.content+"</div>"
for(var n in this.restore_nodes)e(t).find('[data-az-restore="'+n+'"]').html(this.restore_nodes[n])
this.attrs.content=e(t).html()},restore:function(){y.baseclass.prototype.restore.apply(this,arguments)
for(var t in this.restore_nodes)e(this.dom_element).find('[data-az-restore="'+t+'"]').html(this.restore_nodes[t])},showed:function(e,t){y.baseclass.prototype.showed.apply(this,arguments)
var n=this
...
for(var n=e(this.attrs.content),a=0;a<this.restoreable.length;a++)e(n).find(this.restoreable[a]).each(function(){var n=_.uniqueId("r")
e(this).attr("data-az-restore",n),t.restore_nodes[n]=e(this).html()})
e(n).appendTo(this.dom_content_element),y.baseclass.prototype.render.apply(this,arguments)}})}this.template_elements_loaded=!0,qt(),this.try_render_unknown_elements(),e(function(){function a(t){if(1===Object.keys(t).length&&"_"in t)return null
