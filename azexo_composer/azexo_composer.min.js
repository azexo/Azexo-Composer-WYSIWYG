...
case t:a=(n-e)/l+2
break
case n:a=(e-t)/l+4}a/=6}return[a,o,r]}function J(e,t){var a=n+"col-"+t+"-",o=e?e.split("/"):[1,1],i=_.range(1,13),s=!_.isUndefined(o[0])&&_.indexOf(i,parseInt(o[0],10))>=0?parseInt(o[0],10):!1,r=!_.isUndefined(o[1])&&_.indexOf(i,parseInt(o[1],10))>=0?parseInt(o[1],10):!1
return s!==!1&&r!==!1?a+12*s/r:a+"12"}function $(e){return _.isString(e)?e.replace(/(\`{2})/g,'"'):e}function X(e){return decodeURIComponent((e+"").replace(/%(?![\da-f]{2})/gi,function(){return"%25"}))}function W(e,t,n){var a=new Date
a.setDate(a.getDate()+n)
var o=encodeURIComponent(t)+(null===n?"":"; expires="+a.toUTCString())
document.cookie=e+"="+o}function V(e){var t,n,a,o=document.cookie.split(";")
for(t=0;t<o.length;t++)if(n=o[t].substr(0,o[t].indexOf("=")),a=o[t].substr(o[t].indexOf("=")+1),n=n.replace(/^\s+|\s+$/g,""),n==e)return decodeURIComponent(a)}function G(t){var n=parseInt(e(t).css("z-index"))
return e(t).parent().find("*").each(function(){var t=parseInt(e(this).css("z-index"))
t>n&&(n=t)}),n}function Q(t){var n=G(t)
e(t).css("z-index",n+1)}function Z(t,n){var a="<select>"
...
return e(i).chosen({search_contains:!0,allow_single_deselect:!0}),e(i).change(function(){e(this).find("option:selected").each(function(){e(n).val(e(this).val())})}),e(i).parent().find(".chosen-container").width("100%"),e('<div><a class="direct-input" href="#">'+p("Direct input")+"</a></div>").insertBefore(i).click(function(){e(n).css("display","block"),e(i).parent().find(".chosen-container").remove(),e(i).remove(),e(this).remove()}),i}function K(t,n,a){var o='<select multiple="multiple">',i=""
...
e(this).find("option:selected").each(function(){t.push(e(this).val())}),e(n).val(t.join(a))}),e(r).parent().find(".chosen-container").width("100%"),e('<div><a class="direct-input" href="#">'+p("Direct input")+"</a></div>").insertBefore(r).click(function(){e(n).css("display","block"),e(r).parent().find(".chosen-container").remove(),e(r).remove(),e(this).remove()}),r}function et(e){var t=/^.*((youtu.be\/)|(v\/)|(\/u\/\w\/)|(embed\/)|(watch\?))\??v?=?([^#\&\?]*).*/,n=e.match(t)
return n&&11==n[7].length?n[7]:!1}function tt(e){if(-1!=e.search(/^\/\//))return window.location.protocol+e
if(-1!=e.search(/:\/\//))return e
if(-1!=e.search(/^\//))return window.location.origin+e
var t=window.location.href.match(/(.*\/)/)[0]
return t+e}function nt(e,t,a){var o='<select name="'+t+'" class="'+n+'form-control">'
o+='<option value="">'+p("Please select")+"</option>"
for(var i in e)o+=i==a?'<option value="'+i+'" selected>'+e[i]+"</option>":'<option value="'+i+'">'+e[i]+"</option>"
return o+="/<select>"}function at(e){return'<div class="'+n+"alert "+n+"alert-warning "+n+"fade "+n+'in" role="alert"><button type="button" class="'+n+'close" data-dismiss="'+n+'alert"><span aria-hidden="true">×</span><span class="'+n+'sr-only">'+p("Close")+"</span></button>"+e+"</div>"}function ot(){this.dom_element=null,this.heading="",this.description="",this.param_name="",this.required=!1,this.admin_label="",this.holder="",this.wrapper_class="",this.value=null,this.can_be_empty=!1,this.hidden=!1,this.tab="",this.dependency={},"create"in this&&this.create()}function it(e,t){B(t,ot),t.prototype.type=e,ot.prototype.param_types[e]=t}function st(e){if(e.type in ot.prototype.param_types){var t=new ot.prototype.param_types[e.type]
return Y(t,e),t}var t=new ot
return Y(t,e),t}function rt(){rt.baseclass.apply(this,arguments)}function lt(e){var t=document.createElement("div")
return t.innerHTML=e,0===t.childNodes.length?"":t.childNodes[0].nodeValue}function dt(){dt.baseclass.apply(this,arguments)}function ct(){}function pt(e,n){this.id=_.uniqueId(t?"f":"b"),null!=e&&(this.parent=e,"boolean"==typeof n?n?e.children.push(this):e.children.unshift(this):e.children.splice(n,0,this)),this.children=[],this.dom_element=null,this.dom_content_element=null,this.attrs={}
...
this.controls=null,s.add_element(this.id,this,n)}function mt(e,t,n){if(B(n,pt),n.prototype.base=e,n.prototype.is_container=t,pt.prototype.elements[e]=n,pt.prototype.tags[e]=n,t)for(var a=1;a<pt.prototype.max_nested_depth;a++)pt.prototype.tags[e+"_"+a]=n}function ht(){ht.baseclass.apply(this,arguments)}function _t(){if(window.azexo_editor){azexo_add_css("css/font-awesome.css",function(){}),0==e("#azexo-clipboard").length&&e("body").prepend('<div id="azexo-clipboard" style="display:none"></div>'),azexo_add_js({path:"chosen/chosen.jquery.min.js"}),azexo_add_css("chosen/chosen.min.css",function(){})
for(var t in s.elements_instances){var n=s.elements_instances[t]
n instanceof Nt&&e(n.dom_element).addClass("azexo-editor"),null==n.controls&&n.show_controls(),n.update_sortable()}e("#az-exporter").show()}else{for(var t in s.elements_instances){var n=s.elements_instances[t]
n instanceof Nt&&e(n.dom_element).removeClass("azexo-editor"),null!=n.controls&&e(n.controls).remove(),n.update_empty()}e("#az-exporter").hide()}}function ut(){"ajaxurl"in window||(!window.azexo_editor||window.azexo_online)&&delete window.azexo_editor,h(function(t){window.azexo_editor=t,e(function(){_t()}),!t&&"azexo_exporter"in window&&gt()})}function ft(t){e.holdReady(!0),"complete"===document.readyState?setTimeout(t):document.addEventListener?(document.addEventListener("DOMContentLoaded",t,!1),window.addEventListener("load",t,!1)):(document.attachEvent("onreadystatechange",t),window.attachEvent("onload",t))}function vt(o){if(e(o).length>0){var i=e(o).html(),s=/^\s*\<[\s\S]*\>\s*$/.exec(i)
...
e(o).replaceWith(r.dom_element),e(r.dom_element).attr("data-az-type",p),e(r.dom_element).attr("data-az-name",m),r.showed(e,n,a),window.azexo_editor&&r.show_controls()}return window.azexo_editor&&e(r.dom_element).addClass("azexo-editor"),r}return null}function gt(){e("#az-admin-modal").remove()
...
P(function(t){t.length>0&&"0"!=t&&"false"!=t&&(s=e(t).on("keydown.azexo",function(t){13==t.keyCode&&e("#az-admin-modal").find(".save").click()}),e(i).find("."+n+"modal-body").append(s),window.azexo_editor&&e('<button type="button" class="'+n+"btn "+n+'btn-default" data-dismiss="'+n+'modal">'+p("Logout")+"</button>").appendTo("#az-admin-modal .modal-footer").click(function(){W("azexo_password","",null),window.location.reload()}),e("#az-admin-modal").find(".save").click(function(){return R(s.serialize(),function(t){t&&window.location.reload(),e("#az-admin-modal")[a+"modal"]("hide")}),!1}),e("#az-admin-modal")[a+"modal"]("show"))})}function yt(){mn||(mn=!0,e(".az-container").each(function(){var e=vt(this)
e&&l.push(e)}),window.azexo_editor&&0==e("#azexo-clipboard").length&&e("body").prepend('<div id="azexo-clipboard" class="azexo-backend" style="display:none"></div>'),e("body").on("keydown.azexo",function(e){e.ctrlKey&&e.altKey&&gt()}))}function bt(){bt.baseclass.apply(this,arguments)}function wt(e,t,n){if(B(n,bt),n.prototype.base=e,n.prototype.is_container=t,bt.prototype.elements[e]=n,bt.prototype.tags[e]=n,t)for(var a=1;a<bt.prototype.max_nested_depth;a++)bt.prototype.tags[e+"_"+a]=n}function xt(){xt.baseclass.apply(this,arguments)}function zt(e,t){zt.baseclass.apply(this,arguments),this.columns="",t&&"boolean"==typeof t||this.set_columns("1/1"),this.attrs.device="sm"}function kt(e,t){kt.baseclass.call(this,e,t)}function jt(e,t){jt.baseclass.apply(this,arguments),this.linked_elements_index={},t&&"boolean"==typeof t||this.add_item(),this.attach_events()}function Tt(){Tt.baseclass.apply(this,arguments)}function St(){St.baseclass.apply(this,arguments)}function Ct(e,t){Ct.baseclass.apply(this,arguments),t&&"boolean"==typeof t||this.add_tab()}function Ot(){Ot.baseclass.apply(this,arguments)}function It(e,t){It.baseclass.apply(this,arguments),t&&"boolean"==typeof t||this.add_toggle()}function Pt(){Pt.baseclass.apply(this,arguments)}function Rt(e,t){Rt.baseclass.apply(this,arguments),t&&"boolean"==typeof t||this.add_slide()}function At(){At.baseclass.apply(this,arguments)}function Dt(e,t){Dt.baseclass.apply(this,arguments),t&&"boolean"==typeof t||this.add_step(),window.azexo_editor&&this.init_scroll_variables()}function Ut(){Ut.baseclass.apply(this,arguments)}function Nt(){Nt.baseclass.apply(this,arguments),this.rendered=!1,this.loaded_container=null,this.js={},this.css={}}function Lt(){Lt.baseclass.apply(this,arguments),this.menu_items={}
for(var t in s.elements_instances){var o=s.elements_instances[t]
o instanceof xt&&""!=o.attrs.menu_item_title&&(this.menu_items[t]=o.attrs.menu_item_title)}var i=this,r=function(t,o){e("body")[a+"scrollspy"]({target:"#"+i.id+".navbar-collapse",offset:i.navbar_height})
var r=s.get_element(o)
r instanceof xt&&(""!=r.attrs.menu_item_title?(i.menu_items[o]=r.attrs.menu_item_title,i.replace_render(),i.showed(e,n,a)):o in i.menu_items&&(delete i.menu_items[o],i.replace_render(),i.showed(e,n,a)))}
...
var r=s.get_element(o)
r instanceof xt&&(delete i.menu_items[o],i.replace_render(),i.showed(e,n,a))}),e(document).on("azexo_update_sorting",function(t,o){e("body")[a+"scrollspy"]({target:"#"+i.id+".navbar-collapse",offset:i.navbar_height})
var r=e(o.item).closest("[data-az-id]").attr("data-az-id"),l=s.get_element(r)
i.id==r&&e(l.dom_element).find("."+n+"navbar")[a+"affix"]({offset:{top:e(l.dom_element).find("."+n+"navbar").offset().top,bottom:0}})})}function Et(){Et.baseclass.apply(this,arguments)}function Mt(){Mt.baseclass.apply(this,arguments)}function Bt(e,t){B(t,Mt),t.prototype.base=e,Mt.prototype.elements[e]=t,Mt.prototype.tags[e]=t,Mt.prototype.form_elements[e]=t}function Yt(){if("azexo_elements"in window)for(var e=0;e<window.azexo_elements.length;e++){var t=window.azexo_elements[e],n=function(){n.baseclass.apply(this,arguments)}
wt(t.base,t.is_container,n),t.baseclass=n.baseclass,t.params=t.params.concat(n.prototype.params),Y(n.prototype,t)
for(var a=0;a<n.prototype.params.length;a++){var o=n.prototype.params[a],i=st(o)
n.prototype.params[a]=i}}}function qt(){if("azexo_form_elements"in window)for(var e=0;e<window.azexo_form_elements.length;e++){var t=window.azexo_form_elements[e],n=function(){n.baseclass.apply(this,arguments)}
Bt(t.base,n),t.baseclass=n.baseclass,t.params=t.params.concat(n.prototype.params),Y(n.prototype,t)
for(var a=0;a<n.prototype.params.length;a++){var o=n.prototype.params[a],i=st(o)
n.prototype.params[a]=i}}}function Ht(){if("azexo_extend"in window)for(var e in window.azexo_extend){var t=window.azexo_extend[e],n=[]
"params"in t&&(n=t.params),delete t.params
var a=pt.prototype.elements[e]
if(!("extended"in a)){a.extended=!0,Y(a.prototype,t)
for(var o=0;o<n.length;o++){var i=st(n[o])
a.prototype.params.push(i)}}}}function Ft(){(!window.azexo_editor||window.azexo_online)&&z(function(e){_.isObject(e)&&s.create_template_elements(e)})}function Jt(){b(function(e){_.isObject(e)?s.create_cms_elements(e):s.cms_elements_loaded=!0})}function $t(){function t(t){e(t).find("link[href]").each(function(){e(this).attr("href",tt(e(this).attr("href")))}),e(t).find("script[src]").each(function(){e(this).attr("src",tt(e(this).attr("src")))}),e(t).find("img[src]").each(function(){e(this).attr("src",tt(e(this).attr("src")))}),e(t).find('[style*="background-image"]').each(function(){var t=e(this).attr("style").replace(/background-image[: ]*url\(([^\)]+)\) *;/,function(e,t){return e.replace(t,encodeURI(tt(decodeURI(t))))})
...
e.each(fn,function(){u=u+this.name+'"'+this.value+'" '}),t(l),e(l).find(".azexo-backend").remove(),e(l).find(".azexo-editor").removeClass("azexo-editor"),e(l).find(".ui-sortable").removeClass("ui-sortable"),"azexo_export_filter"in window&&window.azexo_export_filter(l),e(l).append(o(bn.theme))
var f="<body "+u+">"+e(l).html()+"</body>",l=e("<div>"+_n+"</div>")
e(l).find(".azexo-backend").remove(),"azexo_export_filter"in window&&window.azexo_export_filter(l),e(l).find("title").text(i),t(l)
for(var v in s)e(l).append('<script src="'+tt(v)+'"></script>')
for(var v in r)e(l).append('<link rel="stylesheet" type="text/css" href="'+tt(v)+'">')
e(l).append("<script type='text/javascript'> window.ajaxurl = '"+tt(window.ajaxurl)+"'; </script>"),e(l).append('<script type="text/javascript"> window.azexo_site_name = "'+vn+'"; </script>')
...
e(l[n].dom_element).detach(),e(gn[t][n].dom_element).appendTo(a)}l=gn[t]
for(var n=0;n<l.length;n++)"to_recursive_showed"in l[n]&&(l[n].recursive_showed(),delete l[n].to_recursive_show)
e(C).val(t),e(O).val(yn[t].title)}function d(t){var o=new Nt(null,!1)
...
for(var t in gn)if(null!=gn[t]){var n=s(gn[t],!0,yn[t].title)
e[t]=btoa(v(encodeURIComponent(n)))}return e}function m(t,a){e(T).find("a").removeClass(n+"active"),yn[t]={title:a},e('<a href="#" class="'+n+"list-group-item "+n+'active">'+t+"</a>").appendTo(T).click(function(){return e(this).hasClass(n+"active")||(e(T).find("a").removeClass(n+"active"),e(this).addClass(n+"active"),r(e(this).text())),!1})}function h(t){e('<option value="'+t+'">'+t+"</option>").appendTo(q),e(q).find('option[value="'+t+'"]').prop("selected","selected"),gn={},yn={},e(T).empty(),gn.index=[]
for(var n=0;n<l.length;n++)gn.index.push(d(l[n].attrs.container))
m("index","Home"),r("index"),e(B).click()}function u(t){U(t,function(a){var o=e.parseJSON(a)
vn=t,gn={},yn=o.pages,bn=o.settings,e(T).empty()
for(var s in o.pages){gn[s]=Array(l.length)
...
for(var h=0;h<l.length;h++)if(l[h].attrs.container==c){gn[s][h]=p
break}}m(s,o.pages[s].title)}r(o.current_page),i(),e(T).find("a").removeClass(n+"active"),e(T).find('a:contains("'+o.current_page+'")').addClass(n+"active"),e("#az-template-elements-welcome").remove(),e("#az-exporter-welcome").remove()})}function f(e,t){for(var n=[],a={},o=0;o<e.length;o++)n.push(st(e[o])),a[e[o].param_name]=e[o].value
ot.prototype.show_editor(n,{name:p("Theme"),attrs:a},function(n){for(var a=0;a<e.length;a++)e[a].value=n[e[a].param_name]
t(e)})}function g(e,t){var n=[]
n.push(st({type:"javascript",heading:p("Configuration"),param_name:"configuration",value:e})),ot.prototype.show_editor(n,{name:p("Theme configuration"),attrs:{configuration:e}},function(e){t(e.configuration)})}if(0==e("#az-exporter").length){window.links_select=function(e){var t={}
for(var n in yn)null!=yn[n]&&(t[n+".html"]=yn[n].title)
Z(t,e)}
for(var y=0;y<l.length;y++)l[y].saveable=!1,e(l[y].controls).remove(),l[y].show_controls()
_n=e("head").html(),un=e("body").html(),fn=e("body").prop("attributes")
...
if(""!=e&&null!=e){gn[e]=[]
for(var t=0;t<l.length;t++)gn[e].push(d(l[t].attrs.container))
...
r(a),delete gn[t],gn[t]=null}return!1}),e('<button class="'+n+"btn "+n+'btn-success">'+p("ZIP download")+"</button>").appendTo(k).click(function(){var e=c()
...
e("<hr>").appendTo(b)
var S=e('<div class="'+n+'text-left"></div>').appendTo(b)
e("<h4>"+p("Current page settings")+"</h4>").appendTo(S)
var C=e('<div class="'+n+'form-group"><label>'+p("File name")+'</label><div><input class="'+n+'form-control" name="name" type="text"></div><p class="'+n+'help-block">'+p('"html"-extension will be added during export process')+"</p></div>").appendTo(S).find('input[name="name"]').change(function(){var t=e(T).find("."+n+"active").text(),a=e(this).val()
gn[a]=gn[t],gn[t]=null,yn[a]=yn[t],yn[t]=null,e(T).find("a."+n+'active:contains("'+t+'")').text(a)
for(var o in gn)if(null!=gn[o])for(var i=0;i<gn[o].length;i++)e(gn[o][i].dom_content_element).find('[href="'+t+'.html"]').each(function(){e(this).attr("href",a+".html")})}),O=e('<div class="'+n+'form-group"><label>'+p("Title")+'</label><div><input class="'+n+'form-control" name="title" type="text"></div><p class="'+n+'help-block">'+p("")+"</p></div>").appendTo(S).find('input[name="title"]').change(function(){var t=e(T).find("."+n+"active").text()
yn[t].title=e(this).val()})
gn.index=l,m("index","Home"),e(C).val("index"),e(O).val("Home")
...
t.settings=bn,t.current_page=e(C).val(),t.pages={}
for(var n in gn)if(null!=yn[n]&&null!=gn[n]){t.pages[n]=yn[n],yn[n].containers={}
for(var a=0;a<gn[n].length;a++){var o=gn[n][a].attrs.container
yn[n].containers[o]=btoa(v(encodeURIComponent(gn[n][a].get_children_shortcode())))}}azexo_add_js({path:"js/json2.min.js",loaded:"JSON"in window,callback:function(){N(e(q).find("option:selected").val(),JSON.stringify(t))}})}),Y=!1
...
var t='<div class="'+n+'modal-header"><button type="button" class="'+n+'close" data-dismiss="'+n+'modal" aria-hidden="true">&times;</button><h4 class="'+n+'modal-title">'+p("FTP upload")+"</h4></div>",o='<div class="'+n+'modal-footer"><button type="button" class="'+n+"btn "+n+'btn-default" data-dismiss="'+n+'modal">'+p("Close")+"</button></div>",i=e('<div id="az-ftp-modal" class="'+n+'modal azexo"><div class="'+n+"modal-dialog "+n+'modal-sm"><div class="'+n+'modal-content">'+t+'<div class="'+n+'modal-body"></div>'+o+"</div></div></div>").prependTo("body"),s=e(i).find("."+n+"modal-body"),r=e('<div class="'+n+'form-group"><label>'+p("Host")+'</label><div><input class="'+n+'form-control" name="host" type="text" value="'+bn.host+'"></div><p class="'+n+'help-block"></p></div>').appendTo(s).find("input"),l=e('<div class="'+n+'form-group"><label>'+p("Username")+'</label><div><input class="'+n+'form-control" name="username" type="text" value="'+bn.username+'"></div><p class="'+n+'help-block"></p></div>').appendTo(s).find("input"),d=e('<div class="'+n+'form-group"><label>'+p("Password")+'</label><div><input class="'+n+'form-control" name="password" type="password" value="'+bn.password+'"></div><p class="'+n+'help-block"></p></div>').appendTo(s).find("input"),m=e('<div class="'+n+'form-group"><label>'+p("Port")+'</label><div><input class="'+n+'form-control" name="port" type="text" value="'+bn.port+'"></div><p class="'+n+'help-block"></p></div>').appendTo(s).find("input"),h=e('<div class="'+n+'form-group"><label>'+p("Directory")+'</label><div><input class="'+n+'form-control" name="directory" type="text" value="'+bn.directory+'"></div><p class="'+n+'help-block"></p></div>').appendTo(s).find("input"),u=e('<button class="'+n+"btn "+n+'btn-primary">'+p("Choose upload directory")+"</button>").appendTo(s).click(function(){function t(a,o){if(e(f).empty().show(),e(y).empty().hide(),e(h).val(a),bn.directory=a,"."!=a){var i=a.split("/")
i.pop()
var s=i.join("/")
e('<li class="az-directory">'+p("< Up one level")+"</li>").appendTo(f).click(function(){E(bn.host,bn.username,bn.password,bn.port,s,function(e){t(s,e)})})
for(var r=0;r<o.length;r++)o[r]=o[r].replace(a+"/","")}for(var r=0;r<o.length;r++){var l=a+"/"+o[r]
!function(a){e('<li class="'+n+"glyphicon "+n+'glyphicon-folder-close">'+o[r]+"</li>").appendTo(f).click(function(){E(bn.host,bn.username,bn.password,bn.port,a,function(e){t(a,e)})})}(l)}}bn.host=e(r).val(),bn.username=e(l).val(),bn.password=e(d).val(),bn.port=e(m).val(),E(bn.host,bn.username,bn.password,bn.port,bn.directory,function(n){_.isArray(n)?(e(u).hide(),t(bn.directory,n)):alert(n)})})
e(s).find("input").change(function(){bn.host=e(r).val(),bn.username=e(l).val(),bn.password=e(d).val(),bn.port=e(m).val(),bn.directory=e(h).val(),""!=bn.host&&""!=bn.username&&""!=bn.password&&""!=bn.port?(e(u).show(),e(v).show()):(e(u).hide(),e(v).hide())})
...
Y=!1}else t.uploaded.length>0&&e(y).append('<div class="'+n+"alert "+n+'alert-info">'+t.uploaded[0]+" uploaded</div>"),t.count>0?(0==a&&(a=t.count),e(g).show().find("."+n+"progress-bar").css("width",(a-t.count)/a*100+"%"),Y=!0,M(JSON.stringify({}),t.site_path,JSON.stringify(t.files),bn.host,bn.username,bn.password,bn.port,bn.directory,o)):(e(g).show().find("."+n+"progress-bar").css("width","100%"),e(y).append('<div class="'+n+"alert "+n+'alert-success">'+p("Done")+"</div>"),Y=!1)}
Y=!0,M(JSON.stringify(t),"",JSON.stringify([]),bn.host,bn.username,bn.password,bn.port,bn.directory,o)}})})
...
e('<button class="az-theme-settings '+n+"btn "+n+'btn-default">'+p("Theme")+"</button>").appendTo(j).click(function(){return f(bn.theme,function(e){bn.theme=e,i()}),!1}),e('<button class="'+n+"btn "+n+'btn-default">'+p("Configuration")+"</button>").appendTo(j).click(function(){return azexo_add_js({path:"js/json2.min.js",loaded:"JSON"in window,callback:function(){function t(){for(var t=.05,n=["color","background-color","border-left-color","border-right-color","border-top-color","border-bottom-color","outline-color"],a={},o=0;o<document.styleSheets.length;o++){var i=document.styleSheets[o]
...
if(null!=p){var m=F(p[1],p[2],p[3])
m[1]>t&&(c in a||(a[c]={}),d in a[c]||(a[c][d]=[]),a[c][d].push(r.selectorText))}}}}}return a}var n=JSON.stringify(bn.theme,null,"	")
if("[]"==n){var a=t(),o=0,s=[]
for(var r in a){var l={}
for(var d in a[r]){for(var c=[],p=0;p<a[r][d].length;p++)c.push(a[r][d][p])
c=c.join(", "),c in l||(l[c]=[]),l[c].push(d)}for(var c in l){var m={type:"colorpicker",heading:l[c].join("/")+" "+o,description:c,param_name:"color"+o,value:r,selector:c,property:l[c]}
s.push(m),o++}}n=JSON.stringify(s,null,"	")}g(n,function(t){bn.theme=e.parseJSON(t),i()})}}),!1}),window.azexo_editor||e(b).hide()}}window.azexo_backend=!0
var Xt=(""+arguments.callee).replace(/((\/\/.*$)|(\/\*[\s\S]*?\*\/)|(\s))/gm,"").match(/^function\s*[^\(]*\(\s*([^\)]*)\)/m)[1].split(/,/),Wt=Xt[0],Vt=Xt[1],Gt=Xt[2],Qt=Xt[3],Zt=Xt[4],Kt=Xt[5],en=Xt[6],tn=Xt[7],nn=Xt[8],an=Xt[9]
...
var on={}
on.shortcode={next:function(e,t,n){var a,o,i=on.shortcode.regexp(e)
return i.lastIndex=n||0,(a=i.exec(t))?"["===a[1]&&"]"===a[7]?on.shortcode.next(e,t,i.lastIndex):(o={index:a.index,content:a[0],shortcode:on.shortcode.fromMatch(a)},a[1]&&(o.match=o.match.slice(1),o.index++),a[7]&&(o.match=o.match.slice(0,-1)),o):void 0},replace:function(e,t,n){return t.replace(on.shortcode.regexp(e),function(e,t,a,o,i,s,r,l){if("["===t&&"]"===l)return e
var d=n(on.shortcode.fromMatch(arguments))
return d?t+d+l:e})},string:function(e){return new on.shortcode(e).string()},regexp:_.memoize(function(e){return RegExp("\\[(\\[?)("+e+")(?![\\w-])([^\\]\\/]*(?:\\/(?!\\])[^\\]\\/]*)*?)(?:(\\/)\\]|\\](?:([^\\[]*(?:\\[(?!\\/\\2\\])[^\\[]*)*)(\\[\\/\\2\\]))?)(\\]?)","g")}),attrs:_.memoize(function(e){var t,n,a={},o=[]
...
return t=e[4]?"self-closing":e[6]?"closed":"single",new on.shortcode({tag:e[2],attrs:e[3],type:t,content:e[5]})}},on.shortcode=_.extend(function(e){_.extend(this,_.pick(e||{},"tag","attrs","type","content"))
var t=this.attrs
this.attrs={named:{},numeric:[]},t&&(_.isString(t)?this.attrs=on.shortcode.attrs(t):_.isEqual(_.keys(t),["named","numeric"])?this.attrs=t:_.each(e.attrs,function(e,t){this.set(t,e)},this))},on.shortcode),_.extend(on.shortcode.prototype,{get:function(e){return this.attrs[_.isNumber(e)?"numeric":"named"][e]},set:function(e,t){return this.attrs[_.isNumber(e)?"numeric":"named"][e]=t,this},string:function(){var e="["+this.tag
return _.each(this.attrs.numeric,function(t){e+=/\s/.test(t)?' "'+t+'"':" "+t}),_.each(this.attrs.named,function(t,n){e+=" "+n+'="'+t+'"'}),"single"===this.type?e+"]":"self-closing"===this.type?e+" /]":(e+="]",this.content&&(e+=this.content),e+"[/"+this.tag+"]")}}),on.html=_.extend(on.html||{},{attrs:function(e){var t,n
return"/"===e[e.length-1]&&(e=e.slice(0,-1)),t=on.shortcode.attrs(e),n=t.named,_.each(t.numeric,function(e){/\s/.test(e)||(n[e]="")}),n},string:function(e){var t="<"+e.tag,n=e.content||""
return _.each(e.attrs,function(e,n){t+=" "+n,""!==e&&(_.isBoolean(e)&&(e=e?"true":"false"),t+='="'+e+'"')}),e.single?t+" />":(t+=">",t+=_.isObject(n)?on.html.string(n):n,t+"</"+e.tag+">")}})
var sn=(_.memoize(function(e){return RegExp("(\\[(\\[?)["+e+"]+(?![\\w-])[^\\]\\/]*[\\/(?!\\])[^\\]\\/]*]?(?:\\/]\\]|\\](?:[^\\[]*(?:\\[(?!\\/"+e+"\\])[^\\[]*)*\\[\\/"+e+"\\])?)\\]?)","g")}),_.memoize(function(e){return RegExp("\\[(\\[?)("+e+")(?![\\w-])([^\\]\\/]*(?:\\/(?!\\])[^\\]\\/]*)*?)(?:(\\/)\\]|\\](?:([^\\[]*(?:\\[(?!\\/\\2\\])[^\\[]*)*)(\\[\\/\\2\\]))?)(\\]?)")}))
if(e.fn.closest_descendents=function(t){for(var n=e(),a=this;a.length;)n=e.merge(n,a.filter(t)),a=a.not(t),a=a.children()
return n},ot.prototype={safe:!0,param_types:{},show_editor:function(t,o,i){e("#az-editor-modal").remove()
...
e(v).append(g)}e(h).append(v),e(d).find("."+n+"modal-body").append(h),e('#az-editor-tabs a[href="#az-editor-tab-1"]')[a+"tab"]("show"),e('#az-editor-modal input[name="el_class"]').each(function(){K(pt.prototype.el_classes,this," ")})
...
e(window).on("scroll.az-editor-modal",function(){e(window).scrollTop(w)}),e("#az-editor-modal")[a+"modal"]("show")},opened:function(){},closed:function(){},render:function(){}},it("container",rt),Y(rt.prototype,{get_value:function(){return e(this.dom_element).find('input[name="'+this.param_name+'_type"]').val()+"/"+e(this.dom_element).find('input[name="'+this.param_name+'_name"]').val()},render:function(t){var a=t.split("/")[0],o=t.split("/")[1]
...
u(function(t){n=Z(t,e(o.dom_element).find('input[name="'+o.param_name+'_type"]')),e(n).chosen().change(function(){f(e(this).val(),function(t){e(a).parent().find(".direct-input").click(),e(o.dom_element).find('input[name="'+o.param_name+'_name"]').val(""),a=Z(t,e(o.dom_element).find('input[name="'+o.param_name+'_name"]'))})})}),f(t.split("/")[0],function(t){a=Z(t,e(o.dom_element).find('input[name="'+o.param_name+'_name"]'))})}}),e.fn.deserialize=function(t){var n=e(this),a={}
return e.each(t.split("&"),function(){var e=this.split("="),t=X(e[0]),n=e.length>1?X(e[1]):null
...
for(var a=0;a<t.length;a++)n.find("select[name='"+e+"'] > option[value='"+t[a]+"']").prop("selected","selected")}),e("input:checkbox:checked,input:radio:checked").each(function(){e(this).attr("name")in a||(this.checked=!1)}),this},it("cms_settings",dt),Y(dt.prototype,{get_value:function(){return e(this.dom_element).find("form").serialize()},render_form:function(t){var n=this
x(t,function(t){e(n.dom_element).empty(),e(t).appendTo(n.dom_element),e(n.dom_element).find('[type="submit"]').remove(),n.form_value.length>0&&e(n.dom_element).deserialize(lt(n.form_value))})},get_form:function(e){var t=e.get_value()
t.length>0&&this.render_form(t)},render:function(t){this.form_value=t,this.dom_element=e('<div class="'+n+'form-group"></div>')},opened:function(){"instance"in this&&this.render_form(this.instance)}}),"azexo_param_types"in window)for(var rn=0;rn<window.azexo_param_types.length;rn++){var ln=window.azexo_param_types[rn],dn=function(){dn.baseclass.apply(this,arguments)}
it(ln.type,dn),ln.baseclass=dn.baseclass,Y(dn.prototype,ln)}window.azexo_add_css=function(t,n){var a=window.azexo_baseurl+t
...
for(var n=0;n<t.length;n++)t[n]()}},n.appendChild(a)},Y(ct.prototype,{elements_instances:{},elements_instances_by_an_name:{},template_elements_loaded:!1,cms_elements_loaded:!1,edit_stack:[],try_render_unknown_elements:function(){if(this.template_elements_loaded&&this.cms_elements_loaded)for(var t in s.elements_instances){var n=s.elements_instances[t]
if(n instanceof ht){var a=n.attrs.content,o=/^\s*\<[\s\S]*\>\s*$/.exec(a)
o?pt.prototype.parse_html.call(n,a):pt.prototype.parse_shortcode.call(n,a)
...
var h=ot.prototype.param_types.icon.prototype.icons.map(function(e){return e.replace(/^/,".").replace(/ /,".")}),u=h.join(", ")
...
t(i),i=e(i).html(),this.baseclass.prototype.params[o].value=i}break}pt.apply(this,arguments)}
mt(v,!1,w),Y(w.prototype,{baseclass:w,template:g,path:f,name:v,icon:"fa fa-cube",description:p(""),thumbnail:y,params:[st({type:"html",heading:p("Content"),param_name:"content",value:""})].concat(w.prototype.params),show_settings_on_create:!1,is_container:!0,has_content:!0,section:b,category:p("Template-elements"),is_template_element:!0,editable:[".az-editable"].concat(o),styleable:[".az-styleable"].concat(i),sortable:[".az-sortable"].concat(r),synchronizable:[".az-synchronizable"].concat(d),restoreable:[".az-restoreable"].concat(c),containable:[".az-containable"].concat(m),restore_nodes:{},contained_elements:{},show_controls:function(){function t(t,n,a,i){var s=[],r="",c="",m="",_=e.trim(e(t).text())
if(""!=_&&(_=e(t).html()),n){if(e(t).is(u)){for(var f=0;f<h.length;f++)if(e(t).is(h[f])){m=h[f].split("."),m.shift(),m=m.join(" ")
break}s.push(st({type:"icon",heading:p("Icon"),param_name:"icon"}))}"IMG"!=e(t).prop("tagName")?""!=_&&s.push(st({type:"textarea",heading:p("Content"),param_name:"content"})):(r=e(t).attr("src"),s.push(st({type:"image",heading:p("Image"),param_name:"image",description:p("Select image from media library.")}))),"A"==e(t).prop("tagName")&&(c=e(t).attr("href"),s.push(st({type:"link",heading:p("Link"),param_name:"link",description:p("Content link (url).")})))}if(a){s.push(st({type:"textfield",heading:p("Content classes"),param_name:"el_class",description:p("If you wish to style particular content element differently, then use this field to add a class name and then refer to it in your css file.")}))
var v=st({type:"style",heading:p("Content style"),param_name:"style",description:p("Style options."),tab:p("Style")})
...
t.push(st({type:"html",heading:p("HTML"),param_name:"html"}))
var n=e(this).attr("data-az-restore"),a=d.restore_nodes[n]
return ot.prototype.show_editor(t,{name:p("Content"),attrs:{html:a}},function(e){d.restore_nodes[n]=e.html,d.restore_content(),d.update_dom(),o()}),!1}})
...
pt.prototype.show_controls.apply(this,arguments)
...
e(document).trigger("azexo_restore",{dom:t}),this.attrs.content=e(t).html()},restore:function(t){pt.prototype.restore.apply(this,arguments)
for(var n in this.restore_nodes)e(t).find('[data-az-restore="'+n+'"]').html(this.restore_nodes[n])
e(document).trigger("azexo_restore",{dom:t}),e(t).find("[data-az-restore]").removeAttr("data-az-restore")},showed:function(e,t){pt.prototype.showed.apply(this,arguments)
var n=this
...
this.attrs.content=e(n).html(),e(this.attrs.content).appendTo(this.dom_content_element),pt.prototype.render.apply(this,arguments)}})}this.template_elements_loaded=!0,Ht(),this.try_render_unknown_elements(),e(function(){function a(t){if(1===Object.keys(t).length&&"_"in t)return null
...
w(t.instance,t.attrs.settings,n.attrs.container,function(n){e(t.dom_content_element).empty(),e(t.dom_content_element).append(n)})},{offset:"100%",triggerOnce:!0}),e(document).trigger("scroll")}})}},render:function(e){this.dom_element=e('<div class="az-element az-cms-element '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=e("<div></div>").appendTo(this.dom_element),o.baseclass.prototype.render.apply(this,arguments)}})}this.cms_elements_loaded=!0,Ht(),this.try_render_unknown_elements()},create_element:function(e,t,n,a){var o=e.get_nested_depth(t)
if(o<pt.prototype.max_nested_depth){var i=pt.prototype.elements[t]
if(e instanceof Nt&&null==e.parent&&!i.prototype.section){var s=new xt(e,n)
s.update_dom()
var r=new i(s,!1)
...
for(var l in pt.prototype.elements)pt.prototype.elements[l].prototype.hidden||"az_popup"!=t.base&&i.indexOf(pt.prototype.elements[l].prototype.base)>=0||(pt.prototype.elements[l].prototype.category in r?r[pt.prototype.elements[l].prototype.category].push(pt.prototype.elements[l]):r[pt.prototype.elements[l].prototype.category]=[pt.prototype.elements[l]])
...
pt.prototype.parse_shortcode.call(t,n)
...
var cn={}
if("azexo_classes"in window&&(cn=window.azexo_classes),pt.prototype={el_classes:e.extend(_.object([n+"optgroup-bootstrap",n+"bg-primary",n+"text-primary",n+"bg-success",n+"text-success",n+"bg-default",n+"text-default",n+"text-muted",n+"small",n+"text-left",n+"text-right",n+"text-center",n+"text-justify",n+"pull-left",n+"pull-right",n+"center-block",n+"well",n+"visible-xs-block",n+"visible-sm-block",n+"visible-md-block",n+"visible-lg-block",n+"hidden-xs",n+"hidden-sm",n+"hidden-md",n+"hidden-lg"],[p("Bootstrap classes"),p("Background primary style"),p("Text primary style"),p("Background success style"),p("Text success style"),p("Background default style"),p("Text default style"),p("Text muted style"),p("Text small style"),p("Text align left"),p("Text align right"),p("Text align center"),p("Text align justify"),p("Pull left"),p("Pull right"),p("Block align center"),p("Well"),p("Visible on extra small devices, phones (<768px)"),p("Visible on small devices, tablets (≥768px)"),p("Visible on medium devices, desktops (≥992px)"),p("Visible on large devices, desktops (≥1200px)"),p("Hidden on extra small devices, phones (<768px)"),p("Hidden on small devices, tablets (≥768px)"),p("Hidden on medium devices, desktops (≥992px)"),p("Hidden on large devices, desktops (≥1200px)")]),cn),elements:{},tags:{},max_nested_depth:3,name:"",category:"",description:"",params:[st({type:"textfield",heading:p("Element classes"),param_name:"el_class",description:p("If you wish to style particular content element differently, then use this field to add a class name and then refer to it in your css file.")}),st({type:"style",heading:p("Style"),param_name:"style",description:p("Style options."),tab:p("Style")}),st({type:"style",heading:p("Hover style"),param_name:"hover_style",important:!0,description:p("Hover style options."),tab:p("Hover style")}),st({type:"integer_slider",heading:p("Left"),param_name:"pos_left",tab:p("Placement"),max:"1",step:"0.01",hidden:!0}),st({type:"integer_slider",heading:p("Right"),param_name:"pos_right",tab:p("Placement"),max:"1",step:"0.01",hidden:!0}),st({type:"integer_slider",heading:p("Top"),param_name:"pos_top",tab:p("Placement"),max:"1",step:"0.01",hidden:!0}),st({type:"integer_slider",heading:p("Bottom"),param_name:"pos_bottom",tab:p("Placement"),max:"1",step:"0.01",hidden:!0}),st({type:"integer_slider",heading:p("Width"),param_name:"pos_width",tab:p("Placement"),max:"1",step:"0.01",hidden:!0}),st({type:"integer_slider",heading:p("Height"),param_name:"pos_height",tab:p("Placement"),max:"1",step:"0.01",hidden:!0}),st({type:"integer_slider",heading:p("Z-index"),param_name:"pos_zindex",tab:p("Placement"),hidden:!0})],icon:"",thumbnail:"",is_container:!1,has_content:!1,frontend_render:!1,show_settings_on_create:!1,wrapper_class:"",weight:0,hidden:!1,disallowed_elements:[],show_parent_controls:!1,highlighted:!0,style_selector:"",section:!1,controls_position:function(){if(!this.is_container||this.has_content){var t=e(this.dom_element).height(),n=e(window).height()
if(t>n){var a=e(window).scrollTop(),o=(e(this.controls).offset().top,e(this.dom_element).offset().top),i=a-o+n/2
i>40&&t>i?e(this.controls).css("top",i):i>t?e(this.controls).css("top",t-40):e(this.controls).css("top",40)}}},update_controls_zindex:function(){Q(this.controls)},show_controls:function(){if(window.azexo_editor){var t=this
...
else if(o instanceof St)if(o.layer_number<o.children.length){var l=o.children[o.layer_number]
...
return null!=this.parent&&(t+=this.parent.get_nested_depth(e)),this.base==e&&t++,t},get_my_shortcode:function(){var e=_.keys(pt.prototype.elements),t=_.object(e,Array.apply(null,Array(e.length)).map(Number.prototype.valueOf,0)),n=this.get_shortcode(t)
return n},get_children_shortcode:function(){for(var e=_.keys(pt.prototype.elements),t=_.object(e,Array.apply(null,Array(e.length)).map(Number.prototype.valueOf,0)),n="",a=0;a<this.children.length;a++)n+=this.children[a].get_shortcode(t)
...
this.is_container&&(s+=this.has_content?this.get_content()+"[/"+a+"]":t+"[/"+a+"]")}return e[this.base]--,s},parse_shortcode:function(t){var n=_.keys(pt.prototype.tags).join("|"),a=on.shortcode.regexp(n),o=e.trim(t).match(a)
if(_.isNull(o)){if(0==t.length)return
this.parse_shortcode("["==t.substring(0,1)&&"]"==t.slice(-1)?"[az_unknown]"+t+"[/az_unknown]":'[az_row][az_column width="1/1"][az_text]'+t+"[/az_text][/az_column][/az_row]")}_.each(o,function(e){var a=e.match(sn(n)),o=a[5],i=RegExp("^[\\s]*\\[\\[?("+_.keys(pt.prototype.tags).join("|")+")(?![\\w-])"),s=on.shortcode.attrs(a[3]),r=a[2]
if(!(this.get_nested_depth(r)>pt.prototype.max_nested_depth)){var l=ht
if(r in pt.prototype.tags&&(l=pt.prototype.tags[r]),this instanceof Nt&&null==this.parent&&!l.prototype.section)return void this.parse_shortcode("[az_section]"+t+"[/az_section]")
var d=new l(this,!0)
d.parse_attrs(s.named)
var c=pt.prototype.tags[r].prototype
...
if(0==e(n).children().closest_descendents("[data-azb]").length&&e.trim(e(n).html()).length>0){var o=new zt(a,!1)
o.children=[]
var i=new kt(o,!1),r=pt.prototype.elements.az_text,l=new r(i,!1)
l.attrs.content=e(n).html(),l.update_dom(),"update_empty"in a&&a.update_empty(),"update_empty"in i&&i.update_empty(),"update_empty"in o&&o.update_empty()}else e(n).children().closest_descendents("[data-azb]").each(function(){var n=e(this).attr("data-azb"),o=ht
n in pt.prototype.tags&&(o=pt.prototype.tags[n])
var i=new o(a,!0)
...
l.length>0&&(i.dom_content_element=e(l),i.has_content?i instanceof ht?(i.attrs.content=e(l).wrap("<div></div>").parent().html(),e(l).unwrap()):i.attrs.content=e(l).html():i.parse_html(l))}})},recursive_render:function(){for(var o=0;o<this.children.length;o++)this.children[o].recursive_render()
...
pt.prototype.parse_shortcode.call(this,n)
...
n.js[e]=!0,window.azexo_add_external_js(e,t)},get_my_container:function(){return this instanceof Nt?this:this.parent.get_my_container()},get_all_disallowed_elements:function(){if("parent"in this){var e=_.uniq(this.parent.get_all_disallowed_elements().concat(this.disallowed_elements))
return e}return this.disallowed_elements}},mt("az_unknown",!0,ht),Y(ht.prototype,{has_content:!0,hidden:!0,show_controls:function(){},update_empty:function(){},render:function(e){if(this.dom_element=e('<div class = "az-element"></div>'),this.dom_content_element=this.dom_element,"content"in this.attrs){var t=/\[[^\]]*\]([^\[]*)\[\/[^\]]*\]/.exec(this.attrs.content)
t&&e(this.dom_element).append(t[1])}ht.baseclass.prototype.render.apply(this,arguments)}}),!("azexo_baseurl"in window))if(e('script[src*="azexo_composer.js"]').length>0){var pn=e('script[src*="azexo_composer.js"]').attr("src")
window.azexo_baseurl=pn.slice(0,pn.indexOf("azexo_composer.js"))}else if(e('script[src*="azexo_composer.min.js"]').length>0){var pn=e('script[src*="azexo_composer.min.js"]').attr("src")
window.azexo_baseurl=pn.slice(0,pn.indexOf("azexo_composer.min.js"))}"azexo_online"in window||(window.azexo_online="http:"==window.location.protocol||"https:"==window.location.protocol),s=new ct,"azexo_editor"in window||(window.azexo_editor=!1),ut(),ft(function(){yt(),"azexo_exporter"in window&&$t(),e.holdReady(!1)})
var mn=!1
...
s.show_js_animations_editor(r,!1,function(){o()}),e("#az-editor-modal").find(".save").off("mousedown.an_js_in").on("mousedown.an_js_in",function(){s.save_js_animations(!1)})}}}),st({type:"dropdown",heading:p("Animation out"),param_name:"an_out",tab:p("Animation"),value:hn,dependency:{element:"an_start",value:["hover","trigger"]}}),st({type:"dropdown",heading:p("JS animation out"),param_name:"an_js_out",tab:p("Animation"),value:{},dependency:{element:"an_out",value:["js"],callback:function(t){function a(){s.save_js_animations(!1),e(s.animations_editor).remove(),delete s.animations_editor}function o(){s.update_js_animations_list()
var t=i.dom_element,n=i.get_value()
i.render(n),e(t).replaceWith(i.dom_element)}var i=this,s=this.element
...
"js"!=e&&a()})
var r=e('<div id="az-js-animation-form" class="'+n+"clearfix "+n+"form-group "+n+'well"></div>').insertAfter(this.dom_element)
s.show_js_animations_editor(r,!1,function(){o()}),e("#az-editor-modal").find(".save").off("mousedown.an_js_out").on("mousedown.an_js_out",function(){s.save_js_animations(!1)})}}}),st({type:"checkbox",heading:p("Hidden"),param_name:"an_hidden",tab:p("Animation"),value:{before_in:p("Before in-animation"),after_in:p("After in-animation")},dependency:{element:"an_start",value:["appear","hover","click","trigger"]}}),st({type:"checkbox",heading:p("Infinite?"),param_name:"an_infinite",tab:p("Animation"),value:{yes:p("Yes, please")},dependency:{element:"an_start",value:["appear","hover","click","trigger"]}}),st({type:"dropdown",heading:p("By letters?"),param_name:"an_letters",tab:p("Animation"),value:{"":p("No"),sequence:p("Sequence"),reverse:p("Reverse"),sync:p("Sync"),shuffle:p("Shuffle")},dependency:{element:"an_start",value:["appear","hover","click","trigger"]}}),st({type:"integer_slider",heading:p("Duration"),param_name:"an_duration",tab:p("Animation"),max:"3000",description:p("In milliseconds."),value:"1000",dependency:{element:"an_start",value:["appear","hover","click","trigger"]}}),st({type:"integer_slider",heading:p("In-delay"),param_name:"an_in_delay",tab:p("Animation"),max:"10000",description:p("In milliseconds."),value:"0",dependency:{element:"an_start",value:["appear","hover","click","trigger"]}}),st({type:"integer_slider",heading:p("Out-delay"),param_name:"an_out_delay",tab:p("Animation"),max:"10000",description:p("In milliseconds."),value:"0",dependency:{element:"an_start",value:["hover","trigger"]}}),st({type:"integer_slider",heading:p("Parent number"),param_name:"an_parent",tab:p("Animation"),max:"10",min:"0",description:p("Define the number of Parent Containers the animation should attempt to break away from."),value:"1",dependency:{element:"an_start",value:["hover","click"]}}),st({type:"dropdown",heading:p("Animation fill mode"),param_name:"an_fill_mode",tab:p("Animation"),value:{"":p("Default"),forwards:p("Forwards"),backwards:p("Backwards"),both:p("Both"),none:p("None")},description:p('"FORWARDS" - after the animation ends (determined by animation-iteration-count), the animation will apply the property values for the time the animation ended; "BACKWARDS" - The animation will apply the property values defined in the keyframe that will start the first iteration of the animation, during the period defined by animation-delay. These are either the values of the from keyframe (when animation-direction is "normal" or "alternate") or those of the to keyframe (when animation-direction is "reverse" or "alternate-reverse"); "BOTH" - the animation will follow the rules for both forwards and backwards. That is, it will extend the animation properties in both directions; "NONE" - The animation will not apply any styles to the target before or after it is executing.'),dependency:{element:"an_start",value:["appear","hover","click","trigger"]}}),st({type:"textfield",heading:p("Name for animations"),param_name:"an_name",hidden:!0}),st({type:"textfield",heading:p("Animation scenes"),param_name:"an_scenes",hidden:!0})].concat(bt.prototype.params),set_in_timeout:function(){var t=this
...
""!=t&&(i=t,_.isObject(a[o])||(a[o]={}),a[o][t]=n)}var p="property"+s,m="property"+s+"value",h=e('<div class="row"><div class="select '+n+'col-xs-5">'+nt(r,p,i)+'</div><div class="value '+n+'col-xs-5"><input class="'+n+'form-control" name="'+m+'" type="text" value="'+l+'"></div><div class="remove '+n+'col-xs-2"><button title="'+c("Remove")+'" type="button" class="control remove '+n+"btn "+n+"btn-danger "+n+"glyphicon "+n+'glyphicon-remove"> </button></div></div>').appendTo(t)
...
window.azexo_editor&&(bt.baseclass.prototype.show_controls.apply(this,arguments),e('<button title="'+c("Scroll animations")+'" class="control scroll-animation '+n+"btn "+n+"btn-warning "+n+"glyphicon "+n+'glyphicon-sort"> </button>').appendTo(this.controls).click(function(){e("#az-js-animation-modal").remove()
...
o.setTween(i)}}})},showed:function(e){bt.baseclass.prototype.showed.apply(this,arguments),this.an_name="","an_name"in this.attrs&&""!=this.attrs.an_name&&(this.an_name=this.attrs.an_name,s.elements_instances_by_an_name[this.an_name]=this),this.an_scenes=[],"an_scenes"in this.attrs&&""!=this.attrs.an_scenes&&(this.an_scenes=e.parseJSON(decodeURIComponent(atob(this.attrs.an_scenes))),this.update_scroll_animation()),"an_start"in this.attrs&&""!=this.attrs.an_start&&"no"!=this.attrs.an_start&&this.animation()},render:function(e){"an_name"in this.attrs&&""!=this.attrs.an_name&&e(this.dom_element).attr("data-an-name",this.attrs.an_name),bt.baseclass.prototype.render.apply(this,arguments)}}),wt("az_section",!0,xt),Y(xt.prototype,{name:p("Section"),icon:"fa fa-square-o",description:p("Bootstrap grid container"),category:p("Layout"),params:[st({type:"checkbox",heading:p("Fluid?"),param_name:"fluid",value:{yes:p("Yes, please")}}),st({type:"dropdown",heading:p("Background Effect"),param_name:"effect",tab:p("Background Effects"),value:{"":p("Simple Image"),fixed:p("Fixed Image"),parallax:p("Parallax Image"),youtube:p("YouTube Video")},description:p("Select the effect you want to apply to the section background.")}),st({type:"integer_slider",heading:p("Parallax speed"),param_name:"parallax_speed",tab:p("Background Effects"),value:20,dependency:{element:"effect",value:["parallax"]}}),st({type:"checkbox",heading:p("Video Play Options"),param_name:"video_options",tab:p("Background Effects"),description:p("Select options for the video."),value:{loop:p("Loop"),mute:p("Muted")},dependency:{element:"effect",value:["youtube"]}}),st({type:"textfield",heading:p("YouTube Video URL"),param_name:"video_youtube",tab:p("Background Effects"),description:p("Enter the YouTube video URL."),dependency:{element:"effect",value:["youtube"]}}),st({type:"textfield",heading:p("Start Time in seconds"),param_name:"video_start",tab:p("Background Effects"),description:p("Enter time in seconds from where video start to play."),value:"0",dependency:{element:"effect",value:["youtube"]}}),st({type:"textfield",heading:p("Stop Time in seconds"),param_name:"video_stop",tab:p("Background Effects"),description:p("Enter time in seconds where video ends."),value:"0",dependency:{element:"effect",value:["youtube"]}})].concat(xt.prototype.params),is_container:!0,section:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},showed:function(e){xt.baseclass.prototype.showed.apply(this,arguments)
var t=this
...
this.add_css("jquery.mb.YTPlayer/css/YTPlayer.css","mb_YTPlayer"in e.fn,function(){}),this.add_js_list({paths:["jquery.mb.YTPlayer/inc/jquery.mb.YTPlayer.js","jquery-waypoints/waypoints.min.js"],loaded:"waypoint"in e.fn&&"mb_YTPlayer"in e.fn,callback:function(){e(t.dom_element).waypoint(function(){e(t.dom_element).attr("data-property","{videoURL:'"+et(t.attrs.video_youtube)+"',containment:'#"+t.id+"', showControls:false, autoPlay:true, loop:"+n+", mute:"+a+", startAt:"+t.attrs.video_start+", stopAt:"+t.attrs.video_stop+", opacity:1, addRaster:false, quality:'default'}"),e(t.dom_element).mb_YTPlayer(),e(t.dom_element).playYTP()},{offset:"100%",triggerOnce:!0}),e(document).trigger("scroll")}})}},render:function(e,t){this.dom_element=e('<div id="'+this.id+'" class="az-element az-section '+this.attrs.el_class+' " style="'+this.attrs.style+'"></div>'),this.dom_content_element="yes"==this.attrs.fluid?e('<div class="az-ctnr '+t+'container-fluid"></div>').appendTo(this.dom_element):e('<div class="az-ctnr '+t+'container"></div>').appendTo(this.dom_element),xt.baseclass.prototype.render.apply(this,arguments)}}),wt("az_row",!0,zt),Y(zt.prototype,{name:p("Row"),icon:"fa fa-table",description:p("One row to implement a Bootstrap grid layout with responsive ability. You can choose number of columns and thier widths. Used by default."),category:p("Layout"),params:[st({type:"dropdown",heading:p("Device"),param_name:"device",value:{xs:p("Extra small devices Phones (<768px)"),sm:p("Small devices Tablets (≥768px)"),md:p("Medium devices Desktops (≥992px)"),lg:p("Large devices Desktops (≥1200px)")},description:p("Bootstrap responsive grid system")})].concat(zt.prototype.params),is_container:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},show_controls:function(){if(window.azexo_editor){zt.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".add").remove(),e(this.controls).find(".paste").remove()
...
if(0==this.children.length)for(var n=0;n<t.length;n++){var a=new kt(this,!0)
...
else{var a=new kt(this,!0)
a.update_dom(),a.update_width(t[n])}this.update_sortable()},render:function(e,t){this.dom_element=e('<div class="az-element az-row '+t+"row "+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=this.dom_element,zt.baseclass.prototype.render.apply(this,arguments)}}),mt("az_column",!0,kt),Y(kt.prototype,{name:p("Column"),params:[st({type:"textfield",heading:p("Column with"),param_name:"width",hidden:!0})].concat(kt.prototype.params),hidden:!0,is_container:!0,show_parent_controls:!0,get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p("Settings for this row and current column. You can choose columns layout by mouse over (or click) this button: ")+'<span class="'+n+"glyphicon "+n+'glyphicon-th"></span></div></div>'},show_controls:function(){window.azexo_editor&&(kt.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".clone").remove(),e(this.controls).find(".copy").remove(),e(this.controls).find(".remove").remove())},get_my_shortcode:function(){return this.get_children_shortcode()},update_width:function(t){e(this.dom_element).removeClass(J(this.attrs.width,this.parent.attrs.device)),this.attrs.width=t,e(this.dom_element).addClass(J(this.attrs.width,this.parent.attrs.device)),e(document).trigger("azexo_update_element",this.id)},render:function(e){this.dom_element=e('<div class="az-element az-ctnr az-column '+this.attrs.el_class+" "+J(this.attrs.width,this.parent.attrs.device)+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=this.dom_element,kt.baseclass.prototype.render.apply(this,arguments)}}),wt("az_grid",!0,jt),Y(jt.prototype,{name:p("Grid"),icon:"fa fa-th-large",description:p("Grid with filter by tags. Every item of grid can contain any number of any types of elements."),category:p("Layout"),params:[st({type:"integer_slider",heading:p("Columns number"),param_name:"columns_number",min:"1",max:"20",value:"3"}),st({type:"checkbox",heading:p("Masonry grid?"),param_name:"masonry",value:{yes:p("Yes, please")}})].concat(jt.prototype.params),is_container:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},update_sortable:function(){function t(e,t){t.placeholder.attr("class",t.helper.attr("class")),t.placeholder.css("width",t.helper.css("width")),t.placeholder.css("height",t.helper.css("height")),t.placeholder.removeClass("ui-sortable-helper"),t.placeholder.addClass("az-sortable-placeholder")}if(window.azexo_editor){var n=this
e(this.dom_element).find("> ul").sortable({items:"> .az-item",connectWith:".az-grid > ul",handle:"> .controls > .drag-and-drop",update:n.update_sorting,placeholder:"az-sortable-placeholder",forcePlaceholderSize:!0,start:t,over:t})}},update_sorting:function(){jt.baseclass.prototype.update_sorting.apply(this,arguments)
var t=s.get_element(e(this).closest("[data-az-id]").attr("data-az-id"))
if(t)for(var n=0;n<t.children.length;n++)t.children[n].update_empty()},show_controls:function(){window.azexo_editor&&(jt.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".add").remove(),e(this.controls).find(".paste").remove(),e(this.controls).find(".clone").remove(),azexo_add_js({path:"js/json2.min.js",loaded:"JSON"in window,callback:function(){}}))},click_add_item:function(e){return e.data.object.add_item(),!1},add_item:function(){var e=new Tt(this,!0)
...
if(e.length==a.children.length)for(var n=pt.prototype.tags[this.base],o=this.get_child_position(),t=0;t<e.length;t++)if(e[t].id!=this.parent.id){var i=e[t],s=new n(i,!0)
...
for(var o=0;o<t.children.length;o++)a.add_control(t.children[o])},showed:function(e,t){jt.baseclass.prototype.showed.apply(this,arguments)
var n=this
...
o.update_dom(),e(document).trigger("azexo_update_sorting",a)}},click_add_tab:function(e){return e.data.object.add_tab(),!1},add_tab:function(){var t=new Ot(this,!1)
...
this.dom_content_element=e(o).appendTo(this.dom_element),Ct.baseclass.prototype.render.apply(this,arguments)}}),mt("az_tab",!0,Ot),Y(Ot.prototype,{name:p("Tab"),params:[st({type:"textfield",heading:p("Tab title"),param_name:"title",value:p("Title")})].concat(Ot.prototype.params),hidden:!0,is_container:!0,show_parent_controls:!0,get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p("Settings for this tabs element and for current tab element. ")+'<span class="'+n+"glyphicon "+n+'glyphicon-plus-sign"></span>'+p(" - add a new tab.")+" "+p("Tabs headers are draggable. You can enter tab title by click on this button: ")+'<span class="'+n+"glyphicon "+n+'glyphicon-pencil"></span></div></div>'},show_controls:function(){window.azexo_editor&&(Ot.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".drag-and-drop").remove(),e('<span class="control '+n+"btn "+n+"btn-primary "+n+'glyphicon">'+this.name+"</span>").prependTo(this.controls))},get_my_shortcode:function(){return this.get_children_shortcode()},edited:function(){Ot.baseclass.prototype.edited.apply(this,arguments),this.parent.update_dom(),e('a[href="#'+this.id+'"]')[a+"tab"]("show")},clone:function(){var t=Ot.baseclass.prototype.get_my_shortcode.apply(this,arguments)
e("#azexo-clipboard").html(btoa(encodeURIComponent(t))),this.parent.paste(this.parent.children.length),this.parent.update_dom()},remove:function(){Ot.baseclass.prototype.remove.apply(this,arguments),this.parent.update_dom()},render:function(e,t){this.dom_element=e('<div id="'+this.id+'" class="az-element az-ctnr az-tab '+t+"tab-pane "+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=this.dom_element,Ot.baseclass.prototype.render.apply(this,arguments)}}),wt("az_accordion",!0,It),Y(It.prototype,{name:p("Accordion"),icon:"fa fa-bars",description:p("Bootstrap content accordion. Every toggle of this element can contain any number of any types of elements."),category:p("Layout"),params:[st({type:"dropdown",heading:p("Type"),param_name:"type",value:{"panel-default":p("Default"),"panel-primary":p("Primary"),"panel-success":p("Success"),"panel-info":p("Info"),"panel-warning":p("Warning"),"panel-danger":p("Danger")}}),st({type:"checkbox",heading:p("Collapsed?"),param_name:"collapsed",value:{yes:p("Yes, please")}})].concat(It.prototype.params),is_container:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},show_controls:function(){window.azexo_editor&&(It.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".add").remove(),e(this.controls).find(".paste").remove(),e('<button title="'+c("Add toggle")+'" class="control add-toggle '+n+"btn "+n+"btn-primary "+n+"glyphicon "+n+'glyphicon-plus-sign" > </button>').appendTo(this.controls).click({object:this},this.click_add_toggle))},update_sortable:function(){window.azexo_editor&&e(this.dom_element).sortable({axis:"y",items:"> .az-toggle",handle:"> .controls > .drag-and-drop",update:this.update_sorting,placeholder:"az-sortable-placeholder",forcePlaceholderSize:!0,over:function(e,t){t.placeholder.attr("class",t.helper.attr("class")),t.placeholder.removeClass("ui-sortable-helper"),t.placeholder.addClass("az-sortable-placeholder")}})},click_add_toggle:function(e){return e.data.object.add_toggle(),!1},add_toggle:function(){var e=new Pt(this,!1)
e.update_dom(),this.update_dom()},update_dom:function(){for(var e=0;e<this.children.length;e++)this.children[e].update_dom()
It.baseclass.prototype.update_dom.apply(this,arguments)},showed:function(e,t,n){It.baseclass.prototype.showed.apply(this,arguments),e(this.dom_element).find("> .az-toggle > ."+t+"in").removeClass(t+"in"),e(this.dom_element).find("> .az-toggle > ."+t+"collapse:not(:first)")[n+"collapse"]({toggle:!1,parent:"#"+this.id}),e(this.dom_element).find("> .az-toggle > ."+t+"collapse:first")[n+"collapse"]({toggle:"yes"!=this.attrs.collapsed,parent:"#"+this.id})},render:function(e,t){this.dom_element=e('<div id="'+this.id+'" class="az-element az-accordion '+t+"panel-group "+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),this.dom_content_element=this.dom_element,It.baseclass.prototype.render.apply(this,arguments)}}),mt("az_toggle",!0,Pt),Y(Pt.prototype,{name:p("Toggle"),params:[st({type:"textfield",heading:p("Toggle title"),param_name:"title",value:p("Title")})].concat(Pt.prototype.params),hidden:!0,is_container:!0,show_parent_controls:!0,get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p("Settings for this accordion element and for current toggle. ")+'<span class="'+n+"glyphicon "+n+'glyphicon-plus-sign"></span>'+p(" - add a new toggle. You can enter toggle title by click on this button: ")+'<span class="'+n+"glyphicon "+n+'glyphicon-pencil"></span></div></div>'},get_my_shortcode:function(){return this.get_children_shortcode()},clone:function(){var t=Pt.baseclass.prototype.get_my_shortcode.apply(this,arguments)
...
""!=this.parent.attrs.type&&(n=this.parent.attrs.type),this.dom_element=e('<div class="az-element az-toggle '+t+"panel "+n+" "+this.attrs.el_class+'" style="'+this.attrs.style+'"><div class="'+t+'panel-heading"><h4 class="'+t+'panel-title"><a data-toggle="'+t+'collapse" data-parent="#'+this.parent.id+'" href="#'+this.id+'">'+this.attrs.title+'</a></h4></div><div id="'+this.id+'" class="'+t+"panel-collapse "+t+'collapse"><div class="'+t+'panel-body az-ctnr"></div></div></div>'),this.dom_content_element=e(this.dom_element).find("."+t+"panel-body"),Pt.baseclass.prototype.render.apply(this,arguments)}}),wt("az_carousel",!0,Rt),Y(Rt.prototype,{name:p("Carousel"),icon:"fa fa-ellipsis-h",description:p("Content carousel. Every slide of this element can contain any number of any types of elements. It can be used for create classic content slider."),category:p("Layout"),params:[st({type:"integer_slider",heading:p("Number items"),param_name:"items",min:"1",max:"10",value:"1"}),st({type:"checkbox",heading:p("Options"),param_name:"options",value:{navigation:p("Navigation"),auto_play:p("Auto play"),mouse:p("Mouse drag"),touch:p("Touch drag")}}),st({type:"dropdown",heading:p("Transition style"),param_name:"transition",value:{"":p("Default"),fade:p("fade"),backSlide:p("backSlide"),goDown:p("goDown"),fadeUp:p("fadeUp")}})].concat(Rt.prototype.params),is_container:!0,show_settings_on_create:!0,frontend_render:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},show_controls:function(){if(window.azexo_editor){Rt.baseclass.prototype.show_controls.apply(this,arguments),e(this.controls).find(".add").remove(),e(this.controls).find(".paste").remove()
...
e.update_dom(),this.update_dom()},showed:function(e){Rt.baseclass.prototype.showed.apply(this,arguments),this.add_css("owl.carousel/owl-carousel/owl.carousel.css","owlCarousel"in e.fn,function(){}),this.add_css("owl.carousel/owl-carousel/owl.theme.css","owlCarousel"in e.fn,function(){}),this.add_css("owl.carousel/owl-carousel/owl.transitions.css","owlCarousel"in e.fn,function(){})
var t=this
...
d.config.visualScaling=d.config.visualScaling/i,e(d.dom_content_element).css("transform",o+" scale("+i+")")})}},update_sortable:function(){if(window.azexo_editor);},click_add_step:function(e){return e.data.object.add_step(),!1},add_step:function(){var e=new Ut(this,!0)
...
else Dt.baseclass.prototype.attach_children.apply(this,arguments)},edited:function(){Dt.baseclass.prototype.edited.apply(this,arguments),this.update_dom()},showed:function(e,t){Dt.baseclass.prototype.showed.apply(this,arguments)
var n=this
...
""!=this.children[a-1].attrs.name&&(o=this.children[a-1].attrs.name),e('<li><a href="#" class="goto" data-step="'+this.children[a-1].id+'">'+o+"</a></li>").appendTo(n)}e('<li><a href="#" class="'+t+'next">&raquo;</a></li>').appendTo(n)}Dt.baseclass.prototype.render.apply(this,arguments)}}),mt("az_step",!0,Ut),Y(Ut.prototype,{name:p("Step"),params:[st({type:"textfield",heading:p("Name"),param_name:"name"}),st({type:"checkbox",heading:p("Options"),param_name:"options",value:{dummy:p("Dummy")}}),st({type:"integer_slider",heading:p("Width"),param_name:"width",min:"1",max:"100000",value:"900"}),st({type:"integer_slider",heading:p("Height"),param_name:"height",min:"1",max:"100000",value:"700"}),st({type:"integer_slider",heading:p("X coordinate"),param_name:"x",min:"-100000",max:"100000",value:"0"}),st({type:"integer_slider",heading:p("Y coordinate"),param_name:"y",min:"-100000",max:"100000",value:"0"}),st({type:"integer_slider",heading:p("Z coordinate"),param_name:"z",min:"-10000",max:"10000",value:"0"}),st({type:"integer_slider",heading:p("X rotate"),param_name:"rotate_x",min:"-180",max:"180",value:"0"}),st({type:"integer_slider",heading:p("Y rotate"),param_name:"rotate_y",min:"-180",max:"180",value:"0"}),st({type:"integer_slider",heading:p("Z rotate"),param_name:"rotate_z",min:"-180",max:"180",value:"0"}),st({type:"integer_slider",heading:p("Scale"),param_name:"scale",min:"0",max:"1000",value:"1",step:"0.01"})].concat(Ut.prototype.params),hidden:!0,is_container:!0,show_parent_controls:!0,disallowed_elements:["az_presentation"],highlighted:!1,get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p('Settings for this presentation element and for current step. Press on "Space" button to going through steps. ')+'<span class="'+n+"glyphicon "+n+'glyphicon-plus-sign"></span>'+p(" - add a new step.")+"</div></div>"},get_my_shortcode:function(){return this.get_children_shortcode()},show_controls:function(){Ut.baseclass.prototype.show_controls.apply(this,arguments),window.azexo_editor&&(e(this.controls).find(".drag-and-drop").remove(),e('<span class="control '+n+"btn "+n+"btn-primary "+n+'glyphicon">'+this.name+"</span>").prependTo(this.controls))},update_sortable:function(){if(window.azexo_editor){var t=this
e(this.dom_element).resizable({stop:function(){t.attrs.width=e(t.dom_element).width(),t.attrs.height=e(t.dom_element).height(),e(document).trigger("azexo_update_element",t.id),"impress"in t.parent&&t.impress.initStep(t.dom_element.get(0))}})}},clone:function(){var t=Ut.baseclass.prototype.get_my_shortcode.apply(this,arguments)
e("#azexo-clipboard").html(btoa(encodeURIComponent(t)))
for(var n=0;n<this.parent.children.length;n++)if(this.parent.children[n].id==this.id){this.parent.paste(n)
break}this.parent.update_dom()},edited:function(){Ut.baseclass.prototype.edited.apply(this,arguments)
var e=this
"impress"in e.parent&&e.parent.impress.initStep(e.dom_element.get(0))},remove:function(){Ut.baseclass.prototype.remove.apply(this,arguments),this.parent.update_dom()},render:function(e){this.dom_element=e('<div id="'+this.id+'" class="az-element az-step az-ctnr step '+this.attrs.el_class+'" style="'+this.attrs.style+'"></div>'),e(this.dom_element).css("width",this.attrs.width),e(this.dom_element).css("height",this.attrs.height),e(this.dom_element).attr("data-x",this.attrs.x),e(this.dom_element).attr("data-y",this.attrs.y),e(this.dom_element).attr("data-z",this.attrs.z),e(this.dom_element).attr("data-rotate-x",this.attrs.rotate_x),e(this.dom_element).attr("data-rotate-y",this.attrs.rotate_y),e(this.dom_element).attr("data-rotate",this.attrs.rotate_z),e(this.dom_element).attr("data-scale",this.attrs.scale),this.dom_content_element=this.dom_element,Ut.baseclass.prototype.render.apply(this,arguments)}}),wt("az_container",!0,Nt),Y(Nt.prototype,{name:p("Container"),icon:"fa fa-archive",description:p("AJAX loaded content from server. Content can be edited and saved to server."),category:p("Layout"),params:[st({type:"container",heading:p("Container"),param_name:"container",description:p("Type and name used as identificator to save container on server."),value:"/"})].concat(Nt.prototype.params),show_settings_on_create:!0,is_container:!0,hidden:!window.azexo_online,saveable:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><div>'+this.name+'</div><div class="'+n+"text-muted "+n+'small">'+this.description+"</div></div>"},get_empty:function(){return'<div class="az-empty"><div class="top '+n+'well"><strong>'+p("Click to put an element here.")+'</strong></div><div class="top-right '+n+'well"><h1>↗</h1><span class="'+n+"glyphicon "+n+'glyphicon-eye-open"></span>'+p(" - toggle editor helpers.")+' <span class="'+n+"glyphicon "+n+'glyphicon-play-circle"></span>'+p(" - toggle animation engine to not hinder editing.")+' <span class="'+n+"glyphicon "+n+'glyphicon-save"></span>'+p(" - save results of editing on server.")+"</div></div>"},show_controls:function(){if(window.azexo_editor){var t=this
Nt.baseclass.prototype.show_controls.apply(this,arguments),null==this.parent&&(e('<button title="'+c("Toggle editor")+'" class="control toggle-editor '+n+"btn "+n+"btn-default "+n+"glyphicon "+n+'glyphicon-eye-open" > </button>').appendTo(this.controls).click(function(){return e(t.dom_element).toggleClass("azexo-editor"),!1}),e('<button title="'+c("Toggle animations")+'" class="control toggle-animations '+n+"btn "+n+"btn-default "+n+"glyphicon "+n+'glyphicon-play-circle" > </button>').appendTo(this.controls).click(function(){return e(t.dom_element).toggleClass("azexo-animations-disabled"),!1}),e(this.controls).removeClass(n+"btn-group-xs"),e(this.controls).find(".edit").remove(),e(this.controls).find(".copy").remove(),e(this.controls).find(".clone").remove(),e(this.controls).find(".remove").remove(),e(this.controls).find(".js-animation").remove(),e(this.controls).find(".drag-and-drop").attr("title",""),e(this.controls).find(".drag-and-drop").removeClass(n+"glyphicon"),e(this.controls).find(".drag-and-drop").removeClass(n+"glyphicon-move"),e(this.controls).find(".drag-and-drop").removeClass("drag-and-drop")),this.saveable&&e('<button title="'+c("Save container")+'" class="control save-container '+n+"btn "+n+"btn-success "+n+"glyphicon "+n+'glyphicon-save" > </button>').appendTo(this.controls).click({object:this},this.click_save_container)}},get_my_shortcode:function(){return this.get_children_shortcode()},get_hover_styles:function(e){var t=""
...
return n}function h(){var t="(function("+Wt+") {\n"
if(t+="if('azexo_backend' in window) return;\n",t+="var "+Vt+" = true;\n",t+="var "+Gt+" = '"+n+"';var "+Qt+" = '"+a+"';\n",t+=""+p+"\n",t+=""+m+"\n",t+=""+y+"\n",t+=""+B+"\n",t+=""+Y+"\n",t+=""+q+"\n",t+=""+$+"\n",t+=Wt+".fn.closest_descendents = "+e.fn.closest_descendents+" \n",t+=""+ot+"\n",t+=ot.name+".prototype.safe = true;\n",t+=ot.name+".prototype.param_types = {};\n",t+=""+st+"\n",t+="window.azexo_add_css="+window.azexo_add_css+"\n",t+="window.azexo_add_js="+window.azexo_add_js+"\n",t+="window.azexo_add_js_list="+window.azexo_add_js_list+"\n",t+="var "+Zt+" = {};\n",t+="var "+Kt+" = {};\n",t+="window.azexo_add_external_js="+window.azexo_add_external_js+"\n",t+=""+ct+"\n",t+=ct.name+".prototype.elements_instances = {};\n",t+=ct.name+".prototype.elements_instances_by_an_name = {};\n",t+=s(ct,"get_element",!0),t+=s(ct,"delete_element",!0),t+=s(ct,"add_element",!0),t+=""+pt+"\n",t+=pt.name+".prototype.p = '"+n+"';\n",t+=pt.name+".prototype.fp = '"+a+"';\n",t+=pt.name+".prototype.elements = {};\n",t+=pt.name+".prototype.tags = {};\n",t+=r(pt),t+=s(pt,"get_hover_style",!0),t+=s(pt,"showed",!0),t+=s(pt,"render",!0),t+=s(pt,"recursive_render",!0),t+=s(pt,"replace_render",!0),t+=s(pt,"update_dom",!0),t+=s(pt,"attach_children",!0),t+=s(pt,"detach_children",!0),t+=s(pt,"recursive_showed",!0),t+=s(pt,"parse_attrs",!0),t+=s(pt,"parse_html",!0),t+=s(pt,"add_css",!0),t+=s(pt,"add_js_list",!0),t+=s(pt,"add_js",!0),t+=s(pt,"add_external_js",!0),t+=s(pt,"get_my_container",!0),"an_start"in g&&(t+=s(pt,"trigger_start_in_animation",!0),t+=s(pt,"trigger_start_out_animation",!0)),t+=""+mt+"\n",t+=""+ht+"\n",t+=mt.name+"('az_unknown', true, "+ht.name+");\n",t+=ht.name+".prototype.has_content = true;\n",t+="window.azexo_baseurl = '"+window.azexo_baseurl+"';\n","ajaxurl"in window&&(t+="window.ajaxurl = '"+tt(window.ajaxurl)+"';\n"),"azexo_lang"in window&&(t+="window.azexo_lang = '"+window.azexo_lang+"';\n"),t+="window.azexo_online = (window.location.protocol == 'http:' || window.location.protocol == 'https:');\n",t+="var "+en+" = new "+ct.name+"();\n",t+="var "+tn+" = null;\n",t+="window.azexo_editor = false;\n","azexo_exporter"in window&&(t+="window.azexo_exported = "+window.azexo_exporter+";\n"),t+="var "+nn+" = [];\n",t+="var "+an+" = {};\n",t+=""+vt+"\n",t+=""+bt+"\n",t+=B.name+"("+bt.name+", "+pt.name+");\n",t+=r(bt),"an_start"in g&&(t+=s(bt,"set_in_timeout",!0),t+=s(bt,"start_in_animation",!0),t+=s(bt,"set_out_timeout",!0),t+=s(bt,"start_out_animation",!0),t+=s(bt,"clear_animation",!0),t+=s(bt,"end_animation",!0),t+=s(bt,"trigger_start_in_animation",!0),t+=s(bt,"trigger_start_out_animation",!0),t+=s(bt,"animation",!0)),("an_scenes"in g||"an_js"in g)&&(t+=s(bt,"make_timeline",!0)),"an_scenes"in g&&(t+=s(bt,"update_scroll_animation",!0)),"an_letters"in g&&(t+=s(bt,"animation_letters",!0)),("an_start"in g||"an_scenes"in g)&&(t+=s(bt,"showed",!0)),t+=s(bt,"render",!0),t+=""+wt+"\n",t+=""+Mt+"\n",t+=B.name+"("+Mt.name+", "+bt.name+");\n",t+=Mt.name+".prototype.form_elements = {};\n",t+=""+Bt+"\n",xt.prototype.base in v&&(t+=""+xt+"\n",t+=wt.name+"('"+xt.prototype.base+"', true, "+xt.name+");\n",t+=r(xt),t+=s(xt,"showed",!0)),zt.prototype.base in v&&(t+=""+zt+"\n",t+=wt.name+"('"+zt.prototype.base+"', true, "+zt.name+");\n",t+=r(zt),t+=zt.name+".prototype.set_columns = function(columns){};\n",t+=""+kt+"\n",t+=mt.name+"('"+kt.prototype.base+"', true, "+kt.name+");\n",t+=r(kt),t+=s(kt,"showed",!0)),jt.prototype.base in v&&(t+=""+jt+"\n",t+=wt.name+"('"+jt.prototype.base+"', true, "+jt.name+");\n",t+=r(jt),t+=jt.name+".prototype.attach_events = function(){};\n",t+=s(jt,"showed",!0),t+=s(jt,"render",!0),t+=""+Tt+"\n",t+=mt.name+"('"+Tt.prototype.base+"', true, "+Tt.name+");\n",t+=r(Tt),t+=s(Tt,"showed",!0),t+=s(Tt,"render",!0)),St.prototype.base in v&&(t+=""+St+"\n",t+=wt.name+"('"+St.prototype.base+"', true, "+St.name+");\n",t+=r(St),t+=s(St,"showed",!0)),Ct.prototype.base in v&&(t+=""+Ct+"\n",t+=wt.name+"('"+Ct.prototype.base+"', true, "+Ct.name+");\n",t+=r(Ct),t+=s(Ct,"showed",!0),t+=s(Ct,"render",!0),t+=""+Ot+"\n",t+=mt.name+"('"+Ot.prototype.base+"', true, "+Ot.name+");\n",t+=r(Ot),t+=s(Ot,"render",!0)),It.prototype.base in v&&(t+=""+It+"\n",t+=wt.name+"('"+It.prototype.base+"', true, "+It.name+");\n",t+=r(It),t+=s(It,"showed",!0),t+=s(It,"render",!0),t+=""+Pt+"\n",t+=mt.name+"('"+Pt.prototype.base+"', true, "+Pt.name+");\n",t+=r(Pt),t+=s(Pt,"render",!0),t+=s(Pt,"showed",!0)),Rt.prototype.base in v&&(t+=""+Rt+"\n",t+=wt.name+"('"+Rt.prototype.base+"', true, "+Rt.name+");\n",t+=r(Rt),t+=Rt.name+".prototype.frontend_render = true;\n",t+=s(Rt,"showed",!0),t+=s(Rt,"render",!0),t+=""+At+"\n",t+=mt.name+"('"+At.prototype.base+"', true, "+At.name+");\n",t+=r(At),t+=At.name+".prototype.frontend_render = true;\n",t+=s(At,"showed",!0),t+=s(At,"render",!0)),Dt.prototype.base in v&&(t+=""+Dt+"\n",t+=wt.name+"('"+Dt.prototype.base+"', true, "+Dt.name+");\n",t+=r(Dt),t+=Dt.name+".prototype.frontend_render = true;\n",t+=s(Dt,"showed",!0),t+=s(Dt,"render",!0),t+=""+Ut+"\n",t+=mt.name+"('"+Ut.prototype.base+"', true, "+Ut.name+");\n",t+=r(Ut)),Nt.prototype.base in v&&(t+=""+Nt+"\n",t+=wt.name+"('"+Nt.prototype.base+"', true, "+Nt.name+");\n",t+=r(Nt),t+=s(Nt,"showed",!0),t+=s(Nt,"load_container",!0),t+=s(Nt,"update_dom",!0),t+=s(Nt,"render",!0),t+=s(Nt,"recursive_render",!0)),Lt.prototype.base in v&&(t+=""+Lt+"\n",t+=mt.name+"('"+Lt.prototype.base+"', false, "+Lt.name+");\n",t+=r(Lt),t+=s(Lt,"showed",!0)),Et.prototype.base in v&&(t+=""+at+"\n","azexo_form_submit_type"in window&&(t+="window.azexo_form_submit_type = '"+window.azexo_form_submit_type+"';\n"),"azexo_form_submit_name"in window&&(t+="window.azexo_form_submit_name = '"+window.azexo_form_submit_name+"';\n"),"recaptcha_publickey"in window&&(t+="window.recaptcha_publickey = '"+window.recaptcha_publickey+"';\n"),t+=""+O+"\n",t+=""+Et+"\n",t+=wt.name+"('"+Et.prototype.base+"', true, "+Et.name+");\n",t+=r(Et),t+=s(Et,"showed",!0),t+=""+C+"\n"),"azexo_elements"in window){t+="window.azexo_elements = [];\n"
...
for(var i=0;i<n.children.length;i++)n.children[i].recursive_showed()
e(document).trigger("scroll")}s.try_render_unknown_elements()})},clone:function(){Nt.baseclass.prototype.clone.apply(this,arguments),this.rendered=!0},recursive_render:function(){t?(this.render(e,n,a),this.children=[]):Nt.baseclass.prototype.recursive_render.apply(this,arguments),window.azexo_editor&&(this.show_controls(),this.update_sortable())},update_dom:function(){this.loaded_container!=this.attrs.container&&(this.children=[],e(this.dom_content_element).empty(),this.rendered=!1,null!=this.parent&&Nt.baseclass.prototype.update_dom.apply(this,arguments))},showed:function(e){Nt.baseclass.prototype.showed.apply(this,arguments)
var t=this
null==this.parent?t.rendered||(t.rendered=!0,t.load_container()):this.add_js({path:"jquery-waypoints/waypoints.min.js",loaded:"waypoint"in e.fn,callback:function(){e(t.dom_element).waypoint(function(){t.rendered||(t.rendered=!0,t.load_container())},{offset:"100%",triggerOnce:!0}),e(document).trigger("scroll")}})},render:function(e){this.dom_element=e('<div class="az-element az-container"><div class="az-ctnr"></div></div>'),this.dom_content_element=e(this.dom_element).find(".az-ctnr"),Nt.baseclass.prototype.render.apply(this,arguments)}}),xt.prototype.params.push(st({type:"textfield",heading:p("Menu item title"),param_name:"menu_item_title",description:p("Title which will be used in scroll menu."),tab:p("Menu")})),mt("az_scroll_menu",!1,Lt),Y(Lt.prototype,{name:p("Scroll Menu"),icon:"fa fa-sitemap",description:p("One page scroll menu"),params:[st({type:"image",heading:p("Logo"),param_name:"logo",description:p("Select image from media library.")}),st({type:"link",heading:p("Logo link"),param_name:"logo_link"})].concat(Lt.prototype.params),showed:function(e,t,n){this.navbar_height=e(this.dom_element).find("."+t+"navbar").height(),Lt.baseclass.prototype.showed.apply(this,arguments)
var a=this
...
i+="</ul>",e(o).append(i),e(this.dom_element).find("."+t+"container-fluid").append(n).append(o),Lt.baseclass.prototype.render.apply(this,arguments)}}),wt("az_form",!0,Et),Y(Et.prototype,{name:p("Form"),icon:"fa fa-envelope-o",description:p("Form container. Can contain form elements for user input and any number of any other elements types."),category:p("Layout"),params:[st({type:"textfield",heading:p("Name"),param_name:"name",description:p("Required."),required:!0}),st({type:"textfield",heading:p("Submit button title"),param_name:"submit_title",value:p("Submit")}),st({type:"textfield",heading:p("Submited message"),param_name:"submited_message",value:p("Submited")}),st({type:"textfield",heading:p("Action URL"),param_name:"action",description:p("URL of server script which will receive submitted form data.")})].concat(Et.prototype.params),is_container:!0,hidden:!window.azexo_online,show_settings_on_create:!0,get_button:function(){return'<div class="'+n+"well "+n+"text-center "+n+'text-overflow" data-az-element="'+this.base+'" style="width:100%;"><i class="'+n+"text-primary "+this.icon+'"></i><p>'+this.name+'</p><p class="'+n+"text-muted "+n+'small">'+this.description+"</p></div>"},get_empty:function(){return'<div class="az-empty"><div class="top-left '+n+'well"><h1>↖</h1>'+p("You can add form element by mouse over this button: ")+'<span class="'+n+"glyphicon "+n+'glyphicon-plus-sign"></span> '+p("You can see all submissions by click on this button: ")+'<span class="'+n+"glyphicon "+n+'glyphicon-list-alt"></span></div></div>'},show_controls:function(){if(window.azexo_editor){Et.baseclass.prototype.show_controls.apply(this,arguments)
var t=this
...
return"azexo_form_submit_name"in window&&(o=window.azexo_form_submit_name),O(a,o,t.attrs.name,e(t.dom_element).serialize(),function(e){e&&t.dom_element.prepend(at(t.attrs.submited_message))}),!1}))},render:function(e,t){this.dom_element=e('<form action="'+this.attrs.action+'" method="post" class="az-element az-form '+this.attrs.el_class+'" style="'+this.attrs.style+'" role="form" enctype="multipart/form-data"></form>'),this.dom_content_element=e('<div class="az-ctnr"></div>').appendTo(this.dom_element),e('<div class="'+t+'form-group"><div class="g-recaptcha"></div></div>').appendTo(this.dom_element),e('<div class="'+t+'form-group"><button class="'+t+"btn "+t+"btn-lg "+t+'btn-primary" type="submit">'+this.attrs.submit_title+"</button></div>").appendTo(this.dom_element),Et.baseclass.prototype.render.apply(this,arguments)}}),B(Mt,bt),Y(Mt.prototype,{form_elements:{},show_parent_controls:".az-form",params:[st({type:"textfield",heading:p("Name"),param_name:"name",description:p("Required."),required:!0}),st({type:"checkbox",heading:p("Field is required?"),param_name:"required",value:{yes:p("Yes, please")}}),st({type:"textfield",heading:p("Title"),param_name:"title"})].concat(Mt.prototype.params)}),Yt(),qt(),Ht(),Ft(),Jt()
var _n="",un="",fn="",vn="",gn={},yn={},bn={theme:[],host:"",username:"",password:"",port:"21",directory:"."}}(window.jQuery,!1,"","",{},{},{},null,[],{})