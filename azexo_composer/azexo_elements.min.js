...
this.dom_element=e('<div class="az-element az-date '+t+"form-group"+this.attrs.el_class+'" style="'+this.attrs.style+'"><label>'+this.attrs.title+'</label><div><input class="'+t+'form-control" name="'+this.attrs.name+'" type="text" '+a+"></div></div>"),this.baseclass.prototype.render.apply(this,arguments)}},{base:"az_textarea",name:t("Textarea"),icon:"fa fa-file-text-o",description:t("Form text area field"),params:[],hidden:!0,show_settings_on_create:!0,render:function(e,t){var a="yes"==this.attrs.required?"required":""
