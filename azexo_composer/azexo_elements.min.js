...
return _.indexOf(i.attrs.display.split(","),"days")>=0&&(a+=e.strftime('<span class="az-days">%-D</span> '+t("days")+" ")),_.indexOf(i.attrs.display.split(","),"hours")>=0&&(a+=e.strftime('<span class="az-hours">%-H</span> '+t("hours")+" ")),_.indexOf(i.attrs.display.split(","),"minutes")>=0&&(a+=e.strftime('<span class="az-minutes">%M</span> '+t("minutes")+" ")),_.indexOf(i.attrs.display.split(","),"seconds")>=0&&(a+=e.strftime('<span class="az-seconds">%S</span> '+t("seconds")+" ")),a}this.baseclass.prototype.showed.apply(this,arguments)
var i=this
...
var r=[{base:"az_dropdown",name:t("Dropdown"),icon:"fa fa-level-down",description:t("Form dropdown field"),params:[{type:"html",heading:t("Options"),param_name:"options",description:t("Separated by new line.")}],hidden:!0,show_settings_on_create:!0,render:function(e,a){var i="yes"==this.attrs.required?"required":"",n='<select name="'+btoa(encodeURIComponent(this.attrs.name))+'" class="'+a+'form-control" '+i+">"
n+='<option value="">'+t("Please select")+"</option>"
for(var s=this.attrs.options.split("\n"),r=0;r<s.length;r++)n+='<option value="'+s[r]+'">'+s[r]+"</option>"
n+="/<select>",this.dom_element=e('<div class="az-element az-dropdown '+a+"form-group"+this.attrs.el_class+'" style="'+this.attrs.style+'" ><label>'+this.attrs.name+"</label><div>"+n+"</div></div>"),this.baseclass.prototype.render.apply(this,arguments)}},{base:"az_checkbox",name:t("Checkbox"),icon:"fa fa-check-square-o",description:t("Form Checkbox field"),params:[{type:"html",heading:t("Options"),param_name:"options",description:t("Separated by new line.")}],hidden:!0,show_settings_on_create:!0,render:function(e,t){for(var a="",i=this.attrs.options.split("\n"),n=0;n<i.length;n++)a+='<div class="'+t+'checkbox"><label><input name="'+btoa(encodeURIComponent(i[n]))+'" type="checkbox" value="'+i[n]+'">'+i[n]+"</label></div>"
